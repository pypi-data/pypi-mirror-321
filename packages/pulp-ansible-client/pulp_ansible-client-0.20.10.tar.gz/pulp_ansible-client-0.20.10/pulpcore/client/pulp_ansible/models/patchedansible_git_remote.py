...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, download_concurrency=None, proxy_url=None, username=None, password=None, sock_connect_timeout=None, ca_cert=None, pulp_labels=None, total_timeout=None, max_retries=None, rate_limit=None, proxy_username=None, sock_read_timeout=None, name=None, headers=None, connect_timeout=None, url=None, client_key=None, tls_validation=None, proxy_password=None, client_cert=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
