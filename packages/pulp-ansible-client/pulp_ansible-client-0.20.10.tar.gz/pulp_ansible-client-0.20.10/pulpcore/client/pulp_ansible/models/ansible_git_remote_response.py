...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, download_concurrency=None, proxy_url=None, pulp_href=None, sock_connect_timeout=None, ca_cert=None, pulp_labels=None, total_timeout=None, pulp_last_updated=None, max_retries=None, rate_limit=None, sock_read_timeout=None, name=None, headers=None, connect_timeout=None, url=None, tls_validation=None, hidden_fields=None, client_cert=None, pulp_created=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
