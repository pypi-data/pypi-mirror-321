...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, sock_read_timeout=None, connect_timeout=None, pulp_last_updated=None, name=None, headers=None, client_cert=None, sock_connect_timeout=None, pulp_labels=None, download_concurrency=None, rate_limit=None, pulp_created=None, url=None, ca_cert=None, hidden_fields=None, proxy_url=None, max_retries=None, tls_validation=None, total_timeout=None, pulp_href=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
