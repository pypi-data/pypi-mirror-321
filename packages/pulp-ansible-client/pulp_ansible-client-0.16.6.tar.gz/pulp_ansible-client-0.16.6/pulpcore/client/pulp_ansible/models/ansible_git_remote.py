...
class AnsibleGitRemote(object):
    ...
    def __init__(self, sock_read_timeout=None, connect_timeout=None, name=None, client_key=None, headers=None, client_cert=None, sock_connect_timeout=None, proxy_username=None, pulp_labels=None, download_concurrency=None, rate_limit=None, url=None, ca_cert=None, proxy_url=None, max_retries=None, password=None, username=None, tls_validation=None, total_timeout=None, proxy_password=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
