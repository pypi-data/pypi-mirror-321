...
class I2cCommandCodes(Enum):
    ...
    """
    I2C_DEINIT                      = makeCommandCode(GROUP_I2C, CommandRole.GENERIC.value, CommandType.REQUEST_RESPONSE.value, 1)
    I2C_SET_PULLUP_RESISTORS        = makeCommandCode(GROUP_I2C, CommandRole.GENERIC.value, CommandType.REQUEST_RESPONSE.value, 2)
    I2C_CONTROLLER_INIT             = makeCommandCode(GROUP_I2C, CommandRole.CONTROLLER.value, CommandType.REQUEST_RESPONSE.value, 1)
    I2C_CONTROLLER_SET_PARAMETERS   = makeCommandCode(GROUP_I2C, CommandRole.CONTROLLER.value, CommandType.REQUEST_RESPONSE.value, 2)
    I2C_CONTROLLER_GET_PARAMETERS   = makeCommandCode(GROUP_I2C, CommandRole.CONTROLLER.value, CommandType.REQUEST_RESPONSE.value, 3)
    I2C_CONTROLLER_WRITE            = makeCommandCode(GROUP_I2C, CommandRole.CONTROLLER.value, CommandType.REQUEST_RESPONSE.value, 4)
    I2C_CONTROLLER_READ             = makeCommandCode(GROUP_I2C, CommandRole.CONTROLLER.value, CommandType.REQUEST_RESPONSE.value, 5)
...
class I2cResultCodes(Enum):
    ...
    """
    I2C_PULLUP_RESISTOR_SETTING_FAILURE = makeResultCode(GROUP_I2C, 1)
    I2C_ARBITRATION_LOST				= makeResultCode(GROUP_I2C, 2)
    I2C_NACK_ADDRESS					= makeResultCode(GROUP_I2C, 3)
    I2C_NACK_BYTE						= makeResultCode(GROUP_I2C, 4)
    I2C_BIT_ERROR						= makeResultCode(GROUP_I2C, 5)
    I2C_START_STOP_ERROR				= makeResultCode(GROUP_I2C, 6)
    I2C_BUSY							= makeResultCode(GROUP_I2C, 7)
    I2C_TIMEOUT_CONTINUE_TRANSFER		= makeResultCode(GROUP_I2C, 8)
    I2C_TIMEOUT_WAITING_BUS_EVENT		= makeResultCode(GROUP_I2C, 9)
    I2C_TIMEOUT_SCL_LOW					= makeResultCode(GROUP_I2C, 10)
    I2C_DMA_REQUEST_FAIL				= makeResultCode(GROUP_I2C, 11)
    I2C_INVALID_PARAMETER				= makeResultCode(GROUP_I2C, 12) 
    I2C_NO_TRANSFER_IN_PROGRESS			= makeResultCode(GROUP_I2C, 13)
    I2C_UNEXPECTED_STATE				= makeResultCode(GROUP_I2C, 14)
