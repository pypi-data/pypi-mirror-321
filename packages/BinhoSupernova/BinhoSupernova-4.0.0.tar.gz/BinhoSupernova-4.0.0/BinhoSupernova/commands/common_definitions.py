...
class CommonResultCodes(Enum):
    ...
    """
    SUCCESS                             = makeResultCode(GROUP_GLOBAL, 0)
    UNSUPPORTED_COMMAND                 = makeResultCode(GROUP_GLOBAL, 1)
    INVALID_COMMAND                     = makeResultCode(GROUP_GLOBAL, 2)
    FULL_RECEPTION_QUEUE                = makeResultCode(GROUP_GLOBAL, 3)
    INVALID_PARAMETER                   = makeResultCode(GROUP_GLOBAL, 4)
    FEATURE_NOT_SUPPORTED_BY_HARDWARE   = makeResultCode(GROUP_GLOBAL, 5)
    BUS_NOT_INITIALIZED                 = makeResultCode(GROUP_GLOBAL, 6)
    BUS_ALREADY_INITIALIZED             = makeResultCode(GROUP_GLOBAL, 7)
    BUS_NOT_SUPPORTED                   = makeResultCode(GROUP_GLOBAL, 8)
    BUS_TIMEOUT                         = makeResultCode(GROUP_GLOBAL, 9)
    RX_FIFO_FULL                        = makeResultCode(GROUP_GLOBAL, 10)
    TX_FIFO_EMPTY                       = makeResultCode(GROUP_GLOBAL, 11)
    UNHANDLED_ERROR                     = makeResultCode(GROUP_GLOBAL, 12)
