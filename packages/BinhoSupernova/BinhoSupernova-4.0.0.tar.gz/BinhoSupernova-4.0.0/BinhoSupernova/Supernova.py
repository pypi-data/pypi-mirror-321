...
"""
from .usb.usb_hid_manager import UsbHidManager, SUPERNOVA_PID
...
class Supernova:
    ...
    def __sendMessage(self, request_metadata) -> None:
        ...
        self.usbHidManager.send(request_metadata["request"])
    ...
    def __onReceiveDriverCallback(self, supernova_response, system_message):
        """
        This function is a built-in callback that is invoked by the usbHidManger attribute when
        a new message is received. It identifies the type of message whether it is a command response
        or an asynchronous notification. If it is command response, it look up the response instance
        from the responsesMap attribute by the command id. Otherwise, invoke the notification constructor
        based on the notification code. Finally, it calls the user-defined callback.
    ...
    @__checkConnection
    def i3cControllerInit(self, id: c_uint16, pushPullRate: I3cPushPullTransferRate, i3cOpenDrainRate: I3cOpenDrainTransferRate, i2cOpenDrainRate: I2cTransferRate) -> dict:
        """
    ...
    @__checkConnection
    def i3cControllerSetParameters(self, id: c_uint16, pushPullRate: I3cPushPullTransferRate, i3cOpenDrainRate: I3cOpenDrainTransferRate, i2cOpenDrainRate: I2cTransferRate) -> dict:
        """
    ...
    def i3cControllerTriggerTargetResetPattern(self, id: c_uint16) -> dict:
        ...
        # Check data validation and serialize the USB request.
        requestSerialization, responseInstance, result = i3cControllerTriggerTargetResetPatternValidator(metadata)
    ...
    def i3cControllerTriggerHdrExitPattern(self, id: c_uint16) -> dict:
        ...
        # Check data validation and serialize the USB request.
        requestSerialization, responseInstance, result = i3cControllerTriggerHdrExitPatternValidator(metadata)
    ...
    @__checkConnection
    def i3cGETCAPS(self, id: c_uint16, targetAddress: c_uint8) -> dict:
        """
    ...
    @__checkConnection
    def i3cDirectENDXFER(self, id: c_uint16, targetAddress, definingByte:c_uint8, data:c_uint8) -> dict:
        """
    ...
    @__checkConnection
    def i3cGETSTATUS(self, id: c_uint16, targetAddress: c_uint8) -> dict:
        """
