...
class UartCommandCodes(Enum):
    ...
    """
    UART_DEINIT                 = makeCommandCode(GROUP_UART, CommandRole.GENERIC.value, CommandType.REQUEST_RESPONSE.value, 1)
    UART_INIT                   = makeCommandCode(GROUP_UART, CommandRole.GENERIC.value, CommandType.REQUEST_RESPONSE.value, 2)
    UART_SET_PARAMETERS         = makeCommandCode(GROUP_UART, CommandRole.GENERIC.value, CommandType.REQUEST_RESPONSE.value, 3)
    UART_GET_PARAMETERS         = makeCommandCode(GROUP_UART, CommandRole.GENERIC.value, CommandType.REQUEST_RESPONSE.value, 4)
    UART_SEND                   = makeCommandCode(GROUP_UART, CommandRole.GENERIC.value, CommandType.REQUEST_RESPONSE.value, 5)
    UART_RECEIVE_NOTIFICATION	= makeCommandCode(GROUP_UART, CommandRole.GENERIC.value, CommandType.NOTIFICATION.value, 1)
