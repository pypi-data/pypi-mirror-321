...
class VannaFlaskAPI:
    ...
    def __init__(
        ...
        def generate_sql(user: any):
            ...
            _LOGGER.info(f'setting question, {id}, {question}')
            self.cache.set(id=id, field='question', value=question)
            _LOGGER.info(f'setting sql, {id}, {sql}')
        ...
        def run_sql(user: any, id: str, sql: str):
            ...
            try:
                # TODO: don't set cap, don't cache--store it somehwhere
                self.cache.set(id=id, field='df', value=df.head(100))
