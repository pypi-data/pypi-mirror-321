...
def statis_log(traffic_type, api_type, service_instance, service_group, service_name, *contents):
    ...
    extra_fields = {'source':source, 'env':env,  'traffic_type': traffic_type, 'api_type': api_type, 'service_instance':service_instance, 'service_group':service_group, 'service_name':service_name, 'log_time':current_time}
