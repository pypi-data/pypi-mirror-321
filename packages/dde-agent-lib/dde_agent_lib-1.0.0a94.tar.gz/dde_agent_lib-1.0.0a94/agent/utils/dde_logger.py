...
def statis_log(traffic_type, api_type, service_instance, service_group, *contents):
    ...
    log_content = f"{current_time}{splitter}{source}{splitter}{env}{splitter}{splitter.join(contents)}"
    extra_fields = {'traffic_type': traffic_type, 'api_type': api_type, 'service_instance':service_instance, 'service_group':service_group}
