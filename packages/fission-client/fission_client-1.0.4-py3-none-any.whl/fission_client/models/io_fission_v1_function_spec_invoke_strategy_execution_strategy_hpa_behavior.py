...
class IoFissionV1FunctionSpecInvokeStrategyExecutionStrategyHpaBehavior(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "scaleDown": IoFissionV1FunctionSpecInvokeStrategyExecutionStrategyHpaBehaviorScaleDown.from_dict(obj["scaleDown"]) if obj.get("scaleDown") is not None else None,
            "scaleUp": IoFissionV1FunctionSpecInvokeStrategyExecutionStrategyHpaBehaviorScaleUp.from_dict(obj["scaleUp"]) if obj.get("scaleUp") is not None else None
        })
        return _obj
