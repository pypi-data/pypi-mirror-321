...
class IoFissionV1EnvironmentSpecBuilderContainerEnvFromInner(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "configMapRef": IoFissionV1EnvironmentSpecBuilderContainerEnvFromInnerConfigMapRef.from_dict(obj["configMapRef"]) if obj.get("configMapRef") is not None else None,
            "prefix": obj.get("prefix"),
            "secretRef": IoFissionV1EnvironmentSpecBuilderContainerEnvFromInnerSecretRef.from_dict(obj["secretRef"]) if obj.get("secretRef") is not None else None
        })
        return _obj
