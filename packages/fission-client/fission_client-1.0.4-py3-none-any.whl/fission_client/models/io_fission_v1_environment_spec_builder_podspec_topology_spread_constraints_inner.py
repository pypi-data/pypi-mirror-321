...
class IoFissionV1EnvironmentSpecBuilderPodspecTopologySpreadConstraintsInner(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "labelSelector": IoFissionV1EnvironmentSpecBuilderPodspecTopologySpreadConstraintsInnerLabelSelector.from_dict(obj["labelSelector"]) if obj.get("labelSelector") is not None else None,
