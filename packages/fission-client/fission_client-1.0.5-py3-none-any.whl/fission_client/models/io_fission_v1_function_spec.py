...
class IoFissionV1FunctionSpec(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "InvokeStrategy": IoFissionV1FunctionSpecInvokeStrategy.from_dict(obj["InvokeStrategy"]) if obj.get("InvokeStrategy") is not None else None,
            "concurrency": obj.get("concurrency"),
            "configmaps": obj.get("configmaps"),
            "environment": IoFissionV1FunctionSpecEnvironment.from_dict(obj["environment"]) if obj.get("environment") is not None else None,
            "functionTimeout": obj.get("functionTimeout"),
            "idletimeout": obj.get("idletimeout"),
            "onceOnly": obj.get("onceOnly"),
            "package": IoFissionV1FunctionSpecPackage.from_dict(obj["package"]) if obj.get("package") is not None else None,
            "podspec": IoFissionV1FunctionSpecPodspec.from_dict(obj["podspec"]) if obj.get("podspec") is not None else None,
            "requestsPerPod": obj.get("requestsPerPod"),
            "resources": IoFissionV1FunctionSpecResources.from_dict(obj["resources"]) if obj.get("resources") is not None else None,
