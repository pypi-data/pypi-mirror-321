...
class ApphubV1EnvironmentSpecBuilderPodspecVolumesInnerCsi(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "nodePublishSecretRef": ApphubV1EnvironmentSpecBuilderPodspecVolumesInnerCsiNodePublishSecretRef.from_dict(obj["nodePublishSecretRef"]) if obj.get("nodePublishSecretRef") is not None else None,
