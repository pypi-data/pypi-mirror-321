...
class ApphubV1FunctionSpecInvokeStrategyExecutionStrategy(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApphubV1FunctionSpecInvokeStrategyExecutionStrategy from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.hpa_metrics:
            for _item_hpa_metrics in self.hpa_metrics:
                if _item_hpa_metrics:
                    _items.append(_item_hpa_metrics.to_dict())
            _dict['hpaMetrics'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApphubV1FunctionSpecInvokeStrategyExecutionStrategy from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "hpaBehavior": ApphubV1FunctionSpecInvokeStrategyExecutionStrategyHpaBehavior.from_dict(obj["hpaBehavior"]) if obj.get("hpaBehavior") is not None else None,
            "hpaMetrics": [ApphubV1FunctionSpecInvokeStrategyExecutionStrategyHpaMetricsInner.from_dict(_item) for _item in obj["hpaMetrics"]] if obj.get("hpaMetrics") is not None else None
        })
        return _obj
