...
class ApphubV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerLivenessProbe(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "grpc": ApphubV1EnvironmentSpecBuilderContainerLivenessProbeGrpc.from_dict(obj["grpc"]) if obj.get("grpc") is not None else None,
            ...
            "tcpSocket": ApphubV1EnvironmentSpecBuilderContainerLivenessProbeTcpSocket.from_dict(obj["tcpSocket"]) if obj.get("tcpSocket") is not None else None,
