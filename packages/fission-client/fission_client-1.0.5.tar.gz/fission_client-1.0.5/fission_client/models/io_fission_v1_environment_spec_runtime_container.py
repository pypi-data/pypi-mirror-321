...
class IoFissionV1EnvironmentSpecRuntimeContainer(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lifecycle": IoFissionV1EnvironmentSpecBuilderContainerLifecycle.from_dict(obj["lifecycle"]) if obj.get("lifecycle") is not None else None,
            "livenessProbe": IoFissionV1EnvironmentSpecBuilderContainerLivenessProbe.from_dict(obj["livenessProbe"]) if obj.get("livenessProbe") is not None else None,
            "name": obj.get("name"),
            ...
            "readinessProbe": IoFissionV1EnvironmentSpecBuilderContainerReadinessProbe.from_dict(obj["readinessProbe"]) if obj.get("readinessProbe") is not None else None,
            ...
            "resources": IoFissionV1EnvironmentSpecBuilderContainerResources.from_dict(obj["resources"]) if obj.get("resources") is not None else None,
            "restartPolicy": obj.get("restartPolicy"),
            "securityContext": IoFissionV1EnvironmentSpecBuilderContainerSecurityContext.from_dict(obj["securityContext"]) if obj.get("securityContext") is not None else None,
            "startupProbe": IoFissionV1EnvironmentSpecBuilderContainerStartupProbe.from_dict(obj["startupProbe"]) if obj.get("startupProbe") is not None else None,
            "stdin": obj.get("stdin"),
