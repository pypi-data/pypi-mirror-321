...
class IoFissionV1EnvironmentSpecRuntimePodspec(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "affinity": IoFissionV1EnvironmentSpecBuilderPodspecAffinity.from_dict(obj["affinity"]) if obj.get("affinity") is not None else None,
            "automountServiceAccountToken": obj.get("automountServiceAccountToken"),
            "containers": [IoFissionV1EnvironmentSpecBuilderPodspecContainersInner.from_dict(_item) for _item in obj["containers"]] if obj.get("containers") is not None else None,
            "dnsConfig": IoFissionV1EnvironmentSpecBuilderPodspecDnsConfig.from_dict(obj["dnsConfig"]) if obj.get("dnsConfig") is not None else None,
            "dnsPolicy": obj.get("dnsPolicy"),
            "enableServiceLinks": obj.get("enableServiceLinks"),
            "ephemeralContainers": [IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInner.from_dict(_item) for _item in obj["ephemeralContainers"]] if obj.get("ephemeralContainers") is not None else None,
            "hostAliases": [IoFissionV1EnvironmentSpecBuilderPodspecHostAliasesInner.from_dict(_item) for _item in obj["hostAliases"]] if obj.get("hostAliases") is not None else None,
            "hostIPC": obj.get("hostIPC"),
            "hostNetwork": obj.get("hostNetwork"),
            "hostPID": obj.get("hostPID"),
            "hostUsers": obj.get("hostUsers"),
            "hostname": obj.get("hostname"),
            "imagePullSecrets": [IoFissionV1EnvironmentSpecBuilderPodspecImagePullSecretsInner.from_dict(_item) for _item in obj["imagePullSecrets"]] if obj.get("imagePullSecrets") is not None else None,
            "initContainers": [IoFissionV1EnvironmentSpecBuilderPodspecContainersInner.from_dict(_item) for _item in obj["initContainers"]] if obj.get("initContainers") is not None else None,
            "nodeName": obj.get("nodeName"),
            "nodeSelector": obj.get("nodeSelector"),
            "os": IoFissionV1EnvironmentSpecBuilderPodspecOs.from_dict(obj["os"]) if obj.get("os") is not None else None,
            "overhead": obj.get("overhead"),
            "preemptionPolicy": obj.get("preemptionPolicy"),
            "priority": obj.get("priority"),
            "priorityClassName": obj.get("priorityClassName"),
            "readinessGates": [IoFissionV1EnvironmentSpecBuilderPodspecReadinessGatesInner.from_dict(_item) for _item in obj["readinessGates"]] if obj.get("readinessGates") is not None else None,
            "resourceClaims": [IoFissionV1EnvironmentSpecBuilderPodspecResourceClaimsInner.from_dict(_item) for _item in obj["resourceClaims"]] if obj.get("resourceClaims") is not None else None,
            "restartPolicy": obj.get("restartPolicy"),
            "runtimeClassName": obj.get("runtimeClassName"),
            "schedulerName": obj.get("schedulerName"),
            "schedulingGates": [IoFissionV1EnvironmentSpecBuilderPodspecSchedulingGatesInner.from_dict(_item) for _item in obj["schedulingGates"]] if obj.get("schedulingGates") is not None else None,
            "securityContext": IoFissionV1EnvironmentSpecBuilderPodspecSecurityContext.from_dict(obj["securityContext"]) if obj.get("securityContext") is not None else None,
            ...
            "tolerations": [IoFissionV1EnvironmentSpecBuilderPodspecTolerationsInner.from_dict(_item) for _item in obj["tolerations"]] if obj.get("tolerations") is not None else None,
            "topologySpreadConstraints": [IoFissionV1EnvironmentSpecBuilderPodspecTopologySpreadConstraintsInner.from_dict(_item) for _item in obj["topologySpreadConstraints"]] if obj.get("topologySpreadConstraints") is not None else None,
            "volumes": [IoFissionV1EnvironmentSpecBuilderPodspecVolumesInner.from_dict(_item) for _item in obj["volumes"]] if obj.get("volumes") is not None else None
        })
        return _obj
