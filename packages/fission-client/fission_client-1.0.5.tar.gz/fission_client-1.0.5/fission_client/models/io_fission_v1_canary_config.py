...
class IoFissionV1CanaryConfig(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": IoFissionV1CanaryConfigSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": IoFissionV1CanaryConfigStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
