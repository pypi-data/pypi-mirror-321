...
class IoFissionV1EnvironmentSpecBuilderPodspecVolumesInner(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "awsElasticBlockStore": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerAwsElasticBlockStore.from_dict(obj["awsElasticBlockStore"]) if obj.get("awsElasticBlockStore") is not None else None,
            "azureDisk": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerAzureDisk.from_dict(obj["azureDisk"]) if obj.get("azureDisk") is not None else None,
            "azureFile": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerAzureFile.from_dict(obj["azureFile"]) if obj.get("azureFile") is not None else None,
            "cephfs": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerCephfs.from_dict(obj["cephfs"]) if obj.get("cephfs") is not None else None,
            "cinder": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerCinder.from_dict(obj["cinder"]) if obj.get("cinder") is not None else None,
            "configMap": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerConfigMap.from_dict(obj["configMap"]) if obj.get("configMap") is not None else None,
            "csi": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerCsi.from_dict(obj["csi"]) if obj.get("csi") is not None else None,
            "downwardAPI": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerDownwardAPI.from_dict(obj["downwardAPI"]) if obj.get("downwardAPI") is not None else None,
            "emptyDir": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerEmptyDir.from_dict(obj["emptyDir"]) if obj.get("emptyDir") is not None else None,
            "ephemeral": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerEphemeral.from_dict(obj["ephemeral"]) if obj.get("ephemeral") is not None else None,
            "fc": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerFc.from_dict(obj["fc"]) if obj.get("fc") is not None else None,
            "flexVolume": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerFlexVolume.from_dict(obj["flexVolume"]) if obj.get("flexVolume") is not None else None,
            "flocker": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerFlocker.from_dict(obj["flocker"]) if obj.get("flocker") is not None else None,
            "gcePersistentDisk": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerGcePersistentDisk.from_dict(obj["gcePersistentDisk"]) if obj.get("gcePersistentDisk") is not None else None,
            "gitRepo": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerGitRepo.from_dict(obj["gitRepo"]) if obj.get("gitRepo") is not None else None,
            "glusterfs": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerGlusterfs.from_dict(obj["glusterfs"]) if obj.get("glusterfs") is not None else None,
            "hostPath": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerHostPath.from_dict(obj["hostPath"]) if obj.get("hostPath") is not None else None,
            "image": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerImage.from_dict(obj["image"]) if obj.get("image") is not None else None,
            "iscsi": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerIscsi.from_dict(obj["iscsi"]) if obj.get("iscsi") is not None else None,
            "name": obj.get("name"),
            "nfs": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerNfs.from_dict(obj["nfs"]) if obj.get("nfs") is not None else None,
            "persistentVolumeClaim": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerPersistentVolumeClaim.from_dict(obj["persistentVolumeClaim"]) if obj.get("persistentVolumeClaim") is not None else None,
            "photonPersistentDisk": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerPhotonPersistentDisk.from_dict(obj["photonPersistentDisk"]) if obj.get("photonPersistentDisk") is not None else None,
            "portworxVolume": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerPortworxVolume.from_dict(obj["portworxVolume"]) if obj.get("portworxVolume") is not None else None,
            "projected": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerProjected.from_dict(obj["projected"]) if obj.get("projected") is not None else None,
            "quobyte": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerQuobyte.from_dict(obj["quobyte"]) if obj.get("quobyte") is not None else None,
            "rbd": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerRbd.from_dict(obj["rbd"]) if obj.get("rbd") is not None else None,
            "scaleIO": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerScaleIO.from_dict(obj["scaleIO"]) if obj.get("scaleIO") is not None else None,
            "secret": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerSecret.from_dict(obj["secret"]) if obj.get("secret") is not None else None,
            "storageos": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerStorageos.from_dict(obj["storageos"]) if obj.get("storageos") is not None else None,
            "vsphereVolume": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerVsphereVolume.from_dict(obj["vsphereVolume"]) if obj.get("vsphereVolume") is not None else None
        })
        return _obj
