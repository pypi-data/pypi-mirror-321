...
class ApphubV1EnvironmentSpec(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "builder": ApphubV1EnvironmentSpecBuilder.from_dict(obj["builder"]) if obj.get("builder") is not None else None,
            "imagepullsecret": obj.get("imagepullsecret"),
            "keeparchive": obj.get("keeparchive"),
            "poolsize": obj.get("poolsize"),
            "resources": ApphubV1EnvironmentSpecResources.from_dict(obj["resources"]) if obj.get("resources") is not None else None,
            "runtime": ApphubV1EnvironmentSpecRuntime.from_dict(obj["runtime"]) if obj.get("runtime") is not None else None,
