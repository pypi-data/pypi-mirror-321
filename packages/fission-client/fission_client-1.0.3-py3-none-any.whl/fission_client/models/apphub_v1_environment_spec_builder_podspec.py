...
class ApphubV1EnvironmentSpecBuilderPodspec(BaseModel):
    """
    ...
    affinity: Optional[ApphubV1EnvironmentSpecBuilderPodspecAffinity] = None
    ...
    containers: List[ApphubV1EnvironmentSpecBuilderPodspecContainersInner] = Field(description="List of containers belonging to the pod. Containers cannot currently be added or removed. There must be at least one container in a Pod. Cannot be updated.")
    dns_config: Optional[ApphubV1EnvironmentSpecBuilderPodspecDnsConfig] = Field(default=None, alias="dnsConfig")
    ...
    ephemeral_containers: Optional[List[ApphubV1EnvironmentSpecBuilderPodspecEphemeralContainersInner]] = Field(default=None, description="List of ephemeral containers run in this pod. Ephemeral containers may be run in an existing pod to perform user-initiated actions such as debugging. This list cannot be specified when creating a pod, and it cannot be modified by updating the pod spec. In order to add an ephemeral container to an existing pod, use the pod's ephemeralcontainers subresource.", alias="ephemeralContainers")
    host_aliases: Optional[List[ApphubV1EnvironmentSpecBuilderPodspecHostAliasesInner]] = Field(default=None, description="HostAliases is an optional list of hosts and IPs that will be injected into the pod's hosts file if specified.", alias="hostAliases")
    ...
    image_pull_secrets: Optional[List[ApphubV1EnvironmentSpecBuilderPodspecImagePullSecretsInner]] = Field(default=None, description="ImagePullSecrets is an optional list of references to secrets in the same namespace to use for pulling any of the images used by this PodSpec. If specified, these secrets will be passed to individual puller implementations for them to use. More info: https://kubernetes.io/docs/concepts/containers/images#specifying-imagepullsecrets-on-a-pod", alias="imagePullSecrets")
    init_containers: Optional[List[ApphubV1EnvironmentSpecBuilderPodspecContainersInner]] = Field(default=None, description="List of initialization containers belonging to the pod. Init containers are executed in order prior to containers being started. If any init container fails, the pod is considered to have failed and is handled according to its restartPolicy. The name for an init container or normal container must be unique among all containers. Init containers may not have Lifecycle actions, Readiness probes, Liveness probes, or Startup probes. The resourceRequirements of an init container are taken into account during scheduling by finding the highest request/limit for each resource type, and then using the max of of that value or the sum of the normal containers. Limits are applied to init containers in a similar fashion. Init containers cannot currently be added or removed. Cannot be updated. More info: https://kubernetes.io/docs/concepts/workloads/pods/init-containers/", alias="initContainers")
    ...
    os: Optional[ApphubV1EnvironmentSpecBuilderPodspecOs] = None
    ...
    readiness_gates: Optional[List[ApphubV1EnvironmentSpecBuilderPodspecReadinessGatesInner]] = Field(default=None, description="If specified, all readiness gates will be evaluated for pod readiness. A pod is ready when all its containers are ready AND all conditions specified in the readiness gates have status equal to \"True\" More info: https://git.k8s.io/enhancements/keps/sig-network/580-pod-readiness-gates", alias="readinessGates")
    resource_claims: Optional[List[ApphubV1EnvironmentSpecBuilderPodspecResourceClaimsInner]] = Field(default=None, description="ResourceClaims defines which ResourceClaims must be allocated and reserved before the Pod is allowed to start. The resources will be made available to those containers which consume them by name.  This is an alpha field and requires enabling the DynamicResourceAllocation feature gate.  This field is immutable.", alias="resourceClaims")
    ...
    scheduling_gates: Optional[List[ApphubV1EnvironmentSpecBuilderPodspecSchedulingGatesInner]] = Field(default=None, description="SchedulingGates is an opaque list of values that if specified will block scheduling the pod. If schedulingGates is not empty, the pod will stay in the SchedulingGated state and the scheduler will not attempt to schedule the pod.  SchedulingGates can only be set at pod creation time, and be removed only afterwards.", alias="schedulingGates")
    security_context: Optional[ApphubV1EnvironmentSpecBuilderPodspecSecurityContext] = Field(default=None, alias="securityContext")
    ...
    tolerations: Optional[List[ApphubV1EnvironmentSpecBuilderPodspecTolerationsInner]] = Field(default=None, description="If specified, the pod's tolerations.")
    topology_spread_constraints: Optional[List[ApphubV1EnvironmentSpecBuilderPodspecTopologySpreadConstraintsInner]] = Field(default=None, description="TopologySpreadConstraints describes how a group of pods ought to spread across topology domains. Scheduler will schedule pods in a way which abides by the constraints. All topologySpreadConstraints are ANDed.", alias="topologySpreadConstraints")
    volumes: Optional[List[ApphubV1EnvironmentSpecBuilderPodspecVolumesInner]] = Field(default=None, description="List of volumes that can be mounted by containers belonging to the pod. More info: https://kubernetes.io/docs/concepts/storage/volumes")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApphubV1EnvironmentSpecBuilderPodspec from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApphubV1EnvironmentSpecBuilderPodspec from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "affinity": ApphubV1EnvironmentSpecBuilderPodspecAffinity.from_dict(obj["affinity"]) if obj.get("affinity") is not None else None,
            "automountServiceAccountToken": obj.get("automountServiceAccountToken"),
            "containers": [ApphubV1EnvironmentSpecBuilderPodspecContainersInner.from_dict(_item) for _item in obj["containers"]] if obj.get("containers") is not None else None,
            "dnsConfig": ApphubV1EnvironmentSpecBuilderPodspecDnsConfig.from_dict(obj["dnsConfig"]) if obj.get("dnsConfig") is not None else None,
            "dnsPolicy": obj.get("dnsPolicy"),
            "enableServiceLinks": obj.get("enableServiceLinks"),
            "ephemeralContainers": [ApphubV1EnvironmentSpecBuilderPodspecEphemeralContainersInner.from_dict(_item) for _item in obj["ephemeralContainers"]] if obj.get("ephemeralContainers") is not None else None,
            "hostAliases": [ApphubV1EnvironmentSpecBuilderPodspecHostAliasesInner.from_dict(_item) for _item in obj["hostAliases"]] if obj.get("hostAliases") is not None else None,
            "hostIPC": obj.get("hostIPC"),
            "hostNetwork": obj.get("hostNetwork"),
            "hostPID": obj.get("hostPID"),
            "hostUsers": obj.get("hostUsers"),
            "hostname": obj.get("hostname"),
            "imagePullSecrets": [ApphubV1EnvironmentSpecBuilderPodspecImagePullSecretsInner.from_dict(_item) for _item in obj["imagePullSecrets"]] if obj.get("imagePullSecrets") is not None else None,
            "initContainers": [ApphubV1EnvironmentSpecBuilderPodspecContainersInner.from_dict(_item) for _item in obj["initContainers"]] if obj.get("initContainers") is not None else None,
            "nodeName": obj.get("nodeName"),
            "nodeSelector": obj.get("nodeSelector"),
            "os": ApphubV1EnvironmentSpecBuilderPodspecOs.from_dict(obj["os"]) if obj.get("os") is not None else None,
            "overhead": obj.get("overhead"),
            "preemptionPolicy": obj.get("preemptionPolicy"),
            "priority": obj.get("priority"),
            "priorityClassName": obj.get("priorityClassName"),
            "readinessGates": [ApphubV1EnvironmentSpecBuilderPodspecReadinessGatesInner.from_dict(_item) for _item in obj["readinessGates"]] if obj.get("readinessGates") is not None else None,
            "resourceClaims": [ApphubV1EnvironmentSpecBuilderPodspecResourceClaimsInner.from_dict(_item) for _item in obj["resourceClaims"]] if obj.get("resourceClaims") is not None else None,
            "restartPolicy": obj.get("restartPolicy"),
            "runtimeClassName": obj.get("runtimeClassName"),
            "schedulerName": obj.get("schedulerName"),
            "schedulingGates": [ApphubV1EnvironmentSpecBuilderPodspecSchedulingGatesInner.from_dict(_item) for _item in obj["schedulingGates"]] if obj.get("schedulingGates") is not None else None,
            "securityContext": ApphubV1EnvironmentSpecBuilderPodspecSecurityContext.from_dict(obj["securityContext"]) if obj.get("securityContext") is not None else None,
            ...
            "tolerations": [ApphubV1EnvironmentSpecBuilderPodspecTolerationsInner.from_dict(_item) for _item in obj["tolerations"]] if obj.get("tolerations") is not None else None,
            "topologySpreadConstraints": [ApphubV1EnvironmentSpecBuilderPodspecTopologySpreadConstraintsInner.from_dict(_item) for _item in obj["topologySpreadConstraints"]] if obj.get("topologySpreadConstraints") is not None else None,
            "volumes": [ApphubV1EnvironmentSpecBuilderPodspecVolumesInner.from_dict(_item) for _item in obj["volumes"]] if obj.get("volumes") is not None else None
        })
        return _obj
