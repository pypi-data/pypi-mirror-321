...
class ApphubV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerSecurityContext(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "appArmorProfile": ApphubV1EnvironmentSpecBuilderContainerSecurityContextAppArmorProfile.from_dict(obj["appArmorProfile"]) if obj.get("appArmorProfile") is not None else None,
            "capabilities": ApphubV1EnvironmentSpecBuilderContainerSecurityContextCapabilities.from_dict(obj["capabilities"]) if obj.get("capabilities") is not None else None,
            ...
            "seLinuxOptions": ApphubV1EnvironmentSpecBuilderContainerSecurityContextSeLinuxOptions.from_dict(obj["seLinuxOptions"]) if obj.get("seLinuxOptions") is not None else None,
            "seccompProfile": ApphubV1EnvironmentSpecBuilderContainerSecurityContextSeccompProfile.from_dict(obj["seccompProfile"]) if obj.get("seccompProfile") is not None else None,
            "windowsOptions": ApphubV1EnvironmentSpecBuilderContainerSecurityContextWindowsOptions.from_dict(obj["windowsOptions"]) if obj.get("windowsOptions") is not None else None
        })
        return _obj
