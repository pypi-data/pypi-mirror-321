...
class IoFissionV1EnvironmentSpecBuilderPodspecSecurityContext(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "appArmorProfile": IoFissionV1EnvironmentSpecBuilderPodspecSecurityContextAppArmorProfile.from_dict(obj["appArmorProfile"]) if obj.get("appArmorProfile") is not None else None,
            ...
            "seLinuxOptions": IoFissionV1EnvironmentSpecBuilderPodspecSecurityContextSeLinuxOptions.from_dict(obj["seLinuxOptions"]) if obj.get("seLinuxOptions") is not None else None,
            "seccompProfile": IoFissionV1EnvironmentSpecBuilderPodspecSecurityContextSeccompProfile.from_dict(obj["seccompProfile"]) if obj.get("seccompProfile") is not None else None,
            "supplementalGroups": obj.get("supplementalGroups"),
            "supplementalGroupsPolicy": obj.get("supplementalGroupsPolicy"),
            "sysctls": [IoFissionV1EnvironmentSpecBuilderPodspecSecurityContextSysctlsInner.from_dict(_item) for _item in obj["sysctls"]] if obj.get("sysctls") is not None else None,
            "windowsOptions": IoFissionV1EnvironmentSpecBuilderPodspecSecurityContextWindowsOptions.from_dict(obj["windowsOptions"]) if obj.get("windowsOptions") is not None else None
        })
        return _obj
