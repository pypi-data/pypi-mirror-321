...
class IoFissionV1EnvironmentSpecBuilderPodspecDnsConfig(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "options": [IoFissionV1EnvironmentSpecBuilderPodspecDnsConfigOptionsInner.from_dict(_item) for _item in obj["options"]] if obj.get("options") is not None else None,
