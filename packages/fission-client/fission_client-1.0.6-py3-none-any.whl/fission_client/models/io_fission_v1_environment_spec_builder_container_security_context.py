...
class IoFissionV1EnvironmentSpecBuilderContainerSecurityContext(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "appArmorProfile": IoFissionV1EnvironmentSpecBuilderContainerSecurityContextAppArmorProfile.from_dict(obj["appArmorProfile"]) if obj.get("appArmorProfile") is not None else None,
            "capabilities": IoFissionV1EnvironmentSpecBuilderContainerSecurityContextCapabilities.from_dict(obj["capabilities"]) if obj.get("capabilities") is not None else None,
            ...
            "seLinuxOptions": IoFissionV1EnvironmentSpecBuilderContainerSecurityContextSeLinuxOptions.from_dict(obj["seLinuxOptions"]) if obj.get("seLinuxOptions") is not None else None,
            "seccompProfile": IoFissionV1EnvironmentSpecBuilderContainerSecurityContextSeccompProfile.from_dict(obj["seccompProfile"]) if obj.get("seccompProfile") is not None else None,
            "windowsOptions": IoFissionV1EnvironmentSpecBuilderContainerSecurityContextWindowsOptions.from_dict(obj["windowsOptions"]) if obj.get("windowsOptions") is not None else None
        })
        return _obj
