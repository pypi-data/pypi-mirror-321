...
class IoFissionV1FunctionSpecInvokeStrategyExecutionStrategyHpaMetricsInnerObject(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "describedObject": IoFissionV1FunctionSpecInvokeStrategyExecutionStrategyHpaMetricsInnerObjectDescribedObject.from_dict(obj["describedObject"]) if obj.get("describedObject") is not None else None,
            "metric": IoFissionV1FunctionSpecInvokeStrategyExecutionStrategyHpaMetricsInnerExternalMetric.from_dict(obj["metric"]) if obj.get("metric") is not None else None,
            "target": IoFissionV1FunctionSpecInvokeStrategyExecutionStrategyHpaMetricsInnerContainerResourceTarget.from_dict(obj["target"]) if obj.get("target") is not None else None
        })
        return _obj
