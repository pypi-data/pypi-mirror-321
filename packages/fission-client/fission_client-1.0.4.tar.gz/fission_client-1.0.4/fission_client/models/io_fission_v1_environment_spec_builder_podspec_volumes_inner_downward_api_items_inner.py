...
class IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerDownwardAPIItemsInner(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fieldRef": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerDownwardAPIItemsInnerFieldRef.from_dict(obj["fieldRef"]) if obj.get("fieldRef") is not None else None,
            "mode": obj.get("mode"),
            "path": obj.get("path"),
            "resourceFieldRef": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerDownwardAPIItemsInnerResourceFieldRef.from_dict(obj["resourceFieldRef"]) if obj.get("resourceFieldRef") is not None else None
        })
        return _obj
