...
class IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInner(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "env": [IoFissionV1EnvironmentSpecBuilderContainerEnvInner.from_dict(_item) for _item in obj["env"]] if obj.get("env") is not None else None,
            "envFrom": [IoFissionV1EnvironmentSpecBuilderContainerEnvFromInner.from_dict(_item) for _item in obj["envFrom"]] if obj.get("envFrom") is not None else None,
            "image": obj.get("image"),
            "imagePullPolicy": obj.get("imagePullPolicy"),
            "lifecycle": IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerLifecycle.from_dict(obj["lifecycle"]) if obj.get("lifecycle") is not None else None,
            "livenessProbe": IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerLivenessProbe.from_dict(obj["livenessProbe"]) if obj.get("livenessProbe") is not None else None,
            "name": obj.get("name"),
            "ports": [IoFissionV1EnvironmentSpecBuilderContainerPortsInner.from_dict(_item) for _item in obj["ports"]] if obj.get("ports") is not None else None,
            "readinessProbe": IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerLivenessProbe.from_dict(obj["readinessProbe"]) if obj.get("readinessProbe") is not None else None,
            "resizePolicy": [IoFissionV1EnvironmentSpecBuilderContainerResizePolicyInner.from_dict(_item) for _item in obj["resizePolicy"]] if obj.get("resizePolicy") is not None else None,
            "resources": IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerResources.from_dict(obj["resources"]) if obj.get("resources") is not None else None,
            "restartPolicy": obj.get("restartPolicy"),
            "securityContext": IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerSecurityContext.from_dict(obj["securityContext"]) if obj.get("securityContext") is not None else None,
            "startupProbe": IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerLivenessProbe.from_dict(obj["startupProbe"]) if obj.get("startupProbe") is not None else None,
            "stdin": obj.get("stdin"),
            ...
            "tty": obj.get("tty"),
            "volumeDevices": [IoFissionV1EnvironmentSpecBuilderContainerVolumeDevicesInner.from_dict(_item) for _item in obj["volumeDevices"]] if obj.get("volumeDevices") is not None else None,
            "volumeMounts": [IoFissionV1EnvironmentSpecBuilderContainerVolumeMountsInner.from_dict(_item) for _item in obj["volumeMounts"]] if obj.get("volumeMounts") is not None else None,
