...
class IoFissionV1FunctionSpecInvokeStrategyExecutionStrategyHpaMetricsInner(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "containerResource": IoFissionV1FunctionSpecInvokeStrategyExecutionStrategyHpaMetricsInnerContainerResource.from_dict(obj["containerResource"]) if obj.get("containerResource") is not None else None,
            "external": IoFissionV1FunctionSpecInvokeStrategyExecutionStrategyHpaMetricsInnerExternal.from_dict(obj["external"]) if obj.get("external") is not None else None,
            "object": IoFissionV1FunctionSpecInvokeStrategyExecutionStrategyHpaMetricsInnerObject.from_dict(obj["object"]) if obj.get("object") is not None else None,
            "pods": IoFissionV1FunctionSpecInvokeStrategyExecutionStrategyHpaMetricsInnerPods.from_dict(obj["pods"]) if obj.get("pods") is not None else None,
            "resource": IoFissionV1FunctionSpecInvokeStrategyExecutionStrategyHpaMetricsInnerResource.from_dict(obj["resource"]) if obj.get("resource") is not None else None,
            "type": obj.get("type")
        })
        return _obj
