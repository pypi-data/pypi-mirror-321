...
class IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerLifecycle(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "postStart": IoFissionV1EnvironmentSpecBuilderContainerLifecyclePostStart.from_dict(obj["postStart"]) if obj.get("postStart") is not None else None,
            "preStop": IoFissionV1EnvironmentSpecBuilderContainerLifecyclePreStop.from_dict(obj["preStop"]) if obj.get("preStop") is not None else None
        })
        return _obj
