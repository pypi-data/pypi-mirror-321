...
class IoFissionV1EnvironmentSpecBuilderPodspecAffinity(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "nodeAffinity": IoFissionV1EnvironmentSpecBuilderPodspecAffinityNodeAffinity.from_dict(obj["nodeAffinity"]) if obj.get("nodeAffinity") is not None else None,
            "podAffinity": IoFissionV1EnvironmentSpecBuilderPodspecAffinityPodAffinity.from_dict(obj["podAffinity"]) if obj.get("podAffinity") is not None else None,
            "podAntiAffinity": IoFissionV1EnvironmentSpecBuilderPodspecAffinityPodAntiAffinity.from_dict(obj["podAntiAffinity"]) if obj.get("podAntiAffinity") is not None else None
        })
        return _obj
