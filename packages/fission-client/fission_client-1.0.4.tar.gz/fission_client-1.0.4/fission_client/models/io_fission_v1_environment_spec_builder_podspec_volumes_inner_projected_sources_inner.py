...
class IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerProjectedSourcesInner(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "clusterTrustBundle": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerProjectedSourcesInnerClusterTrustBundle.from_dict(obj["clusterTrustBundle"]) if obj.get("clusterTrustBundle") is not None else None,
            "configMap": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerProjectedSourcesInnerConfigMap.from_dict(obj["configMap"]) if obj.get("configMap") is not None else None,
            "downwardAPI": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerProjectedSourcesInnerDownwardAPI.from_dict(obj["downwardAPI"]) if obj.get("downwardAPI") is not None else None,
            "secret": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerProjectedSourcesInnerSecret.from_dict(obj["secret"]) if obj.get("secret") is not None else None,
            "serviceAccountToken": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerProjectedSourcesInnerServiceAccountToken.from_dict(obj["serviceAccountToken"]) if obj.get("serviceAccountToken") is not None else None
        })
        return _obj
