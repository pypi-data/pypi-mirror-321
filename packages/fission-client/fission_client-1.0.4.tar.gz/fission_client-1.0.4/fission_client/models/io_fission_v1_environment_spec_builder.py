...
class IoFissionV1EnvironmentSpecBuilder(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "container": IoFissionV1EnvironmentSpecBuilderContainer.from_dict(obj["container"]) if obj.get("container") is not None else None,
            "image": obj.get("image"),
            "podspec": IoFissionV1EnvironmentSpecBuilderPodspec.from_dict(obj["podspec"]) if obj.get("podspec") is not None else None
        })
        return _obj
