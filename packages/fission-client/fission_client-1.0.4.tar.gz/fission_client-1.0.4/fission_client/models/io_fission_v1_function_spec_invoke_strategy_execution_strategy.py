...
class IoFissionV1FunctionSpecInvokeStrategyExecutionStrategy(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hpaBehavior": IoFissionV1FunctionSpecInvokeStrategyExecutionStrategyHpaBehavior.from_dict(obj["hpaBehavior"]) if obj.get("hpaBehavior") is not None else None,
            "hpaMetrics": [IoFissionV1FunctionSpecInvokeStrategyExecutionStrategyHpaMetricsInner.from_dict(_item) for _item in obj["hpaMetrics"]] if obj.get("hpaMetrics") is not None else None
        })
        return _obj
