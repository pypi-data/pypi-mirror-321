...
class IoFissionV1EnvironmentSpecBuilderContainerLifecyclePostStart(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "exec": IoFissionV1EnvironmentSpecBuilderContainerLifecyclePostStartExec.from_dict(obj["exec"]) if obj.get("exec") is not None else None,
            "httpGet": IoFissionV1EnvironmentSpecBuilderContainerLifecyclePostStartHttpGet.from_dict(obj["httpGet"]) if obj.get("httpGet") is not None else None,
            "sleep": IoFissionV1EnvironmentSpecBuilderContainerLifecyclePostStartSleep.from_dict(obj["sleep"]) if obj.get("sleep") is not None else None,
            "tcpSocket": IoFissionV1EnvironmentSpecBuilderContainerLifecyclePostStartTcpSocket.from_dict(obj["tcpSocket"]) if obj.get("tcpSocket") is not None else None
        })
        return _obj
