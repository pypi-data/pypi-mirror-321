...
class IoFissionV1EnvironmentSpecBuilderContainerEnvInnerValueFrom(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "configMapKeyRef": IoFissionV1EnvironmentSpecBuilderContainerEnvInnerValueFromConfigMapKeyRef.from_dict(obj["configMapKeyRef"]) if obj.get("configMapKeyRef") is not None else None,
            "fieldRef": IoFissionV1EnvironmentSpecBuilderContainerEnvInnerValueFromFieldRef.from_dict(obj["fieldRef"]) if obj.get("fieldRef") is not None else None,
            "resourceFieldRef": IoFissionV1EnvironmentSpecBuilderContainerEnvInnerValueFromResourceFieldRef.from_dict(obj["resourceFieldRef"]) if obj.get("resourceFieldRef") is not None else None,
            "secretKeyRef": IoFissionV1EnvironmentSpecBuilderContainerEnvInnerValueFromSecretKeyRef.from_dict(obj["secretKeyRef"]) if obj.get("secretKeyRef") is not None else None
        })
        return _obj
