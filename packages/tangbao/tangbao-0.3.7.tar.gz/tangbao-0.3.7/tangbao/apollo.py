...
class Apollo:
    ...
    class ApolloOpenAI(openai.OpenAI):
        def __init__(self, client_id: str, client_secret_str, token_url: str, base_url: str):
            ...
            super().__init__(api_key=self._apollo_credentials.request_new_token(), base_url=base_url)
