...
class OrderIdentifier(BaseModel):
    ...
    identifier_id: Optional[StrictInt] = Field(default=None, alias="IdentifierId")
    ...
    __properties: ClassVar[List[str]] = ["fkOrderId", "IdentifierId", "IsCustom", "ImageId", "ImageUrl", "Tag", "Name"]
