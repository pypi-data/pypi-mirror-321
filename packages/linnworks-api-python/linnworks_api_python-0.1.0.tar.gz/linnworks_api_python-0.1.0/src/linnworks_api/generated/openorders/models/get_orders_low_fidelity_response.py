...
class GetOrdersLowFidelityResponse(BaseModel):
    """
    GetOrdersLowFidelityResponse
    """ # noqa: E501
    orders: Optional[List[OpenOrderLowFidelity]] = Field(default=None, description="List of low fidelity order headers with order items, composites and product identifiers", alias="Orders")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Orders": [OpenOrderLowFidelity.from_dict(_item) for _item in obj["Orders"]] if obj.get("Orders") is not None else None
        })
        return _obj
