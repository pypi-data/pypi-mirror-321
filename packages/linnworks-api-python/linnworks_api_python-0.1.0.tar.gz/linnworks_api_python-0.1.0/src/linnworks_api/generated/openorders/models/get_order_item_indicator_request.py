...
class GetOrderItemIndicatorRequest(BaseModel):
    """
    GetOrderItemIndicatorRequest
    """ # noqa: E501
    location_id: Optional[StrictStr] = Field(default=None, alias="LocationId")
    items: Optional[List[IndicatorRequest]] = Field(default=None, alias="Items")
    __properties: ClassVar[List[str]] = ["LocationId", "Items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Items": [IndicatorRequest.from_dict(_item) for _item in obj["Items"]] if obj.get("Items") is not None else None
        })
        return _obj
