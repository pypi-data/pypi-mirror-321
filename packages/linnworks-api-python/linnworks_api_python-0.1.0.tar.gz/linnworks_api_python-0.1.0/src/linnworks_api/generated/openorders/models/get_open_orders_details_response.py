...
class GetOpenOrdersDetailsResponse(BaseModel):
    """
    GetOpenOrdersDetailsResponse
    """ # noqa: E501
    orders: Optional[List[OrderDetails]] = Field(default=None, description="List of orders", alias="Orders")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Orders": [OrderDetails.from_dict(_item) for _item in obj["Orders"]] if obj.get("Orders") is not None else None
        })
        return _obj
