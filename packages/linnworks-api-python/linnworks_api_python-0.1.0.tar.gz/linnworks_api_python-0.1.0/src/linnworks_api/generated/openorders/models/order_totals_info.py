...
class OrderTotalsInfo(BaseModel):
    """
    OrderTotalsInfo
    """ # noqa: E501
    ...
    total_charge: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="TotalCharge")
    ...
    __properties: ClassVar[List[str]] = ["Subtotal", "PostageCost", "PostageCostExTax", "Tax", "TotalCharge", "PaymentMethod", "PaymentMethodId", "ProfitMargin", "TotalDiscount", "Currency", "CountryTaxRate", "ConversionRate"]
