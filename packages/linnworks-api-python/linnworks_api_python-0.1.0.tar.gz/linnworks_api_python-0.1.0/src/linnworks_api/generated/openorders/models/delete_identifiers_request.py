...
class DeleteIdentifiersRequest(BaseModel):
    """
    DeleteIdentifiersRequest
    """ # noqa: E501
    tag: Optional[StrictStr] = Field(default=None, description="Tag of the order identifier to delete. E.g. CUSTOM_PRINT. It is not possible to delete a system tag such as AMAZON_PRIME", alias="Tag")
