...
class EmailGenerateAdhocEmailRequest(BaseModel):
    """
    EmailGenerateAdhocEmailRequest
    """ # noqa: E501
    request: Optional[GenerateAdhocEmailRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "request": GenerateAdhocEmailRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
