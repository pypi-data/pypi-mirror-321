...
class GetWarehouseMovesByBinrackRequest(BaseModel):
    """
    GetWarehouseMovesByBinrackRequest
    """ # noqa: E501
    binrack_id: Optional[StrictInt] = Field(default=None, description="The Id of the binrack to get stock moves for", alias="BinrackId")
    __properties: ClassVar[List[str]] = ["BinrackId"]
