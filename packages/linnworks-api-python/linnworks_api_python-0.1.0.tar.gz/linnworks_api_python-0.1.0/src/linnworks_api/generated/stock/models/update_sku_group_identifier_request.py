...
class UpdateSkuGroupIdentifierRequest(BaseModel):
    """
    UpdateSkuGroupIdentifierRequest
    """ # noqa: E501
    identifiers: Optional[List[UpdateSkuGroupIdentifierRequestItems]] = Field(default=None, alias="Identifiers")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Identifiers": [UpdateSkuGroupIdentifierRequestItems.from_dict(_item) for _item in obj["Identifiers"]] if obj.get("Identifiers") is not None else None
        })
        return _obj
