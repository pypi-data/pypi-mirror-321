...
class BatchedBookIn(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["SKU", "BatchNumber", "LocationId", "BinRack", "Quantity", "StockValue", "BatchStatus", "PrioritySequence", "ExpiresOn", "SellBy"]
