...
class StockCreateVariationGroupRequest(BaseModel):
    """
    StockCreateVariationGroupRequest
    """ # noqa: E501
    template: Optional[VariationGroupTemplate] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "template": VariationGroupTemplate.from_dict(obj["template"]) if obj.get("template") is not None else None
        })
        return _obj
