...
class StockConsumption(BaseModel):
    ...
    shipped: Optional[StrictInt] = Field(default=None, alias="Shipped")
    ...
    __properties: ClassVar[List[str]] = ["Date", "StockQuantity", "StockValue", "Shipped", "StockItemId", "StockItemIntId"]
