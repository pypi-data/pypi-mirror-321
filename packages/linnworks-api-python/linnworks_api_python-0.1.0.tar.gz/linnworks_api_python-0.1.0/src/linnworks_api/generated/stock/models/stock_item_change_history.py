...
class StockItemChangeHistory(BaseModel):
    """
    ...
    change_qty: Optional[StrictInt] = Field(default=None, alias="ChangeQty")
    change_value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="ChangeValue")
    ...
    __properties: ClassVar[List[str]] = ["Date", "Level", "StockValue", "Note", "ChangeQty", "ChangeValue", "StockItemId", "StockItemIntId"]
