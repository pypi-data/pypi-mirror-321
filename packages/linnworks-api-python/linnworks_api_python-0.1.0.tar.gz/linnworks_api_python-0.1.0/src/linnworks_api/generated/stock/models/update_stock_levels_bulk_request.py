...
class UpdateStockLevelsBulkRequest(BaseModel):
    """
    UpdateStockLevelsBulkRequest
    """ # noqa: E501
    items: Optional[List[UpdateStockLevelsBulkRequestItem]] = Field(default=None, alias="Items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Items": [UpdateStockLevelsBulkRequestItem.from_dict(_item) for _item in obj["Items"]] if obj.get("Items") is not None else None
        })
        return _obj
