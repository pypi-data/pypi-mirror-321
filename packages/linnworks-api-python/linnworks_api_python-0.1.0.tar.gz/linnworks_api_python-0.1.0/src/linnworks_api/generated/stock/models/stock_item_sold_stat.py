...
class StockItemSoldStat(BaseModel):
    """
    StockItemSoldStat
    """ # noqa: E501
    ...
    detail: Optional[List[StockItemSoldStatDetail]] = Field(default=None, alias="Detail")
    ...
    __properties: ClassVar[List[str]] = ["Source", "Quantity", "Total", "Cost", "ProfitMargin", "Detail", "StockItemId", "StockItemIntId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Detail": [StockItemSoldStatDetail.from_dict(_item) for _item in obj["Detail"]] if obj.get("Detail") is not None else None,
