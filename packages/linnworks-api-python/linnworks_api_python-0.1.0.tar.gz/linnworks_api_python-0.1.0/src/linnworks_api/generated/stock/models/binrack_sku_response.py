...
class BinrackSkuResponse(BaseModel):
    """
    BinrackSkuResponse
    """ # noqa: E501
    skus: Optional[List[StockItemBatch]] = Field(default=None, alias="Skus")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Skus": [StockItemBatch.from_dict(_item) for _item in obj["Skus"]] if obj.get("Skus") is not None else None
        })
        return _obj
