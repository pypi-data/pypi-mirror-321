...
class WarehouseMoveCompleteRequest(BaseModel):
    """
    WarehouseMoveCompleteRequest
    """ # noqa: E501
    move_id: Optional[StrictInt] = Field(default=None, alias="MoveId")
    final_binrack_id: Optional[StrictInt] = Field(default=None, alias="FinalBinrackId")
    __properties: ClassVar[List[str]] = ["MoveId", "FinalBinrackId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "FinalBinrackId": obj.get("FinalBinrackId")
        })
        return _obj
