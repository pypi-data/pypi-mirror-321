...
class GetWarehouseMoveRequest(BaseModel):
    """
    GetWarehouseMoveRequest
    """ # noqa: E501
    move_id: Optional[StrictInt] = Field(default=None, description="Id of the stock move", alias="MoveId")
    __properties: ClassVar[List[str]] = ["MoveId"]
