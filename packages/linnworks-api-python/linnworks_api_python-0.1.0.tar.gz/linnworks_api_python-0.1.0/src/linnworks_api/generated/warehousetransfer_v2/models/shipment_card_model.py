...
class ShipmentCardModel(BaseModel):
    """
    ShipmentCardModel
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["channelId", "createDate", "updateDate", "fromLocation", "id", "amazonShipmentId", "shippingPlanId", "packingType", "planId", "shipmentItemsCount", "shipmentReceived", "shipmentShipped", "status", "toLocation", "type", "items", "shipments"]
