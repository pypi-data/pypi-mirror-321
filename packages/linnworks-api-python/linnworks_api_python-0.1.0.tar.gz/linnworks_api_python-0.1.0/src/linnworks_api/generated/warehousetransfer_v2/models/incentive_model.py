...
class IncentiveModel(BaseModel):
    ...
    IncentiveModel
    """ # noqa: E501
    value: Optional[CurrencyModel] = None
    target: Optional[StrictStr] = None
    description: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["value", "target", "description"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": CurrencyModel.from_dict(obj["value"]) if obj.get("value") is not None else None,
