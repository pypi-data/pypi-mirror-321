...
class UpdateShipmentBoxModel(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["shipmentBoxId", "name", "height", "length", "width", "weight", "weightUnit", "measurementUnit", "quantity"]
