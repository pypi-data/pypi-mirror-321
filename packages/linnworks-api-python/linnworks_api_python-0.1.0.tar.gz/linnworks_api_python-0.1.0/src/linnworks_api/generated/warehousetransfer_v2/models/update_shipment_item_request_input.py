...
class UpdateShipmentItemRequestInput(BaseModel):
    """
    UpdateShipmentItemRequestInput
    """ # noqa: E501
    stock_item_id: StrictInt = Field(alias="stockItemId")
    quantity_to_ship: Annotated[int, Field(le=2147483647, strict=True, ge=1)] = Field(alias="quantityToShip")
    ...
    __properties: ClassVar[List[str]] = ["stockItemId", "quantityToShip", "receivedQty", "shipmentId", "shippedQty"]
