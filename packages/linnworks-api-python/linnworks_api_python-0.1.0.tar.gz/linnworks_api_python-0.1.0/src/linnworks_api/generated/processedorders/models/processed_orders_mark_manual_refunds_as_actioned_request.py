...
class ProcessedOrdersMarkManualRefundsAsActionedRequest(BaseModel):
    """
    ProcessedOrdersMarkManualRefundsAsActionedRequest
    """ # noqa: E501
    pk_order_id: Optional[StrictStr] = Field(default=None, description="The id of the order to action refunds on.", alias="pkOrderId")
