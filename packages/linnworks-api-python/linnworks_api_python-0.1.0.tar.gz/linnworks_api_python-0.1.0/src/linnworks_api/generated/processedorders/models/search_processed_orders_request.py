...
class SearchProcessedOrdersRequest(BaseModel):
    """
    ...
    results_per_page: Optional[StrictInt] = Field(default=None, description="Results Per Page", alias="ResultsPerPage")
    search_sorting: Optional[SearchSorting] = Field(default=None, alias="SearchSorting")
    __properties: ClassVar[List[str]] = ["SearchTerm", "SearchFilters", "DateField", "FromDate", "ToDate", "PageNumber", "ResultsPerPage", "SearchSorting"]
