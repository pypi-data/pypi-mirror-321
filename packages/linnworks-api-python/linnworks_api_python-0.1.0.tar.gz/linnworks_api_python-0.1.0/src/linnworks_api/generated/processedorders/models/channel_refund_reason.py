...
class ChannelRefundReason(BaseModel):
    """
    ChannelRefundReason
    """ # noqa: E501
    tag: Optional[StrictStr] = Field(default=None, alias="Tag")
    display_name: Optional[StrictStr] = Field(default=None, alias="DisplayName")
    sub_reasons: Optional[List[ChannelRefundSubReason]] = Field(default=None, alias="SubReasons")
    __properties: ClassVar[List[str]] = ["Tag", "DisplayName", "SubReasons"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "SubReasons": [ChannelRefundSubReason.from_dict(_item) for _item in obj["SubReasons"]] if obj.get("SubReasons") is not None else None
        })
        return _obj
