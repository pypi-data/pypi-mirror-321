...
class ProcessedOrderNote(BaseModel):
    """
    ProcessedOrderNote
    """ # noqa: E501
    pk_order_note_id: Optional[StrictStr] = Field(default=None, alias="pkOrderNoteId")
    fk_order_id: Optional[StrictStr] = Field(default=None, alias="fkOrderId")
    note: Optional[StrictStr] = Field(default=None, alias="Note")
    note_entry_date: Optional[datetime] = Field(default=None, alias="NoteEntryDate")
    note_user_name: Optional[StrictStr] = Field(default=None, alias="NoteUserName")
    ...
    __properties: ClassVar[List[str]] = ["pkOrderNoteId", "fkOrderId", "Note", "NoteEntryDate", "NoteUserName", "Internal", "NoteTypeId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Note": obj.get("Note"),
            "NoteEntryDate": obj.get("NoteEntryDate"),
            "NoteUserName": obj.get("NoteUserName"),
