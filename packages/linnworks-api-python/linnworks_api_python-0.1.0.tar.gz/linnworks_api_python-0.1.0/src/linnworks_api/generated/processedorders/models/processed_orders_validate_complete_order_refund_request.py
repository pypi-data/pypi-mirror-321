...
class ProcessedOrdersValidateCompleteOrderRefundRequest(BaseModel):
    """
    ProcessedOrdersValidateCompleteOrderRefundRequest
    """ # noqa: E501
    pk_order_id: Optional[StrictStr] = Field(default=None, description="The id of the order", alias="pkOrderId")
