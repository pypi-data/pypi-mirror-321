...
class ProcessedOrdersRefundFreeTextRequest(BaseModel):
    """
    ProcessedOrdersRefundFreeTextRequest
    """ # noqa: E501
    pk_order_id: Optional[StrictStr] = Field(default=None, description="The id of the order to add/update refunds for", alias="pkOrderId")
    refund_items: Optional[List[RefundItem]] = Field(default=None, description="The new/altered refund items", alias="refundItems")
    __properties: ClassVar[List[str]] = ["pkOrderId", "refundItems"]
