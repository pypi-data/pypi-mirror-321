...
class SearchFilters(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["SearchField", "SearchTerm"]
    ...
    def search_field_validate_enum(cls, value):
        ...
        if value not in set(['Source', 'SubSource', 'ItemIdentifier']):
            raise ValueError("must be one of enum values ('Source', 'SubSource', 'ItemIdentifier')")
        return value
