...
class ProcessedOrdersCreateFullResendRequest(BaseModel):
    """
    ProcessedOrdersCreateFullResendRequest
    """ # noqa: E501
    pk_order_id: Optional[StrictStr] = Field(default=None, alias="pkOrderId")
    despatch_location: Optional[StrictStr] = Field(default=None, alias="despatchLocation")
    category: Optional[StrictStr] = None
    reason: Optional[StrictStr] = None
    additional_cost: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="additionalCost")
    __properties: ClassVar[List[str]] = ["pkOrderId", "despatchLocation", "category", "reason", "additionalCost"]
