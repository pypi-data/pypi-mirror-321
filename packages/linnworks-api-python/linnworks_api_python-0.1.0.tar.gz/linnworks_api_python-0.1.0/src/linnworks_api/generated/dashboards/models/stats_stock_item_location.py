...
class StatsStockItemLocation(BaseModel):
    """
    ...
    stock_level: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="StockLevel")
    stock_value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="StockValue")
    __properties: ClassVar[List[str]] = ["StockLocationId", "Location", "StockLevel", "StockValue"]
