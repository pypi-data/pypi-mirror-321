...
class PostSaleSubStatus(BaseModel):
    """
    PostSaleSubStatus
    """ # noqa: E501
    status_tag: Optional[StrictStr] = Field(default=None, alias="StatusTag")
    ...
    editable_fields: Optional[List[StrictStr]] = Field(default=None, alias="EditableFields")
    __properties: ClassVar[List[str]] = ["StatusTag", "StatusDescription", "Actionable", "ActionDescription", "EditableFields"]
