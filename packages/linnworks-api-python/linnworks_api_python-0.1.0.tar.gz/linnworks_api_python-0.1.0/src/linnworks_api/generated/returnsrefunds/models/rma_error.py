...
class RMAError(BaseModel):
    ...
    acknowledged: Optional[StrictBool] = Field(default=None, alias="Acknowledged")
    __properties: ClassVar[List[str]] = ["RMARowId", "ErrorMessage", "DateStamp", "Acknowledged"]
