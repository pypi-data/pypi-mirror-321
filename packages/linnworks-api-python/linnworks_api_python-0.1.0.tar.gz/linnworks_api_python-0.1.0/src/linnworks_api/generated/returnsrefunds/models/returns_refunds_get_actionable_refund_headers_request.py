...
class ReturnsRefundsGetActionableRefundHeadersRequest(BaseModel):
    """
    ReturnsRefundsGetActionableRefundHeadersRequest
    """ # noqa: E501
    request: Optional[GetActionableRefundHeadersRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "request": GetActionableRefundHeadersRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
