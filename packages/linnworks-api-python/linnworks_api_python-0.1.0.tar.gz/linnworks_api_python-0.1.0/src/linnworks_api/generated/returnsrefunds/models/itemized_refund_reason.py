...
class ItemizedRefundReason(BaseModel):
    """
    ItemizedRefundReason
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, alias="Type")
    item_id: Optional[StrictStr] = Field(default=None, alias="ItemId")
    reasons: Optional[List[ChannelReasonBase]] = Field(default=None, alias="Reasons")
    __properties: ClassVar[List[str]] = ["Type", "ItemId", "Reasons"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Reasons": [ChannelReasonBase.from_dict(_item) for _item in obj["Reasons"]] if obj.get("Reasons") is not None else None
        })
        return _obj
