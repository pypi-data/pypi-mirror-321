...
class AcknowledgeRMAErrorsResponse(BaseModel):
    """
    AcknowledgeRMAErrorsResponse
    """ # noqa: E501
    entire_rma_header_set_to_error_acked: Optional[StrictBool] = Field(default=None, description="Determines whether the entire RMA header was set to \"ERROR_ACKED\" state as a result of this call (will be found in the History tab)", alias="EntireRMAHeaderSetToErrorAcked")
    ...
    __properties: ClassVar[List[str]] = ["EntireRMAHeaderSetToErrorAcked", "RMAHeaderId", "Items", "Errors", "Info"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "EntireRMAHeaderSetToErrorAcked": obj.get("EntireRMAHeaderSetToErrorAcked"),
