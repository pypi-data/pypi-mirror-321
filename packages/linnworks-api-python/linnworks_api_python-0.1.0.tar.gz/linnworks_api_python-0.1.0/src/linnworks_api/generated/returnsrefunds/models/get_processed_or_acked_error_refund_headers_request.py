...
class GetProcessedOrAckedErrorRefundHeadersRequest(BaseModel):
    """
    ...
    filters: Optional[ProcessedPostSaleSearchFilters] = Field(default=None, alias="Filters")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Page": obj.get("Page"),
            "Filters": ProcessedPostSaleSearchFilters.from_dict(obj["Filters"]) if obj.get("Filters") is not None else None
        })
        return _obj
