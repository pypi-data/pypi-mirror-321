...
class UpdatedRefundLine(BaseModel):
    """
    UpdatedRefundLine
    """ # noqa: E501
    refund_row_id: Optional[StrictStr] = Field(default=None, alias="RefundRowId")
    remove_from_refund: Optional[StrictBool] = Field(default=None, alias="RemoveFromRefund")
    ...
    __properties: ClassVar[List[str]] = ["RefundRowId", "RemoveFromRefund", "ExternalReference", "IsFreeText", "FreeTextOrNote", "Amount", "Quantity", "ReasonTag", "SubReasonTag", "InsufficientRefundTag", "InsufficientRefundNote", "ReasonCategory"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "RemoveFromRefund": obj.get("RemoveFromRefund"),
