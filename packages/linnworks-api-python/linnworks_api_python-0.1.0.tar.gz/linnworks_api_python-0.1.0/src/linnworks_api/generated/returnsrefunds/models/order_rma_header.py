...
class OrderRMAHeader(BaseModel):
    """
    OrderRMAHeader
    """ # noqa: E501
    rma_header_id: Optional[StrictInt] = Field(default=None, alias="RMAHeaderId")
    rma_lines: Optional[List[VerifiedRMAItem]] = Field(default=None, alias="RMALines")
    ...
    __properties: ClassVar[List[str]] = ["RMAHeaderId", "RMALines", "OrderId", "NumOrderId", "Status", "OrderSource", "OrderSubSource", "ExternalReference", "ChannelInitiated", "CreatedDate", "Actioned", "LastActionDate"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in rma_lines (list)
        _items = []
        if self.rma_lines:
            for _item_rma_lines in self.rma_lines:
                if _item_rma_lines:
                    _items.append(_item_rma_lines.to_dict())
            _dict['RMALines'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "RMALines": [VerifiedRMAItem.from_dict(_item) for _item in obj["RMALines"]] if obj.get("RMALines") is not None else None,
