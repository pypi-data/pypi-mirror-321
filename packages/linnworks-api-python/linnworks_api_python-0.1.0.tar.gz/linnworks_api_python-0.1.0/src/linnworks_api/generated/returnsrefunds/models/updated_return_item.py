...
class UpdatedReturnItem(BaseModel):
    """
    UpdatedReturnItem
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["RMARowId", "RemoveFromBooking", "OrderItemRowId", "ReturnItemSKU", "ReturnItemTitle", "BatchInventoryId", "ReturnLocation", "ReturnQuantity", "RefundAmount", "RefundRowId", "ScrapQuantity", "ReasonCategory", "IsFreeText", "Reason", "ReasonTag", "SubReasonTag", "Status", "BinrackOverride"]
