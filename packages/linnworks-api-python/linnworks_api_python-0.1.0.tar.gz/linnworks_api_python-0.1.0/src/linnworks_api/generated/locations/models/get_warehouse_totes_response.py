...
class GetWarehouseTotesResponse(BaseModel):
    """
    GetWarehouseTotesResponse
    """ # noqa: E501
    totes: Optional[List[WarehouseTOTE]] = Field(default=None, alias="Totes")
    __properties: ClassVar[List[str]] = ["Totes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Totes": [WarehouseTOTE.from_dict(_item) for _item in obj["Totes"]] if obj.get("Totes") is not None else None
        })
        return _obj
