...
class InventoryUpdateImagesRequest(BaseModel):
    """
    InventoryUpdateImagesRequest
    """ # noqa: E501
    images: Optional[List[StockItemImageSimple]] = Field(default=None, description="Images to edit")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "images": [StockItemImageSimple.from_dict(_item) for _item in obj["images"]] if obj.get("images") is not None else None
        })
        return _obj
