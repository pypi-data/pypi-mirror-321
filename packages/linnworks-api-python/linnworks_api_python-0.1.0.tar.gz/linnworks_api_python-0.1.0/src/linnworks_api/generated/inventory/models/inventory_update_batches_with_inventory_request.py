...
class InventoryUpdateBatchesWithInventoryRequest(BaseModel):
    """
    InventoryUpdateBatchesWithInventoryRequest
    """ # noqa: E501
    batches: Optional[List[StockItemBatch]] = Field(default=None, description="List of batches to update")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "batches": [StockItemBatch.from_dict(_item) for _item in obj["batches"]] if obj.get("batches") is not None else None
        })
        return _obj
