...
class GetBatchAuditResponse(BaseModel):
    """
    GetBatchAuditResponse
    """ # noqa: E501
    response: Optional[List[StockItemBatchAudit]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": [StockItemBatchAudit.from_dict(_item) for _item in obj["response"]] if obj.get("response") is not None else None
        })
        return _obj
