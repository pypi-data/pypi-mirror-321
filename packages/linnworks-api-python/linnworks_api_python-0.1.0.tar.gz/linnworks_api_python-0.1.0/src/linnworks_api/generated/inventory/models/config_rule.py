...
class ConfigRule(BaseModel):
    ...
    rules: Optional[List[PropertyRule]] = Field(default=None, alias="Rules")
    __properties: ClassVar[List[str]] = ["FieldName", "Rules"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Rules": [PropertyRule.from_dict(_item) for _item in obj["Rules"]] if obj.get("Rules") is not None else None
        })
        return _obj
