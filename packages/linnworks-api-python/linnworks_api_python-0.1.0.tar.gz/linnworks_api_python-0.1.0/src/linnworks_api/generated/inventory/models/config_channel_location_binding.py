...
class ConfigChannelLocationBinding(BaseModel):
    """
    ConfigChannelLocationBinding
    """ # noqa: E501
    locations: Optional[List[ConfigChannelLocation]] = Field(default=None, alias="Locations")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Locations": [ConfigChannelLocation.from_dict(_item) for _item in obj["Locations"]] if obj.get("Locations") is not None else None
        })
        return _obj
