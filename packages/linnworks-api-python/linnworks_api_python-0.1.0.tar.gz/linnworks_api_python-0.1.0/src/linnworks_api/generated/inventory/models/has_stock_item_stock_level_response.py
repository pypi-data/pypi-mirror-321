...
class HasStockItemStockLevelResponse(BaseModel):
    """
    HasStockItemStockLevelResponse
    """ # noqa: E501
    has_stock_level: Optional[StrictBool] = Field(default=None, alias="HasStockLevel")
    __properties: ClassVar[List[str]] = ["HasStockLevel"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "HasStockLevel": obj.get("HasStockLevel")
        })
        return _obj
