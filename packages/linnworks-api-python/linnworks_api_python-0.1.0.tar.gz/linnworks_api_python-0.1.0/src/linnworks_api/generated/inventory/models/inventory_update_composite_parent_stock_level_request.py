...
class InventoryUpdateCompositeParentStockLevelRequest(BaseModel):
    """
    ...
    location_id: Optional[StrictStr] = Field(default=None, description="Stock location id", alias="locationId")
    field_value: Optional[StrictInt] = Field(default=None, description="Stock tracked status", alias="fieldValue")
    __properties: ClassVar[List[str]] = ["stockItemId", "locationId", "fieldValue"]
