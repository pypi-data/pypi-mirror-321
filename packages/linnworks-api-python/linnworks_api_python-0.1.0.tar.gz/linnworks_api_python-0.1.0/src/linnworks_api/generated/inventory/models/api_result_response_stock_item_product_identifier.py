...
class APIResultResponseStockItemProductIdentifier(BaseModel):
    """
    APIResultResponseStockItemProductIdentifier
    """ # noqa: E501
    result: Optional[StockItemProductIdentifier] = Field(default=None, alias="Result")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Result": StockItemProductIdentifier.from_dict(obj["Result"]) if obj.get("Result") is not None else None,
