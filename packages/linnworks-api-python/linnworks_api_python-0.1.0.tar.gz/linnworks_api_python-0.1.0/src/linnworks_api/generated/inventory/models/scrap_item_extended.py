...
class ScrapItemExtended(BaseModel):
    """
    ScrapItemExtended
    """ # noqa: E501
    pk_scrap_id: Optional[StrictStr] = Field(default=None, alias="pkScrapId")
    ...
    scrap_category: Optional[StrictStr] = Field(default=None, alias="ScrapCategory")
    scrap_reason: Optional[StrictStr] = Field(default=None, alias="ScrapReason")
    __properties: ClassVar[List[str]] = ["pkScrapId", "BatchInventoryId", "fkStockItemId", "Quantity", "ScrapCategory", "ScrapReason"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pkScrapId": obj.get("pkScrapId"),
            "BatchInventoryId": obj.get("BatchInventoryId"),
            "fkStockItemId": obj.get("fkStockItemId"),
            "Quantity": obj.get("Quantity"),
            "ScrapCategory": obj.get("ScrapCategory"),
            "ScrapReason": obj.get("ScrapReason")
        })
        return _obj
