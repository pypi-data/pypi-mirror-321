...
class UpdateInventoryItemRequest(BaseModel):
    ...
    stock_item_id: Optional[StrictStr] = Field(default=None, description="Stock Item Id. If not provided, it will be retrieved using the Item Number", alias="StockItemId")
    ...
    in_order: Optional[StrictInt] = Field(default=None, alias="InOrder")
    ...
    shipped_separately: Optional[StrictBool] = Field(default=None, alias="ShippedSeparately")
    ...
    __properties: ClassVar[List[str]] = ["VariationGroupName", "StockItemId", "ItemDescription", "Quantity", "InOrder", "Due", "MinimumLevel", "Available", "IsCompositeParent", "ShippedSeparately", "ItemNumber", "ItemTitle", "BarcodeNumber", "MetaData", "IsVariationParent", "isBatchedStockType", "PurchasePrice", "RetailPrice", "TaxRate", "PostalServiceId", "PostalServiceName", "CategoryId", "CategoryName", "PackageGroupId", "PackageGroupName", "Height", "Width", "Depth", "Weight", "CreationDate", "InventoryTrackingType", "BatchNumberScanRequired", "SerialNumberScanRequired", "StockItemIntId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ShippedSeparately": obj.get("ShippedSeparately"),
