...
class InventoryGetBatchAuditRequest(BaseModel):
    """
    InventoryGetBatchAuditRequest
    """ # noqa: E501
    request: Optional[GetBatchAuditRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "request": GetBatchAuditRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
