...
class StockItemExtendedPropertyWithSku(BaseModel):
    """
    StockItemExtendedPropertyWithSku
    """ # noqa: E501
    item_number: Optional[StrictStr] = Field(default=None, description="The ItemNumber (SKU) of the item  This is used to calculate the StockItemId if it has been omitted", alias="ItemNumber")
    ...
    propery_name: Optional[StrictStr] = Field(default=None, alias="ProperyName")
    ...
    __properties: ClassVar[List[str]] = ["ItemNumber", "pkRowId", "fkStockItemId", "ProperyName", "PropertyValue", "PropertyType"]
