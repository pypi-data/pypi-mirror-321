...
class ConfigPaymentMethodMappingItem(BaseModel):
    """
    ...
    fk_bank_id: Optional[StrictStr] = Field(default=None, alias="fkBankId")
    ...
    __properties: ClassVar[List[str]] = ["fkChannelId", "pkRowId", "Tag", "fkBankId", "PaymentMethodName", "Site", "IsChanged"]
