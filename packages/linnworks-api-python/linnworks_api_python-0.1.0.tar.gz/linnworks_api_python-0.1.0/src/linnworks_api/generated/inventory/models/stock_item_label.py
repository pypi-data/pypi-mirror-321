...
class StockItemLabel(BaseModel):
    """
    StockItemLabel
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["StockItemId", "ItemNumber", "ItemTitle", "Quantity", "BinRack", "BatchNumber", "BatchInventoryId", "LocationId", "StockItemIntId"]
