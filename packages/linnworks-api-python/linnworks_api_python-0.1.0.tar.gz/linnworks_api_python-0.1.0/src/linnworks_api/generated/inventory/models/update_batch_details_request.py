...
class UpdateBatchDetailsRequest(BaseModel):
    """
    ...
    reset_batch_dates: Optional[StrictBool] = Field(default=None, alias="ResetBatchDates")
    __properties: ClassVar[List[str]] = ["StockItemId", "InventoryTrackingType", "BatchNumberScanRequired", "ResetBatchDates"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ResetBatchDates": obj.get("ResetBatchDates")
        })
        return _obj
