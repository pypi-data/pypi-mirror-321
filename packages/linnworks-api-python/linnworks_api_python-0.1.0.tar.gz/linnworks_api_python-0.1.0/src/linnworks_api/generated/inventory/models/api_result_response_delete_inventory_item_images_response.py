...
class APIResultResponseDeleteInventoryItemImagesResponse(BaseModel):
    """
    APIResultResponseDeleteInventoryItemImagesResponse
    """ # noqa: E501
    result: Optional[DeleteInventoryItemImagesResponse] = Field(default=None, alias="Result")
    ...
    __properties: ClassVar[List[str]] = ["Result", "ResultStatus", "Message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Result": DeleteInventoryItemImagesResponse.from_dict(obj["Result"]) if obj.get("Result") is not None else None,
