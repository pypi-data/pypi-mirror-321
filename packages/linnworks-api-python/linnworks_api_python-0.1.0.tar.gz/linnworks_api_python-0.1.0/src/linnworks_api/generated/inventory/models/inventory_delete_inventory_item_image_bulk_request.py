...
class InventoryDeleteInventoryItemImageBulkRequest(BaseModel):
    """
    InventoryDeleteInventoryItemImageBulkRequest
    """ # noqa: E501
    request: Optional[List[DeleteInventoryItemImagesRequest]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "request": [DeleteInventoryItemImagesRequest.from_dict(_item) for _item in obj["request"]] if obj.get("request") is not None else None
        })
        return _obj
