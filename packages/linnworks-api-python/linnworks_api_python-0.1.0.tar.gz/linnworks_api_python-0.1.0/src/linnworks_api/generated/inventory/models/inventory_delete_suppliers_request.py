...
class InventoryDeleteSuppliersRequest(BaseModel):
    """
    InventoryDeleteSuppliersRequest
    """ # noqa: E501
    suppliers_ids: Optional[List[StrictStr]] = Field(default=None, alias="suppliersIds")
    __properties: ClassVar[List[str]] = ["suppliersIds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "suppliersIds": obj.get("suppliersIds")
        })
        return _obj
