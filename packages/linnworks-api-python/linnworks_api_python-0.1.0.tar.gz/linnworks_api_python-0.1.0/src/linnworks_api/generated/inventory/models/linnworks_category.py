...
class LinnworksCategory(BaseModel):
    """
    LinnworksCategory
    """ # noqa: E501
    ...
    structure_category_id: Optional[StrictInt] = Field(default=None, alias="StructureCategoryId")
    product_category_id: Optional[StrictInt] = Field(default=None, alias="ProductCategoryId")
    __properties: ClassVar[List[str]] = ["CategoryId", "CategoryName", "StructureCategoryId", "ProductCategoryId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "StructureCategoryId": obj.get("StructureCategoryId"),
