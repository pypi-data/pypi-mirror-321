...
class BatchedAPIResponseDeleteInventoryItemBulkResponse(BaseModel):
    """
    BatchedAPIResponseDeleteInventoryItemBulkResponse
    """ # noqa: E501
    results: Optional[List[APIResultResponseDeleteInventoryItemBulkResponse]] = Field(default=None, alias="Results")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Results": [APIResultResponseDeleteInventoryItemBulkResponse.from_dict(_item) for _item in obj["Results"]] if obj.get("Results") is not None else None,
