...
class GetProductIdentifierExtendedResponse(BaseModel):
    """
    GetProductIdentifierExtendedResponse
    """ # noqa: E501
    types: Optional[List[ProductIdentifierInformation]] = Field(default=None, alias="Types")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Types": [ProductIdentifierInformation.from_dict(_item) for _item in obj["Types"]] if obj.get("Types") is not None else None
        })
        return _obj
