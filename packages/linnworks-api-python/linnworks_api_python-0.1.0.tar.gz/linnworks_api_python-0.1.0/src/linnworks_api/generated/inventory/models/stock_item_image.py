...
class StockItemImage(BaseModel):
    ...
    full_source: Optional[StrictStr] = Field(default=None, alias="FullSource")
    check_sum_value: Optional[StrictStr] = Field(default=None, alias="CheckSumValue")
    ...
    checksum_value: Optional[StrictStr] = Field(default=None, alias="ChecksumValue")
    raw_checksum: Optional[StrictStr] = Field(default=None, alias="RawChecksum")
    ...
    __properties: ClassVar[List[str]] = ["Source", "FullSource", "CheckSumValue", "pkRowId", "IsMain", "SortOrder", "ChecksumValue", "RawChecksum", "StockItemId", "StockItemIntId"]
