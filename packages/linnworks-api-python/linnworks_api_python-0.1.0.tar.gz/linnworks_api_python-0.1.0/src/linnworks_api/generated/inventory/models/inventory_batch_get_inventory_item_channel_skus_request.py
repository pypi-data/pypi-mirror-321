...
class InventoryBatchGetInventoryItemChannelSKUsRequest(BaseModel):
    """
    InventoryBatchGetInventoryItemChannelSKUsRequest
    """ # noqa: E501
    inventory_item_ids: Optional[List[StrictStr]] = Field(default=None, description="List of Stock item Id's'", alias="inventoryItemIds")
    __properties: ClassVar[List[str]] = ["inventoryItemIds"]
