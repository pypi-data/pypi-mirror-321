...
class StockItemAuditTrail(BaseModel):
    """
    StockItemAuditTrail
    """ # noqa: E501
    audit_type: Optional[StrictStr] = Field(default=None, alias="AuditType")
    audit_trail_date: Optional[datetime] = Field(default=None, alias="AuditTrailDate")
    audit_text: Optional[StrictStr] = Field(default=None, alias="AuditText")
    ...
    __properties: ClassVar[List[str]] = ["AuditType", "AuditTrailDate", "AuditText", "UserName", "StockItemId", "StockItemIntId"]
