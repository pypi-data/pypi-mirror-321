...
class InventoryUpdateUserSpecificViewRequest(BaseModel):
    """
    InventoryUpdateUserSpecificViewRequest
    """ # noqa: E501
    view_name: Optional[StrictStr] = Field(default=None, description="Current user-specific view name", alias="viewName")
    view: Optional[InventoryView] = None
    __properties: ClassVar[List[str]] = ["viewName", "view"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "view": InventoryView.from_dict(obj["view"]) if obj.get("view") is not None else None
        })
        return _obj
