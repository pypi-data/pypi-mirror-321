...
class ShipStationDeleteShipStationIntegrationRequest(BaseModel):
    """
    ShipStationDeleteShipStationIntegrationRequest
    """ # noqa: E501
    integration_id: Optional[StrictStr] = Field(default=None, description="Id of the integration to delete", alias="integrationId")
