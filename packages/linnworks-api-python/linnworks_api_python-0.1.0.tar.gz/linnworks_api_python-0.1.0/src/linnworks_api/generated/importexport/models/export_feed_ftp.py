...
class ExportFeedFTP(ExportGenericFeed):
    """
    ExportFeedFTP
    """ # noqa: E501
    ...
    ssl: Optional[StrictBool] = Field(default=None, alias="SSL")
    passive_mode: Optional[StrictBool] = Field(default=None, alias="PassiveMode")
    __properties: ClassVar[List[str]] = ["FeedType", "FileName", "FilePath", "TempFileName", "IfFileExist", "discriminator", "Server", "Port", "UserName", "Password", "SSL", "PassiveMode"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "SSL": obj.get("SSL"),
            "PassiveMode": obj.get("PassiveMode")
        })
        return _obj
