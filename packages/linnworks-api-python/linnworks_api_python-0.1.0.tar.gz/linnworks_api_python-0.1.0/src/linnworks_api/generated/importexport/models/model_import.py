...
class ModelImport(BaseModel):
    ...
    ModelImport
    """ # noqa: E501
    specification: Optional[SpecificationImportGenericFeedImportColumn] = Field(default=None, alias="Specification")
    register: Optional[ImportRegister] = Field(default=None, alias="Register")
    schedules: Optional[List[Schedule]] = Field(default=None, alias="Schedules")
    __properties: ClassVar[List[str]] = ["Specification", "Register", "Schedules"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Specification": SpecificationImportGenericFeedImportColumn.from_dict(obj["Specification"]) if obj.get("Specification") is not None else None,
            "Register": ImportRegister.from_dict(obj["Register"]) if obj.get("Register") is not None else None,
