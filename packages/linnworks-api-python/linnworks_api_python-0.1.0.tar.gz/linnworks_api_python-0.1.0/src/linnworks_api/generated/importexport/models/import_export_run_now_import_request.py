...
class ImportExportRunNowImportRequest(BaseModel):
    """
    ImportExportRunNowImportRequest
    """ # noqa: E501
    import_id: Optional[StrictInt] = Field(default=None, description="Import id to execute", alias="importId")
