...
class ImportRegisterPublicSchedules(BaseModel):
    """
    ImportRegisterPublicSchedules
    """ # noqa: E501
    schedules: Optional[List[Schedule]] = Field(default=None, alias="Schedules")
    last_file_checksum: Optional[StrictStr] = Field(default=None, alias="LastFileChecksum")
    import_status: Optional[StrictStr] = Field(default=None, alias="ImportStatus")
    import_skipped: Optional[StrictBool] = Field(default=None, alias="ImportSkipped")
    ...
    __properties: ClassVar[List[str]] = ["Schedules", "LastFileChecksum", "ImportStatus", "ImportSkipped", "Id", "Type", "FriendlyName", "Executing", "justOnce", "Started", "Completed", "IsQueued", "Enabled", "IsNew", "AllSchedulesDisabled", "TimeZoneOffset", "NextSchedule"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['StockItemCompositions', 'Customers', 'eBayCompatibility', 'eBayCompatibilityKtypes', 'eBayCompatibilityePID', 'Inventory', 'ProcessOrder', 'StockCount', 'SupplierPricesByCode', 'StockLevelBySupplierCode', 'StockLevel', 'ItemMapping', 'ItemMappingWithChannelLocations', 'Orders', 'FulfilmentCenterOrdersImport', 'FulfilmentCenterInventoryImport', 'DeletePriceByChannel', 'DeleteTitleByChannel', 'DeleteDescriptionByChannel', 'DeleteStockItem', 'DeleteImages', 'DeleteNonPrimaryImages', 'DeletePrimaryImages', 'DeleteExtendedProperties', 'DeleteVariationItems', 'DeleteItemMapping', 'DeleteComposition', 'DeleteSuppliersFromItems', 'StockLevelBatch', 'ebayListingStrikeOff', 'ebayListingRelistPendingDelete', 'RenameSKU', 'ProductIdentifiers', 'TrackingNumbers', 'JITStatus', 'ReorderPointGeneralParams', 'ReorderPointWeeklyParams', 'eBayCompatibilityKtypesCulture', 'eBayCompatibilityePIDCulture', 'MultipleListingTitlesAndPrices', 'StockSupplierDetail', 'StockLevelBatchBySupplierCode', 'WeightAndDimensions']):
            raise ValueError("must be one of enum values ('StockItemCompositions', 'Customers', 'eBayCompatibility', 'eBayCompatibilityKtypes', 'eBayCompatibilityePID', 'Inventory', 'ProcessOrder', 'StockCount', 'SupplierPricesByCode', 'StockLevelBySupplierCode', 'StockLevel', 'ItemMapping', 'ItemMappingWithChannelLocations', 'Orders', 'FulfilmentCenterOrdersImport', 'FulfilmentCenterInventoryImport', 'DeletePriceByChannel', 'DeleteTitleByChannel', 'DeleteDescriptionByChannel', 'DeleteStockItem', 'DeleteImages', 'DeleteNonPrimaryImages', 'DeletePrimaryImages', 'DeleteExtendedProperties', 'DeleteVariationItems', 'DeleteItemMapping', 'DeleteComposition', 'DeleteSuppliersFromItems', 'StockLevelBatch', 'ebayListingStrikeOff', 'ebayListingRelistPendingDelete', 'RenameSKU', 'ProductIdentifiers', 'TrackingNumbers', 'JITStatus', 'ReorderPointGeneralParams', 'ReorderPointWeeklyParams', 'eBayCompatibilityKtypesCulture', 'eBayCompatibilityePIDCulture', 'MultipleListingTitlesAndPrices', 'StockSupplierDetail', 'StockLevelBatchBySupplierCode', 'WeightAndDimensions')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "LastFileChecksum": obj.get("LastFileChecksum"),
            "ImportStatus": obj.get("ImportStatus"),
            "ImportSkipped": obj.get("ImportSkipped"),
            "Id": obj.get("Id"),
            "Type": obj.get("Type"),
