...
class Export(BaseModel):
    ...
    Export
    """ # noqa: E501
    specification: Optional[ExportSpecification] = Field(default=None, alias="Specification")
    register: Optional[ExportRegister] = Field(default=None, alias="Register")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Specification": ExportSpecification.from_dict(obj["Specification"]) if obj.get("Specification") is not None else None,
            "Register": ExportRegister.from_dict(obj["Register"]) if obj.get("Register") is not None else None,
