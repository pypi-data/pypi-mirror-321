...
class NamedScheduleConfiguration(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["Name", "RepetitionType", "OneTimeDate", "DailyFrequency", "OccursFrequencyStartingDate", "OccursFrequencyEveryX", "WeeklyDays", "OccursFrequency", "OccursOnceAtTime", "OccursEveryHours", "StartingTime", "EndingTime", "Enabled"]
