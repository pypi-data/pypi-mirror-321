...
class AddShipmentPalletsRequest(BaseModel):
    """
    ...
    shipment_pallets: Optional[List[ShipmentPalletCreateModel]] = Field(default=None, alias="shipmentPallets")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "shipmentPallets": [ShipmentPalletCreateModel.from_dict(_item) for _item in obj["shipmentPallets"]] if obj.get("shipmentPallets") is not None else None
        })
        return _obj
