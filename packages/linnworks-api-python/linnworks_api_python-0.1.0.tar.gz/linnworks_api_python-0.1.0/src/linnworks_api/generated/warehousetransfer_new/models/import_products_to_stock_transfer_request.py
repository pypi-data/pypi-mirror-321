...
class ImportProductsToStockTransferRequest(BaseModel):
    """
    ...
    settings: Optional[ImportStockTransferSettingModel] = None
    __properties: ClassVar[List[str]] = ["transferId", "fileId", "settings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "settings": ImportStockTransferSettingModel.from_dict(obj["settings"]) if obj.get("settings") is not None else None
        })
        return _obj
