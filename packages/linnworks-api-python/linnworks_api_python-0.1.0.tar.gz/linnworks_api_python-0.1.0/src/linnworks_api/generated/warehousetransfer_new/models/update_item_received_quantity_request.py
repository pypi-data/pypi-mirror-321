...
class UpdateItemReceivedQuantityRequest(BaseModel):
    """
    ...
    received_quantity: Optional[Annotated[int, Field(le=2147483647, strict=True, ge=0)]] = Field(default=None, alias="receivedQuantity")
    __properties: ClassVar[List[str]] = ["transferId", "transferItemId", "receivedQuantity"]
