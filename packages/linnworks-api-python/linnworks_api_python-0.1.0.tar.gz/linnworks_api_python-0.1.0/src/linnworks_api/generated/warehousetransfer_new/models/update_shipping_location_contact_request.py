...
class UpdateShippingLocationContactRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["stockLocationId", "name", "company", "country", "region", "city", "address1", "address2", "postcode"]
