...
class AddItemBatchesRequest(BaseModel):
    """
    AddItemBatchesRequest
    """ # noqa: E501
    batches: List[ItemBatchModel]
    transfer_item_id: StrictInt = Field(alias="transferItemId")
    transfer_id: StrictInt = Field(alias="transferId")
    __properties: ClassVar[List[str]] = ["batches", "transferItemId", "transferId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "batches": [ItemBatchModel.from_dict(_item) for _item in obj["batches"]] if obj.get("batches") is not None else None,
