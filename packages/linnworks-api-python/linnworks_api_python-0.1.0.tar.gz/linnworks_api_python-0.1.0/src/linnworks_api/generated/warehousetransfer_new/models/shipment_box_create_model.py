...
class ShipmentBoxCreateModel(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["shipmentId", "shipmentPalletId", "name", "height", "depth", "width", "weight", "weightUnit", "dimensionUnit"]
