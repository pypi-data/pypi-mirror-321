...
class ShipmentBoxModel(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["shipmentBoxId", "shipmentId", "shipmentPalletId", "name", "height", "depth", "width", "shipmentDimensionUnit", "weight", "shipmentWeightUnit", "trackingNumber"]
