...
class CreateShipmentItemInBulkRequest(BaseModel):
    """
    CreateShipmentItemInBulkRequest
    """ # noqa: E501
    items: Annotated[List[ShippingItem], Field(max_length=200)]
    shipping_plan_id: Optional[StrictInt] = Field(default=None, alias="shippingPlanId")
    __properties: ClassVar[List[str]] = ["items", "shippingPlanId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [ShippingItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
