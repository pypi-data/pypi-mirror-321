...
class ImportProductsToStockRequestRequest(BaseModel):
    """
    ...
    settings: Optional[ImportStockRequestSettingModel] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "settings": ImportStockRequestSettingModel.from_dict(obj["settings"]) if obj.get("settings") is not None else None
        })
        return _obj
