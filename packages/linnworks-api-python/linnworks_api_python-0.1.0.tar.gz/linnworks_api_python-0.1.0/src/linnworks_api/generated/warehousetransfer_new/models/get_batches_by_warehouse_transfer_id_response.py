...
class GetBatchesByWarehouseTransferIdResponse(BaseModel):
    """
    GetBatchesByWarehouseTransferIdResponse
    """ # noqa: E501
    batches: Optional[List[StockItemBatchResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "batches": [StockItemBatchResponse.from_dict(_item) for _item in obj["batches"]] if obj.get("batches") is not None else None
        })
        return _obj
