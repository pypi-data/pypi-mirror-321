...
class CreateShippingPlanRequest(BaseModel):
    """
    ...
    to_location_id: StrictStr = Field(alias="toLocationId")
    __properties: ClassVar[List[str]] = ["channelId", "fromLocationId", "packingType", "whoPreps", "planId", "status", "toLocationId"]
