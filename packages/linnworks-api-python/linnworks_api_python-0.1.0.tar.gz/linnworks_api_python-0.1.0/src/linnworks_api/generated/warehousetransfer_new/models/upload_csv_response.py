...
class UploadCsvResponse(BaseModel):
    ...
    expiration_date: Optional[datetime] = Field(default=None, description="File gets deleted from s3 automatically", alias="expirationDate")
    __properties: ClassVar[List[str]] = ["fileId", "expirationDate"]
