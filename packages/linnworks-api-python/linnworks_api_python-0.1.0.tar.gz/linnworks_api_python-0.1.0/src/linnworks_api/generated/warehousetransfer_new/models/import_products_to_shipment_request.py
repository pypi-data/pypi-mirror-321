...
class ImportProductsToShipmentRequest(BaseModel):
    """
    ...
    settings: Optional[ImportSettingModel] = None
    __properties: ClassVar[List[str]] = ["shippingPlanId", "fileId", "settings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "settings": ImportSettingModel.from_dict(obj["settings"]) if obj.get("settings") is not None else None
        })
        return _obj
