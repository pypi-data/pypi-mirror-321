...
class UpdatePackingTypeRequest(BaseModel):
    """
    UpdatePackingTypeRequest
    """ # noqa: E501
    packing_type: Optional[PackingType] = Field(default=None, alias="packingType")
    shipping_plan_id: Optional[StrictInt] = Field(default=None, alias="shippingPlanId")
    __properties: ClassVar[List[str]] = ["packingType", "shippingPlanId"]
