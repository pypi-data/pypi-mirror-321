...
class ManifestPackage(BaseModel):
    ...
    package_seq_no: Optional[StrictInt] = Field(default=None, alias="PackageSeqNo")
    ...
    package_format: Optional[StrictStr] = Field(default=None, alias="PackageFormat")
    ...
    items: Optional[List[SavedItem]] = Field(default=None, alias="Items")
    __properties: ClassVar[List[str]] = ["OrderReference", "PackageSeqNo", "Weight", "Depth", "Width", "Height", "PackageFormat", "TrackingNumber", "Value", "Items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "PackageSeqNo": obj.get("PackageSeqNo"),
            "Weight": obj.get("Weight"),
            "Depth": obj.get("Depth"),
            "Width": obj.get("Width"),
            "Height": obj.get("Height"),
            "PackageFormat": obj.get("PackageFormat"),
            "TrackingNumber": obj.get("TrackingNumber"),
            "Value": obj.get("Value"),
            "Items": [SavedItem.from_dict(_item) for _item in obj["Items"]] if obj.get("Items") is not None else None
        })
        return _obj
