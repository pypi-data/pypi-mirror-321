...
class UpdateWarehouseZoneTypeResponse(BaseModel):
    """
    UpdateWarehouseZoneTypeResponse
    """ # noqa: E501
    type: Optional[WarehouseZoneType] = Field(default=None, alias="Type")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Type": WarehouseZoneType.from_dict(obj["Type"]) if obj.get("Type") is not None else None
        })
        return _obj
