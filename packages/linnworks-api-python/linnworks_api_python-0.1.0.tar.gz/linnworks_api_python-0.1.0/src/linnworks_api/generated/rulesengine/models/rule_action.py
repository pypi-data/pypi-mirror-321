...
class RuleAction(BaseModel):
    ...
    rule_version: Optional[StrictInt] = Field(default=None, alias="RuleVersion")
    fk_rule_id: Optional[StrictInt] = Field(default=None, alias="fkRuleId")
    properties: Optional[List[RuleActionProperty]] = Field(default=None, alias="Properties")
    __properties: ClassVar[List[str]] = ["pkActionId", "ActionName", "ActionType", "ActionValue", "fkConditionId", "RuleVersion", "fkRuleId", "Properties"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Properties": [RuleActionProperty.from_dict(_item) for _item in obj["Properties"]] if obj.get("Properties") is not None else None
        })
        return _obj
