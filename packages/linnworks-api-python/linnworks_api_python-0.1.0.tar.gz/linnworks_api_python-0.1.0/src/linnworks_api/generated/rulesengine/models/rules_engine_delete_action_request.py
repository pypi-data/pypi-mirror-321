...
class RulesEngineDeleteActionRequest(BaseModel):
    """
    RulesEngineDeleteActionRequest
    """ # noqa: E501
    pk_action_id: Optional[StrictInt] = Field(default=None, description="The id of the action to delete", alias="pkActionId")
    __properties: ClassVar[List[str]] = ["pkActionId"]
