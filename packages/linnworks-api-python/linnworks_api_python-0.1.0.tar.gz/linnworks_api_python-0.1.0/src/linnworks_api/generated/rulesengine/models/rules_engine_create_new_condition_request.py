...
class RulesEngineCreateNewConditionRequest(BaseModel):
    """
    RulesEngineCreateNewConditionRequest
    """ # noqa: E501
    header: Optional[ConditionHeaderBasic] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "header": ConditionHeaderBasic.from_dict(obj["header"]) if obj.get("header") is not None else None
        })
        return _obj
