...
class RulesEngineDeleteConditionRequest(BaseModel):
    """
    RulesEngineDeleteConditionRequest
    """ # noqa: E501
    pk_condition_id: Optional[StrictInt] = Field(default=None, description="The condition to delete", alias="pkConditionId")
    __properties: ClassVar[List[str]] = ["pkConditionId"]
