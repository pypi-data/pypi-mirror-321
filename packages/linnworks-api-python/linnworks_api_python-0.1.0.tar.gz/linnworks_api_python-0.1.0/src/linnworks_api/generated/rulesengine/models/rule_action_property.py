...
class RuleActionProperty(BaseModel):
    """
    RuleActionProperty
    """ # noqa: E501
    action_property_id: Optional[StrictInt] = Field(default=None, alias="ActionPropertyId")
    ...
    __properties: ClassVar[List[str]] = ["ActionPropertyId", "ActionId", "DisplayName", "Value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ActionPropertyId": obj.get("ActionPropertyId"),
