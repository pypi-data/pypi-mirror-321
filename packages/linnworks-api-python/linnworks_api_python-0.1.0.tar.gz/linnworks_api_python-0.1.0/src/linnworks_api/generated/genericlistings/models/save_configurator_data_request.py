...
class SaveConfiguratorDataRequest(BaseModel):
    """
    ...
    ids: Optional[List[StrictInt]] = Field(default=None, alias="Ids")
    data: Optional[Dict[str, Any]] = Field(default=None, description="Here should come the same data, that was returned from GetConfiguratorData request, with only modifications, allowed by appropriate layout.", alias="Data")
    force_save: Optional[StrictBool] = Field(default=None, description="Not valid to use", alias="ForceSave")
    __properties: ClassVar[List[str]] = ["ChannelType", "ChannelName", "DataKey", "Ids", "Data", "ForceSave"]
