...
class SaveConfiguratorFieldsRequest(BaseModel):
    """
    ...
    fields_to_save: Optional[Dict[str, Dict[str, Any]]] = Field(default=None, description="info key : value", alias="FieldsToSave")
    __properties: ClassVar[List[str]] = ["ChannelType", "ChannelName", "ConfiguratorId", "FieldsToSave"]
