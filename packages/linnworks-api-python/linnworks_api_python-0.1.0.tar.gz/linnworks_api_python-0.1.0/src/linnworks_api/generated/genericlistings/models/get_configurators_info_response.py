...
class GetConfiguratorsInfoResponse(BaseModel):
    """
    GetConfiguratorsInfoResponse
    """ # noqa: E501
    configurators_info: Optional[List[Dict[str, Any]]] = Field(default=None, alias="ConfiguratorsInfo")
    __properties: ClassVar[List[str]] = ["ConfiguratorsInfo"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ConfiguratorsInfo": obj.get("ConfiguratorsInfo")
        })
        return _obj
