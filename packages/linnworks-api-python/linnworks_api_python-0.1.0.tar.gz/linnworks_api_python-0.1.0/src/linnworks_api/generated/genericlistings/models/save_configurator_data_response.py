...
class SaveConfiguratorDataResponse(BaseModel):
    """
    SaveConfiguratorDataResponse
    """ # noqa: E501
    is_saved: Optional[StrictBool] = Field(default=None, alias="IsSaved")
    validation_results: Optional[Dict[str, Any]] = Field(default=None, alias="ValidationResults")
    __properties: ClassVar[List[str]] = ["IsSaved", "ValidationResults"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ValidationResults": obj.get("ValidationResults")
        })
        return _obj
