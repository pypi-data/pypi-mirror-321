...
class CheckAllocatableToPickwaveResponse(BaseModel):
    """
    Check allocatable to pickwave response.
    """ # noqa: E501
    results: Optional[List[PickWaveAllocateCheckResult]] = Field(default=None, description="List of results", alias="Results")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Results": [PickWaveAllocateCheckResult.from_dict(_item) for _item in obj["Results"]] if obj.get("Results") is not None else None
        })
        return _obj
