...
class PickingCheckAllocatableToPickwaveRequest(BaseModel):
    """
    PickingCheckAllocatableToPickwaveRequest
    """ # noqa: E501
    request: Optional[CheckAllocatableToPickwaveRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "request": CheckAllocatableToPickwaveRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
