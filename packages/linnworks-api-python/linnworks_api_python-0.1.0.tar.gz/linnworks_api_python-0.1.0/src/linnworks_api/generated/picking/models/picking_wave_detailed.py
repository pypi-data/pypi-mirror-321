...
class PickingWaveDetailed(BaseModel):
    """
    PickingWaveDetailed
    """ # noqa: E501
    ...
    email_address: Optional[StrictStr] = Field(default=None, description="Allocated user EmailAddress", alias="EmailAddress")
    created_date: Optional[datetime] = Field(default=None, description="Creation date", alias="CreatedDate")
    order_count: Optional[StrictInt] = Field(default=None, description="Order Count - Number of orders in pickwave.", alias="OrderCount")
    item_count: Optional[StrictInt] = Field(default=None, description="Item Count - Number of items in pickwave.", alias="ItemCount")
    items_picked: Optional[StrictInt] = Field(default=None, description="Items Picked - Number of items picked in pickwave.", alias="ItemsPicked")
    orders_picked: Optional[StrictInt] = Field(default=None, description="Orders Picked - Number of orders picked in pickwave.", alias="OrdersPicked")
    accumulated_in_progress_seconds: Optional[StrictInt] = Field(default=None, description="Time taken in pickwave", alias="AccumulatedInProgressSeconds")
    ...
    orders: Optional[List[PickingWaveOrderDetailed]] = Field(default=None, description="Orders in pickwave.", alias="Orders")
    ...
    __properties: ClassVar[List[str]] = ["LocationId", "UserId", "EmailAddress", "CreatedDate", "OrderCount", "ItemCount", "ItemsPicked", "OrdersPicked", "AccumulatedInProgressSeconds", "StartTime", "EndTime", "GroupType", "SortingType", "Orders", "Options", "PickingWaveId", "State"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Orders": [PickingWaveOrderDetailed.from_dict(_item) for _item in obj["Orders"]] if obj.get("Orders") is not None else None,
