...
class PickingUpdatePickingWaveItemWithNewBinrackRequest(BaseModel):
    """
    PickingUpdatePickingWaveItemWithNewBinrackRequest
    """ # noqa: E501
    request: Optional[UpdatePickingWaveItemWithNewBinrackRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "request": UpdatePickingWaveItemWithNewBinrackRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
