...
class CheckAllocatableToPickwaveRequest(BaseModel):
    """
    Request for allocatioable orders to pickwave.
    """ # noqa: E501
    order_ids: Optional[List[StrictInt]] = Field(default=None, description="List of integer order ids", alias="OrderIds")
