...
class UpdatePickedItemDeltaRequest(BaseModel):
    """
    UpdatePickedItemDeltaRequest
    """ # noqa: E501
    deltas: Optional[List[UpdatePickedItemDeltaRequestItem]] = Field(default=None, alias="Deltas")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Deltas": [UpdatePickedItemDeltaRequestItem.from_dict(_item) for _item in obj["Deltas"]] if obj.get("Deltas") is not None else None
        })
        return _obj
