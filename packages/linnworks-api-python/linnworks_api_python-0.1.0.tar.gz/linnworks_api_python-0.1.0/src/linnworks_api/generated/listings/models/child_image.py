...
class ChildImage(BaseModel):
    ...
    parent_image_id: Optional[StrictStr] = Field(default=None, alias="ParentImageId")
    __properties: ClassVar[List[str]] = ["ImageName", "ImageURL", "Path", "ImageId", "ParentImageId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ParentImageId": obj.get("ParentImageId")
        })
        return _obj
