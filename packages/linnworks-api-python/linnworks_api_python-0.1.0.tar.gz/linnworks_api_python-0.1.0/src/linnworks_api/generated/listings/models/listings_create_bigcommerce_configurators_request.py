...
class ListingsCreateBigcommerceConfiguratorsRequest(BaseModel):
    """
    ListingsCreateBigcommerceConfiguratorsRequest
    """ # noqa: E501
    configs: Optional[List[BigCommerceConfigurator]] = Field(default=None, description="Configs to create")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "configs": [BigCommerceConfigurator.from_dict(_item) for _item in obj["configs"]] if obj.get("configs") is not None else None
        })
        return _obj
