...
class ListingsGetBigCommerceTemplatesRequest(BaseModel):
    """
    ListingsGetBigCommerceTemplatesRequest
    """ # noqa: E501
    parameters: Optional[GetTemplatesParameters] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "parameters": GetTemplatesParameters.from_dict(obj["parameters"]) if obj.get("parameters") is not None else None
        })
        return _obj
