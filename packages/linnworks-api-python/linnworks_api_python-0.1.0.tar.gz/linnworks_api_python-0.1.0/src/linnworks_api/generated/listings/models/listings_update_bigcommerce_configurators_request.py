...
class ListingsUpdateBigcommerceConfiguratorsRequest(BaseModel):
    """
    ListingsUpdateBigcommerceConfiguratorsRequest
    """ # noqa: E501
    configs: Optional[List[BigCommerceConfigurator]] = Field(default=None, description="Configs to update")
