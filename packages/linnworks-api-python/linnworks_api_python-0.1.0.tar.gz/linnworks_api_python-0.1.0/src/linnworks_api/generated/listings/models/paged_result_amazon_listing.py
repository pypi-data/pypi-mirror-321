...
class PagedResultAmazonListing(BaseModel):
    """
    PagedResultAmazonListing
    """ # noqa: E501
    items: Optional[List[AmazonListing]] = Field(default=None, alias="Items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Items": [AmazonListing.from_dict(_item) for _item in obj["Items"]] if obj.get("Items") is not None else None,
