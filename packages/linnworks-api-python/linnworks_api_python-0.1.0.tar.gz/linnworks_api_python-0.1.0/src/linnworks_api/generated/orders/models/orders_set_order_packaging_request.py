...
class OrdersSetOrderPackagingRequest(BaseModel):
    """
    OrdersSetOrderPackagingRequest
    """ # noqa: E501
    request: Optional[SetOrderPackagingRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "request": SetOrderPackagingRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
