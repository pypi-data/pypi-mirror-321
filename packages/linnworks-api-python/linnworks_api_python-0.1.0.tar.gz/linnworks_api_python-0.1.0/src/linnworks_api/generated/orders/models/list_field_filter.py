...
class ListFieldFilter(BaseModel):
    """
    ListFieldFilter
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["Value", "Type", "FieldCode"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['Is', 'Not']):
            raise ValueError("must be one of enum values ('Is', 'Not')")
        return value
