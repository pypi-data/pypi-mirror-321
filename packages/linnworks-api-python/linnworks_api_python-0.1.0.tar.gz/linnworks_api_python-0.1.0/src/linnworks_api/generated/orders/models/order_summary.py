...
class OrderSummary(BaseModel):
    ...
    process_date: Optional[datetime] = Field(default=None, alias="ProcessDate")
    ...
    num_products: Optional[StrictInt] = Field(default=None, alias="NumProducts")
    fulfillment_location_id: Optional[StrictStr] = Field(default=None, alias="FulfillmentLocationId")
    __properties: ClassVar[List[str]] = ["OrderId", "NumOrderId", "ReceivedDate", "ProcessDate", "Source", "CustomerName", "NumProducts", "FulfillmentLocationId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ProcessDate": obj.get("ProcessDate"),
            "Source": obj.get("Source"),
            "CustomerName": obj.get("CustomerName"),
            "NumProducts": obj.get("NumProducts"),
            "FulfillmentLocationId": obj.get("FulfillmentLocationId")
        })
        return _obj
