...
class OrderSplit(BaseModel):
    ...
    OrderSplit
    """ # noqa: E501
    items: Optional[List[OrderSplitOutItem]] = Field(default=None, alias="Items")
    postal_service_id: Optional[StrictStr] = Field(default=None, alias="PostalServiceId")
    park_order: Optional[StrictBool] = Field(default=None, alias="ParkOrder")
    __properties: ClassVar[List[str]] = ["Items", "PostalServiceId", "ParkOrder"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Items": [OrderSplitOutItem.from_dict(_item) for _item in obj["Items"]] if obj.get("Items") is not None else None,
            "PostalServiceId": obj.get("PostalServiceId"),
            "ParkOrder": obj.get("ParkOrder")
        })
        return _obj
