...
class OrdersSetOrderCustomerInfoRequest(BaseModel):
    """
    OrdersSetOrderCustomerInfoRequest
    """ # noqa: E501
    order_id: Optional[StrictStr] = Field(default=None, description="Order id", alias="orderId")
    info: Optional[OrderCustomerInfo] = None
    save_to_crm: Optional[StrictBool] = Field(default=None, description="Whether to save the shipping address into CRM, default = false", alias="saveToCrm")
    __properties: ClassVar[List[str]] = ["orderId", "info", "saveToCrm"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "info": OrderCustomerInfo.from_dict(obj["info"]) if obj.get("info") is not None else None,
            "saveToCrm": obj.get("saveToCrm")
        })
        return _obj
