...
class LinePricingRequest(BaseModel):
    ...
    tax_rate_percentage: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="TaxRatePercentage")
    tax_inclusive: Optional[StrictBool] = Field(default=None, alias="TaxInclusive")
    __properties: ClassVar[List[str]] = ["PricePerUnit", "DiscountPercentage", "TaxRatePercentage", "TaxInclusive"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "TaxRatePercentage": obj.get("TaxRatePercentage"),
