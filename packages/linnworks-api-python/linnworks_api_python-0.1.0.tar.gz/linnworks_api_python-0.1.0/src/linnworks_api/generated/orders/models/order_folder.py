...
class OrderFolder(BaseModel):
    """
    OrderFolder
    """ # noqa: E501
    pk_folder_id: Optional[StrictStr] = Field(default=None, alias="pkFolderId")
    folder_name: Optional[StrictStr] = Field(default=None, alias="FolderName")
    __properties: ClassVar[List[str]] = ["pkFolderId", "FolderName"]
