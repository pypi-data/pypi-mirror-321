...
class OrdersUpdateOrderItemRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["orderId", "orderItem", "fulfilmentCenter", "source", "subSource"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of order_item
        if self.order_item:
            _dict['orderItem'] = self.order_item.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "orderItem": OrderItem.from_dict(obj["orderItem"]) if obj.get("orderItem") is not None else None,
