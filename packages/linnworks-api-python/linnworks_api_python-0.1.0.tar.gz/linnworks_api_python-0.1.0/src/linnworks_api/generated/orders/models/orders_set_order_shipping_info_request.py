...
class OrdersSetOrderShippingInfoRequest(BaseModel):
    """
    OrdersSetOrderShippingInfoRequest
    """ # noqa: E501
    order_id: Optional[StrictStr] = Field(default=None, description="Order id", alias="orderId")
    info: Optional[UpdateOrderShippingInfoRequest] = None
    __properties: ClassVar[List[str]] = ["orderId", "info"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "info": UpdateOrderShippingInfoRequest.from_dict(obj["info"]) if obj.get("info") is not None else None
        })
        return _obj
