...
class OrderItemOptionUpdate(BaseModel):
    ...
    """ # noqa: E501
    delete_entry: Optional[StrictBool] = Field(default=None, alias="DeleteEntry")
    pk_option_id: Optional[StrictStr] = Field(default=None, alias="pkOptionId")
    var_property: Optional[StrictStr] = Field(default=None, alias="Property")
    value: Optional[StrictStr] = Field(default=None, alias="Value")
    __properties: ClassVar[List[str]] = ["DeleteEntry", "pkOptionId", "Property", "Value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "DeleteEntry": obj.get("DeleteEntry"),
            "pkOptionId": obj.get("pkOptionId"),
