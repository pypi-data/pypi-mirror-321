...
class OrdersSetPaymentMethodsRequest(BaseModel):
    """
    OrdersSetPaymentMethodsRequest
    """ # noqa: E501
    payment_methods: Optional[List[PaymentMethod]] = Field(default=None, description="List of payment methods", alias="paymentMethods")
