...
class OrdersGetOpenOrdersByItemBarcodeRequest(BaseModel):
    """
    OrdersGetOpenOrdersByItemBarcodeRequest
    """ # noqa: E501
    product_barcode: Optional[StrictStr] = Field(default=None, description="Item barcode", alias="productBarcode")
    ...
    __properties: ClassVar[List[str]] = ["productBarcode", "filters", "locationId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "productBarcode": obj.get("productBarcode"),
