...
class CalcBinItem(BaseModel):
    """
    CalcBinItem
    """ # noqa: E501
    shipping_order_item_id: Optional[StrictInt] = Field(default=None, alias="ShippingOrderItemId")
    bin_id: Optional[StrictStr] = Field(default=None, alias="BinId")
    ...
    __properties: ClassVar[List[str]] = ["ShippingOrderItemId", "BinId", "fkOrderItemId", "BoxId", "Quantity"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ShippingOrderItemId": obj.get("ShippingOrderItemId"),
            "BinId": obj.get("BinId"),
