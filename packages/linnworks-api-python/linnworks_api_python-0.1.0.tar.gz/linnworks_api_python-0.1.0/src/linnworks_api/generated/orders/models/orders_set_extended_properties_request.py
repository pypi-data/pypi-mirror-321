...
class OrdersSetExtendedPropertiesRequest(BaseModel):
    """
    OrdersSetExtendedPropertiesRequest
    """ # noqa: E501
    order_id: Optional[StrictStr] = Field(default=None, description="Order id (pkOrderID)", alias="orderId")
    extended_properties: Optional[List[ExtendedProperty]] = Field(default=None, description="Extended property information", alias="extendedProperties")
