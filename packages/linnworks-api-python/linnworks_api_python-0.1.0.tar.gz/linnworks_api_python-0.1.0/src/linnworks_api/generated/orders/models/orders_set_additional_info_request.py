...
class OrdersSetAdditionalInfoRequest(BaseModel):
    """
    OrdersSetAdditionalInfoRequest
    """ # noqa: E501
    order_id: Optional[StrictStr] = Field(default=None, description="Order id", alias="orderId")
    row_id: Optional[StrictStr] = Field(default=None, description="Item row id", alias="rowId")
    additional_info: Optional[List[OrderItemOption]] = Field(default=None, description="Additional info to set", alias="additionalInfo")
    __properties: ClassVar[List[str]] = ["orderId", "rowId", "additionalInfo"]
