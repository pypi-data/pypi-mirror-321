...
class NumericFieldFilter(BaseModel):
    """
    NumericFieldFilter
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["Type", "Value", "FieldCode"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['Equal', 'Greater', 'Lower']):
            raise ValueError("must be one of enum values ('Equal', 'Greater', 'Lower')")
        return value
