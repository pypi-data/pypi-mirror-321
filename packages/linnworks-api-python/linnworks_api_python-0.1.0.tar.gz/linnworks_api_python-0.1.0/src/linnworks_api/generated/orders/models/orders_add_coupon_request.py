...
class OrdersAddCouponRequest(BaseModel):
    """
    OrdersAddCouponRequest
    """ # noqa: E501
    order_id: Optional[StrictStr] = Field(default=None, description="Order id", alias="orderId")
    barcode: Optional[StrictStr] = Field(default=None, description="Coupon barcode")
    coupon_data: Optional[CouponValidationResult] = Field(default=None, alias="couponData")
    fulfilment_center: Optional[StrictStr] = Field(default=None, description="Current fulfilment center", alias="fulfilmentCenter")
    __properties: ClassVar[List[str]] = ["orderId", "barcode", "couponData", "fulfilmentCenter"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of coupon_data
        if self.coupon_data:
            _dict['couponData'] = self.coupon_data.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "couponData": CouponValidationResult.from_dict(obj["couponData"]) if obj.get("couponData") is not None else None,
