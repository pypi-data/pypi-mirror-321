...
class SettingsInsertCurrencyConversionRatesRequest(BaseModel):
    """
    SettingsInsertCurrencyConversionRatesRequest
    """ # noqa: E501
    rates: Optional[List[CurrencyConversionRate]] = Field(default=None, description="Currencies to insert")
