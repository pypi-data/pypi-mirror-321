...
class CommonPurchaseOrderPaymentStatement(BaseModel):
    """
    CommonPurchaseOrderPaymentStatement
    """ # noqa: E501
    purchase_payment_statement_id: Optional[StrictInt] = Field(default=None, alias="PurchasePaymentStatementId")
    line_cost: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="LineCost")
    ...
    fk_purchase_additional_cost_item_id: Optional[StrictInt] = Field(default=None, alias="fkPurchaseAdditionalCostItemId")
    __properties: ClassVar[List[str]] = ["PurchasePaymentStatementId", "LineCost", "ConversionRate", "Currency", "Reference", "CreationDate", "PaymentDate", "fkPurchaseAdditionalCostItemId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "PurchasePaymentStatementId": obj.get("PurchasePaymentStatementId"),
