...
class FindStockItemResponse(BaseModel):
    """
    FindStockItemResponse
    """ # noqa: E501
    items: Optional[List[PurchaseItemFound]] = Field(default=None, alias="Items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Items": [PurchaseItemFound.from_dict(_item) for _item in obj["Items"]] if obj.get("Items") is not None else None
        })
        return _obj
