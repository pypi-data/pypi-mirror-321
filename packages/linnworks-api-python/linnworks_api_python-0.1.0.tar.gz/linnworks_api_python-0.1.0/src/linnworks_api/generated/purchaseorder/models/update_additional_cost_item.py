...
class UpdateAdditionalCostItem(BaseModel):
    """
    UpdateAdditionalCostItem
    """ # noqa: E501
    purchase_additional_cost_item_id: Optional[StrictInt] = Field(default=None, description="Additional cost line row id, uniquely identifying each cost line", alias="PurchaseAdditionalCostItemId")
    ...
    __properties: ClassVar[List[str]] = ["PurchaseAdditionalCostItemId", "Id", "AdditionalCostTypeId", "Reference", "SubTotalLineCost", "TaxRate", "Currency", "ConversionRate", "AllocationLocked", "Print", "AllocationMethod"]
