...
class DeliverPurchaseOrderItemResponse(BaseModel):
    """
    DeliverPurchaseOrderItemResponse
    """ # noqa: E501
    new_purchase_order_item: Optional[PurchaseOrderItem] = Field(default=None, alias="NewPurchaseOrderItem")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "NewPurchaseOrderItem": PurchaseOrderItem.from_dict(obj["NewPurchaseOrderItem"]) if obj.get("NewPurchaseOrderItem") is not None else None,
