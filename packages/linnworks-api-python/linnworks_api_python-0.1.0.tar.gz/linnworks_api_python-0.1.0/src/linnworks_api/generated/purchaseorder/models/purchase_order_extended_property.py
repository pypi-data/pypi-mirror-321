...
class PurchaseOrderExtendedProperty(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["RowId", "PurchaseID", "AddedDateTime", "UserName", "PropertyName", "PropertyValue"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "AddedDateTime": obj.get("AddedDateTime"),
