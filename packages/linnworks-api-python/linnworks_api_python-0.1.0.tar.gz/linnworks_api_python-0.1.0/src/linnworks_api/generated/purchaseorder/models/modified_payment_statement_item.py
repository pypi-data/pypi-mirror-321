...
class ModifiedPaymentStatementItem(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["Id", "PurchasePaymentStatementId", "LineCost", "ConversionRate", "Currency", "Reference", "CreationDate", "PaymentDate", "fkPurchaseAdditionalCostItemId"]
