...
class PurchaseOrderUpdatePurchaseOrderExtendedPropertyRequest(BaseModel):
    """
    PurchaseOrderUpdatePurchaseOrderExtendedPropertyRequest
    """ # noqa: E501
    request: Optional[UpdatePurchaseOrderExtendedPropertyRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "request": UpdatePurchaseOrderExtendedPropertyRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
