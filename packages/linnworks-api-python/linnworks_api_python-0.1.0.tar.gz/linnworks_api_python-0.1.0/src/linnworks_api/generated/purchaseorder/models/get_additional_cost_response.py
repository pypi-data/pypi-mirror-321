...
class GetAdditionalCostResponse(BaseModel):
    """
    GetAdditionalCostResponse
    """ # noqa: E501
    items: Optional[List[CommonPurchaseOrderAdditionalCost]] = Field(default=None, description="List of additional cost items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [CommonPurchaseOrderAdditionalCost.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
