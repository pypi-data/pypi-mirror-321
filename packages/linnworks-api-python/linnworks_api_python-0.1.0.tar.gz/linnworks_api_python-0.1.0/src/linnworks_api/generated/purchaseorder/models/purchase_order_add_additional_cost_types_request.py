...
class PurchaseOrderAddAdditionalCostTypesRequest(BaseModel):
    """
    PurchaseOrderAddAdditionalCostTypesRequest
    """ # noqa: E501
    request: Optional[AddAdditionalCostTypesRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "request": AddAdditionalCostTypesRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
