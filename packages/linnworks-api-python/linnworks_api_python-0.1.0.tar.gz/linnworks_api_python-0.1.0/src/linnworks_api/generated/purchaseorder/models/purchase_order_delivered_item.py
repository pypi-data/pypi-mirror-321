...
class PurchaseOrderDeliveredItem(BaseModel):
    """
    PurchaseOrderDeliveredItem
    """ # noqa: E501
    pk_purchase_item_id: Optional[StrictStr] = Field(default=None, alias="pkPurchaseItemId")
    quantity_delivered: Optional[StrictInt] = Field(default=None, alias="QuantityDelivered")
    __properties: ClassVar[List[str]] = ["pkPurchaseItemId", "QuantityDelivered"]
