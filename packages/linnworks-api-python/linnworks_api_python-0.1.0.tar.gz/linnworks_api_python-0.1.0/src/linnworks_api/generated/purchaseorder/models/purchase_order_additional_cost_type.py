...
class PurchaseOrderAdditionalCostType(BaseModel):
    """
    ...
    is_shipping_type: Optional[StrictBool] = Field(default=None, alias="IsShippingType")
    is_partial_allocation: Optional[StrictBool] = Field(default=None, alias="IsPartialAllocation")
