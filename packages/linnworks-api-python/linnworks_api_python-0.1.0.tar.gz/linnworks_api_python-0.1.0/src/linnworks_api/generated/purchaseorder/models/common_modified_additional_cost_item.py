...
class CommonModifiedAdditionalCostItem(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["Id", "PurchaseAdditionalCostItemId", "AdditionalCostTypeId", "Reference", "SubTotalLineCost", "TaxRate", "Tax", "Currency", "ConversionRate", "TotalLineCost", "CostAllocation", "AllocationLocked", "AdditionalCostTypeName", "AdditionalCostTypeIsShippingType", "AdditionalCostTypeIsPartialAllocation", "Print", "AllocationMethod"]
