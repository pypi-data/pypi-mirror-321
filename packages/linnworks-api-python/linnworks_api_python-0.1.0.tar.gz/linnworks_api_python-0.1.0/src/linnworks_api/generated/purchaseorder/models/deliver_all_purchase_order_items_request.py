...
class DeliverAllPurchaseOrderItemsRequest(BaseModel):
    """
    ...
    items: Optional[List[PurchaseOrderDeliveredItem]] = Field(default=None, alias="Items")
    __properties: ClassVar[List[str]] = ["pkPurchaseId", "DeliveryId", "Items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Items": [PurchaseOrderDeliveredItem.from_dict(_item) for _item in obj["Items"]] if obj.get("Items") is not None else None
        })
        return _obj
