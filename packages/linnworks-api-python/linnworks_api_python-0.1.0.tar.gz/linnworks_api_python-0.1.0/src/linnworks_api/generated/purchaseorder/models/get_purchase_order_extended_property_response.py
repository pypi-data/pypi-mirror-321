...
class GetPurchaseOrderExtendedPropertyResponse(BaseModel):
    """
    GetPurchaseOrderExtendedPropertyResponse
    """ # noqa: E501
    items: Optional[List[PurchaseOrderExtendedProperty]] = Field(default=None, description="Purchase order extended properties", alias="Items")
