...
class WarehouseTransferDeleteEmptyDraftTransferRequest(BaseModel):
    """
    WarehouseTransferDeleteEmptyDraftTransferRequest
    """ # noqa: E501
    pk_transfer_id: Optional[StrictStr] = Field(default=None, description="The id of the transfer to be deleted.", alias="pkTransferId")
