...
class WarehouseTransferPrintTransferRequest(BaseModel):
    """
    WarehouseTransferPrintTransferRequest
    """ # noqa: E501
    pk_transfer_id: Optional[StrictStr] = Field(default=None, description="The transfer ID", alias="pkTransferId")
