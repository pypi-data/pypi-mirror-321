...
class WarehouseTransferChangeTransferItemSentQuantityRequest(BaseModel):
    """
    ...
    pk_transfer_item_id: Optional[StrictStr] = Field(default=None, description="The id of the item.", alias="pkTransferItemId")
