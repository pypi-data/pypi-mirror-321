...
class AddItemsToTransferRequest(BaseModel):
    """
    AddItemsToTransferRequest
    """ # noqa: E501
    transfer_id: Optional[StrictStr] = Field(default=None, alias="TransferId")
    transfer_items: Optional[List[WarehouseTransferItemQuantity]] = Field(default=None, alias="TransferItems")
    __properties: ClassVar[List[str]] = ["TransferId", "TransferItems"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "TransferItems": [WarehouseTransferItemQuantity.from_dict(_item) for _item in obj["TransferItems"]] if obj.get("TransferItems") is not None else None
        })
        return _obj
