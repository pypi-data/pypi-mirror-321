...
class WarehouseTransferCreateTransferFromDescrepanciesRequest(BaseModel):
    """
    WarehouseTransferCreateTransferFromDescrepanciesRequest
    """ # noqa: E501
    pk_transfer_id: Optional[StrictStr] = Field(default=None, description="pkTransferId", alias="pkTransferId")
    __properties: ClassVar[List[str]] = ["pkTransferId"]
