...
class ChannelServiceLinks(BaseModel):
    """
    ChannelServiceLinks
    """ # noqa: E501
    ...
    channel_service: Optional[StrictStr] = Field(default=None, alias="ChannelService")
    channel_tag: Optional[StrictStr] = Field(default=None, alias="ChannelTag")
    site: Optional[StrictStr] = Field(default=None, alias="Site")
    __properties: ClassVar[List[str]] = ["Channel", "ChannelName", "ChannelService", "ChannelTag", "Site"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ChannelService": obj.get("ChannelService"),
