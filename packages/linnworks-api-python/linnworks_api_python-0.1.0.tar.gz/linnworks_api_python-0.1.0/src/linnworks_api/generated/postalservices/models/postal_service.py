...
class PostalService(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["PostalServiceName", "PostalServiceTag", "ServiceCountry", "PostalServiceCode", "Vendor", "PrintModule", "PrintModuleTitle", "pkPostalServiceId", "TrackingNumberRequired", "WeightRequired", "IgnorePackagingGroup", "fkShippingAPIConfigId", "IntegratedServiceId"]
