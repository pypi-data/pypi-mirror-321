...
class DeleteOrdersFromPickingWavesRequest(BaseModel):
    """
    DeleteOrdersFromPickingWavesRequest
    """ # noqa: E501
    order_ids: Optional[List[StrictInt]] = Field(default=None, description="List of Linnworks OrderIds", alias="OrderIds")
