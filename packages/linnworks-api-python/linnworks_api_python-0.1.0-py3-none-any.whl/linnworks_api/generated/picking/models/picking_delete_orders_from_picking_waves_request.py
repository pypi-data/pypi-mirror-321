...
class PickingDeleteOrdersFromPickingWavesRequest(BaseModel):
    """
    PickingDeleteOrdersFromPickingWavesRequest
    """ # noqa: E501
    request: Optional[DeleteOrdersFromPickingWavesRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "request": DeleteOrdersFromPickingWavesRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
