...
class PickingWaveItemUpdate(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["PickingWaveItemsRowId", "TOTId", "TrayTag", "PickingTag", "PickedQuantity", "OrderState", "ItemState", "ToPickQuantity"]
