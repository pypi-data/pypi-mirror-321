...
class PickingWaveGenerateMulti(BaseModel):
    """
    PickingWaveGenerateMulti
    """ # noqa: E501
    orders: Optional[List[PickingWaveGenerateOrderMulti]] = Field(default=None, description="Orders", alias="Orders")
    group_type: Optional[StrictStr] = Field(default=None, description="Pickwave group type (optional, if not set parent sort will be used)", alias="GroupType")
    __properties: ClassVar[List[str]] = ["Orders", "GroupType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Orders": [PickingWaveGenerateOrderMulti.from_dict(_item) for _item in obj["Orders"]] if obj.get("Orders") is not None else None,
