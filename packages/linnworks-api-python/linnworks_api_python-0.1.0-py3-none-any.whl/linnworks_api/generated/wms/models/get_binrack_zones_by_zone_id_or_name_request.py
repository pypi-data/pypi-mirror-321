...
class GetBinrackZonesByZoneIdOrNameRequest(BaseModel):
    """
    GetBinrackZonesByZoneIdOrNameRequest
    """ # noqa: E501
    stock_location_int_id: Optional[StrictInt] = Field(default=None, alias="StockLocationIntId")
    zone_names: Optional[List[StrictStr]] = Field(default=None, alias="ZoneNames")
    zone_ids: Optional[List[StrictInt]] = Field(default=None, alias="ZoneIds")
    __properties: ClassVar[List[str]] = ["StockLocationIntId", "ZoneNames", "ZoneIds"]
