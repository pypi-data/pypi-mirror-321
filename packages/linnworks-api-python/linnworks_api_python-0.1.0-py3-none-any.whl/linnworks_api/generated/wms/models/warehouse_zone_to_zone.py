...
class WarehouseZoneToZone(BaseModel):
    """
    WarehouseZoneToZone
    """ # noqa: E501
    zone_id: Optional[StrictInt] = Field(default=None, alias="ZoneId")
    zone_id_parent: Optional[StrictInt] = Field(default=None, alias="ZoneIdParent")
    __properties: ClassVar[List[str]] = ["ZoneId", "ZoneIdParent"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ZoneIdParent": obj.get("ZoneIdParent")
        })
        return _obj
