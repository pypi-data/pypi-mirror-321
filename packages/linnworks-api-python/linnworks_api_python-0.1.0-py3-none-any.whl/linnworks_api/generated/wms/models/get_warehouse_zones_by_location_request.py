...
class GetWarehouseZonesByLocationRequest(BaseModel):
    """
    GetWarehouseZonesByLocationRequest
    """ # noqa: E501
    stock_location_int_id: Optional[StrictInt] = Field(default=None, alias="StockLocationIntId")
    only_binrack_assignable: Optional[StrictBool] = Field(default=None, alias="OnlyBinrackAssignable")
    __properties: ClassVar[List[str]] = ["StockLocationIntId", "OnlyBinrackAssignable"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "OnlyBinrackAssignable": obj.get("OnlyBinrackAssignable")
        })
        return _obj
