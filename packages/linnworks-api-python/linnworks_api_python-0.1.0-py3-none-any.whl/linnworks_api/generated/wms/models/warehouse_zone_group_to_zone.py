...
class WarehouseZoneGroupToZone(BaseModel):
    """
    WarehouseZoneGroupToZone
    """ # noqa: E501
    zone_id: Optional[StrictInt] = Field(default=None, alias="ZoneId")
    zone_group_id: Optional[StrictInt] = Field(default=None, alias="ZoneGroupId")
    __properties: ClassVar[List[str]] = ["ZoneId", "ZoneGroupId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ZoneGroupId": obj.get("ZoneGroupId")
        })
        return _obj
