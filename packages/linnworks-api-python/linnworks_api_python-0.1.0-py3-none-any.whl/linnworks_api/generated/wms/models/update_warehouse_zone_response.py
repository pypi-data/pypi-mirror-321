...
class UpdateWarehouseZoneResponse(BaseModel):
    """
    UpdateWarehouseZoneResponse
    """ # noqa: E501
    zone: Optional[WarehouseZone] = Field(default=None, alias="Zone")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Zone": WarehouseZone.from_dict(obj["Zone"]) if obj.get("Zone") is not None else None
        })
        return _obj
