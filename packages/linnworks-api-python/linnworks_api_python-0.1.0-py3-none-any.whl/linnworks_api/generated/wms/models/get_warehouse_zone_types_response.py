...
class GetWarehouseZoneTypesResponse(BaseModel):
    """
    GetWarehouseZoneTypesResponse
    """ # noqa: E501
    types: Optional[List[WarehouseZoneType]] = Field(default=None, description="Warehouse zone types", alias="Types")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Types": [WarehouseZoneType.from_dict(_item) for _item in obj["Types"]] if obj.get("Types") is not None else None
        })
        return _obj
