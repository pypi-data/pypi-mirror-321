...
class WarehouseZone(BaseModel):
    ...
    parent_zone_id: Optional[StrictInt] = Field(default=None, alias="ParentZoneId")
    hierarchy_level: Optional[StrictInt] = Field(default=None, alias="HierarchyLevel")
    stock_location_int_id: Optional[StrictInt] = Field(default=None, alias="StockLocationIntId")
    __properties: ClassVar[List[str]] = ["ZoneId", "ZoneTypeId", "Name", "ParentZoneId", "HierarchyLevel", "StockLocationIntId"]
