...
class WarehouseTransferCreateTransferRequestWithReturnRequest(BaseModel):
    """
    WarehouseTransferCreateTransferRequestWithReturnRequest
    """ # noqa: E501
    from_location_id: Optional[StrictStr] = Field(default=None, description="pkLocationId for from Location", alias="fromLocationId")
    to_location_id: Optional[StrictStr] = Field(default=None, description="pkLocationId for to Location", alias="toLocationId")
    __properties: ClassVar[List[str]] = ["fromLocationId", "toLocationId"]
