...
class WarehouseTransferChangeTransferItemReceivedQuantityRequest(BaseModel):
    """
    ...
    pk_transfer_item_id: Optional[StrictStr] = Field(default=None, description="The id of the bin item.", alias="pkTransferItemId")
    quantity: Optional[StrictInt] = Field(default=None, description="The new quantity.", alias="Quantity")
    __properties: ClassVar[List[str]] = ["pkTransferId", "pkBinId", "pkTransferItemId", "Quantity"]
