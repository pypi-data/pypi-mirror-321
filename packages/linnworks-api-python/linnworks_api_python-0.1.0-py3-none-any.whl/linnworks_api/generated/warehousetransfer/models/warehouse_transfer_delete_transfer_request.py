...
class WarehouseTransferDeleteTransferRequest(BaseModel):
    """
    ...
    delete_reason: Optional[StrictStr] = Field(default=None, description="Explanation for deletion", alias="DeleteReason")
    __properties: ClassVar[List[str]] = ["pkTransferId", "DeleteReason"]
