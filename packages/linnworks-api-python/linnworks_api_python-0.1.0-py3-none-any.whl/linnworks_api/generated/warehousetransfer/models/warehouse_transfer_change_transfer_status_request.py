...
class WarehouseTransferChangeTransferStatusRequest(BaseModel):
    """
    WarehouseTransferChangeTransferStatusRequest
    """ # noqa: E501
    pk_transfer_id: Optional[StrictStr] = Field(default=None, description="pkTransferId for transfer requiring status change", alias="pkTransferId")
    new_status: Optional[StrictStr] = Field(default=None, description="new status for transfer", alias="newStatus")
    __properties: ClassVar[List[str]] = ["pkTransferId", "newStatus"]
