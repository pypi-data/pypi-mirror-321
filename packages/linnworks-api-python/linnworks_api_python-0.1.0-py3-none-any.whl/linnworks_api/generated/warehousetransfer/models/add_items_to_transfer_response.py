...
class AddItemsToTransferResponse(BaseModel):
    """
    AddItemsToTransferResponse
    """ # noqa: E501
    transfer_items: Optional[List[WarehouseTransferItem]] = Field(default=None, alias="TransferItems")
    __properties: ClassVar[List[str]] = ["TransferItems"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "TransferItems": [WarehouseTransferItem.from_dict(_item) for _item in obj["TransferItems"]] if obj.get("TransferItems") is not None else None
        })
        return _obj
