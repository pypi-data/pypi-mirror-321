...
class ExportFeedSFTP(ExportGenericFeed):
    """
    ExportFeedSFTP
    """ # noqa: E501
    ...
    compression: Optional[StrictBool] = Field(default=None, alias="Compression")
    __properties: ClassVar[List[str]] = ["FeedType", "FileName", "FilePath", "TempFileName", "IfFileExist", "discriminator", "Server", "Port", "UserName", "Password", "Compression"]
