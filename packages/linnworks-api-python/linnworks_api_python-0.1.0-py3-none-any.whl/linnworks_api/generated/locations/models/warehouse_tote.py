...
class WarehouseTOTE(BaseModel):
    """
    WarehouseTOTE
    """ # noqa: E501
    tote_id: Optional[StrictInt] = Field(default=None, alias="ToteId")
    tote_barcode: Optional[StrictStr] = Field(default=None, alias="ToteBarcode")
    location_id: Optional[StrictStr] = Field(default=None, alias="LocationId")
    __properties: ClassVar[List[str]] = ["ToteId", "ToteBarcode", "LocationId"]
