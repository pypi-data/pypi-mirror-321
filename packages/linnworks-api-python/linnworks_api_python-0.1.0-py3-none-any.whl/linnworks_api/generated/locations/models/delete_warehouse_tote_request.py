...
class DeleteWarehouseToteRequest(BaseModel):
    """
    DeleteWarehouseToteRequest
    """ # noqa: E501
    tote_ids: Optional[List[StrictInt]] = Field(default=None, description="List of warehouse tote ids to delete", alias="ToteIds")
    location_id: Optional[StrictStr] = Field(default=None, description="Location id", alias="LocationId")
    __properties: ClassVar[List[str]] = ["ToteIds", "LocationId"]
