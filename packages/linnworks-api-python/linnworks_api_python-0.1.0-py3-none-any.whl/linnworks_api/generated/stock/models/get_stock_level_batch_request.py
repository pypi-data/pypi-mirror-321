...
class GetStockLevelBatchRequest(BaseModel):
    """
    GetStockLevelBatchRequest
    """ # noqa: E501
    stock_item_ids: Optional[List[StrictStr]] = Field(default=None, description="List of stock item ids to get stock level", alias="StockItemIds")
