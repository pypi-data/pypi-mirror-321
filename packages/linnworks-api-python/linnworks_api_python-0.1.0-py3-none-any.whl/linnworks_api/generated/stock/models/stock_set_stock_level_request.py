...
class StockSetStockLevelRequest(BaseModel):
    """
    StockSetStockLevelRequest
    """ # noqa: E501
    stock_levels: Optional[List[StockLevelUpdate]] = Field(default=None, description="The new stock items levels to set", alias="stockLevels")
