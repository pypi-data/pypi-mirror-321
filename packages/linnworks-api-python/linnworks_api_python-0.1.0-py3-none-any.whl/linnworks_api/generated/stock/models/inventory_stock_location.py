...
class InventoryStockLocation(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["StockLocationId", "StockLocationIntId", "LocationName", "LocationTag", "IsFulfillmentCenter", "IsWarehouseManaged", "BinRack"]
