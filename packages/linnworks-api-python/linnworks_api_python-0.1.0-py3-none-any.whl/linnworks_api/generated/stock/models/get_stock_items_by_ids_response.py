...
class GetStockItemsByIdsResponse(BaseModel):
    """
    GetStockItemsByIdsResponse
    """ # noqa: E501
    items: Optional[List[StockItemHeader]] = Field(default=None, description="List of stock item headers.", alias="Items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Items": [StockItemHeader.from_dict(_item) for _item in obj["Items"]] if obj.get("Items") is not None else None
        })
        return _obj
