...
class StockUpdateStockLevelsBySKURequest(BaseModel):
    """
    StockUpdateStockLevelsBySKURequest
    """ # noqa: E501
    stock_levels: Optional[List[StockLevelUpdate]] = Field(default=None, description="The new stock items levels to adjust", alias="stockLevels")
    change_source: Optional[StrictStr] = Field(default=None, alias="changeSource")
    __properties: ClassVar[List[str]] = ["stockLevels", "changeSource"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "stockLevels": [StockLevelUpdate.from_dict(_item) for _item in obj["stockLevels"]] if obj.get("stockLevels") is not None else None,
