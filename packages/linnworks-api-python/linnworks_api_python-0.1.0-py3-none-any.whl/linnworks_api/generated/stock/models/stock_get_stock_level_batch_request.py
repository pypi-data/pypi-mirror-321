...
class StockGetStockLevelBatchRequest(BaseModel):
    """
    StockGetStockLevelBatchRequest
    """ # noqa: E501
    request: Optional[GetStockLevelBatchRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "request": GetStockLevelBatchRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
