...
class GetStockItemsByIdsRequest(BaseModel):
    """
    GetStockItemsByIdsRequest
    """ # noqa: E501
    stock_item_ids: Optional[List[StrictStr]] = Field(default=None, description="Collection of Stock item id (uniqueidentifier)", alias="StockItemIds")
    __properties: ClassVar[List[str]] = ["StockItemIds"]
