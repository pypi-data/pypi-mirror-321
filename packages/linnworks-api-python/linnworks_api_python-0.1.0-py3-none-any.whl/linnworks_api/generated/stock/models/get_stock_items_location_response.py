...
class GetStockItemsLocationResponse(BaseModel):
    """
    GetStockItemsLocationResponse
    """ # noqa: E501
    stock_item_locations: Optional[List[StockItemLocation]] = Field(default=None, alias="StockItemLocations")
    __properties: ClassVar[List[str]] = ["StockItemLocations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "StockItemLocations": [StockItemLocation.from_dict(_item) for _item in obj["StockItemLocations"]] if obj.get("StockItemLocations") is not None else None
        })
        return _obj
