...
class ProcessedOrdersRefundShippingRequest(BaseModel):
    """
    ProcessedOrdersRefundShippingRequest
    """ # noqa: E501
    pk_order_id: Optional[StrictStr] = Field(default=None, description="The id of the order whose shipping needs to be refunded", alias="pkOrderId")
    __properties: ClassVar[List[str]] = ["pkOrderId"]
