...
class ProcessedOrdersIsRefundValidRequest(BaseModel):
    """
    ProcessedOrdersIsRefundValidRequest
    """ # noqa: E501
    pk_order_id: Optional[StrictStr] = Field(default=None, description="The id of the order to validate the refund with", alias="pkOrderId")
    refund_items: Optional[List[RefundItem]] = Field(default=None, description="The refund rows", alias="refundItems")
