...
class ProcessedOrdersRefundServicesRequest(BaseModel):
    """
    ProcessedOrdersRefundServicesRequest
    """ # noqa: E501
    pk_order_id: Optional[StrictStr] = Field(default=None, description="The id of the order to refund services for.", alias="pkOrderId")
    refund_items: Optional[List[RefundItem]] = Field(default=None, description="Refunds for service items", alias="refundItems")
