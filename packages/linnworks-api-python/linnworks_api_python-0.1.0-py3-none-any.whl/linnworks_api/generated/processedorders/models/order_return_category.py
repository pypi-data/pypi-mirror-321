...
class OrderReturnCategory(BaseModel):
    """
    OrderReturnCategory
    """ # noqa: E501
    pk_item_id: Optional[StrictInt] = Field(default=None, alias="pkItemId")
    category_name: Optional[StrictStr] = Field(default=None, alias="CategoryName")
    __properties: ClassVar[List[str]] = ["pkItemId", "CategoryName"]
