...
class ProcessedOrdersAddOrderNoteRequest(BaseModel):
    """
    ...
    note_text: Optional[StrictStr] = Field(default=None, description="The note text", alias="noteText")
    is_internal: Optional[StrictBool] = Field(default=None, description="True if the note should be internal, False if it shouldn't", alias="isInternal")
    __properties: ClassVar[List[str]] = ["pkOrderID", "noteText", "isInternal"]
