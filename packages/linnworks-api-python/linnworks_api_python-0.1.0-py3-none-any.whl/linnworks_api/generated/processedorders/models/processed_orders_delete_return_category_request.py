...
class ProcessedOrdersDeleteReturnCategoryRequest(BaseModel):
    """
    ProcessedOrdersDeleteReturnCategoryRequest
    """ # noqa: E501
    pk_item_id: Optional[StrictInt] = Field(default=None, description="The id of the category to delete.", alias="pkItemId")
    __properties: ClassVar[List[str]] = ["pkItemId"]
