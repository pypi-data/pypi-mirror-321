...
class ExistingRefundTotal(BaseModel):
    """
    ExistingRefundTotal
    """ # noqa: E501
    ...
    refundable: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="Refundable")
    __properties: ClassVar[List[str]] = ["Amount", "TotalCharge", "Refundable"]
