...
class ProcessedOrdersAddReturnCategoryRequest(BaseModel):
    """
    ProcessedOrdersAddReturnCategoryRequest
    """ # noqa: E501
    category_name: Optional[StrictStr] = Field(default=None, description="The name of the category to add.", alias="categoryName")
