...
class PostalServicesDeletePostalServiceRequest(BaseModel):
    """
    PostalServicesDeletePostalServiceRequest
    """ # noqa: E501
    id_to_delete: Optional[StrictStr] = Field(default=None, description="Postal service ID to delete", alias="idToDelete")
    __properties: ClassVar[List[str]] = ["idToDelete"]
