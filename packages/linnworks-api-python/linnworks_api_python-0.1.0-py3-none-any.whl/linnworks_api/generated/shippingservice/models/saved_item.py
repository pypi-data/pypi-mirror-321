...
class SavedItem(BaseModel):
    ...
    unit_value_currency: Optional[StrictStr] = Field(default=None, alias="UnitValueCurrency")
    __properties: ClassVar[List[str]] = ["Name", "Quantity", "UnitValue", "UnitValueCurrency"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "UnitValueCurrency": obj.get("UnitValueCurrency")
        })
        return _obj
