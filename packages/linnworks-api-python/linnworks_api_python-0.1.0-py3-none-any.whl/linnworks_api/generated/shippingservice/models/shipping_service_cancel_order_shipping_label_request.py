...
class ShippingServiceCancelOrderShippingLabelRequest(BaseModel):
    """
    ShippingServiceCancelOrderShippingLabelRequest
    """ # noqa: E501
    request: Optional[CancelOrderShippingLabelRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "request": CancelOrderShippingLabelRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
