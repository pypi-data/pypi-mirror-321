...
class GenericPagedResultConsignment(BaseModel):
    """
    ...
    data: Optional[List[Consignment]] = Field(default=None, alias="Data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Data": [Consignment.from_dict(_item) for _item in obj["Data"]] if obj.get("Data") is not None else None
        })
        return _obj
