...
class PrintError(BaseModel):
    ...
    tags: Optional[List[PrintErrorTags]] = Field(default=None, alias="Tags")
    __properties: ClassVar[List[str]] = ["TemplateType", "Id", "Error", "Tags"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Id": obj.get("Id"),
            "Error": obj.get("Error"),
            "Tags": [PrintErrorTags.from_dict(_item) for _item in obj["Tags"]] if obj.get("Tags") is not None else None
        })
        return _obj
