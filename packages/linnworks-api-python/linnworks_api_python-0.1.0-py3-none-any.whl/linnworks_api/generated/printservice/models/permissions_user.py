...
class PermissionsUser(BaseModel):
    ...
    fk_user_id: Optional[StrictStr] = Field(default=None, alias="fkUserId")
    ...
    totp_authentication_enabled: Optional[StrictBool] = Field(default=None, alias="TotpAuthenticationEnabled")
    password_problems: Optional[StrictInt] = Field(default=None, alias="PasswordProblems")
    __properties: ClassVar[List[str]] = ["UserId", "fkUserId", "SuperAdmin", "EmailAddress", "UserType", "TotpAuthenticationEnabled", "PasswordProblems"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fkUserId": obj.get("fkUserId"),
            "SuperAdmin": obj.get("SuperAdmin"),
            "EmailAddress": obj.get("EmailAddress"),
            "UserType": obj.get("UserType"),
            "TotpAuthenticationEnabled": obj.get("TotpAuthenticationEnabled"),
            "PasswordProblems": obj.get("PasswordProblems")
        })
        return _obj
