...
class UpdateShippingPlanRequestInput(BaseModel):
    """
    UpdateShippingPlanRequestInput
    """ # noqa: E501
    channel_id: Annotated[int, Field(le=2147483647, strict=True, ge=1)] = Field(alias="channelId")
    ...
    to_location: StrictStr = Field(alias="toLocation")
    __properties: ClassVar[List[str]] = ["channelId", "fromLocation", "inboundPlanId", "isPackingInfoKnown", "planId", "status", "toLocation"]
