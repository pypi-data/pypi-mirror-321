...
class AddShipmentBoxModel(BaseModel):
    """
    AddShipmentBoxModel
    """ # noqa: E501
    ...
    measurement_unit: Optional[UnitOfMeasurement] = Field(default=None, alias="measurementUnit")
    weight_unit: Optional[UnitOfWeight] = Field(default=None, alias="weightUnit")
    quantity: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["shippingPlanId", "shipmentId", "packingGroupId", "name", "height", "length", "width", "weight", "measurementUnit", "weightUnit", "quantity"]
