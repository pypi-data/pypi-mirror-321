...
class PackingGroupModel(BaseModel):
    """
    PackingGroupModel
    """ # noqa: E501
    packing_group_id: Optional[StrictStr] = Field(default=None, alias="packingGroupId")
    items: Optional[List[ItemModel]] = None
    __properties: ClassVar[List[str]] = ["packingGroupId", "items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [ItemModel.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
