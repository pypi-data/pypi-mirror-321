...
class StockItemSearchModel(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["barcodeNumber", "itemNumber", "itemTitle", "sellerSKU", "asin"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if barcode_number (nullable) is None
        # and model_fields_set contains the field
        if self.barcode_number is None and "barcode_number" in self.model_fields_set:
            _dict['barcodeNumber'] = None
