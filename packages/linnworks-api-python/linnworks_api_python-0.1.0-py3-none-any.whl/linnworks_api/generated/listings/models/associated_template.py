...
class AssociatedTemplate(BaseModel):
    """
    AssociatedTemplate
    """ # noqa: E501
    template_id: Optional[StrictStr] = Field(default=None, alias="TemplateId")
    used_config_id: Optional[StrictStr] = Field(default=None, alias="UsedConfigId")
    name: Optional[StrictStr] = Field(default=None, alias="Name")
    site: Optional[StrictStr] = Field(default=None, alias="Site")
    __properties: ClassVar[List[str]] = ["TemplateId", "UsedConfigId", "Name", "Site"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "UsedConfigId": obj.get("UsedConfigId"),
            "Name": obj.get("Name"),
            "Site": obj.get("Site")
        })
        return _obj
