...
class ListingsDeleteeBayConfiguratorsRequest(BaseModel):
    """
    ListingsDeleteeBayConfiguratorsRequest
    """ # noqa: E501
    configs: Optional[List[StrictStr]] = Field(default=None, description="Configs guid")
