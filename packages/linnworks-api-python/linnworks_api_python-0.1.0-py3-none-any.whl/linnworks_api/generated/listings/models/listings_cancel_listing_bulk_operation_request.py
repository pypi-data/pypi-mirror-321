...
class ListingsCancelListingBulkOperationRequest(BaseModel):
    """
    ListingsCancelListingBulkOperationRequest
    """ # noqa: E501
    pk_operation_id: Optional[StrictInt] = Field(default=None, alias="pkOperationId")
    __properties: ClassVar[List[str]] = ["pkOperationId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pkOperationId": obj.get("pkOperationId")
        })
        return _obj
