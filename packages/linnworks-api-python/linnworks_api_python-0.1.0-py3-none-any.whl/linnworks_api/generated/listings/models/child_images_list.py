...
class ChildImagesList(BaseModel):
    """
    ChildImagesList
    """ # noqa: E501
    child_id: Optional[StrictStr] = Field(default=None, alias="ChildId")
    images: Optional[List[ChildImage]] = Field(default=None, alias="Images")
    __properties: ClassVar[List[str]] = ["ChildId", "Images"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Images": [ChildImage.from_dict(_item) for _item in obj["Images"]] if obj.get("Images") is not None else None
        })
        return _obj
