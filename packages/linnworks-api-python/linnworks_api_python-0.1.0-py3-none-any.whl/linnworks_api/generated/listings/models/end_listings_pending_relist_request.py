...
class EndListingsPendingRelistRequest(BaseModel):
    """
    EndListingsPendingRelistRequest
    """ # noqa: E501
    listings: Optional[List[EbayListingAudit]] = Field(default=None, alias="Listings")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Listings": [EbayListingAudit.from_dict(_item) for _item in obj["Listings"]] if obj.get("Listings") is not None else None
        })
        return _obj
