...
class SiteFilter(BaseModel):
    ...
    sites: Optional[StrictStr] = Field(default=None, alias="Sites")
    selected_sites: Optional[List[StrictStr]] = Field(default=None, alias="SelectedSites")
    __properties: ClassVar[List[str]] = ["Source", "SubSource", "Sites", "SelectedSites"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Sites": obj.get("Sites"),
            "SelectedSites": obj.get("SelectedSites")
        })
        return _obj
