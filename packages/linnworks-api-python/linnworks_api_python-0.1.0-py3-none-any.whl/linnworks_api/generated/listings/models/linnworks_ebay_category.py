...
class LinnworksEbayCategory(BaseModel):
    """
    LinnworksEbayCategory
    """ # noqa: E501
    is_default: Optional[StrictBool] = Field(default=None, alias="IsDefault")
    lot_size_disabled: Optional[StrictBool] = Field(default=None, alias="LotSizeDisabled")
    is_product_required: Optional[StrictBool] = Field(default=None, alias="IsProductRequired")
    variations_enabled: Optional[StrictBool] = Field(default=None, alias="VariationsEnabled")
    site_supported: Optional[StrictBool] = Field(default=None, alias="SiteSupported")
    ...
    __properties: ClassVar[List[str]] = ["IsDefault", "LotSizeDisabled", "IsProductRequired", "VariationsEnabled", "SiteSupported", "CategoryId", "CategoryName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "LotSizeDisabled": obj.get("LotSizeDisabled"),
            "IsProductRequired": obj.get("IsProductRequired"),
            "VariationsEnabled": obj.get("VariationsEnabled"),
            "SiteSupported": obj.get("SiteSupported"),
