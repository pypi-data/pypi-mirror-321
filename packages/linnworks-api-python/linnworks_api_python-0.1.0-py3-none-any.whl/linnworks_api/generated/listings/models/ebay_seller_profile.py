...
class EbaySellerProfile(BaseModel):
    """
    EbaySellerProfile
    """ # noqa: E501
    ...
    seller_profile_extended_property: Optional[StrictStr] = Field(default=None, alias="SellerProfileExtendedProperty")
    __properties: ClassVar[List[str]] = ["ProfileId", "ProfileType", "ProfileName", "ErrorMessage", "SellerProfileExtendedProperty"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "SellerProfileExtendedProperty": obj.get("SellerProfileExtendedProperty")
        })
        return _obj
