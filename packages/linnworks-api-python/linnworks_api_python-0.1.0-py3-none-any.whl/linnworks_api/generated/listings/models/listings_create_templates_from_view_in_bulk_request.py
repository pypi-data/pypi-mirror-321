...
class ListingsCreateTemplatesFromViewInBulkRequest(BaseModel):
    """
    ListingsCreateTemplatesFromViewInBulkRequest
    """ # noqa: E501
    parameters: Optional[CreateTemplatesInBulkParameters] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "parameters": CreateTemplatesInBulkParameters.from_dict(obj["parameters"]) if obj.get("parameters") is not None else None
        })
        return _obj
