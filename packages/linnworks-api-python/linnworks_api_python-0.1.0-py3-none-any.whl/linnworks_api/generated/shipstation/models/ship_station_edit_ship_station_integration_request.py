...
class ShipStationEditShipStationIntegrationRequest(BaseModel):
    """
    ShipStationEditShipStationIntegrationRequest
    """ # noqa: E501
    integration: Optional[ShipStationConfig] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "integration": ShipStationConfig.from_dict(obj["integration"]) if obj.get("integration") is not None else None
        })
        return _obj
