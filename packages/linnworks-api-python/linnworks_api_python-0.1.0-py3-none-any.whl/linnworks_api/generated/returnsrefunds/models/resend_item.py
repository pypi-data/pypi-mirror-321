...
class ResendItem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ResendQuantity", "DespatchLocationId", "AdditionalCost", "OrderItemRowId", "ReturnItemSKU", "ReturnItemTitle", "BatchInventoryId", "ReturnLocation", "ReturnQuantity", "RefundAmount", "RefundRowId", "ScrapQuantity", "ReasonCategory", "IsFreeText", "Reason", "ReasonTag", "SubReasonTag", "Status", "BinrackOverride"]
