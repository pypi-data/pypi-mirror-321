...
class ReturnItem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["OrderItemRowId", "ReturnItemSKU", "ReturnItemTitle", "BatchInventoryId", "ReturnLocation", "ReturnQuantity", "RefundAmount", "RefundRowId", "ScrapQuantity", "ReasonCategory", "IsFreeText", "Reason", "ReasonTag", "SubReasonTag", "Status", "BinrackOverride"]
