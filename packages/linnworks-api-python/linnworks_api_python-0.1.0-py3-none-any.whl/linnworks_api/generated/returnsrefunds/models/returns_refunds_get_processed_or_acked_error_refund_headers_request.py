...
class ReturnsRefundsGetProcessedOrAckedErrorRefundHeadersRequest(BaseModel):
    """
    ReturnsRefundsGetProcessedOrAckedErrorRefundHeadersRequest
    """ # noqa: E501
    request: Optional[GetProcessedOrAckedErrorRefundHeadersRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "request": GetProcessedOrAckedErrorRefundHeadersRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
