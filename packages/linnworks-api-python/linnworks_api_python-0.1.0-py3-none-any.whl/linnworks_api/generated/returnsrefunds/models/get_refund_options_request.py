...
class GetRefundOptionsRequest(BaseModel):
    """
    GetRefundOptionsRequest
    """ # noqa: E501
    refund_header_id: Optional[StrictInt] = Field(default=None, description="If included, will return the relevant refund header as part of the RefundOptions object in the response", alias="RefundHeaderId")
