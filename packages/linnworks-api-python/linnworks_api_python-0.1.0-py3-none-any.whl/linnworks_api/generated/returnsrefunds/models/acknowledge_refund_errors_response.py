...
class AcknowledgeRefundErrorsResponse(BaseModel):
    """
    AcknowledgeRefundErrorsResponse
    """ # noqa: E501
    entire_refund_header_set_to_error_acked: Optional[StrictBool] = Field(default=None, description="Determines whether the entire refund header was set to \"ERROR_ACKED\" state as a result of this call (will be found in the History tab)", alias="EntireRefundHeaderSetToErrorAcked")
    ...
    __properties: ClassVar[List[str]] = ["EntireRefundHeaderSetToErrorAcked", "RefundHeaderId", "RefundReference", "Status", "CannotRefundReason", "Errors", "RefundLines"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "EntireRefundHeaderSetToErrorAcked": obj.get("EntireRefundHeaderSetToErrorAcked"),
