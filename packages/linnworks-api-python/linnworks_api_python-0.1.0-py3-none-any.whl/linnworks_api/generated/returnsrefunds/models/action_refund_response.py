...
class ActionRefundResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["SuccessfullyActioned", "RefundHeaderId", "RefundReference", "Status", "CannotRefundReason", "Errors", "RefundLines"]
