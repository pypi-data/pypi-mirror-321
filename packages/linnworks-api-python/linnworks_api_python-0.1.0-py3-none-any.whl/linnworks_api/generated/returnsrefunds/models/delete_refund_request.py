...
class DeleteRefundRequest(BaseModel):
    """
    DeleteRefundRequest
    """ # noqa: E501
    refund_header_id: Optional[StrictInt] = Field(default=None, description="Identifies the refund header to be deleted", alias="RefundHeaderId")
    reason_tag: Optional[StrictStr] = Field(default=None, description="Reason for deleting the refund. Channel Dependant", alias="ReasonTag")
    ...
    __properties: ClassVar[List[str]] = ["RefundHeaderId", "ReasonTag", "RejectOnChannel"]
