...
class GetRMAHeadersByOrderIdResponse(BaseModel):
    """
    GetRMAHeadersByOrderIdResponse
    """ # noqa: E501
    rma_headers: Optional[List[OrderRMAHeader]] = Field(default=None, alias="RMAHeaders")
    __properties: ClassVar[List[str]] = ["RMAHeaders"]
