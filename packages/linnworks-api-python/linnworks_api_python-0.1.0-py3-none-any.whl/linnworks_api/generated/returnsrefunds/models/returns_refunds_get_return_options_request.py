...
class ReturnsRefundsGetReturnOptionsRequest(BaseModel):
    """
    ReturnsRefundsGetReturnOptionsRequest
    """ # noqa: E501
    request: Optional[GetReturnOptionsRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "request": GetReturnOptionsRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
