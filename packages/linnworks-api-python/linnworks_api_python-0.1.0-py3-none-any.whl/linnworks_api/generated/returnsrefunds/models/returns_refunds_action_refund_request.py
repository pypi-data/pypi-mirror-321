...
class ReturnsRefundsActionRefundRequest(BaseModel):
    """
    ReturnsRefundsActionRefundRequest
    """ # noqa: E501
    request: Optional[ActionRefundRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "request": ActionRefundRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
