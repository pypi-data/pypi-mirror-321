...
class ActionRMABookingResponse(BaseModel):
    """
    ActionRMABookingResponse
    """ # noqa: E501
    refund_header_id: Optional[StrictInt] = Field(default=None, description="If a refund was created as part of accepting the return/exchange booking, this identifies the created header", alias="RefundHeaderId")
    status: Optional[PostSaleStatus] = Field(default=None, alias="Status")
    successfully_actioned: Optional[StrictBool] = Field(default=None, description="Determines whether the header was marked as actioned in the database", alias="SuccessfullyActioned")
    ...
    __properties: ClassVar[List[str]] = ["RefundHeaderId", "Status", "SuccessfullyActioned", "RMAHeaderId", "Items", "Errors", "Info"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "SuccessfullyActioned": obj.get("SuccessfullyActioned"),
