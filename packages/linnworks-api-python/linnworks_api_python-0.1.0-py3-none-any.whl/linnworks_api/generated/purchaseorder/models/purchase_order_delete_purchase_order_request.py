...
class PurchaseOrderDeletePurchaseOrderRequest(BaseModel):
    """
    PurchaseOrderDeletePurchaseOrderRequest
    """ # noqa: E501
    pk_purchase_id: Optional[StrictStr] = Field(default=None, description="Purchase Order unique id", alias="pkPurchaseId")
