...
class ModifyAdditionalCostRequest(BaseModel):
    """
    ModifyAdditionalCostRequest
    """ # noqa: E501
    items_to_add: Optional[List[AddAdditionalCostItem]] = Field(default=None, description="list of additional cost items to add. Each item has Id which will be returned to you to match the item you are adding to array on your side", alias="itemsToAdd")
    items_to_update: Optional[List[UpdateAdditionalCostItem]] = Field(default=None, description="List of items to update. Each line is identified by", alias="itemsToUpdate")
    items_to_delete: Optional[List[StrictInt]] = Field(default=None, description="List of items to delete, provide list of PurchaseAdditionalCostItemId's", alias="itemsToDelete")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "itemsToAdd": [AddAdditionalCostItem.from_dict(_item) for _item in obj["itemsToAdd"]] if obj.get("itemsToAdd") is not None else None,
            "itemsToUpdate": [UpdateAdditionalCostItem.from_dict(_item) for _item in obj["itemsToUpdate"]] if obj.get("itemsToUpdate") is not None else None,
