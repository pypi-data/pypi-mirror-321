...
class DeliverPurchaseOrderItemRequest(BaseModel):
    """
    ...
    add_to_delivered: Optional[StrictInt] = Field(default=None, alias="AddToDelivered")
    delivery_id: Optional[StrictInt] = Field(default=None, alias="DeliveryId")
    __properties: ClassVar[List[str]] = ["BatchNumber", "BinRack", "PrioritySequence", "BatchStatus", "pkPurchaseId", "pkPurchaseItemId", "Delivered", "AddToDelivered", "DeliveryId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "AddToDelivered": obj.get("AddToDelivered"),
