...
class ModifyAdditionalCostAllocationRequest(BaseModel):
    """
    ...
    items_to_add: Optional[List[AddAdditionalCostAllocationItem]] = Field(default=None, description="Items to add", alias="itemsToAdd")
    items_to_update: Optional[List[UpdateAdditionalCostAllocationItem]] = Field(default=None, description="Items to update", alias="itemsToUpdate")
    items_to_delete: Optional[List[StrictInt]] = Field(default=None, description="Items to delete by CostAllocationId", alias="itemsToDelete")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "itemsToAdd": [AddAdditionalCostAllocationItem.from_dict(_item) for _item in obj["itemsToAdd"]] if obj.get("itemsToAdd") is not None else None,
            "itemsToUpdate": [UpdateAdditionalCostAllocationItem.from_dict(_item) for _item in obj["itemsToUpdate"]] if obj.get("itemsToUpdate") is not None else None,
