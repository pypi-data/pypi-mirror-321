...
class PurchaseOrderModifyPaymentStatementResponse(BaseModel):
    """
    PurchaseOrderModifyPaymentStatementResponse
    """ # noqa: E501
    modified_items: Optional[List[ModifiedPaymentStatementItem]] = Field(default=None, description="List of modified items, added or updated. Each item has Id which was provided in the request", alias="ModifiedItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ModifiedItems": [ModifiedPaymentStatementItem.from_dict(_item) for _item in obj["ModifiedItems"]] if obj.get("ModifiedItems") is not None else None
        })
        return _obj
