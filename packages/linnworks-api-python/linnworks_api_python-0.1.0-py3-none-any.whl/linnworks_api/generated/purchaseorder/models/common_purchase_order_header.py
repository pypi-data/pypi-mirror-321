...
class CommonPurchaseOrderHeader(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["pkPurchaseID", "fkSupplierId", "fkLocationId", "ExternalInvoiceNumber", "Status", "Currency", "SupplierReferenceNumber", "Locked", "UnitAmountTaxIncludedType", "LineCount", "DeliveredLinesCount", "DateOfPurchase", "DateOfDelivery", "QuotedDeliveryDate", "PostagePaid", "TotalCost", "taxPaid", "ShippingTaxRate", "ConversionRate", "ConvertedShippingCost", "ConvertedShippingTax", "ConvertedOtherCost", "ConvertedOtherTax", "ConvertedGrandTotal"]
