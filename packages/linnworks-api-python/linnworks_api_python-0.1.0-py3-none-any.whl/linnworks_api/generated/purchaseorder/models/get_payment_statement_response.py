...
class GetPaymentStatementResponse(BaseModel):
    """
    GetPaymentStatementResponse
    """ # noqa: E501
    items: Optional[List[CommonPurchaseOrderPaymentStatement]] = Field(default=None, description="List of payment statements")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [CommonPurchaseOrderPaymentStatement.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
