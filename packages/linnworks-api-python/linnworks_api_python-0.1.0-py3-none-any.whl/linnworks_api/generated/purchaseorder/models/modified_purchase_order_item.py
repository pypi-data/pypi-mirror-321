...
class ModifiedPurchaseOrderItem(BaseModel):
    """
    Modified purchase order item
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="unique row id which was supplied in the ModifyPurchaseOrderItem, you can match this id to the request item. The same Id is returned to back from the request parameter", alias="Id")
    purchase_item_id: Optional[StrictStr] = Field(default=None, description="Unique purchase order item id. Purchase order item is deleted and updated by PurchaseOrderItemId", alias="PurchaseItemId")
    ...
    __properties: ClassVar[List[str]] = ["Id", "PurchaseItemId", "StockItemId", "Qty", "BoundToOpenOrdersItems", "QuantityBoundToOpenOrdersItems", "Cost", "TaxRate", "PackQuantity", "PackSize"]
