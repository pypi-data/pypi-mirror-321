...
class AddAdditionalCostTypesRequest(BaseModel):
    """
    AddAdditionalCostTypesRequest
    """ # noqa: E501
    type_name: Optional[StrictStr] = Field(default=None, description="Additional cost name", alias="TypeName")
    is_shipping_type: Optional[StrictBool] = Field(default=None, description="Type of additional cost is shipping cost", alias="IsShippingType")
    is_partial_allocation: Optional[StrictBool] = Field(default=None, description="Type must be 100% allocated to PO items", alias="IsPartialAllocation")
    ...
    __properties: ClassVar[List[str]] = ["TypeName", "IsShippingType", "IsPartialAllocation", "Print", "AllocationMethod"]
