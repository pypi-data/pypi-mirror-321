...
class GetPaymentStatementRequest(BaseModel):
    """
    Request class for getting purchase order payment statements
    """ # noqa: E501
    purchase_id: Optional[StrictStr] = Field(default=None, description="Purchase order unique identifier of a PO", alias="PurchaseId")
