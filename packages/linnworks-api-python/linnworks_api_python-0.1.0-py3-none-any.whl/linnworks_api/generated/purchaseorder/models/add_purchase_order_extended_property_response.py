...
class AddPurchaseOrderExtendedPropertyResponse(BaseModel):
    """
    AddPurchaseOrderExtendedPropertyResponse
    """ # noqa: E501
    items: Optional[List[PurchaseOrderExtendedProperty]] = Field(default=None, description="Added purchase order extended properties", alias="Items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Items": [PurchaseOrderExtendedProperty.from_dict(_item) for _item in obj["Items"]] if obj.get("Items") is not None else None
        })
        return _obj
