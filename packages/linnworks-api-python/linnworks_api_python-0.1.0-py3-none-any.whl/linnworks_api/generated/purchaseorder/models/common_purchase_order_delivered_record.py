...
class CommonPurchaseOrderDeliveredRecord(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["pkDeliveryRecordId", "fkPurchaseItemId", "fkStockLocationId", "UnitCost", "DeliveredQuantity", "CreatedDateTime", "ModifiedDateTime", "fkBatchInventoryId"]
