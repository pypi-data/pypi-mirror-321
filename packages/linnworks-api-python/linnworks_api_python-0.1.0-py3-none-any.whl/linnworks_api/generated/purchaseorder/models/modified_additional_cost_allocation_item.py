...
class ModifiedAdditionalCostAllocationItem(BaseModel):
    """
    ModifiedAdditionalCostAllocationItem
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Relation to the initial request. This Id will match to what was specified in the request so that the client side can be updated with new CostAllocationIds", alias="Id")
    ...
    __properties: ClassVar[List[str]] = ["Id", "CostAllocationId", "PurchaseAdditionalCostItemId", "PurchaseItemId", "AllocationPercentage"]
