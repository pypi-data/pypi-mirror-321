...
class DeleteAdditionalCostTypesRequest(BaseModel):
    """
    DeleteAdditionalCostTypesRequest
    """ # noqa: E501
    additional_cost_type_id: Optional[StrictInt] = Field(default=None, description="Additional cost type Ids to delete", alias="AdditionalCostTypeId")
    __properties: ClassVar[List[str]] = ["AdditionalCostTypeId"]
