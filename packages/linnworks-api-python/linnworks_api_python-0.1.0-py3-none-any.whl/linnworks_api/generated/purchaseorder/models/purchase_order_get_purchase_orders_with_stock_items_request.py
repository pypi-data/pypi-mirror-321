...
class PurchaseOrderGetPurchaseOrdersWithStockItemsRequest(BaseModel):
    """
    PurchaseOrderGetPurchaseOrdersWithStockItemsRequest
    """ # noqa: E501
    purchase_order: Optional[PurchaseOrderWithStockItem] = Field(default=None, alias="purchaseOrder")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "purchaseOrder": PurchaseOrderWithStockItem.from_dict(obj["purchaseOrder"]) if obj.get("purchaseOrder") is not None else None
        })
        return _obj
