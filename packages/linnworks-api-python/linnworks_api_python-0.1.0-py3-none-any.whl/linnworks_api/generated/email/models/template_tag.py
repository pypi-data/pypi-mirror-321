...
class TemplateTag(BaseModel):
    ...
    selection_path: Optional[StrictStr] = Field(default=None, alias="SelectionPath")
    is_list: Optional[StrictBool] = Field(default=None, alias="IsList")
    __properties: ClassVar[List[str]] = ["Tag", "Name", "SelectionPath", "IsList"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Tag": obj.get("Tag"),
            "Name": obj.get("Name"),
            "SelectionPath": obj.get("SelectionPath"),
