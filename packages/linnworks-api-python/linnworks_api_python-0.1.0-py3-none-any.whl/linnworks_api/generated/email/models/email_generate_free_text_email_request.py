...
class EmailGenerateFreeTextEmailRequest(BaseModel):
    """
    EmailGenerateFreeTextEmailRequest
    """ # noqa: E501
    request: Optional[GenerateFreeTextEmailRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "request": GenerateFreeTextEmailRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
