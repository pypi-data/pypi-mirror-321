...
class GenerateFreeTextEmailResponse(BaseModel):
    """
    GenerateFreeTextEmailResponse
    """ # noqa: E501
    is_complete: Optional[StrictBool] = Field(default=None, alias="isComplete")
    failed_recipients: Optional[List[StrictStr]] = Field(default=None, alias="FailedRecipients")
    __properties: ClassVar[List[str]] = ["isComplete", "FailedRecipients"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "FailedRecipients": obj.get("FailedRecipients")
        })
        return _obj
