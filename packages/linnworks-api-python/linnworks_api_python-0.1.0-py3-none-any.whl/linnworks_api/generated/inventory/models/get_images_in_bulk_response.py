...
class GetImagesInBulkResponse(BaseModel):
    """
    Bulk image response.
    """ # noqa: E501
    images: Optional[List[GetImagesInBulkResponseImage]] = Field(default=None, alias="Images")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Images": [GetImagesInBulkResponseImage.from_dict(_item) for _item in obj["Images"]] if obj.get("Images") is not None else None
        })
        return _obj
