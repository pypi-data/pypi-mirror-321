...
class InventoryGetInventoryItemAuditTrailPagedRequest(BaseModel):
    """
    InventoryGetInventoryItemAuditTrailPagedRequest
    """ # noqa: E501
    request: Optional[GetInventoryItemAuditTrailPagedRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "request": GetInventoryItemAuditTrailPagedRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
