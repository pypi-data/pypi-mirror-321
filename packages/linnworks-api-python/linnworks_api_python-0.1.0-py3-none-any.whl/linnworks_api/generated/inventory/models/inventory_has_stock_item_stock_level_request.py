...
class InventoryHasStockItemStockLevelRequest(BaseModel):
    """
    InventoryHasStockItemStockLevelRequest
    """ # noqa: E501
    request: Optional[HasStockItemStockLevelRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "request": HasStockItemStockLevelRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
