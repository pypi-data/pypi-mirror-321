...
class ConfigPropertySelectionListSelectStringValueOptionGuid(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["OnGetSelectionList", "Loaded", "pkPropertyId", "IsChanged", "PropertyValue", "PropertyType"]
