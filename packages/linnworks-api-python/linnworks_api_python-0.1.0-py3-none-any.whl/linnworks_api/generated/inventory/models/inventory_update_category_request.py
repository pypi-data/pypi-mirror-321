...
class InventoryUpdateCategoryRequest(BaseModel):
    """
    InventoryUpdateCategoryRequest
    """ # noqa: E501
    category: Optional[LinnworksCategory] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "category": LinnworksCategory.from_dict(obj["category"]) if obj.get("category") is not None else None
        })
        return _obj
