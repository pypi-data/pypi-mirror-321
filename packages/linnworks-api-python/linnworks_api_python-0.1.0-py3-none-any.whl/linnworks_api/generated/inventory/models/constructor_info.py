...
class ConstructorInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["MemberType", "MethodImplementationFlags", "MethodHandle", "Attributes", "CallingConvention", "IsGenericMethodDefinition", "ContainsGenericParameters", "IsGenericMethod", "IsSecurityCritical", "IsSecuritySafeCritical", "IsSecurityTransparent", "IsPublic", "IsPrivate", "IsFamily", "IsAssembly", "IsFamilyAndAssembly", "IsFamilyOrAssembly", "IsStatic", "IsFinal", "IsVirtual", "IsHideBySig", "IsAbstract", "IsSpecialName", "IsConstructor", "Name", "DeclaringType", "ReflectedType", "CustomAttributes", "MetadataToken", "Module"]
