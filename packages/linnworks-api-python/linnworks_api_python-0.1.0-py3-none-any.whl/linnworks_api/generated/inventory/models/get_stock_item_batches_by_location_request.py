...
class GetStockItemBatchesByLocationRequest(BaseModel):
    """
    ...
    only_available: Optional[StrictBool] = Field(default=None, alias="OnlyAvailable")
    __properties: ClassVar[List[str]] = ["StockItemId", "LocationId", "OnlyAvailable"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "OnlyAvailable": obj.get("OnlyAvailable")
        })
        return _obj
