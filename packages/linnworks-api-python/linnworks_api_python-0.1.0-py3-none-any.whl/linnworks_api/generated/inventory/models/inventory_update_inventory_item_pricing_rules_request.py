...
class InventoryUpdateInventoryItemPricingRulesRequest(BaseModel):
    """
    InventoryUpdateInventoryItemPricingRulesRequest
    """ # noqa: E501
    rules: Optional[List[StockItemPricingRule]] = Field(default=None, description="List of stock item pricing rules to update")
