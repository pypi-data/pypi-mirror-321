...
class InventoryGetInventoryItemBatchInformationRequest(BaseModel):
    """
    InventoryGetInventoryItemBatchInformationRequest
    """ # noqa: E501
    request: Optional[GetInventoryItemBatchInformationRequest] = Field(default=None, alias="Request")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Request": GetInventoryItemBatchInformationRequest.from_dict(obj["Request"]) if obj.get("Request") is not None else None
        })
        return _obj
