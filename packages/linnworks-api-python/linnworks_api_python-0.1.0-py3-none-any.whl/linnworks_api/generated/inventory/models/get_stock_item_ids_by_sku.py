...
class GetStockItemIdsBySKU(BaseModel):
    """
    Get stock item id's by sku request class.
    """ # noqa: E501
    items: Optional[List[GetStockItemIdsBySKUItem]] = Field(default=None, description="Response items of StockItemId and SKU", alias="Items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Items": [GetStockItemIdsBySKUItem.from_dict(_item) for _item in obj["Items"]] if obj.get("Items") is not None else None
        })
        return _obj
