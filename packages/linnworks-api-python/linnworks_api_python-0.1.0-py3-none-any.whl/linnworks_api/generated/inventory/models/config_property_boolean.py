...
class ConfigPropertyBoolean(BaseModel):
    """
    ...
    property_value: Optional[StrictBool] = Field(default=None, alias="PropertyValue")
    property_type: Optional[StrictStr] = Field(default=None, alias="PropertyType")
    __properties: ClassVar[List[str]] = ["pkPropertyId", "Loaded", "IsChanged", "PropertyValue", "PropertyType"]
