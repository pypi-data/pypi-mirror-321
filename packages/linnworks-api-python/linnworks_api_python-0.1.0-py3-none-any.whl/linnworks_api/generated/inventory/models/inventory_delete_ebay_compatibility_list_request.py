...
class InventoryDeleteEbayCompatibilityListRequest(BaseModel):
    """
    InventoryDeleteEbayCompatibilityListRequest
    """ # noqa: E501
    request: Optional[DeleteEbayCompatibilityListRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "request": DeleteEbayCompatibilityListRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
