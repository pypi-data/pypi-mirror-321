...
class BatchedAPIResponseStockItemProductIdentifier(BaseModel):
    """
    BatchedAPIResponseStockItemProductIdentifier
    """ # noqa: E501
    results: Optional[List[APIResultResponseStockItemProductIdentifier]] = Field(default=None, alias="Results")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Results": [APIResultResponseStockItemProductIdentifier.from_dict(_item) for _item in obj["Results"]] if obj.get("Results") is not None else None,
