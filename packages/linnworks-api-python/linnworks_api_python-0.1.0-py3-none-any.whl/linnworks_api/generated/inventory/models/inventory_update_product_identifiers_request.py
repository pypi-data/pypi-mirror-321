...
class InventoryUpdateProductIdentifiersRequest(BaseModel):
    """
    InventoryUpdateProductIdentifiersRequest
    """ # noqa: E501
    request: Optional[UpdateProductIdentifiersRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "request": UpdateProductIdentifiersRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
