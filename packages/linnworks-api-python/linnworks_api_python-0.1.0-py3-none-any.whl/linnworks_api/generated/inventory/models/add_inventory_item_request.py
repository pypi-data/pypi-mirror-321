...
class AddInventoryItemRequest(BaseModel):
    ...
    """ # noqa: E501
    inventory_items: Optional[List[StockItemHeader]] = Field(default=None, alias="InventoryItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "InventoryItems": [StockItemHeader.from_dict(_item) for _item in obj["InventoryItems"]] if obj.get("InventoryItems") is not None else None
        })
        return _obj
