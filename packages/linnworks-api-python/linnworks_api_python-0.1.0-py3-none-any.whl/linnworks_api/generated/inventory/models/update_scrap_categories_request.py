...
class UpdateScrapCategoriesRequest(BaseModel):
    """
    UpdateScrapCategoriesRequest
    """ # noqa: E501
    categories: Optional[List[ScrapCategory]] = Field(default=None, alias="Categories")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Categories": [ScrapCategory.from_dict(_item) for _item in obj["Categories"]] if obj.get("Categories") is not None else None
        })
        return _obj
