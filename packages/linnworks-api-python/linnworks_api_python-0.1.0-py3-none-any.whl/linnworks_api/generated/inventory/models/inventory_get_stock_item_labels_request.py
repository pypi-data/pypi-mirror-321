...
class InventoryGetStockItemLabelsRequest(BaseModel):
    """
    InventoryGetStockItemLabelsRequest
    """ # noqa: E501
    selected_regions: Optional[List[TupleInt32Int32]] = Field(default=None, description="Row numbers to retrieve item ids for", alias="selectedRegions")
    token: Optional[StrictStr] = Field(default=None, description="Search Token")
    location: Optional[StrictStr] = Field(default=None, description="Location id")
    __properties: ClassVar[List[str]] = ["selectedRegions", "token", "location"]
