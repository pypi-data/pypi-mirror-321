...
class InventoryDeleteUserSpecificViewRequest(BaseModel):
    """
    InventoryDeleteUserSpecificViewRequest
    """ # noqa: E501
    view_name: Optional[StrictStr] = Field(default=None, description="User-specific view name", alias="viewName")
    __properties: ClassVar[List[str]] = ["viewName"]
