...
class PagedResultStockItemAuditTrail(BaseModel):
    """
    PagedResultStockItemAuditTrail
    """ # noqa: E501
    items: Optional[List[StockItemAuditTrail]] = Field(default=None, alias="Items")
    ...
    __properties: ClassVar[List[str]] = ["Items", "TotalItems", "CurrentPage", "EntriesPerPage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Items": [StockItemAuditTrail.from_dict(_item) for _item in obj["Items"]] if obj.get("Items") is not None else None,
