...
class GetSelectionListSelectStringValueOption(BaseModel):
    """
    GetSelectionListSelectStringValueOption
    """ # noqa: E501
    method: Optional[MethodInfo] = Field(default=None, alias="Method")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Method": MethodInfo.from_dict(obj["Method"]) if obj.get("Method") is not None else None,
