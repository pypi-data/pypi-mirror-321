...
class InventoryUpdateBatchDetailsRequest(BaseModel):
    """
    InventoryUpdateBatchDetailsRequest
    """ # noqa: E501
    request: Optional[UpdateBatchDetailsRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "request": UpdateBatchDetailsRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
