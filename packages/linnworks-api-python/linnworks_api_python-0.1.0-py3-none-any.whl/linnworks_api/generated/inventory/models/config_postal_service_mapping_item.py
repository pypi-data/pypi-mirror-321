...
class ConfigPostalServiceMappingItem(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["fkChannelId", "pkRowId", "Tag", "fkPostalServiceId", "PostalServiceName", "Site", "IsChanged"]
