...
class ConfigPropertySelectionListSelectStringValueOptionString(BaseModel):
    """
    ConfigPropertySelectionListSelectStringValueOptionString
    """ # noqa: E501
    on_get_selection_list: Optional[GetSelectionListSelectStringValueOption] = Field(default=None, alias="OnGetSelectionList")
    ...
    __properties: ClassVar[List[str]] = ["OnGetSelectionList", "pkPropertyId", "Loaded", "IsChanged", "PropertyValue", "PropertyType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of on_get_selection_list
        if self.on_get_selection_list:
            _dict['OnGetSelectionList'] = self.on_get_selection_list.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "OnGetSelectionList": GetSelectionListSelectStringValueOption.from_dict(obj["OnGetSelectionList"]) if obj.get("OnGetSelectionList") is not None else None,
