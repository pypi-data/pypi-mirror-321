...
class InventoryDeleteBatchesByStockItemIdRequest(BaseModel):
    """
    InventoryDeleteBatchesByStockItemIdRequest
    """ # noqa: E501
    stock_item_id: Optional[StrictStr] = Field(default=None, description="Stock item unique identifier", alias="stockItemId")
    __properties: ClassVar[List[str]] = ["stockItemId"]
