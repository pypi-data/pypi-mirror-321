...
class APIResultResponseDeleteInventoryItemBulkResponse(BaseModel):
    """
    APIResultResponseDeleteInventoryItemBulkResponse
    """ # noqa: E501
    result: Optional[DeleteInventoryItemBulkResponse] = Field(default=None, alias="Result")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Result": DeleteInventoryItemBulkResponse.from_dict(obj["Result"]) if obj.get("Result") is not None else None,
