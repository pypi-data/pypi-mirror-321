...
class TemplateToProcess(BaseModel):
    """
    TemplateToProcess
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["TemplateId", "Action"]
    ...
    def action_validate_enum(cls, value):
        ...
        if value not in set(['NotAllowed', 'ChannelSpecific', 'Create', 'Update', 'Relist', 'Delete', 'Revise']):
            raise ValueError("must be one of enum values ('NotAllowed', 'ChannelSpecific', 'Create', 'Update', 'Relist', 'Delete', 'Revise')")
        return value
