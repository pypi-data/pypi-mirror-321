...
class GenericListingsSaveConfiguratorDescriptionRequest(BaseModel):
    """
    GenericListingsSaveConfiguratorDescriptionRequest
    """ # noqa: E501
    request: Optional[SaveConfiguratorDescriptionRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "request": SaveConfiguratorDescriptionRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
