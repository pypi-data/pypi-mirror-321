...
class DeleteConfiguratorsResponse(BaseModel):
    """
    DeleteConfiguratorsResponse
    """ # noqa: E501
    deleted_ids: Optional[List[StrictInt]] = Field(default=None, alias="DeletedIds")
    __properties: ClassVar[List[str]] = ["DeletedIds"]
