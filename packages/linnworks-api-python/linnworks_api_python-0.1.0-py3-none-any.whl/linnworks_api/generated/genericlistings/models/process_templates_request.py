...
class ProcessTemplatesRequest(BaseModel):
    """
    ...
    template_requests: Optional[List[TemplateToProcess]] = Field(default=None, alias="TemplateRequests")
    __properties: ClassVar[List[str]] = ["ChannelType", "ChannelName", "TemplateRequests"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in template_requests (list)
        _items = []
        if self.template_requests:
            for _item_template_requests in self.template_requests:
                if _item_template_requests:
                    _items.append(_item_template_requests.to_dict())
            _dict['TemplateRequests'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "TemplateRequests": [TemplateToProcess.from_dict(_item) for _item in obj["TemplateRequests"]] if obj.get("TemplateRequests") is not None else None
        })
        return _obj
