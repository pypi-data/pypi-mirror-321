...
class GetLatestCurrencyRateResponse(BaseModel):
    """
    GetLatestCurrencyRateResponse
    """ # noqa: E501
    base_currency: Optional[StrictStr] = Field(default=None, alias="BaseCurrency")
    rates: Optional[List[CurrencyRate]] = Field(default=None, alias="Rates")
    __properties: ClassVar[List[str]] = ["BaseCurrency", "Rates"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Rates": [CurrencyRate.from_dict(_item) for _item in obj["Rates"]] if obj.get("Rates") is not None else None
        })
        return _obj
