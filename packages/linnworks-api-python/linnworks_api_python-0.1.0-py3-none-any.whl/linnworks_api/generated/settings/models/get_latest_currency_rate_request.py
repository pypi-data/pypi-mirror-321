...
class GetLatestCurrencyRateRequest(BaseModel):
    """
    GetLatestCurrencyRateRequest
    """ # noqa: E501
    base_currency: Optional[StrictStr] = Field(default=None, description="Base currency for conversion rates, if null, USD is used", alias="BaseCurrency")
    __properties: ClassVar[List[str]] = ["BaseCurrency"]
