...
class SettingsUpdateCurrencyConversionRatesRequest(BaseModel):
    """
    SettingsUpdateCurrencyConversionRatesRequest
    """ # noqa: E501
    rates: Optional[List[CurrencyConversionRate]] = Field(default=None, description="Rates to update. Currency is the key")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rates": [CurrencyConversionRate.from_dict(_item) for _item in obj["rates"]] if obj.get("rates") is not None else None
        })
        return _obj
