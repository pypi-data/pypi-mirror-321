...
class RulesEngineUpdateActionRequest(BaseModel):
    """
    RulesEngineUpdateActionRequest
    """ # noqa: E501
    action: Optional[ActionWeb] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "action": ActionWeb.from_dict(obj["action"]) if obj.get("action") is not None else None
        })
        return _obj
