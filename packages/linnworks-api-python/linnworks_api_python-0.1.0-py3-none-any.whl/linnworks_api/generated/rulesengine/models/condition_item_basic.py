...
class ConditionItemBasic(BaseModel):
    """
    ConditionItemBasic
    """ # noqa: E501
    pk_condition_item_id: Optional[StrictInt] = Field(default=None, alias="pkConditionItemId")
    ...
    evaluation: Optional[StrictStr] = Field(default=None, alias="Evaluation")
    ...
    __properties: ClassVar[List[str]] = ["pkConditionItemId", "fkConditionId", "FieldName", "Evaluation", "Values", "KeyValue"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pkConditionItemId": obj.get("pkConditionItemId"),
