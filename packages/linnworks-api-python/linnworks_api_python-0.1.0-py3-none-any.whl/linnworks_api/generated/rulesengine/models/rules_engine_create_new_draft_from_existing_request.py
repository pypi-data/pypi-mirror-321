...
class RulesEngineCreateNewDraftFromExistingRequest(BaseModel):
    """
    RulesEngineCreateNewDraftFromExistingRequest
    """ # noqa: E501
    pk_rule_id: Optional[StrictInt] = Field(default=None, description="The existing rule id.", alias="pkRuleId")
    rule_name: Optional[StrictStr] = Field(default=None, description="The name of the new draft.", alias="ruleName")
    __properties: ClassVar[List[str]] = ["pkRuleId", "ruleName"]
