...
class RulesEngineCreateDraftFromExistingRequest(BaseModel):
    """
    RulesEngineCreateDraftFromExistingRequest
    """ # noqa: E501
    pk_rule_id: Optional[StrictInt] = Field(default=None, description="The rule id to create a draft of.", alias="pkRuleId")
    __properties: ClassVar[List[str]] = ["pkRuleId"]
