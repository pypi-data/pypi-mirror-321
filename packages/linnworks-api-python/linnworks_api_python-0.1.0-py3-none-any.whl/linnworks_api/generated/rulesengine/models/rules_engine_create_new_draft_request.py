...
class RulesEngineCreateNewDraftRequest(BaseModel):
    """
    RulesEngineCreateNewDraftRequest
    """ # noqa: E501
    rule_name: Optional[StrictStr] = Field(default=None, description="The name for the new draft.", alias="ruleName")
    type: Optional[StrictStr] = Field(default=None, description="The rule type.")
    __properties: ClassVar[List[str]] = ["ruleName", "type"]
