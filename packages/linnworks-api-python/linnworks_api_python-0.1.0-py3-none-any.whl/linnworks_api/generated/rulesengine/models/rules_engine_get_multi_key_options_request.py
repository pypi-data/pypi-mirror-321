...
class RulesEngineGetMultiKeyOptionsRequest(BaseModel):
    """
    RulesEngineGetMultiKeyOptionsRequest
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="The rule type.")
    field_names: Optional[List[StrictStr]] = Field(default=None, description="The field names to get the keys for", alias="fieldNames")
    __properties: ClassVar[List[str]] = ["type", "fieldNames"]
