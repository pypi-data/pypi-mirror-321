...
class GetAvailableChannelsResponse(BaseModel):
    """
    GetAvailableChannelsResponse
    """ # noqa: E501
    channels: Optional[List[ServiceInformation]] = Field(default=None, alias="Channels")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Channels": [ServiceInformation.from_dict(_item) for _item in obj["Channels"]] if obj.get("Channels") is not None else None
        })
        return _obj
