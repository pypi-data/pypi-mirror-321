...
class SearchOrdersRequest(BaseModel):
    ...
    include_processed: Optional[StrictBool] = Field(default=None, alias="IncludeProcessed")
    __properties: ClassVar[List[str]] = ["LocationId", "SearchTerm", "IncludeProcessed"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "IncludeProcessed": obj.get("IncludeProcessed")
        })
        return _obj
