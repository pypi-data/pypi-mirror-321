...
class PostFilterPagedResponseOpenOrder(BaseModel):
    """
    PostFilterPagedResponseOpenOrder
    """ # noqa: E501
    result_count_removed_by_post_filter: Optional[StrictInt] = Field(default=None, alias="ResultCountRemovedByPostFilter")
    ...
    data: Optional[List[OpenOrder]] = Field(default=None, alias="Data")
    __properties: ClassVar[List[str]] = ["ResultCountRemovedByPostFilter", "PageNumber", "EntriesPerPage", "TotalEntries", "TotalPages", "Data"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        excluded_fields: Set[str] = set([
            "result_count_removed_by_post_filter",
            "total_pages",
        ])
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ResultCountRemovedByPostFilter": obj.get("ResultCountRemovedByPostFilter"),
            "PageNumber": obj.get("PageNumber"),
            "EntriesPerPage": obj.get("EntriesPerPage"),
            "TotalEntries": obj.get("TotalEntries"),
            "TotalPages": obj.get("TotalPages"),
            "Data": [OpenOrder.from_dict(_item) for _item in obj["Data"]] if obj.get("Data") is not None else None
        })
        return _obj
