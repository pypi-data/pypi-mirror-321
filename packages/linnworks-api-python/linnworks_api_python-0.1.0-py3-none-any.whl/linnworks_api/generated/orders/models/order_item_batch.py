...
class OrderItemBatch(BaseModel):
    """
    OrderItemBatch
    """ # noqa: E501
    ...
    assignment_type: Optional[StrictStr] = Field(default=None, alias="AssignmentType")
    __properties: ClassVar[List[str]] = ["OrderItemBatchId", "OrderItemRowId", "BatchInventoryId", "Quantity", "Batch", "DespatchUnitValue", "AssignmentType"]
