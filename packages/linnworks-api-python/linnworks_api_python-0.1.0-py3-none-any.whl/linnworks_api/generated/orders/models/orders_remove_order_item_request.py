...
class OrdersRemoveOrderItemRequest(BaseModel):
    """
    OrdersRemoveOrderItemRequest
    """ # noqa: E501
    order_id: Optional[StrictStr] = Field(default=None, description="Order id", alias="orderId")
    rowid: Optional[StrictStr] = Field(default=None, description="Row id of the item")
    fulfilment_center: Optional[StrictStr] = Field(default=None, description="Fulfilment center id", alias="fulfilmentCenter")
    __properties: ClassVar[List[str]] = ["orderId", "rowid", "fulfilmentCenter"]
