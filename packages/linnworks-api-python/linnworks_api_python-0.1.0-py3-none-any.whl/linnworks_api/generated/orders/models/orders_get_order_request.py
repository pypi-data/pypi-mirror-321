...
class OrdersGetOrderRequest(BaseModel):
    """
    ...
    load_items: Optional[StrictBool] = Field(default=None, description="Load or not the order items information", alias="loadItems")
    load_additional_info: Optional[StrictBool] = Field(default=None, description="Load or not the order additional info", alias="loadAdditionalInfo")
    __properties: ClassVar[List[str]] = ["orderId", "fulfilmentLocationId", "loadItems", "loadAdditionalInfo"]
