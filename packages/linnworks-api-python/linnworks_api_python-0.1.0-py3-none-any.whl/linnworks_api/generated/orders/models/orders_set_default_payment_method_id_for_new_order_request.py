...
class OrdersSetDefaultPaymentMethodIdForNewOrderRequest(BaseModel):
    """
    OrdersSetDefaultPaymentMethodIdForNewOrderRequest
    """ # noqa: E501
    payment_method: Optional[StrictStr] = Field(default=None, description="Id of the payment method", alias="paymentMethod")
