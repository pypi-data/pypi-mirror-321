...
class OrdersSetInvoicesPrintedRequest(BaseModel):
    """
    OrdersSetInvoicesPrintedRequest
    """ # noqa: E501
    order_ids: Optional[List[StrictStr]] = Field(default=None, description="List of orders to mark as label printed", alias="orderIds")
