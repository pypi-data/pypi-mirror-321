...
class OrdersMergeOrdersRequest(BaseModel):
    """
    OrdersMergeOrdersRequest
    """ # noqa: E501
    orders_to_merge: Optional[List[StrictStr]] = Field(default=None, description="Orders to merge", alias="ordersToMerge")
    fulfilment_center: Optional[StrictStr] = Field(default=None, description="Current fulfilment center", alias="fulfilmentCenter")
    pk_postal_service_id: Optional[StrictStr] = Field(default=None, description="Postal service id", alias="pkPostalServiceId")
    __properties: ClassVar[List[str]] = ["ordersToMerge", "fulfilmentCenter", "pkPostalServiceId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ordersToMerge": obj.get("ordersToMerge"),
