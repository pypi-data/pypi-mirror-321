...
class OrdersCancelOrderRequest(BaseModel):
    """
    ...
    refund: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Refund quantity")
    note: Optional[StrictStr] = Field(default=None, description="Note a attach")
    __properties: ClassVar[List[str]] = ["orderId", "fulfilmentCenter", "refund", "note"]
