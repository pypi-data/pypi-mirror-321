...
class OrdersSetOrderGeneralInfoRequest(BaseModel):
    """
    OrdersSetOrderGeneralInfoRequest
    """ # noqa: E501
    order_id: Optional[StrictStr] = Field(default=None, description="Order id", alias="orderId")
    info: Optional[OrderGeneralInfo] = None
    was_draft: Optional[StrictBool] = Field(default=None, description="Indicate if the order was a draft before this operation", alias="wasDraft")
    __properties: ClassVar[List[str]] = ["orderId", "info", "wasDraft"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "info": OrderGeneralInfo.from_dict(obj["info"]) if obj.get("info") is not None else None,
            "wasDraft": obj.get("wasDraft")
        })
        return _obj
