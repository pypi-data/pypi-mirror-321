...
class OrdersSetOrderTotalsInfoRequest(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "info": OrderTotalsInfo.from_dict(obj["info"]) if obj.get("info") is not None else None
        })
        return _obj
