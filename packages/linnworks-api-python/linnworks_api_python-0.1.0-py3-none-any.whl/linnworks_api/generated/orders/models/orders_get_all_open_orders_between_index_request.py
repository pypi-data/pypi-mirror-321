...
class OrdersGetAllOpenOrdersBetweenIndexRequest(BaseModel):
    """
    OrdersGetAllOpenOrdersBetweenIndexRequest
    """ # noqa: E501
    from_index: Optional[StrictInt] = Field(default=None, description="From index", alias="fromIndex")
    to_index: Optional[StrictInt] = Field(default=None, description="To index", alias="toIndex")
    ...
    __properties: ClassVar[List[str]] = ["fromIndex", "toIndex", "filters", "sorting", "fulfilmentCenter", "additionalFilter"]
