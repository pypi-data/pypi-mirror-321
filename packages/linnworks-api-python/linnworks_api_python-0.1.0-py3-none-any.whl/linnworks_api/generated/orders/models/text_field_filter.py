...
class TextFieldFilter(BaseModel):
    """
    TextFieldFilter
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["Type", "Text", "FieldCode"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['Equal', 'Contains', 'StartWith', 'EndsWith']):
            raise ValueError("must be one of enum values ('Equal', 'Contains', 'StartWith', 'EndsWith')")
        return value

    @field_validator('field_code')
    def field_code_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
