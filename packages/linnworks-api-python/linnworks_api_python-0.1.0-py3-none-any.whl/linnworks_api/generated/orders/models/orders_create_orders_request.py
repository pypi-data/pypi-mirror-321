...
class OrdersCreateOrdersRequest(BaseModel):
    """
    OrdersCreateOrdersRequest
    """ # noqa: E501
    orders: Optional[List[ChannelOrder]] = Field(default=None, description="List of orders to create")
    location: Optional[StrictStr] = Field(default=None, description="Location to create the order")
    __properties: ClassVar[List[str]] = ["orders", "location"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "orders": [ChannelOrder.from_dict(_item) for _item in obj["orders"]] if obj.get("orders") is not None else None,
