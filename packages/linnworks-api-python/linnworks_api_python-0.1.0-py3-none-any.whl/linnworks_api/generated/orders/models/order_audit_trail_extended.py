...
class OrderAuditTrailExtended(BaseModel):
    """
    OrderAuditTrailExtended
    """ # noqa: E501
    pk_order_id: Optional[StrictStr] = Field(default=None, alias="pkOrderId")
    audit_trail: Optional[List[OrderAuditTrail]] = Field(default=None, alias="AuditTrail")
    __properties: ClassVar[List[str]] = ["pkOrderId", "AuditTrail"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "AuditTrail": [OrderAuditTrail.from_dict(_item) for _item in obj["AuditTrail"]] if obj.get("AuditTrail") is not None else None
        })
        return _obj
