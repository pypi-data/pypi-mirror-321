...
class AddExtendedPropertiesRequest(BaseModel):
    """
    AddExtendedPropertiesRequest
    """ # noqa: E501
    order_id: Optional[StrictStr] = Field(default=None, description="Order id of the order to append extended properties to", alias="OrderId")
    extended_properties: Optional[List[BasicExtendedProperty]] = Field(default=None, description="Array of basic extended properties to be added", alias="ExtendedProperties")
    __properties: ClassVar[List[str]] = ["OrderId", "ExtendedProperties"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ExtendedProperties": [BasicExtendedProperty.from_dict(_item) for _item in obj["ExtendedProperties"]] if obj.get("ExtendedProperties") is not None else None
        })
        return _obj
