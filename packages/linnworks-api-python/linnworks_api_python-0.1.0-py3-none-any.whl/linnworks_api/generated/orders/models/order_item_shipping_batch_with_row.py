...
class OrderItemShippingBatchWithRow(BaseModel):
    """
    ...
    fk_order_item_batch_id: Optional[StrictInt] = Field(default=None, alias="fkOrderItemBatchId")
    quantity: Optional[StrictInt] = Field(default=None, alias="Quantity")
    __properties: ClassVar[List[str]] = ["OrderItemRowId", "BatchNumber", "fkBinId", "fkOrderItemBatchId", "Quantity"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fkOrderItemBatchId": obj.get("fkOrderItemBatchId"),
