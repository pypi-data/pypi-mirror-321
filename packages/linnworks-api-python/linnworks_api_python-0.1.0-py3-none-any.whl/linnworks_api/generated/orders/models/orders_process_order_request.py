...
class OrdersProcessOrderRequest(BaseModel):
    """
    OrdersProcessOrderRequest
    """ # noqa: E501
    order_id: Optional[StrictStr] = Field(default=None, description="Order id", alias="orderId")
    scan_performed: Optional[StrictBool] = Field(default=None, description="Indicate if the scan has been performed", alias="scanPerformed")
    ...
    __properties: ClassVar[List[str]] = ["orderId", "scanPerformed", "locationId", "context"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "scanPerformed": obj.get("scanPerformed"),
