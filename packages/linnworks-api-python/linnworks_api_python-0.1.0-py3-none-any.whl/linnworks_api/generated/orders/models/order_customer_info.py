...
class OrderCustomerInfo(BaseModel):
    ...
    address: Optional[CustomerAddress] = Field(default=None, alias="Address")
    billing_address: Optional[CustomerAddress] = Field(default=None, alias="BillingAddress")
    __properties: ClassVar[List[str]] = ["ChannelBuyerName", "Address", "BillingAddress"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "BillingAddress": CustomerAddress.from_dict(obj["BillingAddress"]) if obj.get("BillingAddress") is not None else None
        })
        return _obj
