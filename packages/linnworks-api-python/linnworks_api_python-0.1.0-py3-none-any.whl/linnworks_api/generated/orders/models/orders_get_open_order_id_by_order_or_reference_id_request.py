...
class OrdersGetOpenOrderIdByOrderOrReferenceIdRequest(BaseModel):
    """
    OrdersGetOpenOrderIdByOrderOrReferenceIdRequest
    """ # noqa: E501
    order_or_reference_id: Optional[StrictStr] = Field(default=None, description="reference number or order number", alias="orderOrReferenceId")
    ...
    __properties: ClassVar[List[str]] = ["orderOrReferenceId", "filters", "locationId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "orderOrReferenceId": obj.get("orderOrReferenceId"),
