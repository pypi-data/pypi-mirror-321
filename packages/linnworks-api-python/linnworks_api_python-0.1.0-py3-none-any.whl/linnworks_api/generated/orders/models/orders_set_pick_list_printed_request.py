...
class OrdersSetPickListPrintedRequest(BaseModel):
    """
    OrdersSetPickListPrintedRequest
    """ # noqa: E501
    request: Optional[SetPickListPrintedRequest] = Field(default=None, alias="Request")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Request": SetPickListPrintedRequest.from_dict(obj["Request"]) if obj.get("Request") is not None else None
        })
        return _obj
