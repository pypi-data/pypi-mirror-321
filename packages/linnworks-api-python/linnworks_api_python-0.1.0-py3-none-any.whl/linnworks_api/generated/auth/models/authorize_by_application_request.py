...
class AuthorizeByApplicationRequest(BaseModel):
    """
    AuthorizeByApplicationRequest
    """ # noqa: E501
    application_id: Optional[StrictStr] = Field(default=None, alias="ApplicationId")
    application_secret: Optional[StrictStr] = Field(default=None, alias="ApplicationSecret")
    token: Optional[StrictStr] = Field(default=None, alias="Token")
    __properties: ClassVar[List[str]] = ["ApplicationId", "ApplicationSecret", "Token"]
