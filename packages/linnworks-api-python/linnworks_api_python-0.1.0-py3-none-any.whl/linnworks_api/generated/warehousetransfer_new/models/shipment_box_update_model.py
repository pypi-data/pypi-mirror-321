...
class ShipmentBoxUpdateModel(BaseModel):
    """
    ...
    is_stacked: Optional[StrictBool] = Field(default=None, alias="isStacked")
    ...
    __properties: ClassVar[List[str]] = ["shipmentBoxId", "shipmentId", "name", "shipmentPalletId", "height", "depth", "width", "weight", "isStacked", "weightUnit", "dimensionUnit", "trackingNumber"]
