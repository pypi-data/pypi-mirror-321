...
class UpdatePackSizeQuantityRequest(BaseModel):
    """
    UpdatePackSizeQuantityRequest
    """ # noqa: E501
    from_location_id: StrictStr = Field(alias="fromLocationId")
    pack_quantity: StrictInt = Field(alias="packQuantity")
    ...
    __properties: ClassVar[List[str]] = ["fromLocationId", "packQuantity", "packSize", "shipmentItemId", "shippingPlanId"]
