...
class UpdateAmazonShipmentItemQuantityRequest(BaseModel):
    """
    UpdateAmazonShipmentItemQuantityRequest
    """ # noqa: E501
    from_location_id: StrictStr = Field(alias="fromLocationId")
    quantity_to_ship: StrictInt = Field(alias="quantityToShip")
    shipment_id: StrictInt = Field(alias="shipmentId")
    stock_item_int_id: StrictInt = Field(alias="stockItemIntId")
    __properties: ClassVar[List[str]] = ["fromLocationId", "quantityToShip", "shipmentId", "stockItemIntId"]
