...
class ImportSettingModel(BaseModel):
    """
    ImportSettingModel
    """ # noqa: E501
    ...
    column_mappings: Optional[List[ImportColumnMappingModel]] = Field(default=None, alias="columnMappings")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "columnMappings": [ImportColumnMappingModel.from_dict(_item) for _item in obj["columnMappings"]] if obj.get("columnMappings") is not None else None
        })
        return _obj
