...
class ShipmentCarrierModel(BaseModel):
    """
    ShipmentCarrierModel
    """ # noqa: E501
    shipment_carrier_id: Optional[StrictInt] = Field(default=None, alias="shipmentCarrierId")
    is_partnered: Optional[StrictBool] = Field(default=None, alias="isPartnered")
    name: Optional[StrictStr] = None
    country: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["shipmentCarrierId", "isPartnered", "name", "country"]
