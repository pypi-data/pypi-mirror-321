...
class UpdateItemRequestedQuantityRequest(BaseModel):
    """
    ...
    requested_quantity: Optional[Annotated[int, Field(le=2147483647, strict=True, ge=0)]] = Field(default=None, alias="requestedQuantity")
    __properties: ClassVar[List[str]] = ["transferId", "transferItemId", "requestedQuantity"]
