...
class UpdateFromLocationRequest(BaseModel):
    """
    UpdateFromLocationRequest
    """ # noqa: E501
    new_location_id: Optional[StrictStr] = Field(default=None, alias="newLocationId")
    pk_transfer_id: Optional[StrictInt] = Field(default=None, alias="pkTransferId")
    __properties: ClassVar[List[str]] = ["newLocationId", "pkTransferId"]
