...
class UpdateShipmentItemRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["conditionId", "stockItemId", "packQuantity", "packSize", "quantityToShip", "receivedQty", "shipmentId", "shippedQty"]
