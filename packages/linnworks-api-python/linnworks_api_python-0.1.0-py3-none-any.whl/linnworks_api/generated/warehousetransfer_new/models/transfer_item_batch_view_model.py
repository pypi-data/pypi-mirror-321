...
class TransferItemBatchViewModel(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["batchId", "batchInventoryId", "batchNumber", "batchStatus", "availableQuantity", "quantity", "expiryDate", "sellBy", "prioritySequence", "unitCost", "binRack"]
