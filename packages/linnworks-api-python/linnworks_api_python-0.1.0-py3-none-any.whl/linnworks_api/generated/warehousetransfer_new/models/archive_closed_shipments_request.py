...
class ArchiveClosedShipmentsRequest(BaseModel):
    """
    ArchiveClosedShipmentsRequest
    """ # noqa: E501
    shipment_ids: Optional[List[StrictInt]] = Field(default=None, alias="shipmentIds")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if shipment_ids (nullable) is None
        # and model_fields_set contains the field
        if self.shipment_ids is None and "shipment_ids" in self.model_fields_set:
            _dict['shipmentIds'] = None
