...
class ItemBatchModel(BaseModel):
    """
    ItemBatchModel
    """ # noqa: E501
    ...
    quantity_to_transfer: Optional[StrictInt] = Field(default=None, alias="quantityToTransfer")
    __properties: ClassVar[List[str]] = ["batchId", "batchInventoryId", "quantityToTransfer"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "quantityToTransfer": obj.get("quantityToTransfer")
        })
        return _obj
