...
class StockItemModel(BaseModel):
    ...
    quantity: Optional[StrictInt] = Field(default=None, description="Quantity in stock")
    in_order_book: Optional[StrictInt] = Field(default=None, description="Quantity in order book", alias="inOrderBook")
    available: Optional[StrictInt] = Field(default=None, description="Available level. Quantity - InOrder,<br>Its used in Stock Finder UI")
    __properties: ClassVar[List[str]] = ["stockItemId", "stockItemIntId", "asin", "sellerSku", "thumbnailSource", "itemNumber", "itemTitle", "condition", "fbaTotalStock", "quantity", "inOrderBook", "available"]
