...
def test_case_82():
    ...
    material_name = "N-DECANE"
    diameter = 2.0
    height = 4.0
    wind_speed = 10.0
    fire_type = PoolFireType.EARLY
    weather_stability = AtmosphericStabilityClass.STABILITY_A

    # Define the initial state of the tank.
    state = State(temperature = 300.0, pressure = 1.0E+06, liquid_fraction = 0.0)
