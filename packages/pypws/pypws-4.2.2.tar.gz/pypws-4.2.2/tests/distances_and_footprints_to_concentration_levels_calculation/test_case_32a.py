...
def test_case_32a():
    ...
    if resultCode == resultCode.SUCCESS:
        if (len(distances_and_footprints_to_concentration_levels_calculation.contour_points) != 571):
        ...
        if (abs((distances_and_footprints_to_concentration_levels_calculation.contour_points[len(distances_and_footprints_to_concentration_levels_calculation.contour_points)-3].x -(-5.362230773849922))/(-5.362230773849922)) > 1e-3):
        ...
        if (abs((distances_and_footprints_to_concentration_levels_calculation.distances_concentration[0] - 14.217127672933938)/ 14.217127672933938) > 1e-3):
