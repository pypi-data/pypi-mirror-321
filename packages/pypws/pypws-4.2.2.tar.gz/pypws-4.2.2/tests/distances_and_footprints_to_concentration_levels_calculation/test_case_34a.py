...
def test_case_34a():
    ...
    if resultCode == resultCode.SUCCESS:
        ...
        if (abs((distances_and_footprints_to_concentration_levels_calculation.contour_points[len(distances_and_footprints_to_concentration_levels_calculation.contour_points)-3].x -(0.14752624168213124))/(0.14752624168213124)) > 1e-3):
        ...
        if (abs((distances_and_footprints_to_concentration_levels_calculation.distances_concentration[0] - 284.3660799524719)/ 284.3660799524719) > 1e-3):
