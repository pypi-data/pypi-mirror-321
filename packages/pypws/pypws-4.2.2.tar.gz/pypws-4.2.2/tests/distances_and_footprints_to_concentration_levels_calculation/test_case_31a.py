...
if resultCode == resultCode.SUCCESS:
    if (len(distances_and_footprints_to_concentration_levels_calculation.contour_points) != 719):
    ...
    if (abs((distances_and_footprints_to_concentration_levels_calculation.contour_points[len(distances_and_footprints_to_concentration_levels_calculation.contour_points)-3].x -(-7.732811736508124))/(-7.732811736508124)) > 1e-3):
    ...
    if (abs((distances_and_footprints_to_concentration_levels_calculation.distances_concentration[0] - 35.42977471021019)/ 35.42977471021019) > 1e-3):
