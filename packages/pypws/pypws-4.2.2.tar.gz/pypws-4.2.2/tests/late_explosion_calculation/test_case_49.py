...
def test_49():
    ...
    if resultCode == resultCode.SUCCESS:
        if (abs((late_explosion_to_OP_levels_calculation.explosion_unif_conf_overpressure_results[0].exploded_mass - 30.9794847027564)/30.9794847027564)>1e-3):
        ...
        if (abs((late_explosion_to_OP_levels_calculation.explosion_unif_conf_overpressure_results[0].ignition_time - 1.2238607938995776)/1.2238607938995776)>1e-3):
