...
def test_case_95():
    ...
    # Define the weather
    weather = Weather(wind_speed = 1.0, stability_class = AtmosphericStabilityClass.STABILITY_AB)
    ...
    dispersion_output_config = DispersionOutputConfig(special_concentration = SpecialConcentration.UFL, resolution = Resolution.LOW, elevation = 1.0)
