...
def test_case_124():
    ...
    dispersion_output_config = DispersionOutputConfig(concentration = end_point_concentration, elevation = 40.0)
    ...
    if resultCode == resultCode.SUCCESS:
        if (abs((distances_to_conc_levels_calculation.distances[0] - 359.2705758867665)/359.2705758867665) > 1e-3):
