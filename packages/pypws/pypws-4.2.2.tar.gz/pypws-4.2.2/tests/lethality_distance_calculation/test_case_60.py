...
def test_case_60():
    ...
    if resultCode == resultCode.SUCCESS:
        ...
        if (abs((lethality_distance_calculation.toxic_records[len(lethality_distance_calculation.toxic_records)-1].toxic_result-0.0002606607566133512)/0.0002606607566133512)>1e-3):
