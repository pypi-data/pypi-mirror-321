...
class TrinoConnector:
    def __init__(self, credentials, GSheetHelper, host="interactive.starburst.zalando.net", port=443, catalog="hive"):
        """
        ...
        self.GSheetHelper = GSheetHelper
    ...
    def __connect__(self):
        ...
        """
        gsheet = self.GSheetHelper("1Bw1PmPnIgx3RqEHFuMhtKDeFUBm-OzDhuEO_9GwZCRY", self.__credentials__)
