...
class DirectoryGroupPage(BaseModel):
    """
    DirectoryGroupPage
    """ # noqa: E501
    ...
    items: Optional[List[DirectoryGroup]] = Field(default=None, description="The list of items retrieved.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [DirectoryGroup.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
