...
class TestFmcObjectReference(unittest.TestCase):
    """FmcObjectReference unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FmcObjectReference:
        """Test FmcObjectReference
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FmcObjectReference`
        """
        model = FmcObjectReference()
        if include_optional:
            return FmcObjectReference(
    ...
    def testFmcObjectReference(self):
        """Test FmcObjectReference"""
