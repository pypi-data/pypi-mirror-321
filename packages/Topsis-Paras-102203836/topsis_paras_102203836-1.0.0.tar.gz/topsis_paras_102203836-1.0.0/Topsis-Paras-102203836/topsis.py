...
def topsis(input_file, weights, impacts, output_file):
    try:
        ...
        # Validate the structure of the input file
        if data.shape[1] < 3:
        ...
        # Separate object/variable names and decision matrix
        fund_names = data.iloc[:, 0]  # First column (object/variable names)
        matrix = data.iloc[:, 1:]  # Rest of the columns (numeric criteria)

        # Check if all columns from the 2nd to the last contain numeric values
        ...
        # Validate the weights and impacts strings
        ...
        # Validate the number of impacts and ensure valid format
