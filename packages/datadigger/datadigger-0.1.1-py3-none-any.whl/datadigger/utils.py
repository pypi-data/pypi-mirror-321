...
def get_selector_content( soup_obj: Optional[BeautifulSoup], css_selectors_ele: Optional[str] = None, css_selector: Optional[str] = None, attr: Optional[str] = None ) -> Optional[Union[str, List[BeautifulSoup]]]:
    """
    ...
    Parameters:
        ...
        css_selectors_ele (Optional[str]): CSS selector to get a list of matching elements.
    ...
    Returns:
        Optional[Union[str, List[BeautifulSoup]]]: Extracted content based on the specified criteria.
            - If `css_selectors_ele` is provided, returns a list of elements.
    ...
    try:
        # Return a list of matching elements if `css_selectors_ele` is provided.
        if css_selectors_ele is not None and css_selector is None and attr is None:
            return soup_obj.select(css_selectors_ele)

        # Return the text content of the first matching element for `css_selector`.
        elif css_selector is not None and css_selectors_ele is None and attr is None:
        ...
        elif css_selector is not None and attr is not None and css_selectors_ele is None:
            element = soup_obj.select_one(css_selector)
        ...
        elif attr is not None and css_selectors_ele is None and css_selector is None:
        ...
        elif attr is None and css_selectors_ele is None and css_selector is None:
