...
def bulk_update_enforcement_levels(
    ...
    try:
        response_parsed = PostContractResponse.parse_obj(response)
        logger.info(f"Updated {len(response_parsed.contractIds)} contract(s)")
    except Exception as e:
        logger.error(f"Failed to update contracts: {e}")
