...
- `Today only`: Make a temporary change to this deck's limit. '''
    ...
    def deck_config_updating_cards(self, current_cards_count: int, total_cards_count: int) -> str:
        ...
        return self._translate(11, 204, {"current_cards_count": current_cards_count, "total_cards_count": total_cards_count})


    def deck_config_used_by_decks(self, decks: int) -> str:
        r''' used by {$decks} decks '''
        return self._translate(11, 205, {"decks": decks})
...
class LegacyTranslationEnum:
    ...
    DECK_CONFIG_TIMER_TITLE = (11, 200)
    DECK_CONFIG_TITLE = (11, 201)
    DECK_CONFIG_TODAY_ONLY = (11, 202)
    DECK_CONFIG_UNABLE_TO_DETERMINE_DESIRED_RETENTION = (11, 203)
    DECK_CONFIG_UPDATING_CARDS = (11, 204)
    DECK_CONFIG_USED_BY_DECKS = (11, 205)
    DECK_CONFIG_WAIT_FOR_AUDIO = (11, 206)
    DECK_CONFIG_WAIT_FOR_AUDIO_TOOLTIP = (11, 207)
    DECK_CONFIG_WAIT_FOR_AUDIO_TOOLTIP_2 = (11, 208)
    DECK_CONFIG_WEIGHTS = (11, 209)
    DECK_CONFIG_WEIGHTS_TOOLTIP = (11, 210)
    DECK_CONFIG_WEIGHTS_TOOLTIP2 = (11, 211)
    DECK_CONFIG_WHICH_DECK = (11, 212)
    DECK_CONFIG_WILL_REQUIRE_FULL_SYNC = (11, 213)
    ...
    STATISTICS_TRUE_RETENTION_MONTH = (32, 115)
    STATISTICS_TRUE_RETENTION_NOT_APPLICABLE = (32, 116)
    STATISTICS_TRUE_RETENTION_PASS = (32, 117)
    STATISTICS_TRUE_RETENTION_RANGE = (32, 118)
    STATISTICS_TRUE_RETENTION_RETENTION = (32, 119)
    STATISTICS_TRUE_RETENTION_SUBTITLE = (32, 120)
    STATISTICS_TRUE_RETENTION_TITLE = (32, 121)
    STATISTICS_TRUE_RETENTION_TODAY = (32, 122)
    STATISTICS_TRUE_RETENTION_WEEK = (32, 123)
    STATISTICS_TRUE_RETENTION_YEAR = (32, 124)
    STATISTICS_TRUE_RETENTION_YESTERDAY = (32, 125)
    STUDYING_AGAIN = (33, 0)
