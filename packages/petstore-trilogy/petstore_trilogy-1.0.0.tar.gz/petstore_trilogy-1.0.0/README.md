...
with petstore_trilogy.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = petstore_trilogy.PetApi(api_client)
    pet = petstore_trilogy.Pet() # Pet | Create a new pet in the store
