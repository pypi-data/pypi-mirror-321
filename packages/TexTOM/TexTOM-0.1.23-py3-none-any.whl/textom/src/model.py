...
class model:
    ...
    def _symmetrize( self ):
        ...
        allHSH = {}
        for n in self.ns:
            allHSH[str(n)] = np.empty([(n+1)**2,Nrot], dtype_complex)
            k=0
            for l in range(n+1):
        ...
        self.Xsn = {'0': np.array([[1.]], dtype_complex)}
        l = 0
...
def _Rs_n_stack( Gs, n, Xsn ):
    ...
    '''
    Rs_stack = np.zeros( (Gs.shape[0], Xsn.shape[0], Xsn.shape[0]), data_type )
