...
-   Pin bilby==2.2.3, bilby_pipe==1.4.2, ligo.em-bright==1.2.1, ligo-followup-advocate==1.2.11
    which have been reviewed/to-be reviewed and approved by sccb.
    Avoid testing with python3.12 in this release since ligo.em-bright pin does not support
    python3.12.
