...
def QuantumCoreUpdate(
    ...
    - **Tenho autonomia total** para escolher de **1 a 3 arquivos** que apresentem maior potencial de melhoria.  
    ...
    - Após criar o PR, utilizo a função **checkcommentspr** para verificar e retornar **comentários humanos** feitos no PR.  
    ...
    - **autopullrequest** → Cria automaticamente um Pull Request com commit, título e descrição gerados.  
    - **checkcommentspr** → Verifica e retorna **comentários humanos** feitos no Pull Request.
    ...
    mensagem = f"""
    ### **Missão:** 
    Analise automaticamente o repositório `{repo_name}`, selecione de **1 a 3 arquivos** estratégicos e implemente melhorias sem alterar a estrutura original do projeto.
    ...
    - Selecione de **1 a 3 arquivos** com base em sua relevância.  
    ...
    6. **Verifique Comentários no PR:**  
    - Após a criação do PR, utilize a função **checkcommentspr** para verificar se houve **comentários humanos**.  
    - Se houver feedback, **analise** e **aplique ajustes necessários**.
    ...
    - **Objetivo:** Identificar e retornar **comentários humanos** no Pull Request.
