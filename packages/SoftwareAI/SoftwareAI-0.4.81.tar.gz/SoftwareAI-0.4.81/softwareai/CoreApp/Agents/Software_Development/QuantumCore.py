...
class SoftwareDevelopment:
    ...
    def QuantumCoreUpdate(
        ...
        if UseVectorstoreToGenerateFiles == True:
            ...
            # """
            mensaxgem = f"""
            Analise o arquivo `main.py` do repositório `{repo_name}` e identifique melhorias no código com base nos arquivos armazenados em `QuantumCore_Work_Environment`.

            ### **Suas Tarefas:**  
            1. **Detecte pontos de melhoria** no código, como otimizações de desempenho, refatorações, correções de bugs ou implementações de novas funcionalidades.  
            2. **Implemente as melhorias** diretamente no arquivo.  
            3. **Salve automaticamente** o arquivo com as melhorias utilizando **autosave**.  
            - O caminho para salvar o arquivo deve ser **lido do arquivo `environment.txt`** localizado em `QuantumCore_Work_Environment`.  
            4. **Crie automaticamente**:  
            - **Commit Message** descritiva e concisa.  
            - **Título do Pull Request (PR)** claro e objetivo.  
            - **Descrição do PR** detalhando as melhorias implementadas.  
            5. **Verifique a integridade** do código com **execute_py** para garantir que não há erros.  
            6. **Abra um Pull Request** no repositório utilizando **autopullrequest**.  

            ### **Detalhes do Pull Request:**  
            - **Repo Owner:** {self.companyname}
            - **Repo Name:** {repo_name}  
            - **Branch Name:** {branch_name}  
            - **File Path:** *Use o caminho salvo com autosave*  
            - **Token de Autenticação:** {github_token}  

            ### **Diretrizes para Geração Automática:**  
            - A **Commit Message** deve ser breve, seguindo o padrão:  
            - *feat:* para novas funcionalidades.  
            - *fix:* para correções de bugs.  
            - *refactor:* para melhorias sem alteração de comportamento.  
            - O **Título do PR** deve ser direto e resumir a mudança principal.  
            - A **Descrição do PR** deve explicar:  
            - O problema identificado.  
            - As melhorias aplicadas.  
            - Impacto da mudança.  

            ### **Regras Adicionais:**  
            - Execute o **execute_py** para validar o código antes do commit.  
            - Utilize os arquivos de suporte encontrados em `QuantumCore_Work_Environment`:  
            {file_paths}  
            - Garanta que o caminho do arquivo salvo esteja corretamente configurado no **File Path** do Pull Request.
            """
