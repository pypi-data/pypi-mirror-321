...
class SoftwareDevelopment:
    ...
    def QuantumCoreUpdate(
        ...
        if UseVectorstoreToGenerateFiles == True:
            ...
            # """
            mensaxgem = f"""
            Analise o arquivo `main.py` do repositório `{repo_name}` e identifique melhorias no código 
            ...
            3. **Salve automaticamente** o arquivo com as melhorias utilizando **autosave** no caminho .  
            - O caminho para salvar o arquivo main: {os.getenv("PATH_SOFTWARE_DEVELOPMENT_PY_ENV")}
