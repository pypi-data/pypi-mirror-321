...
def QuantumCoreUpdate(
    ...
    - **Tenho autonomia total** para escolher de **1 arquivos** que apresentem maior potencial de melhoria.  
    ...
    mensagem = f"""
    ### **Missão:** 
    Analise automaticamente o repositório `{repo_name}`, selecione de **1 arquivos** estratégicos e implemente melhorias sem alterar a estrutura original do projeto.
    ...
    - Selecione de **1 arquivos** com base em sua relevância.  
