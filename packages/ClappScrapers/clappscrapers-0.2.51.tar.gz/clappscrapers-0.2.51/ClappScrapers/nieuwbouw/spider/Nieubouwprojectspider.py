...
class NieuwbouwprojectspiderSpider(scrapy.Spider):
    ...
    def parse_projects(self, response):
        ...
        # Check for the "volgende" link to determine if there are more pages
        next_page_link = response.css('a[href*="sort=titel_asc"][href*="&p="]:contains("volgende")::attr(href)').get()
