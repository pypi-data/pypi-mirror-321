...
class ModelGPT():
    ...
    @error_handler
    def train_model(self, dataset_, epochs=1, lr=5e-5, decay_rate=1.00, decay_steps=1000, loss_avg=1500, distr=True, change_batch=500, split_training=False, val_split=0.1):
        ...
        with strategy.scope():
            ...
            for epoch in range(epochs):
                ...
                if val:
                    progress_bar_val = tqdm(dist_val_dataset, desc=f"Epoch {epoch + 1} [Validation]", unit="batch")
                    for batch in progress_bar_val:
                        ...
                        progress_bar_val.set_postfix(val_loss=(sum(val_losses) / len(val_losses)))
