...
class Optimizer(ABC):
    ...
    @abstractmethod
    def optimize(self, num_samples_training: int, num_iterations: int, display: bool, **kwargs) -> OptimizeResult:
        pass
...
class MonteCarlo(Optimizer):
    ...
    def optimize(self, num_samples_training: int, num_iterations: int, display: bool=False, **kwargs) -> OptimizeResult:
        """
        Optimizes the hyperparameters.
            ...
            returns: OptimizedResult containing information about the optimization process and its results.
        """
