...
from fmcore.util import type_str, optional_dependency, as_list, get_default, EnvUtil, set_param_from_alias, \
    FileSystemUtil
...
from fmcore.framework.task import LanguageModelTaskMixin, GenerativeLM
...
with optional_dependency('accelerate', 'torch', 'transformers'):
    ...
    class AccelerateEvaluator(LocalEvaluator):
        ...
        def _load_model(
            ...
            from fmcore.algorithm.alexa_teacher_models import AlexaTMSeq2Seq, ALEXA_TM_SEQ2SEQ_MODEL_NAMES
