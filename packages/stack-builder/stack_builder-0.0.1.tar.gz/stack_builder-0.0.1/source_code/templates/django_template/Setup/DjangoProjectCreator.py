import os
import subprocess
from source_code.templates.django_template.Setup.UpdateSetting import UpdateSetting
from source_code.templates.django_template.Setup.TemplateRenderer import TemplateRenderer
...
class DjangoProjectCreator:
    ...
    def run_docker_container(self):
        ...
        startproject_command = (
            f"docker run --rm -v {self.project_dir}:/app django_engine "
            f"django-admin startproject {self.project_name} /app/"
        )
