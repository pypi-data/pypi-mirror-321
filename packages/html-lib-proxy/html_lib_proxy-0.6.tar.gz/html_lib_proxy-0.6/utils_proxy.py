...
def p_proxy(ips, username, pwd):
    ...
    # proxy_ips = [
    #     f"47.251.162.252:{port}",  # 替换为实际的第一个代理 IP 和端口
    #     f"47.251.111.150:{port}",  # 替换为实际的第二个代理 IP 和端口
    #     f"47.89.192.159:{port}",  # 替换为实际的第三个代理 IP 和端口
    #     f"47.90.226.233:{port}",  # 替换为实际的第二个代理 IP 和端口
    #     f"47.90.210.153:{port}"   # 替换为实际的第三个代理 IP 和端口
    # ]
