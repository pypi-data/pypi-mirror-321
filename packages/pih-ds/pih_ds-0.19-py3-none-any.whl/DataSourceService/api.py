...
from pih.collections import nstr
...
class DataStorageAndSourceApi:
    ...
    def execute(
        self,
        function: Callable[[PooledMySQLConnection], Any],
        default_value: Any = None,
        use_return_of_action: bool = True,
        catch_exception: bool = False,
    ) -> Any:
        result: Any = default_value
        connection: PooledMySQLConnection | None = None
        try:
            connection = self.create_connection()
            temp_result: Any = function(connection)
    ...
    def get_settings_value(self, key: nstr, default_value: Any = None) -> Any:
    ...
    def set_storage_value(
        self, key: str, value: dict | None, section: nstr = None
    ) -> bool:
    ...
    def get_storage_value(
        self, key: nstr, section: nstr = None
    ) -> dict | None:
        section = section or STORAGE_SECTION
        db: JsonLmdb = self.get_storage_container(section)
    ...
    def update_polibase_person_information_quest(
        ...
        def action(connection: PooledMySQLConnection) -> bool:
            ...
            set_statement_string: nstr = None
            field_value: Any = None
            field_value_string: nstr = None
    ...
    def get_gkeep_item_list_by_any(
        self, name: nstr, title: nstr, full_equaliment: bool | None
    ) -> list[GKeepItem]:
        search_critery_name: nstr = None
        search_critery_title: nstr = None
    ...
    def get_condition_string(
        self, search_critery: Any = None, use_and: bool = True
    ) -> str:
        result: str = ""
