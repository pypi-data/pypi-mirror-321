def get_users(self, include=None, sort=None, pageToken=None, pageSize=None, id__in=None, id__ne=None, locationId__in=None, locationId__ne=None, firstName__in=None, firstName__contains=None, lastName__in=None, lastName__contains=None, email__in=None, email__contains=None, permissions_administrator=None, status_loginStatus__in=None, q=None, qRelevance__gte=None):
 ...
 * qRelevance is optional ordering parameter which is available if q filter is used, if q filter is not passed qRelevance as ordering parameter will return error 400
        ...
        - id__ne (query): Filter to get the users whose id is not equal to the provided value. The lookup is exact but case insensitive.
