    ...
    def _get_nvm_info(self):
        ...
        for nvm_name, nvm_data in nvm_dict.items():
            ...
            if nr_of_unused_signals > 0:
                ...
                if use_rte_nvm_structs and False:
                    ...
                    for idx in range(nr_of_unused_signals):
                        element_name = f"{self.zc_nvm.struct_member_prefix}Unused_{idx}"
                        data_types[data_type_name]["elements"][element_name] = default_datatype
                else:
