...
class Array0f16(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Array1f16(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Array22f(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Array22f16(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Array22f64(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Array2f16(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Array334b(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Array334f(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Array334f16(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Array334f64(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Array33f(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Array33f16(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Array33f64(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Array34b(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Array34f(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Array34f16(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Array34f64(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Array3f16(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Array41f16(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Array43f16(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Array441f(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Array441f16(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Array441f64(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Array443f(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Array443f16(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Array443f64(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Array444f(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Array444f16(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Array444f64(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Array44f16(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Array4f16(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class ArrayXf16(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Matrix2f16(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Matrix34f(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Matrix34f16(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Matrix34f64(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Matrix3f16(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Matrix41f16(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Matrix43f16(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Matrix44f16(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Matrix4f16(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class Quaternion4f16(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
...
class TensorXf16(drjit.ArrayBase):
    def __getitem__(self, key, /):
        """Return self[key]."""
