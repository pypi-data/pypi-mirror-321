...
conf = {
    bstack11111_opy_ (u"ࠪࡥࡵࡶ࡟ࡢࡷࡷࡳࡲࡧࡴࡦࠩᄶ"): False,
    bstack11111_opy_ (u"ࠫࡧࡹࡴࡢࡥ࡮ࡣࡸ࡫ࡳࡴ࡫ࡲࡲࠬᄷ"): True,
    bstack11111_opy_ (u"ࠬࡹ࡫ࡪࡲࡢࡷࡪࡹࡳࡪࡱࡱࡣࡸࡺࡡࡵࡷࡶࠫᄸ"): False
}
class Config(object):
    instance = None
    def __init__(self):
        self._1lllll1l1l1_opy_ = conf
    @classmethod
    def bstack11lll111l_opy_(cls):
        if cls.instance:
            return cls.instance
        return Config()
    def get_property(self, property_name):
        return self._1lllll1l1l1_opy_.get(property_name, None)
    def bstack1l1111llll_opy_(self, property_name, bstack1lllll1l11l_opy_):
        self._1lllll1l1l1_opy_[property_name] = bstack1lllll1l11l_opy_
    def bstack11111l1ll_opy_(self, val):
        self._1lllll1l1l1_opy_[bstack11111_opy_ (u"࠭ࡳ࡬࡫ࡳࡣࡸ࡫ࡳࡴ࡫ࡲࡲࡤࡹࡴࡢࡶࡸࡷࠬᄹ")] = bool(val)
    def bstack111ll1l1ll_opy_(self):
        return self._1lllll1l1l1_opy_.get(bstack11111_opy_ (u"ࠧࡴ࡭࡬ࡴࡤࡹࡥࡴࡵ࡬ࡳࡳࡥࡳࡵࡣࡷࡹࡸ࠭ᄺ"), False)