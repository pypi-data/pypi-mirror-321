...
from ...models.cancel_return_envelope_order_response_200 import CancelReturnEnvelopeOrderResponse200
...
) -> Optional[CancelReturnEnvelopeOrderResponse200]:
    if response.status_code == 200:
        response_200 = CancelReturnEnvelopeOrderResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[CancelReturnEnvelopeOrderResponse200]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Cancel Return Envelope Order
     ...
     <p>Cancels a return envelope by <code>id</code> and return envelope order by
    <code>orderID</code>.</p>
