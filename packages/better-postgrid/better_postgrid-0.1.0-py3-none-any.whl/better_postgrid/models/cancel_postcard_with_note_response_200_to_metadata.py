...
T = TypeVar("T", bound="CancelPostcardWithNoteResponse200ToMetadata")


@_attrs_define
class CancelPostcardWithNoteResponse200ToMetadata:
    """
    Attributes:
        account_number (Union[Unset, str]):  Example: 1112.
        code (Union[Unset, str]):  Example: 12345.
        date_created (Union[Unset, str]):  Example: 20-Sep-21.
        date_due (Union[Unset, str]):  Example: 20-Sep-21.
        days (Union[Unset, str]):  Example: 40.
        invoice_number (Union[Unset, str]):  Example: 1000.
    """
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        cancel_postcard_with_note_response_200_to_metadata = cls(
        ...
        cancel_postcard_with_note_response_200_to_metadata.additional_properties = d
        return cancel_postcard_with_note_response_200_to_metadata
