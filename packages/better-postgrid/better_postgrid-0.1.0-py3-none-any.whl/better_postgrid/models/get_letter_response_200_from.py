...
T = TypeVar("T", bound="GetLetterResponse200From")


@_attrs_define
class GetLetterResponse200From:
    """
    Attributes:
        address_line_1 (Union[Unset, str]):  Example: 212-3075 14TH AVE.
        address_line_2 (Union[Unset, str]):
        address_status (Union[Unset, str]):  Example: corrected.
        city (Union[Unset, str]):  Example: MARKHAM.
        ...
        id (Union[Unset, str]):  Example: contact_cZb84jmqSmL27ZS2abBrnD.
        object_ (Union[Unset, str]):  Example: contact.
        postal_or_zip (Union[Unset, str]):  Example: L3R0G9.
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_letter_response_200_from = cls(
        ...
        get_letter_response_200_from.additional_properties = d
        return get_letter_response_200_from
