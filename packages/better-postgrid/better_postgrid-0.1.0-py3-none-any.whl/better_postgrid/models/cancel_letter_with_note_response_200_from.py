...
if TYPE_CHECKING:
    from ..models.cancel_letter_with_note_response_200_from_metadata import CancelLetterWithNoteResponse200FromMetadata


T = TypeVar("T", bound="CancelLetterWithNoteResponse200From")


@_attrs_define
class CancelLetterWithNoteResponse200From:
    """
    Attributes:
        ...
        metadata (Union[Unset, CancelLetterWithNoteResponse200FromMetadata]):
    ...
    metadata: Union[Unset, "CancelLetterWithNoteResponse200FromMetadata"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        from ..models.cancel_letter_with_note_response_200_from_metadata import (
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = CancelLetterWithNoteResponse200FromMetadata.from_dict(_metadata)
        ...
        cancel_letter_with_note_response_200_from = cls(
        ...
        cancel_letter_with_note_response_200_from.additional_properties = d
        return cancel_letter_with_note_response_200_from
