...
if TYPE_CHECKING:
    from ..models.list_events_response_200_data_item_data_from_metadata import (
        ListEventsResponse200DataItemDataFromMetadata,
    )


T = TypeVar("T", bound="ListEventsResponse200DataItemDataFrom")


@_attrs_define
class ListEventsResponse200DataItemDataFrom:
    """
    Attributes:
        address_line_1 (Union[Unset, str]):  Example: 2 PICKWICK PLAZA.
        address_line_2 (Union[Unset, str]):
        address_status (Union[Unset, str]):  Example: verified.
        city (Union[Unset, str]):  Example: GREENWICH.
        company_name (Union[Unset, str]):  Example: Interactive Brokers LLC.
        country (Union[Unset, str]):  Example: UNITED STATES.
        country_code (Union[Unset, str]):  Example: US.
        description (Union[Unset, str]):  Example: 1097916.
        email (Union[Unset, str]):
        first_name (Union[Unset, str]):
        id (Union[Unset, str]):  Example: contact_wCVRSWWYjx6QHF8Z2kisUA.
        job_title (Union[Unset, str]):
        last_name (Union[Unset, str]):
        metadata (Union[Unset, ListEventsResponse200DataItemDataFromMetadata]):
        object_ (Union[Unset, str]):  Example: contact.
        phone_number (Union[Unset, str]):
        postal_or_zip (Union[Unset, str]):  Example: 6831.
        province_or_state (Union[Unset, str]):  Example: CT.
    """
    ...
    metadata: Union[Unset, "ListEventsResponse200DataItemDataFromMetadata"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = ListEventsResponse200DataItemDataFromMetadata.from_dict(_metadata)
        ...
        list_events_response_200_data_item_data_from = cls(
        ...
        list_events_response_200_data_item_data_from.additional_properties = d
        return list_events_response_200_data_item_data_from
