...
T = TypeVar("T", bound="ListEventsResponse200DataItemDataToMetadata")


@_attrs_define
class ListEventsResponse200DataItemDataToMetadata:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        list_events_response_200_data_item_data_to_metadata = cls(
            amount=amount,
        ...
        list_events_response_200_data_item_data_to_metadata.additional_properties = d
        return list_events_response_200_data_item_data_to_metadata
