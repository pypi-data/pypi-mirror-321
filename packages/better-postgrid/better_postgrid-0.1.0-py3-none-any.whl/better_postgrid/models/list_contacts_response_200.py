...
class ListContactsResponse200:
    """
    Attributes:
        data (Union[Unset, list['ListContactsResponse200DataItem']]):  Example: [{'addressLine1': '20-20 BAY ST FLOOR
            11', 'addressLine2': '', 'addressStatus': 'verified', 'city': 'TORONTO', 'companyName': 'PostGrid', 'country':
            'CANADA', 'countryCode': 'CA', 'createdAt': '2020-11-12T00:05:26.677Z', 'firstName': 'Kevin', 'id':
            'contact_nA8mdzveShFEmFraaChaDn', 'live': False, 'object': 'contact', 'postalOrZip': 'M5J2N8',
            'provinceOrState': 'ON', 'updatedAt': '2020-11-12T00:05:26.677Z'}].
    ...
    data: Union[Unset, list["ListContactsResponse200DataItem"]] = UNSET
