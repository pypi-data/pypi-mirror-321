...
T = TypeVar("T", bound="CreateSelfMailerResponse201To")


@_attrs_define
class CreateSelfMailerResponse201To:
    """
    Attributes:
        address_line_1 (Union[Unset, str]):  Example: 22-20 BAY ST.
        address_line_2 (Union[Unset, Any]):
        ...
        id (Union[Unset, str]):  Example: contact_j2aCvBWzVuPM77LZwU6eEw.
        object_ (Union[Unset, str]):  Example: contact.
        postal_or_zip (Union[Unset, Any]):
        province_or_state (Union[None, Unset, str]):  Example: NY.
    """

    address_line_1: Union[Unset, str] = UNSET
    address_line_2: Union[Unset, Any] = UNSET
    ...
    province_or_state: Union[None, Unset, str] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        province_or_state: Union[None, Unset, str]
        if isinstance(self.province_or_state, Unset):
            province_or_state = UNSET
        else:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_province_or_state(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
        ...
        province_or_state = _parse_province_or_state(d.pop("provinceOrState", UNSET))

        create_self_mailer_response_201_to = cls(
        ...
        create_self_mailer_response_201_to.additional_properties = d
        return create_self_mailer_response_201_to
