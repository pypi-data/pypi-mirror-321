...
T = TypeVar("T", bound="ListTrackersResponse200DataItem")


@_attrs_define
class ListTrackersResponse200DataItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        list_trackers_response_200_data_item = cls(
        ...
        list_trackers_response_200_data_item.additional_properties = d
        return list_trackers_response_200_data_item
