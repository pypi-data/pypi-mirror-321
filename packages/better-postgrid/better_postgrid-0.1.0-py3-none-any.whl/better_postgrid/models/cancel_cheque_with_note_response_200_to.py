...
if TYPE_CHECKING:
    from ..models.cancel_cheque_with_note_response_200_to_metadata import CancelChequeWithNoteResponse200ToMetadata


T = TypeVar("T", bound="CancelChequeWithNoteResponse200To")


@_attrs_define
class CancelChequeWithNoteResponse200To:
    """
    Attributes:
        address_line_1 (Union[Unset, str]):  Example: 1290 HERCULES AVENUE.
        address_line_2 (Union[Unset, str]):
        address_status (Union[Unset, str]):  Example: verified.
        city (Union[Unset, str]):  Example: HOUSTON.
        ...
        email (Union[Unset, str]):  Example: john@axiomspace.com.
        first_name (Union[Unset, str]):  Example: John.
        id (Union[Unset, str]):  Example: contact_e8cVVSakApQnZTCHjoGXPf.
        job_title (Union[Unset, str]):  Example: Manager, Information Technology Support.
        last_name (Union[Unset, str]):  Example: Smith.
        metadata (Union[Unset, CancelChequeWithNoteResponse200ToMetadata]):
        object_ (Union[Unset, str]):  Example: contact.
        postal_or_zip (Union[Unset, str]):  Example: 77058.
    ...
    metadata: Union[Unset, "CancelChequeWithNoteResponse200ToMetadata"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = CancelChequeWithNoteResponse200ToMetadata.from_dict(_metadata)
        ...
        cancel_cheque_with_note_response_200_to = cls(
        ...
        cancel_cheque_with_note_response_200_to.additional_properties = d
        return cancel_cheque_with_note_response_200_to
