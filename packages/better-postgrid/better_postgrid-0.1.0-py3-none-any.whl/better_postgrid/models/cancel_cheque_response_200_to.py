...
T = TypeVar("T", bound="CancelChequeResponse200To")


@_attrs_define
class CancelChequeResponse200To:
    """
    Attributes:
        address_line_1 (Union[Unset, str]):  Example: 238 SHREWSBURY ST..
        address_line_2 (Union[Unset, str]):
        address_status (Union[Unset, str]):  Example: verified.
        city (Union[Unset, str]):  Example: WORCESTER.
        country (Union[Unset, str]):  Example: CANADA.
        country_code (Union[Unset, str]):  Example: CA.
        first_name (Union[Unset, str]):  Example: Jane.
        id (Union[Unset, str]):  Example: contact_v4RjDJZpSAZx3EtoBCuU4v.
        last_name (Union[Unset, str]):  Example: Eden.
        object_ (Union[Unset, str]):  Example: contact.
        postal_or_zip (Union[Unset, str]):  Example: 01604.
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        cancel_cheque_response_200_to = cls(
        ...
        cancel_cheque_response_200_to.additional_properties = d
        return cancel_cheque_response_200_to
