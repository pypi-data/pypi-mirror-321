...
T = TypeVar("T", bound="CancelLetterResponse200From")


@_attrs_define
class CancelLetterResponse200From:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        cancel_letter_response_200_from = cls(
        ...
        cancel_letter_response_200_from.additional_properties = d
        return cancel_letter_response_200_from
