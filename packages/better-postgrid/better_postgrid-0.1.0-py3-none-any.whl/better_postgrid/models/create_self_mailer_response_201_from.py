...
if TYPE_CHECKING:
    from ..models.create_self_mailer_response_201_from_metadata import CreateSelfMailerResponse201FromMetadata


T = TypeVar("T", bound="CreateSelfMailerResponse201From")


@_attrs_define
class CreateSelfMailerResponse201From:
    """
    Attributes:
        address_line_1 (Union[Unset, str]):  Example: 145 MULBERRY ST.
        address_line_2 (Union[None, Unset, str]):  Example: APT PH D.
        address_status (Union[Unset, str]):  Example: verified.
        city (Union[Unset, str]):  Example: NEW YORK.
        company_name (Union[Unset, str]):
        country (Union[Unset, str]):  Example: UNITED STATES.
        country_code (Union[Unset, str]):  Example: US.
        description (Union[Unset, str]):  Example: Contact with no last name.
        email (Union[Unset, str]):
        first_name (Union[Unset, str]):  Example: Anna Marie.
        id (Union[Unset, str]):  Example: contact_ajjGFyDSwYPDcf2h7Cww98.
        job_title (Union[Unset, str]):
        last_name (Union[Unset, str]):
        metadata (Union[Unset, CreateSelfMailerResponse201FromMetadata]):
        object_ (Union[Unset, str]):  Example: contact.
        phone_number (Union[Unset, str]):  Example: (718) 567-0845.
        postal_or_zip (Union[None, Unset, str]):  Example: 10013.
        province_or_state (Union[Unset, str]):  Example: NY.
    """
    ...
    metadata: Union[Unset, "CreateSelfMailerResponse201FromMetadata"] = UNSET
    object_: Union[Unset, str] = UNSET
    phone_number: Union[Unset, str] = UNSET
    postal_or_zip: Union[None, Unset, str] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        postal_or_zip: Union[None, Unset, str]
        if isinstance(self.postal_or_zip, Unset):
            postal_or_zip = UNSET
        else:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = CreateSelfMailerResponse201FromMetadata.from_dict(_metadata)

        object_ = d.pop("object", UNSET)

        phone_number = d.pop("phoneNumber", UNSET)

        def _parse_postal_or_zip(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        postal_or_zip = _parse_postal_or_zip(d.pop("postalOrZip", UNSET))

        province_or_state = d.pop("provinceOrState", UNSET)

        create_self_mailer_response_201_from = cls(
        ...
        create_self_mailer_response_201_from.additional_properties = d
        return create_self_mailer_response_201_from
