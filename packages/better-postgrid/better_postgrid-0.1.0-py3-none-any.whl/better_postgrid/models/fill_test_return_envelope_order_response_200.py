...
T = TypeVar("T", bound="FillTestReturnEnvelopeOrderResponse200")


@_attrs_define
class FillTestReturnEnvelopeOrderResponse200:
    """
    Attributes:
        created_at (Union[Unset, str]):  Example: 2021-12-16T03:36:20.255Z.
        id (Union[Unset, str]):  Example: return_envelope_order_7Lfcisz49i1PP8XDC6ewqy.
        live (Union[Unset, bool]):
        object_ (Union[Unset, str]):  Example: return_envelope_order.
        quantity_filled (Union[Unset, float]):  Example: 100.
        ...
        status (Union[Unset, str]):  Example: filled.
        updated_at (Union[Unset, str]):  Example: 2021-12-16T03:37:05.450Z.
    """
    ...
    quantity_filled: Union[Unset, float] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        fill_test_return_envelope_order_response_200 = cls(
        ...
        fill_test_return_envelope_order_response_200.additional_properties = d
        return fill_test_return_envelope_order_response_200
