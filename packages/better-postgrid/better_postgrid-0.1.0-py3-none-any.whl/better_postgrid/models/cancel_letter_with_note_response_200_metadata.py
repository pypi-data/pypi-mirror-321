...
T = TypeVar("T", bound="CancelLetterWithNoteResponse200Metadata")


@_attrs_define
class CancelLetterWithNoteResponse200Metadata:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        cancel_letter_with_note_response_200_metadata = cls(
            postgrid_dashboard=postgrid_dashboard,
        )

        cancel_letter_with_note_response_200_metadata.additional_properties = d
        return cancel_letter_with_note_response_200_metadata
