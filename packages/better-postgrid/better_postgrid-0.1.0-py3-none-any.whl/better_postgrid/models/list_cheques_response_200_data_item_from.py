...
T = TypeVar("T", bound="ListChequesResponse200DataItemFrom")


@_attrs_define
class ListChequesResponse200DataItemFrom:
    """
    Attributes:
        ...
        id (Union[Unset, str]):  Example: contact_2ebY285LeamvfBZrJTdCvP.
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        list_cheques_response_200_data_item_from = cls(
        ...
        list_cheques_response_200_data_item_from.additional_properties = d
        return list_cheques_response_200_data_item_from
