...
T = TypeVar("T", bound="ListEventsResponse200DataItemDataFromMetadata")


@_attrs_define
class ListEventsResponse200DataItemDataFromMetadata:
    """
    Attributes:
        amount (Union[Unset, float]):  Example: 2071.28.
        cheque_number (Union[Unset, Any]):
        memo (Union[Unset, str]):  Example: FBO Daniel Devore Roth IRA U5039335.
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        list_events_response_200_data_item_data_from_metadata = cls(
            amount=amount,
        ...
        list_events_response_200_data_item_data_from_metadata.additional_properties = d
        return list_events_response_200_data_item_data_from_metadata
