...
T = TypeVar("T", bound="CancelSelfMailersResponse200From")


@_attrs_define
class CancelSelfMailersResponse200From:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        cancel_self_mailers_response_200_from = cls(
        ...
        cancel_self_mailers_response_200_from.additional_properties = d
        return cancel_self_mailers_response_200_from
