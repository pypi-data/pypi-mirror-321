...
T = TypeVar("T", bound="ProgressTestPostcardResponse200To")


@_attrs_define
class ProgressTestPostcardResponse200To:
    """
    Attributes:
        ...
        id (Union[Unset, str]):  Example: contact_juQr1pWXFncdPKMy4LE52N.
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        progress_test_postcard_response_200_to = cls(
        ...
        progress_test_postcard_response_200_to.additional_properties = d
        return progress_test_postcard_response_200_to
