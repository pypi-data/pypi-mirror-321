...
if TYPE_CHECKING:
    from ..models.list_events_response_200_data_item_data_to_metadata import ListEventsResponse200DataItemDataToMetadata


T = TypeVar("T", bound="ListEventsResponse200DataItemDataTo")


@_attrs_define
class ListEventsResponse200DataItemDataTo:
    """
    Attributes:
        address_line_1 (Union[Unset, str]):  Example: 27571 SANDY SHORES DR SW.
        address_line_2 (Union[Unset, str]):
        address_status (Union[Unset, str]):  Example: verified.
        city (Union[Unset, str]):  Example: VASHON.
        ...
        first_name (Union[Unset, str]):  Example: David.
        id (Union[Unset, str]):  Example: contact_j4UQMhBkq6mz2Vvj2coLwX.
        job_title (Union[Unset, str]):
        last_name (Union[Unset, str]):  Example: Becker.
        metadata (Union[Unset, ListEventsResponse200DataItemDataToMetadata]):
        object_ (Union[Unset, str]):  Example: contact.
        phone_number (Union[Unset, str]):
        postal_or_zip (Union[Unset, str]):  Example: 98070.
        province_or_state (Union[Unset, str]):  Example: WA.
    """
    ...
    metadata: Union[Unset, "ListEventsResponse200DataItemDataToMetadata"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        from ..models.list_events_response_200_data_item_data_to_metadata import (
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = ListEventsResponse200DataItemDataToMetadata.from_dict(_metadata)
        ...
        list_events_response_200_data_item_data_to = cls(
        ...
        list_events_response_200_data_item_data_to.additional_properties = d
        return list_events_response_200_data_item_data_to
