...
T = TypeVar("T", bound="ListLettersResponse200DataItemFrom")


@_attrs_define
class ListLettersResponse200DataItemFrom:
    """
    Attributes:
        address_line_1 (Union[Unset, str]):  Example: 20-20 BAY ST FLOOR 11.
        address_line_2 (Union[Unset, str]):
        address_status (Union[Unset, str]):  Example: corrected.
        ...
        id (Union[Unset, str]):  Example: contact_dk6G7aFruyzTfAMzDstUBp.
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        list_letters_response_200_data_item_from = cls(
        ...
        list_letters_response_200_data_item_from.additional_properties = d
        return list_letters_response_200_data_item_from
