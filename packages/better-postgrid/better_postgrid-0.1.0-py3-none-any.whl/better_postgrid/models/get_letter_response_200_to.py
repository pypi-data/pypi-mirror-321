...
T = TypeVar("T", bound="GetLetterResponse200To")


@_attrs_define
class GetLetterResponse200To:
    """
    Attributes:
        ...
        id (Union[Unset, str]):  Example: contact_cqyde5u6FDJggQ8nj9q7s9.
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_letter_response_200_to = cls(
        ...
        get_letter_response_200_to.additional_properties = d
        return get_letter_response_200_to
