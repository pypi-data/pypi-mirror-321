...
T = TypeVar("T", bound="CancelLetterWithNoteResponse200To")


@_attrs_define
class CancelLetterWithNoteResponse200To:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        cancel_letter_with_note_response_200_to = cls(
        ...
        cancel_letter_with_note_response_200_to.additional_properties = d
        return cancel_letter_with_note_response_200_to
