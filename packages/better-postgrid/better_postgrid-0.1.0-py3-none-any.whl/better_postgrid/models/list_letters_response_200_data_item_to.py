...
T = TypeVar("T", bound="ListLettersResponse200DataItemTo")


@_attrs_define
class ListLettersResponse200DataItemTo:
    """
    Attributes:
        ...
        id (Union[Unset, str]):  Example: contact_qCpdmxgNV37pCoENhoCrPH.
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        list_letters_response_200_data_item_to = cls(
        ...
        list_letters_response_200_data_item_to.additional_properties = d
        return list_letters_response_200_data_item_to
