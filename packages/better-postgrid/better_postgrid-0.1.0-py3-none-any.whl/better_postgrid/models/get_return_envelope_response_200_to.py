...
T = TypeVar("T", bound="GetReturnEnvelopeResponse200To")


@_attrs_define
class GetReturnEnvelopeResponse200To:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_return_envelope_response_200_to = cls(
        ...
        get_return_envelope_response_200_to.additional_properties = d
        return get_return_envelope_response_200_to
