...
if TYPE_CHECKING:
    from ..models.cancel_postcard_response_200_to import CancelPostcardResponse200To


T = TypeVar("T", bound="CancelPostcardResponse200")


@_attrs_define
class CancelPostcardResponse200:
    """
    Attributes:
        ...
        to (Union[Unset, CancelPostcardResponse200To]):
        updated_at (Union[Unset, str]):  Example: 2020-12-23T07:16:30.679Z.
        url (Union[Unset, str]):  Example: https://pg-prod-bucket-
            ...
            90&Signature=h7L7M9JI0A4VqUs7Fhk83Wfb%2B7Q%3D.
    """
    ...
    to: Union[Unset, "CancelPostcardResponse200To"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_to, Unset):
            ...
            to = CancelPostcardResponse200To.from_dict(_to)

        updated_at = d.pop("updatedAt", UNSET)

        url = d.pop("url", UNSET)

        cancel_postcard_response_200 = cls(
            back_html=back_html,
        ...
        cancel_postcard_response_200.additional_properties = d
        return cancel_postcard_response_200
