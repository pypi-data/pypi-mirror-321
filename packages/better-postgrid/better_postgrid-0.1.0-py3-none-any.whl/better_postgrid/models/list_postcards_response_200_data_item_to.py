...
T = TypeVar("T", bound="ListPostcardsResponse200DataItemTo")


@_attrs_define
class ListPostcardsResponse200DataItemTo:
    """
    Attributes:
        ...
        id (Union[Unset, str]):  Example: contact_6fMMFdvk7YSSKVgaKyJaQS.
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        list_postcards_response_200_data_item_to = cls(
        ...
        list_postcards_response_200_data_item_to.additional_properties = d
        return list_postcards_response_200_data_item_to
