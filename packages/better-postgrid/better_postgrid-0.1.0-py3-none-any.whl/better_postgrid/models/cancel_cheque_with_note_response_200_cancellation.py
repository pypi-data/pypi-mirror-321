...
T = TypeVar("T", bound="CancelChequeWithNoteResponse200Cancellation")


@_attrs_define
class CancelChequeWithNoteResponse200Cancellation:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        cancel_cheque_with_note_response_200_cancellation = cls(
            cancelled_by_user=cancelled_by_user,
            note=note,
            reason=reason,
        )

        cancel_cheque_with_note_response_200_cancellation.additional_properties = d
        return cancel_cheque_with_note_response_200_cancellation
