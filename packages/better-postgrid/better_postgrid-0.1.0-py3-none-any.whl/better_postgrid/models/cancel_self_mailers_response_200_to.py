...
T = TypeVar("T", bound="CancelSelfMailersResponse200To")


@_attrs_define
class CancelSelfMailersResponse200To:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        cancel_self_mailers_response_200_to = cls(
        ...
        cancel_self_mailers_response_200_to.additional_properties = d
        return cancel_self_mailers_response_200_to
