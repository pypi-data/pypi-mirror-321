...
T = TypeVar("T", bound="ListSelfMailersResponse200DataItemTo")


@_attrs_define
class ListSelfMailersResponse200DataItemTo:
    """
    Attributes:
        ...
        id (Union[Unset, str]):  Example: contact_3BQJWhUfKQFGKLQF42YM5T.
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        list_self_mailers_response_200_data_item_to = cls(
        ...
        list_self_mailers_response_200_data_item_to.additional_properties = d
        return list_self_mailers_response_200_data_item_to
