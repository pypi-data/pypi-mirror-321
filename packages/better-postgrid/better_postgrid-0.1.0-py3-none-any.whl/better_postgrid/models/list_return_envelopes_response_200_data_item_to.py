...
T = TypeVar("T", bound="ListReturnEnvelopesResponse200DataItemTo")


@_attrs_define
class ListReturnEnvelopesResponse200DataItemTo:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        list_return_envelopes_response_200_data_item_to = cls(
        ...
        list_return_envelopes_response_200_data_item_to.additional_properties = d
        return list_return_envelopes_response_200_data_item_to
