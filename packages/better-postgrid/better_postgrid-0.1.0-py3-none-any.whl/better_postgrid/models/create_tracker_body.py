...
T = TypeVar("T", bound="CreateTrackerBody")


@_attrs_define
class CreateTrackerBody:
    """
    Attributes:
        redirect_url_template (Union[Unset, str]):  Example: https://postgrid.com?name={{to.firstName}}.
        url_expire_after_days (Union[Unset, str]):  Example: 30.
    """
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        create_tracker_body = cls(
            redirect_url_template=redirect_url_template,
            url_expire_after_days=url_expire_after_days,
        )

        create_tracker_body.additional_properties = d
        return create_tracker_body
