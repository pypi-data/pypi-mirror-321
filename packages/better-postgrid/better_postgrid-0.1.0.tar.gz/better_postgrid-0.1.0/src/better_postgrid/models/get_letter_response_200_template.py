...
T = TypeVar("T", bound="GetLetterResponse200Template")


@_attrs_define
class GetLetterResponse200Template:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_letter_response_200_template = cls(
        ...
        get_letter_response_200_template.additional_properties = d
        return get_letter_response_200_template
