...
if TYPE_CHECKING:
    from ..models.get_self_mailer_response_200_from_metadata import GetSelfMailerResponse200FromMetadata


T = TypeVar("T", bound="GetSelfMailerResponse200From")


@_attrs_define
class GetSelfMailerResponse200From:
    """
    Attributes:
        address_line_1 (Union[Unset, str]):  Example: 18380 FUCHSIA RD.
        address_line_2 (Union[Unset, str]):
        address_status (Union[Unset, str]):  Example: verified.
        city (Union[Unset, str]):  Example: FORT MYERS.
        country (Union[Unset, str]):  Example: UNITED STATES.
        country_code (Union[Unset, str]):  Example: US.
        first_name (Union[Unset, str]):  Example: Arturo.
        id (Union[Unset, str]):  Example: contact_iNaKXaRVN5FjWobxV1SXe7.
        last_name (Union[Unset, str]):  Example: Moralez.
        metadata (Union[Unset, GetSelfMailerResponse200FromMetadata]):
        object_ (Union[Unset, str]):  Example: contact.
        postal_or_zip (Union[Unset, str]):  Example: 33967.
        province_or_state (Union[Unset, str]):  Example: FL.
    """
    ...
    metadata: Union[Unset, "GetSelfMailerResponse200FromMetadata"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = GetSelfMailerResponse200FromMetadata.from_dict(_metadata)
        ...
        get_self_mailer_response_200_from = cls(
        ...
        get_self_mailer_response_200_from.additional_properties = d
        return get_self_mailer_response_200_from
