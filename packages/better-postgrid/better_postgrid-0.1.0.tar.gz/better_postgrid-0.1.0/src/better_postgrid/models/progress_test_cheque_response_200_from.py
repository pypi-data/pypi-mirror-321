...
T = TypeVar("T", bound="ProgressTestChequeResponse200From")


@_attrs_define
class ProgressTestChequeResponse200From:
    """
    Attributes:
        ...
        id (Union[Unset, str]):  Example: contact_tCq5vq67jb3zuST2QA7oBS.
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        progress_test_cheque_response_200_from = cls(
        ...
        progress_test_cheque_response_200_from.additional_properties = d
        return progress_test_cheque_response_200_from
