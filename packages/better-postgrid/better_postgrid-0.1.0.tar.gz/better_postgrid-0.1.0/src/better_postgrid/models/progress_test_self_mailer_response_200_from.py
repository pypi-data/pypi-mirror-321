...
T = TypeVar("T", bound="ProgressTestSelfMailerResponse200From")


@_attrs_define
class ProgressTestSelfMailerResponse200From:
    """
    Attributes:
        address_line_1 (Union[Unset, str]):  Example: 490 OLD SANTA FE TRAIL.
        address_line_2 (Union[Unset, str]):
        address_status (Union[Unset, str]):  Example: verified.
        city (Union[Unset, str]):  Example: SANTA FE.
        country (Union[Unset, str]):  Example: UNITED STATES.
        country_code (Union[Unset, str]):  Example: US.
        first_name (Union[Unset, str]):  Example: Steve.
        ...
        postal_or_zip (Union[Unset, str]):  Example: 87501.
        province_or_state (Union[Unset, str]):  Example: NM.
    """
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        progress_test_self_mailer_response_200_from = cls(
        ...
        progress_test_self_mailer_response_200_from.additional_properties = d
        return progress_test_self_mailer_response_200_from
