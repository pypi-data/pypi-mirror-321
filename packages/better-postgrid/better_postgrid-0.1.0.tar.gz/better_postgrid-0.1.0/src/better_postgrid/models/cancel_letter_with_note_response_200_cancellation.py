...
T = TypeVar("T", bound="CancelLetterWithNoteResponse200Cancellation")


@_attrs_define
class CancelLetterWithNoteResponse200Cancellation:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        cancel_letter_with_note_response_200_cancellation = cls(
            cancelled_by_user=cancelled_by_user,
            note=note,
            reason=reason,
        )

        cancel_letter_with_note_response_200_cancellation.additional_properties = d
        return cancel_letter_with_note_response_200_cancellation
