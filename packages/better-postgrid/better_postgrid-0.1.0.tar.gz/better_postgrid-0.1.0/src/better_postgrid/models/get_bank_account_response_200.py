...
T = TypeVar("T", bound="GetBankAccountResponse200")


@_attrs_define
class GetBankAccountResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_bank_account_response_200 = cls(
        ...
        get_bank_account_response_200.additional_properties = d
        return get_bank_account_response_200
