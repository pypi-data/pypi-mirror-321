...
T = TypeVar("T", bound="ProgressTestSelfMailerResponse200To")


@_attrs_define
class ProgressTestSelfMailerResponse200To:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        progress_test_self_mailer_response_200_to = cls(
        ...
        progress_test_self_mailer_response_200_to.additional_properties = d
        return progress_test_self_mailer_response_200_to
