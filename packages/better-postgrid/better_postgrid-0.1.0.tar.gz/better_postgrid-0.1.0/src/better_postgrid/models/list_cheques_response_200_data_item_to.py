...
T = TypeVar("T", bound="ListChequesResponse200DataItemTo")


@_attrs_define
class ListChequesResponse200DataItemTo:
    """
    Attributes:
        ...
        id (Union[Unset, str]):  Example: contact_sUeaxGua7LgDfwGcBEBfz1.
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        list_cheques_response_200_data_item_to = cls(
        ...
        list_cheques_response_200_data_item_to.additional_properties = d
        return list_cheques_response_200_data_item_to
