...
if TYPE_CHECKING:
    from ..models.cancel_postcard_with_note_response_200_to_metadata import CancelPostcardWithNoteResponse200ToMetadata


T = TypeVar("T", bound="CancelPostcardWithNoteResponse200To")


@_attrs_define
class CancelPostcardWithNoteResponse200To:
    """
    Attributes:
        address_line_1 (Union[Unset, str]):  Example: 145 MULBERRY ST.
        address_line_2 (Union[Unset, str]):  Example: APT PH D.
        ...
        description (Union[Unset, str]):  Example: This is a contact with no last name.
        email (Union[Unset, str]):  Example: John@postgrid.com.
        first_name (Union[Unset, str]):  Example: John.
        id (Union[Unset, str]):  Example: contact_tYToZ4NoWZw59PfxLMUpsf.
        job_title (Union[Unset, str]):
        last_name (Union[Unset, str]):  Example: Smith.
        metadata (Union[Unset, CancelPostcardWithNoteResponse200ToMetadata]):
        object_ (Union[Unset, str]):  Example: contact.
        phone_number (Union[Unset, str]):
        postal_or_zip (Union[Unset, str]):  Example: 10013.
    ...
    metadata: Union[Unset, "CancelPostcardWithNoteResponse200ToMetadata"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        from ..models.cancel_postcard_with_note_response_200_to_metadata import (
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = CancelPostcardWithNoteResponse200ToMetadata.from_dict(_metadata)
        ...
        cancel_postcard_with_note_response_200_to = cls(
        ...
        cancel_postcard_with_note_response_200_to.additional_properties = d
        return cancel_postcard_with_note_response_200_to
