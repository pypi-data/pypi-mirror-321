...
T = TypeVar("T", bound="ProgressTestChequeResponse200To")


@_attrs_define
class ProgressTestChequeResponse200To:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        progress_test_cheque_response_200_to = cls(
        ...
        progress_test_cheque_response_200_to.additional_properties = d
        return progress_test_cheque_response_200_to
