...
T = TypeVar("T", bound="CreateLetterResponse201From")


@_attrs_define
class CreateLetterResponse201From:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        create_letter_response_201_from = cls(
        ...
        create_letter_response_201_from.additional_properties = d
        return create_letter_response_201_from
