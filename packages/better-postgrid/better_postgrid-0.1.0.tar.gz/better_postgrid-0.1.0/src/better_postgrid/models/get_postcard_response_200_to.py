...
T = TypeVar("T", bound="GetPostcardResponse200To")


@_attrs_define
class GetPostcardResponse200To:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_postcard_response_200_to = cls(
        ...
        get_postcard_response_200_to.additional_properties = d
        return get_postcard_response_200_to
