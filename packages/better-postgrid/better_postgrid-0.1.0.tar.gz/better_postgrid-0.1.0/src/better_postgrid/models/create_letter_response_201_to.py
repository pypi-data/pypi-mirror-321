...
T = TypeVar("T", bound="CreateLetterResponse201To")


@_attrs_define
class CreateLetterResponse201To:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        create_letter_response_201_to = cls(
        ...
        create_letter_response_201_to.additional_properties = d
        return create_letter_response_201_to
