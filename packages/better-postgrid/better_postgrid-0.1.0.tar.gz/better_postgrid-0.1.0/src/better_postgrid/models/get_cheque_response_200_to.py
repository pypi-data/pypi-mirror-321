...
T = TypeVar("T", bound="GetChequeResponse200To")


@_attrs_define
class GetChequeResponse200To:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_cheque_response_200_to = cls(
        ...
        get_cheque_response_200_to.additional_properties = d
        return get_cheque_response_200_to
