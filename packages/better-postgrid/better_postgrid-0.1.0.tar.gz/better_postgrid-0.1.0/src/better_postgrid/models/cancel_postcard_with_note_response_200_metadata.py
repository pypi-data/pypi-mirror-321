...
T = TypeVar("T", bound="CancelPostcardWithNoteResponse200Metadata")


@_attrs_define
class CancelPostcardWithNoteResponse200Metadata:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        cancel_postcard_with_note_response_200_metadata = cls(
            postgrid_dashboard=postgrid_dashboard,
        )

        cancel_postcard_with_note_response_200_metadata.additional_properties = d
        return cancel_postcard_with_note_response_200_metadata
