...
T = TypeVar("T", bound="CancelChequeResponse200From")


@_attrs_define
class CancelChequeResponse200From:
    """
    Attributes:
        address_line_1 (Union[Unset, str]):  Example: 800 W CUMMINGS PARK SUITE 6650.
        address_line_2 (Union[Unset, str]):
        address_status (Union[Unset, str]):  Example: verified.
        city (Union[Unset, str]):  Example: WOBURN.
        country (Union[Unset, str]):  Example: CANADA.
        country_code (Union[Unset, str]):  Example: CA.
        first_name (Union[Unset, str]):  Example: Scott.
        id (Union[Unset, str]):  Example: contact_w5QLw7pPmRuZU3AB5uVTTw.
        last_name (Union[Unset, str]):  Example: Behman.
        object_ (Union[Unset, str]):  Example: contact.
        postal_or_zip (Union[Unset, str]):  Example: 01801.
        province_or_state (Union[Unset, str]):  Example: MA.
    """
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        cancel_cheque_response_200_from = cls(
        ...
        cancel_cheque_response_200_from.additional_properties = d
        return cancel_cheque_response_200_from
