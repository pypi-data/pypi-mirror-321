...
T = TypeVar("T", bound="ProgressTestLetterResponse200From")


@_attrs_define
class ProgressTestLetterResponse200From:
    """
    Attributes:
        ...
        id (Union[Unset, str]):  Example: contact_nt4MYqiigmt4EWdKXARwDk.
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        progress_test_letter_response_200_from = cls(
        ...
        progress_test_letter_response_200_from.additional_properties = d
        return progress_test_letter_response_200_from
