...
T = TypeVar("T", bound="GetReturnEnvelopeOrderResponse200ReturnEnvelopeTo")


@_attrs_define
class GetReturnEnvelopeOrderResponse200ReturnEnvelopeTo:
    """
    Attributes:
        address_line_1 (Union[Unset, str]):  Example: 20 BAY ST TORONTO ON.
        address_line_2 (Union[Unset, Any]):
        address_status (Union[Unset, str]):  Example: verified.
        city (Union[Unset, Any]):
        country (Union[Unset, str]):  Example: CANADA.
        country_code (Union[Unset, str]):  Example: CA.
        first_name (Union[Unset, str]):  Example: Apaar.
        id (Union[Unset, str]):  Example: contact_kFjQtFqJtRXgahx5vgc9mA.
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_return_envelope_order_response_200_return_envelope_to = cls(
        ...
        get_return_envelope_order_response_200_return_envelope_to.additional_properties = d
        return get_return_envelope_order_response_200_return_envelope_to
