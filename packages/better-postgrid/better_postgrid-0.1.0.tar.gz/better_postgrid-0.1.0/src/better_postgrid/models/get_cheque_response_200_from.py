...
T = TypeVar("T", bound="GetChequeResponse200From")


@_attrs_define
class GetChequeResponse200From:
    """
    Attributes:
        ...
        country (Union[Unset, Any]):
        country_code (Union[Unset, Any]):
        id (Union[Unset, str]):  Example: contact_jkTtb6ovKZ7xXe7N5rXipX.
        object_ (Union[Unset, str]):  Example: contact.
        postal_or_zip (Union[Unset, str]):  Example: M5V 4G9.
    ...
    country_code: Union[Unset, Any] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_cheque_response_200_from = cls(
        ...
        get_cheque_response_200_from.additional_properties = d
        return get_cheque_response_200_from
