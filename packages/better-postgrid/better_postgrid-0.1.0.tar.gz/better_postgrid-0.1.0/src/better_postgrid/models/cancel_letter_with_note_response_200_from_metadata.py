...
T = TypeVar("T", bound="CancelLetterWithNoteResponse200FromMetadata")


@_attrs_define
class CancelLetterWithNoteResponse200FromMetadata:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        cancel_letter_with_note_response_200_from_metadata = cls(
        ...
        cancel_letter_with_note_response_200_from_metadata.additional_properties = d
        return cancel_letter_with_note_response_200_from_metadata
