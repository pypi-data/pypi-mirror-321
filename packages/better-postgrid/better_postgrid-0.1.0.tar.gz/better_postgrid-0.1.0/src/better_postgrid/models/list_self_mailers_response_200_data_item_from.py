...
T = TypeVar("T", bound="ListSelfMailersResponse200DataItemFrom")


@_attrs_define
class ListSelfMailersResponse200DataItemFrom:
    """
    Attributes:
        ...
        first_name (Union[Unset, str]):  Example: Ricky.
        id (Union[Unset, str]):  Example: contact_tydRUvrZsw39Nc6guEccid.
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        list_self_mailers_response_200_data_item_from = cls(
        ...
        list_self_mailers_response_200_data_item_from.additional_properties = d
        return list_self_mailers_response_200_data_item_from
