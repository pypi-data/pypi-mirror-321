...
T = TypeVar("T", bound="CancelPostcardResponse200To")


@_attrs_define
class CancelPostcardResponse200To:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        cancel_postcard_response_200_to = cls(
        ...
        cancel_postcard_response_200_to.additional_properties = d
        return cancel_postcard_response_200_to
