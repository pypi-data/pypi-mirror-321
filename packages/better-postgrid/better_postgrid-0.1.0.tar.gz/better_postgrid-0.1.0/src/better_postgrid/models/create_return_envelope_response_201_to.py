...
T = TypeVar("T", bound="CreateReturnEnvelopeResponse201To")


@_attrs_define
class CreateReturnEnvelopeResponse201To:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        create_return_envelope_response_201_to = cls(
        ...
        create_return_envelope_response_201_to.additional_properties = d
        return create_return_envelope_response_201_to
