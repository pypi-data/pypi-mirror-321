...
T = TypeVar("T", bound="ListReturnEnvelopeOrdersResponse200DataItem")


@_attrs_define
class ListReturnEnvelopeOrdersResponse200DataItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        list_return_envelope_orders_response_200_data_item = cls(
        ...
        list_return_envelope_orders_response_200_data_item.additional_properties = d
        return list_return_envelope_orders_response_200_data_item
