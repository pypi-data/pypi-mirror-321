...
T = TypeVar("T", bound="GetSelfMailerResponse200FromMetadata")


@_attrs_define
class GetSelfMailerResponse200FromMetadata:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_self_mailer_response_200_from_metadata = cls(
            county=county,
        ...
        get_self_mailer_response_200_from_metadata.additional_properties = d
        return get_self_mailer_response_200_from_metadata
