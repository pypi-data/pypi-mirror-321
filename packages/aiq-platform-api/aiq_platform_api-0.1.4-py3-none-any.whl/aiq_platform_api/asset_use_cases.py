...
from .common_utils import (AttackIQRestClient, AttackIQLogger, AssetUtils, TagUtils, TaggedItemUtils, AssetStatus, )
...
def main():
    ...
    if asset_id:
        ...
        logger.warning("ATTACKIQ_ASSET_UUID environment variable is not set. Skipping asset-specific operations.")
