...
setup(
    ...
    install_requires=[
        "aurm-python-sdk @ https://artifactory.prod.aue1k.saasure.net/ui/api/v1/download/contentBrowsing/eng-services-python/aurm-python-sdk/1.0.1/aurm_python_sdk-1.0.1-py3-none-any.whl"
    ],
    python_requires=">3.5",
)
