...
bot = ZohencelmlBot()  # No key passed, will use default key
temps = Templates(groq_api=bot.get_groq_api_key())
...
models_folder_path = os.path.join(current_file_location, 'utils')
