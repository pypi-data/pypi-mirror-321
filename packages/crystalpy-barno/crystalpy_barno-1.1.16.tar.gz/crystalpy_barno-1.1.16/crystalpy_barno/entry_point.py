...
def generate_report(report_type, filename, output_path, parameters, formulas, file_type=FileTypes.PDF):
    report = ReportFactory.create_report(report_type, filename, output_path, parameters, formulas)
