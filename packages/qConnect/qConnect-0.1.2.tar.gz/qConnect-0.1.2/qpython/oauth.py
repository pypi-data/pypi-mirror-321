...
def retrieve_tokens_AZURE_pkce(TENANT_ID = "", CLIENT_ID = "", KDB_SCOPE = "", tokens = {}, REDIRECT_PORT = 5000):
    ...
    #check if we already have tokens, and if they are expired, retrieve new tokens using teh refresh token
    if tokens:
    ...
    print("OAuthCallbackHandler.auth_code: ", OAuthCallbackHandler.auth_code)
    print("OAuthCallbackHandler.error: ", OAuthCallbackHandler.error)
