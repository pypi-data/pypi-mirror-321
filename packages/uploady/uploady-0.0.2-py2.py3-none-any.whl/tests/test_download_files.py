...
from uploady.download_files import pipe_file, CHUNK_FILE_SIZE, JoinStrategyBase, UnionJoinStrategy, \
...
class TestUnionJoinStrategy(unittest.TestCase):
    ...
    @patch("uploady.download_files.JoinStrategyBase.add_download_file")
    ...
    @patch('builtins.open')
    @patch('uploady.download_files.os')
    @patch('uploady.download_files.pipe_file')
...
class TestGetJoinStrategy(unittest.TestCase):
    def test_get_join_strategy(self):
        ...
        with patch("uploady.download_files.JOIN_STRATEGIES", strategies):
...
class TestJoinDownloadSplitFiles(unittest.TestCase):
    @patch("uploady.download_files.get_join_strategy")
