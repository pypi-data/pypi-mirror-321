...
from uploady.caption_formatter import Duration, FileSize, FileMedia, FilePath, CHUNK_SIZE, CaptionFormatter, \
    test_caption_format
...
class TestFileMedia(unittest.TestCase):
    ...
    @patch("uploady.caption_formatter.video_metadata")
...
class TestFilePath(unittest.TestCase):
    ...
    @patch("uploady.caption_formatter.hashlib")
    ...
    @patch("uploady.caption_formatter.os.stat")
    ...
    @patch("uploady.caption_formatter.datetime")
    ...
    @patch("uploady.caption_formatter.FileSize")
    @unittest.skipIf(sys.version_info < (3, 8), "Python 3.7 is not supported.")
    ...
    @patch("uploady.caption_formatter.FileMedia")
    ...
    @patch("uploady.caption_formatter.mimetypes")
    ...
    @patch("uploady.caption_formatter.Path.cwd")
...
class TestTestCaptionFormat(unittest.TestCase):
    ...
    @patch("uploady.caption_formatter.print")
