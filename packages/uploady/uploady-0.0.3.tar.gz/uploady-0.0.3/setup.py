...
URL = 'https://github.com/ankit-chaubey/uploady/'

PACKAGE_NAME = 'uploady'
PACKAGE_DOWNLOAD_URL = 'https://github.com/ankit-chaubey/uploady/archive/master.zip'
MODULE = 'uploady'
...
setup(
    ...
    entry_points={
        "console_scripts": [
            "uploady = uploady.management:upload_cli",
            "telegram-download = uploady.management:download_cli",
        ],
    },
