...
from peek_core_docdb._private.server.controller.ImportController import (
    ImportController,
)
...
class DocDbApi(DocDbApiABC):
    ...
    def createOrUpdateDocuments(
        self, documentsEncodedPayload: bytes
    ) -> Deferred:
        return self._importController.createOrUpdateDocuments(
            documentsEncodedPayload
        )
