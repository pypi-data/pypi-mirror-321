...
from annolid import configs as auto_labeling_configs
from .types import AutoLabelingResult
from .utils import GenericWorker

from annolid.configs import get_config, save_config
...
class ModelManager(QObject):
    ...
    def _load_model(self, model_id):
        ...
        if model_config["type"] == "grounding_sam":
            from annolid.segmentation.SAM.grounded_sam import GroundingSAM
