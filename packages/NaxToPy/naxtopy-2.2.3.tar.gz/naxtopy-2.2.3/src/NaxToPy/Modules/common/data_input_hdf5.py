...
class DataEntry:
    ...
    def __init__(self):
        ...
        self._results_name_type: str = "ELEMENT"
    ...
    # Method to obtain the Results type --------------------------------------------------------------------------------
    @property 
    def ResultsNameType (self) -> Literal["ELEMENT", "CORNER", "NODE"]: 
    ...
    def ResultsNameType(self, value: Literal["ELEMENT", "CORNER", "NODE"]) -> None: 
        if type(value) == str: 
            if value == "ELEMENT" or value == "CORNER" or value == "NODE": 
