...
class AllowablesORTO(Allowables):
    def __init__(self):
        super().__init__()
        self._xcompressive: float = None
        self._ycompressive: float = None
        self._xtensile: float= None
        self._ytensile: float = None
...
class Orthotropic(Material):
    ...
    def __init__(self, n2p_material: N2PMaterial):
        ...
        if n2p_material:
            if isinstance(n2p_material,N2PMaterial):
                self._n2p_material = n2p_material
                if n2p_material.MatType == 'MAT8' or n2p_material.MatType == 'ORTHOTROPIC':
