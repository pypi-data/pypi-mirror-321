            ...
            if cpython_version in link:
                ...
                if content is not None:
                    ...
                    if searched is not None:
                        yield searched.group(1), searched.group(2), searched.group(3), link
...
if _system == 'Linux':
    ...
    def make_natten_package_command(natten_version, executable = sys.executable, is_link_mode = True, need_combined_version = False):
        ...
        torch_versions, torch_simple_versions, cuda_simple_versions, links = map(list, zip(*generate_possible_natten_versions(cpython_version, natten_version)))
    ...
    def make_natten_package_command(natten_version, executable = sys.executable, is_link_mode = False, need_combined_version = False):
