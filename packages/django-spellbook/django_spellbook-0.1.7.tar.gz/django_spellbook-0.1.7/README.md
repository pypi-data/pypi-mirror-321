...
- Each markdown file is read and converted to HTML using Spellbook's markdown parser, which supports Django-like tags and Spellblocks for more flexible styling and layout options.
