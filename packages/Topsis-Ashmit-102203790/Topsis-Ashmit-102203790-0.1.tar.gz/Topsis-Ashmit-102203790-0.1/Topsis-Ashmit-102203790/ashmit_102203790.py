...
class Topsis:
    def validate_inputs(self, weights, impacts, num_criteria):
        try:
    ...
    def topsis(self, input_file, weights, impacts, output_file):
        try:
        ...
        weights, impacts = self.validate_inputs(weights, impacts, num_criteria)
...
if __name__ == "__main__":
    ...
    topsis = Topsis()
    topsis.topsis(input_file, weights, impacts, output_file)
