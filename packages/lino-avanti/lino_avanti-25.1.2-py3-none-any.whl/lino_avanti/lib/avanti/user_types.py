...
class Coordinator(SiteUser, CoursesUser, OfficeOperator, CheckdataUser,
                  ClientsNameUser, DataExporter):
    pass


class Secretary(SiteUser, CoursesUser, OfficeUser, OfficeOperator,
...
class SocialWorker(SiteUser, CoachingsUser, CoursesUser, ContactsUser,
                   ...
                   ClientsUser, Explorer, PollsUser, CheckdataUser):
    pass
...
class SiteStaff(SiteUser, CoachingsStaff, CoursesUser, ContactsStaff,
                ...
                ClientsStaff, Explorer, PollsStaff, CheckdataUser):
    pass
