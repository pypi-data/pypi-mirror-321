...
class ComputeScore:
    def __init__(self, primary_model_path, p808_model_path) -> None:
        self.onnx_sess = ort.InferenceSession(primary_model_path, providers=providers) # , 'CPUExecutionProvider'
        self.p808_onnx_sess = ort.InferenceSession(p808_model_path, providers=providers) # , 'CPUExecutionProvider'
