...
class AlarmModel(BaseModel):
    ...
    created_at: Annotated[str, "告警发生的时间"] = Field(default_factory=timestamp_to_utc_format_date_string)
    updated_at: Annotated[str, "告警入库的时间"] = Field(default_factory=timestamp_to_utc_format_date_string)
