...
if config.ENABLE_LANGCHAIN:
    BT_INTERCEPTORS += ('langchain_openai.llms.base', frameworks.intercept_langchain_openai_llms),
    BT_INTERCEPTORS += ('langchain_openai.embeddings.base', frameworks.intercept_langchain_openai_embeddings),
    BT_INTERCEPTORS += ('langchain_openai.chat_models.base',
                        frameworks.intercept_langchain_openai_chat_models),
