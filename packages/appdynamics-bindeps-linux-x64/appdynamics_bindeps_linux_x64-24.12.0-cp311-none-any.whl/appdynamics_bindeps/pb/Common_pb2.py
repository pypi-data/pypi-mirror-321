...
_NAMEKEYVALUEPAIR = _descriptor.Descriptor(
  name='NameKeyValuePair',
  full_name='appdynamics.pb.Common.NameKeyValuePair',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='appdynamics.pb.Common.NameKeyValuePair.name', index=0,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='keyValuePair', full_name='appdynamics.pb.Common.NameKeyValuePair.keyValuePair', index=1,
...
_NAMEKEYVALUEPAIR.fields_by_name['keyValuePair'].message_type = _NAMEVALUEPAIR
...
DESCRIPTOR.message_types_by_name['NameKeyValuePair'] = _NAMEKEYVALUEPAIR
...
NameKeyValuePair = _reflection.GeneratedProtocolMessageType('NameKeyValuePair', (_message.Message,), dict(
  DESCRIPTOR = _NAMEKEYVALUEPAIR,
  __module__ = 'Common_pb2'
  # @@protoc_insertion_point(class_scope:appdynamics.pb.Common.NameKeyValuePair)
  ))
_sym_db.RegisterMessage(NameKeyValuePair)
