...
class Intercept:
    def __init__(self,tab: MixTab, chromium: Chromium):
        ...
        self._driver.run("Network.setRequestInterception",
                patterns = [
                    ...
                    # },
                    {
                        'urlPattern': '*://www.genspark.ai/_nuxt/DZ9J2WiB.js',  # 精确拦截目标 JS 文件
                        'resourceType': 'Script',
    ...
    def route(self, **kwargs):
        ...
        if 'DZ9J2WiB.js' in url:
            self.DZ9J2WiB_intercepted(**kwargs)
    ...
    def DZ9J2WiB_intercepted(self,**kwargs):
        ...
        if kwargs.get('responseHeaders') and body['base64Encoded']:
            ...
            count = content.find(find_content)
            if count != -1:
