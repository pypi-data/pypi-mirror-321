...
def AddMultibodyPlantConstraints(plant: pydrake.multibody.plant.MultibodyPlant, q: numpy.ndarray[object[m, 1]], prog: pydrake.solvers.MathematicalProgram, plant_context: pydrake.systems.framework.Context) -> list[pydrake.solvers.BindingTConstraintU]: ...
@overload
