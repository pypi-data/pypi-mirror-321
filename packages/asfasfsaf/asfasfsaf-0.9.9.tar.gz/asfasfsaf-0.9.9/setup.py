...
setup(
    name='asfasfsaf',  # Название вашей библиотеки
    version=version,  # Версия
    author='Daniil_Viktorovich',  # Ваше имя
    author_email='daniil789p@gmail.com',  # Ваш email
    packages=['asfasfsaf'],  # Найти все пакеты
    install_requires=['psycopg2'],  # Список зависимостей
    description='A simple example library',  # Краткое описание
    long_description='asfasfsaf',  # Длинное описание
    #long_description_content_type='text/markdown',  # Формат длинного описания
    url='https://github.com/DanikPryanik71/my_library',  # URL на ваш репозиторий
    download_url= 'https://github.com/DanikPryanik71/my_library/archive/v{}.zip'.format(version),
