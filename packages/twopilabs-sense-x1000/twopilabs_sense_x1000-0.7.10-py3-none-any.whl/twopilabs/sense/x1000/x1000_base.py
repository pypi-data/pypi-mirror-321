    ...
    class AcqDType(Enum):
        ...
        def info(self) -> 'SenseX1000Base.AcqDTypeInfo':
            ...
            return {
                ...
                self.F64DTMA7LE.value: SenseX1000Base.AcqDTypeInfo(
                    min=None, max=None, mag=None, np=np.dtype(([('dist', '<f8'), ('time', '<f8'), ('mag', '<f8'), ('angle', '<f8')], (7,)))),
                self.F64DTMA8LE.value: SenseX1000Base.AcqDTypeInfo(
                    min=None, max=None, mag=None, np=np.dtype(([('dist', '<f8'), ('time', '<f8'), ('mag', '<f8'), ('angle', '<f8')], (8,)))),
            }[self.value]
