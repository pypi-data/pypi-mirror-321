...
class AssignmentBase:
    ...
    def from_partial_json(obj: dict):
        return AssignmentBase(
            ...
            division=DivisionConfig.from_json(obj['division']) if 'division' in obj else None,
    ...
    def from_json_or_default(default, obj: dict):
        return AssignmentBase(
            ignored_submissions=obj.get('ignoredSubmissions', default.ignored_submissions),
            draft_feedback=obj.get('draftFeedback', default.draft_feedback),
            default_code_block_language=obj.get('defaultCodeBlockLanguage', default.default_code_block_language),
            division=DivisionConfig.from_json(obj['division']) if 'division' in obj else default.division,
...
class Config:
    ...
    @staticmethod
    def from_json(obj: dict):
        assignment_defaults = AssignmentBase.from_partial_json(obj['assignmentDefaults'])
        ...
        return Config(
            ...
            assignments={id_: AssignmentConfig.from_json(id_, assignment_defaults, obj['assignments'][id_]) for id_ in
                         obj['assignments']},
            graders={id_: GraderConfig.from_json(id_, obj['graders'][id_]) for id_ in obj['graders']},
