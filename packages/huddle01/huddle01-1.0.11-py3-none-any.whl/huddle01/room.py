        ...
        try:
            ...
            for peer in room_info.peers:
                ...
                for remote_producer in remote_producers:
                    logger.debug(
                        "[ Emitting ] Remote Producer Added", remote_producer.label, remote_producer.producer_id
                    )

                    self.emit(RoomEvents.RemoteProducerAdded, RoomEventsData.RemoteProducerAdded(
