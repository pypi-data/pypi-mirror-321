...
class SubClip:
    ...
    def __init__(self, video: Clip):
        ...
        self._positions = [('center', 'center') for _ in range(video.n_frames)]
    ...
    def _apply_speed_factor(self, video):
        ...
        def _get_frame_ts_applying_speed_factors(self: SubClip):
            ...
            while current_frame_index < self.number_of_frames:
                ...
                if current_speed_factor < 1:
                    ...
                    if not PythonValidator.is_number(self._zoom):
                        zoom.extend([self._zoom[current_frame_index]] * times_to_append)
            ...
            return final_video_frame_ts, final_audio_frame_ts, resizes, positions, rotations, zoom

        final_video_frame_ts, final_audio_frame_ts, resizes, positions, rotations, zoom = _get_frame_ts_applying_speed_factors(self)
        ...
        self._zoom = zoom if not PythonValidator.is_number(self._zoom) else self._zoom
    ...
    def _process(self):
        ...
        # TODO: Position must be depending on resized because
        # position is the center and we need to calculate the
        # upper left corner
