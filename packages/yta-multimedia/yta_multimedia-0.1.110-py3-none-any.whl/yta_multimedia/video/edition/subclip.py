...
class VideoAttributeModifier:
    ...
    def __init__(self, modifier: Union[any, 'VideoSetting', 'Graphic']):
...
class SubClip:
    ...
    def color_temperature(self, value: VideoAttributeModifier):
        """
    ...
    @brightness.setter
    def brightness(self, value: VideoAttributeModifier):
        _validate_is_video_attribute_modifier_instance(value)
    ...
    @contrast.setter
    def contrast(self, value: VideoAttributeModifier):
        _validate_is_video_attribute_modifier_instance(value)
    ...
    @sharpness.setter
    def sharpness(self, value: VideoAttributeModifier):
        _validate_is_video_attribute_modifier_instance(value)
    ...
    def white_balance(self, value: VideoAttributeModifier):
        _validate_is_video_attribute_modifier_instance(value)
    ...
    @speed_factor.setter
    def speed_factor(self, value: VideoAttributeModifier):
        _validate_is_video_attribute_modifier_instance(value)
    ...
    def set_color_temperature(self, start: int, end: Union[int, None] = None, rate_function: mRateFunction = mRateFunction.LINEAR):
        ...
        frames.
        """
        self.color_temperature = VideoAttributeModifier(
            VideoSetting(
                start,
    ...
    def set_brightness(self, start: int, end: Union[int, None] = None, rate_function: mRateFunction = mRateFunction.LINEAR):
        ...
        frames.
        """
        self.brightness = VideoAttributeModifier(
            VideoSetting(
                start,
                start if end is None else end,
                mRateFunction.to_enum(rate_function)
    ...
    def set_contrast(self, start: int, end: Union[int, None] = None, rate_function: mRateFunction = mRateFunction.LINEAR):
        ...
        frames.
        """
        self.contrast = VideoAttributeModifier(
            VideoSetting(
                start,
                start if end is None else end,
                mRateFunction.to_enum(rate_function)
    ...
    def set_sharpness(self, start: int, end: Union[int, None] = None, rate_function: mRateFunction = mRateFunction.LINEAR):
        ...
        frames.
        """
        self.sharpness = VideoAttributeModifier(
            VideoSetting(
                start,
                start if end is None else end,
                mRateFunction.to_enum(rate_function)
    ...
    def set_white_balance(self, start: int, end: Union[int, None] = None, rate_function: mRateFunction = mRateFunction.LINEAR):
        ...
        frames.
        """
        self.white_balance = VideoAttributeModifier(
            VideoSetting(
                start,
                start if end is None else end,
                mRateFunction.to_enum(rate_function)
    ...
    def set_speed_factor(self, start: int, end: Union[int, None] = None, rate_function: mRateFunction = mRateFunction.LINEAR):
        ...
        frames.
        """
        self.speed_factor = VideoAttributeModifier(
            VideoSetting(
                start,
                start if end is None else end,
                mRateFunction.to_enum(rate_function)
    ...
    def _process(self):
        ...
        # TODO: Edit speed with speed factors (carefully)
