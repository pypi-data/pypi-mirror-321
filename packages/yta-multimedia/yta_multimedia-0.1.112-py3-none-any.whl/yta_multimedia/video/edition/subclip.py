...
class SubClip:
    ...
    def _apply_speed_factor(self):
        ...
        _, final_video_frame_ts = _get_video_frame_ts_applying_speed_factors(self)
        _, final_audio_frame_ts = _get_video_audio_frame_ts_applying_speed_factors(self)
        ...
        video = video.time_transform(
            lambda t: transform_t_with_both_frames(t, self.video.fps, self.audio.fps), apply_to = ['mask', 'audio']
        )
    ...
    def _process(self):
        ...
        if PythonValidator.is_number(self.speed_factor):
            ...
            video = self._apply_speed_factor()
