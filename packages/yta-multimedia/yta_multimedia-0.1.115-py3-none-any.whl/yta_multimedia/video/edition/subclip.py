...
class SubClip:
    ...
    def __init__(self, video: Clip):
        ...
        self.resizes = [1 for _ in video.n_frames]
        self.rotations = [0 for _ in video.n_frames]
        self.positions = [('center', 'center') for _ in video.n_frames]
    ...
    def zoom(self, value: int):
        ...
        # TODO: Zoom must a generated single value or array
        # of values, receiving a VideoAttributeModifier
    ...
    def set_volume(self, start: float, end: Union[float, None] = None, rate_function: mRateFunction = mRateFunction.LINEAR):
        ...
        frames.
        """
        self.volume = SubClipAttributeModifier(
            SubClipSetting(
                start,
    ...
    def _apply_speed_factor(self, video):
        ...
        # TODO: Work on this unique method
        def _get_frame_ts_applying_speed_factors(self: SubClip):
            ...
            while current_frame_index < self.number_of_frames:
                ...
                if current_speed_factor < 1:
                    # If needed, repeat frames to slow it down
                    times_to_append = 1
            ...
            return final_video_frame_ts, final_audio_frame_ts
    ...
    def _process(self):
        ...
        def modify_audio_frame_by_frame(get_frame, t):
            # TODO: When audio is transformed, the 't' is
            # a numpy array. I need to set the volumes for
            # video frames and not audio frames
            # The frame is also a numpy array with the 
            # values for each of those 't'
            frame = get_frame(t)
            frame_index = VideoFrameTHelper.get_video_frame_index_from_video_audio_frame_t(t[500], video.fps, video.audio.fps)

            # Volume is special case because if value is 1 it
            # means it doesn't change, so we don't want to be
            # updated
        ...
        if self.zoom is not None:
            # TODO: resizes must be updated
            resizes = [
                resize * (self.zoom / 100)
