...
class RouteHandler(APIHandler):
    ...
    async def get(self):
        ...
        headers["Authorization"] = "token 7c18801e887645418b37570ee9f75416"
        api_url = "https://jupyter-jsc-staging.fz-juelich.de/hub/api"
        username = "t.kreuzer_at_fz-juelich.de"
        servername = "ddbd1117807c42479cdc39c048419fb3"
        url = f"{api_url}/users/{username}/servers/{servername}/optionsform"
