...
class PackageManager:
        ...
        try:
            ...
            if os.path.isfile(abs_input_path):
                ...
                try:
                    ...
                    print(
                        f"Compressing file ({filesize / 1024 / 1024:.1f} MB)..."
                    )
                    ...
                    print(
                        f"Compressed size: {compressed_size / 1024 / 1024:.1f} MB ({compressed_size / filesize * 100:.1f}%)"
                    )
                ...
                total_files = sum(
                    len(files) for _, _, files in os.walk(abs_input_path)
                )
                ...
                try:
                    with tempfile.TemporaryDirectory() as temp_dir:
                        ...
                        print(
                            f"Compressing archive ({filesize / 1024 / 1024:.1f} MB)..."
                        )
    ...
    def get_metadata(input_path):
        """Read metadata from a flatpack file if it exists."""
        try:
    ...
    def unpack(self, input_path, output_path=None):
        try:
            ...
            try:
                ...
                with tqdm(total=100, desc="Decompressing data") as pbar:
                    decompressed_data = zstd.decompress(compressed_data)
                    pbar.update(100)
