...
def test_pycfs_arguments_exist_and_are_set(dummy_pycfs_obj, dummy_params):
    ...
    assert dummy_pycfs_obj.track_results == dummy_params.track_results
...
def test_pycfs_default_arguments(default_pycfs_obj, default_params):
    ...
    assert default_pycfs_obj.track_results == default_params.track_results
...
def test_init_filenames(default_pycfs_obj):
    ...
    assert default_pycfs_obj.cfs_file_init == f"{DEFAULT_TEMPLATES_PATH}{DEFAULT_PROJECT}_{temp_ext}.{XML_EXT}"
    assert default_pycfs_obj.mat_file_init == f"{DEFAULT_TEMPLATES_PATH}{mat_file_name}_{temp_ext}.{XML_EXT}"
    assert default_pycfs_obj.jou_file_init == f"{DEFAULT_TEMPLATES_PATH}{DEFAULT_PROJECT}_{temp_ext}.{JOU_EXT}"
