...
class CFSMeshData:
    ...
    def split_regions_by_connectivity(self, result_data: CFSResultData | None = None, regions: list[CFSRegData] | None = None):
        ...
        if result_data is not None:
            ...
            all_new_result_data = CFSResultData(analysis_type=new_result_data_arrays[0].AnalysisType, data=new_result_data_arrays)
        else:
