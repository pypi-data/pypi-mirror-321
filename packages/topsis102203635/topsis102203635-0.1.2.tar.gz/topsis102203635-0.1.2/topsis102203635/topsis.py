...
class Topsis:
    ...
    def calculate(self):
        ...
        distance_ideal = self.calculate_distance(norm_df, ideal_solution, self.distance_metric)
        distance_negative_ideal = self.calculate_distance(norm_df, negative_ideal_solution, self.distance_metric)
