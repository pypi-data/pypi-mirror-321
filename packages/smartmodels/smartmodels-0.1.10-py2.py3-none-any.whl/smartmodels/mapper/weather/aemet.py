...
from ...model.weather.meteo import ObservationData, WarningArea, WarningData

class ObservationDataMapper(Mapper):
    PYDANTIC = ObservationData
    ...
    wind_speed_average = "vv", FLOAT, None
    ...
    insolation = "inso", FLOAT, None
    visibility = "vis", FLOAT, None




class WarningAreaMapper(Mapper):
    PYDANTIC = WarningArea
...
class WarningDataMapper(WarningAreaMapper):
    PYDANTIC = WarningData
