...
INTERFACE_PROMPT = f"""
The tool need to know which network interface to run the protocol stack on.

NOTE: This preferable should not be your main network card,
