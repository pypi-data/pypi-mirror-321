...
from nwgraph.graph import Graph
from nwgraph.nodes import DimNode
from nwgraph.logger import nwg_logger as logger
from nwgraph.message_passing import PathwayListMessagePassing
from nwgraph.message_passing.pathway_list_message_passing import MessagePassingType, NodeStatesType
from nwgraph.pathway import ConvergingPathways, PathwayList
from nwgraph.utils import EdgeIndex

from .utils import MeanEnsemble, SumEnsemble, MedianEnsemble, MpModels, EnsembleFn, AggFnsType, EnsembleType, \
    ModelOrLazyModel
...
class PathwayListMp(PathwayListMessagePassing):
    ...
    def message_pass(self) -> MessagePassingType:
        ...
        node_states: NodeStatesType = self.node_states
        ...
        for t in range(1, self.n_steps + 1):
            ...
            if t != self.n_steps:
                node_states = self.update(self.aggregate(node_messages))
