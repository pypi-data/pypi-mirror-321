...
def graph_subgraph(self: "Graph", edge_names_or_indexes: list[str] | list[EdgeIndex], prune_nodes: bool) -> "Graph":
    ...
    if prune_nodes:
        ...
        # Note: n_nodes_set and node states is reset here.
        # TODO: Is there any way to return a view in the original graph?
        self_copy._node_states = tr.FloatTensor([tr.nan] * len(self_copy.nodes))
        self_copy._n_nodes_set = 0
