...
setuptools.setup(
    name='pollination-imageless-annual-glare',                              # will be used for package name unless it is overwritten using __queenbee__ info.
    ...
    url='https://github.com/pollination/imageless-annual-glare',                   # will be translated to home
    project_urls={
    ...
    description='Imageless annual glare recipe for Pollination.',                  # will be used as package description
    ...
    keywords='honeybee, radiance, ladybug-tools, daylight, imageless-annual-glare',# will be used as keywords
