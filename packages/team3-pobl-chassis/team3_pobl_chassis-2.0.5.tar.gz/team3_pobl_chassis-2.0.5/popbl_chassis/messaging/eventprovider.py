...
class EventProvider:
    ...
    async def create(cls, rabbitmq_hosts, rabbitmq_user, rabbitmq_password, logger: logging.Logger, exchange_name: str = 'events'):
        ...
        self.ssl_context = ssl.create_default_context(cafile="./certificates/certs/cacert.pem")
        self.ssl_context.load_cert_chain(certfile="./certificates/certs/rabbitmq.pem", keyfile="./certificates/private/rabbitmq.pem")
