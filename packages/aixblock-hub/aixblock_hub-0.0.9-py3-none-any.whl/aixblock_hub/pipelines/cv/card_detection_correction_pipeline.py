...
from aixblock_hub.pipelines.cv.ocr_utils.model_resnet18_half import \
    CardDetectionCorrectionModel
from aixblock_hub.pipelines.cv.ocr_utils.table_process import (
...
class CardDetectionCorrection(Pipeline):
    ...
    >>> detector("https://app.aixblock.io/test/images/card_detection_correction.jpg")
    >>>   {
