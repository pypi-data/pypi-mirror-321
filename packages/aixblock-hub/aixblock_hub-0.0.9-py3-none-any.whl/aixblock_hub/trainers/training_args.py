...
from aixblock_hub.trainers.cli_argument_parser import CliArgumentParser
...
class TrainArgs:
    ...
    hub_token: str = field(
        ...
        metadata={
            'help':
            'The modelhub token, you can also set the token to the env variable `AIXBLOCK_API_TOKEN`',
...
def build_dataset_from_file(filename):
    ...
    """
    from aixblock import MsDataset
    train_set = []
    eval_set = []
