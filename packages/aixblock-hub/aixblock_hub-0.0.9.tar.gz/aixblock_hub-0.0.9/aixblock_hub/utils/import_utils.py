...
from aixblock_hub.utils.ast_utils import (INDEX_KEY, MODULE_KEY, REQUIREMENT_KEY,
                                        load_index)
from aixblock_hub.utils.error import *  # noqa
...
class LazyImportModule(ModuleType):
    ...
    def _get_module(self, module_name: str):
        try:
            ...
            if not any(
                    module_name_full.startswith(f'aixblock_hub.{prefix}')
