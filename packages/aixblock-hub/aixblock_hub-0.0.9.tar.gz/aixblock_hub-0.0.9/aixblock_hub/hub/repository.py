...
from aixblock_hub.hub.errors import GitError, InvalidParameter, NotLoginException
...
class Repository:
    ...
    def __init__(self,
        ...
        """Instantiate a Repository object by cloning the remote AIxBlockHub repo

        Args:
            model_dir (str): The model root directory.
            clone_from (str): model id in aixblock-hub from which git clone
        ...
        if auth_token:
            ...
            self.auth_token = aixblockConfig.get_token()
...
class DatasetRepository:
    ...
    def __init__(self,
                 ...
                 git_path: Optional[str] = None):
        """
        Instantiate a Dataset Repository object by cloning the remote aixblock dataset repo

        Args:
            repo_work_dir (str): The dataset repo root directory.
            dataset_id (str): dataset id in aixblock from which git clone
