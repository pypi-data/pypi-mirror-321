...
class PlugMentalForSequenceClassification(PlugMentalPreTrainedModel):
    ...
    Preprocessor:
        ...
        is `aixblock.preprocessors.TextClassificationTransformersPreprocessor`.
    ...
    Parameters:
        config (:class:`~aixblock.models.nlp.plug_mental.PlugMentalConfig`): Model configuration class with
    ...
    def forward(self,
        ...
        Returns:
            Returns `aixblock.outputs.AttentionTextClassificationModelOutput`
        """
