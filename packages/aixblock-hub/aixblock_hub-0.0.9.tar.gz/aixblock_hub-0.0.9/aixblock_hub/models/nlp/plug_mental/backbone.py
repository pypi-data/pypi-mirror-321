...
from aixblock_hub.outputs import AttentionBackboneModelOutput
from aixblock_hub.utils.constant import Tasks
from aixblock_hub.utils.logger import get_logger
from aixblock_hub.utils.nlp.utils import parse_labels_in_order
...
class PlugMentalModel(PlugMentalPreTrainedModel):
    ...
    Parameters:
        config (:class:`~aixblock.models.nlp.plug_mental.SbertConfig`): Model configuration class with
    ...
    def forward(self,
        ...
        Returns:
            Returns `aixblock.outputs.AttentionBackboneModelOutputWithEmbedding`
