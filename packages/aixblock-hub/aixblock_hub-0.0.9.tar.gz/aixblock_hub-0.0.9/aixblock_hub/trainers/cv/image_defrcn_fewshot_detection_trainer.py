...
from aixblock_hub.models.cv.image_defrcn_fewshot.evaluation.evaluator import \
...
class DefaultTrainer(SimpleTrainer):
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        ...
        if evaluator_type == 'coco':
            from aixblock_hub.models.cv.image_defrcn_fewshot.evaluation.coco_evaluation import COCOEvaluator
            evaluator_list.append(
                COCOEvaluator(dataset_name, True, output_folder))
        if evaluator_type == 'pascal_voc':
            from aixblock_hub.models.cv.image_defrcn_fewshot.evaluation.pascal_voc_evaluation import PascalVOCEvaluator
...
class ImageDefrcnFewshotTrainer(BaseTrainer):
    ...
    def model_surgery(cls,
        ...
        from aixblock_hub.models.cv.image_defrcn_fewshot.utils.model_surgery_op import model_surgery as _model_surgery
