...
from aixblock_hub.models.cv.video_frame_interpolation.utils.scene_change_detection import \
    do_scene_detect
from aixblock_hub.models.cv.video_frame_interpolation.VFINet_for_video_frame_interpolation import \
...
class VideoFrameInterpolationPipeline(Pipeline):
    ...
    >>> video = 'https://app.aixblock.io/test/videos/video_frame_interpolation_test.mp4'
