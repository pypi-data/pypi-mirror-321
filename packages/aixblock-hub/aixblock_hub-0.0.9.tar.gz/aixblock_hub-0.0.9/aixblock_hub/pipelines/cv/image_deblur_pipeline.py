...
from aixblock_hub.models.cv.image_deblur import NAFNetForImageDeblur
from aixblock_hub.outputs import OutputKeys
from aixblock_hub.pipelines.base import Input, Pipeline
from aixblock_hub.pipelines.builder import PIPELINES
from aixblock_hub.preprocessors import ImageDeblurPreprocessor, LoadImage
...
class ImageDeblurPipeline(Pipeline):
    ...
    >>> import cv2
    >>>
    >>> img = 'https://app.aixblock.io/test/images/blurry.jpg'
