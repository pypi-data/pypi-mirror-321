...
class ChatGLM6bTextGenerationPipeline(Pipeline):
    ...
    def __init__(self,
                 ...
                 use_bf16=False,
                 **kwargs):
        from aixblock_hub.models.nlp.chatglm.text_generation import (
...
class ChatGLM6bV2TextGenerationPipeline(Pipeline):
    ...
    def __init__(self,
                 ...
                 use_bf16=False,
                 **kwargs):
        from aixblock import AutoTokenizer
...
class QWenChatPipeline(Pipeline):
    ...
    def __init__(self, model: Union[Model, str], **kwargs):
        from aixblock import AutoModelForCausalLM, AutoTokenizer
...
class SeqGPTPipeline(Pipeline):
    ...
    def __init__(self, model: Union[Model, str], **kwargs):
        from aixblock_hub.utils.hf_util import AutoTokenizer
...
class Llama2TaskPipeline(TextGenerationPipeline):
    ...
    def __init__(self,
        ...
        Examples:
            ...
            >>> import torch
            >>> from aixblock_hub.pipelines import pipeline
            >>> from aixblock_hub.hub import snapshot_download, Model
            >>> model_dir = snapshot_download("aixblock/Llama-2-13b-chat-ms",
        ...
        from aixblock_hub.models.nlp.llama2 import Llama2Tokenizer
...
class Llama2chatTaskPipeline(Pipeline):
    """Use `model` and `preprocessor` to create a generation pipeline for prediction.
        ...
        Examples:
            ...
            >>> import torch
            >>> from aixblock_hub.pipelines import pipeline
            >>> from aixblock import Model
            >>> pipe = pipeline(task=Tasks.chat, model="aixblock/Llama-2-7b-chat-ms", device_map='auto',
