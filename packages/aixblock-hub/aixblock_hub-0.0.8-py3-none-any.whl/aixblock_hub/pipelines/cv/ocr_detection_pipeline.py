...
from aixblock_hub.models.cv.ocr_detection import OCRDetection
...
class OCRDetectionPipeline(Pipeline):
    ...
    >>> result = ocr_detection('https://app.aixblock.io/test/images/ocr_detection.jpg')
    ...
    def postprocess(self, inputs: Dict[str, Any]) -> Dict[str, Any]:
        if self.model_type == 'DBNet':
            ...
            if count == 0 or count < rboxes.shape[0]:
                raise Exception('aixblock error: No text detected')
            rboxes = rboxes[:count, :]
