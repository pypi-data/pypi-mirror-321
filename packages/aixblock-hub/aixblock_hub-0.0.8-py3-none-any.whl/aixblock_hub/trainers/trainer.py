...
from aixblock_hub.hub.check_model import check_local_model_is_latest
from aixblock_hub.metainfo import Trainers
from aixblock_hub.metrics import build_metric, task_default_metrics
from aixblock_hub.metrics.prediction_saving_wrapper import \
    PredictionSavingWrapper
from aixblock_hub.models.base import Model, TorchModel
...
from aixblock_hub.outputs import ModelOutputBase
from aixblock_hub.preprocessors.base import Preprocessor
from aixblock_hub.trainers.hooks.builder import HOOKS
from aixblock_hub.trainers.hooks.priority import Priority, get_priority
from aixblock_hub.trainers.lrscheduler.builder import build_lr_scheduler
from aixblock_hub.trainers.optimizer.builder import build_optimizer
from aixblock_hub.utils.config import Config, ConfigDict, JSONIteratorEncoder
from aixblock_hub.utils.constant import (DEFAULT_MODEL_REVISION, ConfigFields,
                                       ConfigKeys, DistributedParallelType,
                                       Invoke, ModeKeys, ModelFile, ThirdParty,
                                       TrainerStages)
from aixblock_hub.utils.data_utils import to_device
from aixblock_hub.utils.device import create_device
from aixblock_hub.utils.file_utils import func_receive_dict_inputs
from aixblock_hub.utils.import_utils import is_swift_available
from aixblock_hub.utils.logger import get_logger
from aixblock_hub.utils.registry import build_from_cfg
from aixblock_hub.utils.torch_utils import (compile_model, get_dist_info,
...
class EpochBasedTrainer(BaseTrainer):
    ...
    def get_data_collator(self, data_collator, remove_unused_data=False):
        ...
        if remove_unused_data:
            from aixblock_hub.utils.data_collators import RemoveColumnsCollator
    ...
    def build_dataset(self,
        ...
        Args:
            ...
            mode (str): `train`, `eval` or `inference`. See aixblock.utils.constant.ModeKeys
    ...
    def set_checkpoint_file_to_hook(self, checkpoint_path, load_all_state,
        ...
        if checkpoint_path is not None:
            from aixblock_hub.trainers.hooks import LoadCheckpointHook
    ...
    def evaluation_loop(self, data_loader, metric_classes):
        ...
        if self._dist:
            from aixblock_hub.trainers.utils.inference import multi_gpu_test
            ...
            from aixblock_hub.trainers.utils.inference import single_gpu_test
