...
from aixblock_hub.models.cv.pedestrian_attribute_recognition.model import \
    PedestrainAttribute
...
class PedestrainAttributeRecognitionPipeline(Pipeline):
    ...
    >>> output = handle('https://app.aixblock.io/test/images/keypoints_detect/000000442836.jpg')
    ```
    """
