...
from aixblock_hub.metainfo import DEFAULT_MODEL_FOR_PIPELINE
from aixblock_hub.models.base import Model
from aixblock_hub.utils.config import ConfigDict, check_config
from aixblock_hub.utils.constant import (DEFAULT_MODEL_REVISION, Invoke, Tasks,
                                       ThirdParty)
...
def pipeline(task: str = None,
    ...
    # TODO: port the swift infer based on transformer into aixblock
