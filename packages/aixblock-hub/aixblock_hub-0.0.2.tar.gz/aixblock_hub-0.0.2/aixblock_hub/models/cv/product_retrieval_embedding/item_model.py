...
from aixblock_hub.models.cv.product_retrieval_embedding.item_detection import \
    YOLOXONNX
from aixblock_hub.models.cv.product_retrieval_embedding.item_embedding import (
