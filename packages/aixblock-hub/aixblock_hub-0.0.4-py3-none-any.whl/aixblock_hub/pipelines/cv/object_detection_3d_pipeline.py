...
from aixblock_hub.models.cv.object_detection_3d.depe import DepeDetect
from aixblock_hub.models.cv.object_detection_3d.depe.result_vis import \
    plot_result
...
class ObjectDetection3DPipeline(Pipeline):
    ...
    def __init__(self, model: str, **kwargs):
        ...
        if os.getenv('AIXBLOCK_ENVIRONMENT') == 'eas':
            self.num_workers = 0
        else:
            self.num_workers = 4
