...
from aixblock_hub.trainers.base import BaseTrainer
...
class FaceDetectionScrfdTrainer(BaseTrainer):
    ...
    def __init__(self,
        ...
        from aixblock_hub.models.cv.face_detection.scrfd.mmdet_patch.datasets import RetinaFaceDataset
        from aixblock_hub.models.cv.face_detection.scrfd.mmdet_patch.datasets.pipelines import DefaultFormatBundleV2
        from aixblock_hub.models.cv.face_detection.scrfd.mmdet_patch.datasets.pipelines import LoadAnnotationsV2
        from aixblock_hub.models.cv.face_detection.scrfd.mmdet_patch.datasets.pipelines import RotateV2
        from aixblock_hub.models.cv.face_detection.scrfd.mmdet_patch.datasets.pipelines import RandomSquareCrop
        from aixblock_hub.models.cv.face_detection.scrfd.mmdet_patch.models.backbones import ResNetV1e
        from aixblock_hub.models.cv.face_detection.scrfd.mmdet_patch.models.dense_heads import SCRFDHead
        from aixblock_hub.models.cv.face_detection.scrfd.mmdet_patch.models.detectors import SCRFD
