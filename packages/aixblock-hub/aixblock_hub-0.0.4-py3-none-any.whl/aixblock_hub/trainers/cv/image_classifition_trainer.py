...
from aixblock_hub.utils.constant import DEFAULT_MODEL_REVISION, Invoke, ModelFile
...
class ImageClassifitionTrainer(BaseTrainer):
    ...
    def __init__(
        ...
        import torch
        import mmcv
        from aixblock_hub.models.cv.image_classification.utils import get_ms_dataset_root, get_classes
        from mmcls.models import build_classifier
        from mmcv.runner import get_dist_info, init_dist
        from mmcls.apis import set_random_seed
        from mmcls.utils import collect_env
        from mmcv.utils import get_logger as mmcv_get_logger
        import aixblock_hub.models.cv.image_classification.backbones
        ...
        mmcv_get_logger('aixblock_hub')  # set name of mmcv logger
    ...
    def train(self, *args, **kwargs):
        ...
        from aixblock_hub.models.cv.image_classification.utils import get_ms_dataset_root, MmDataset, preprocess_transform
    ...
    def evaluate(self,
        ...
        import warnings
        import torch
        from aixblock_hub.models.cv.image_classification.utils import (
