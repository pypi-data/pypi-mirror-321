...
from aixblock_hub.hub.api import aixblockConfig
from aixblock_hub.msdatasets.auth.auth_config import OssAuthConfig
from aixblock_hub.msdatasets.context.dataset_context_config import \
    DatasetContextConfig
from aixblock_hub.msdatasets.data_files.data_files_manager import \
    DataFilesManager
from aixblock_hub.msdatasets.dataset_cls import ExternalDataset
from aixblock_hub.msdatasets.meta.data_meta_manager import DataMetaManager
from aixblock_hub.utils.constant import (DatasetFormations, DatasetPathName,
                                       DownloadMode, VirgoDatasetConfig)
from aixblock_hub.utils.logger import get_logger
from aixblock_hub.utils.url_utils import valid_url
...
class OssDownloader(BaseDownloader):
    ...
    def _authorize(self) -> None:
        ...
        Get credentials from cache and send to the aixblock-hub in the future. """
        cookies = aixblockConfig.get_cookies()
        git_token = aixblockConfig.get_token()
        user_info = aixblockConfig.get_user_info()
    ...
    def _prepare_and_download(self) -> None:
        """ Fetch data-files from aixblock dataset-hub. """
        ...
        if self.builder is None and not dataset_py_script:
            raise f'meta-file: {dataset_name}.py not found on the aixblock hub.'
...
class VirgoDownloader(BaseDownloader):
    ...
    def _authorize(self):
        ...
        from aixblock_hub.msdatasets.auth.auth_config import VirgoAuthConfig
    ...
    def _build(self):
        ...
        """
        from aixblock_hub.msdatasets.dataset_cls.dataset import VirgoDataset
        import pandas as pd
