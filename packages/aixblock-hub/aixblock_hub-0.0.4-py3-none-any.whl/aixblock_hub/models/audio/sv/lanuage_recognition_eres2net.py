...
from aixblock_hub.models import MODELS, TorchModel
from aixblock_hub.models.audio.sv.DTDNN import CAMPPlus
from aixblock_hub.models.audio.sv.DTDNN_layers import DenseLayer
from aixblock_hub.models.audio.sv.ERes2Net import ERes2Net
...
class LanguageRecognitionERes2Net(TorchModel):
    ...
    def forward(self, audio):
        ...
        assert len(audio.shape) == 2, \
            'aixblock error: the shape of input audio to model needs to be [N, T]'
        # audio shape: [N, T]
