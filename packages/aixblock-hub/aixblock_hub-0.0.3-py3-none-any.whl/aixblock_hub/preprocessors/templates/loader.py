...
from aixblock import AutoTokenizer, get_logger, snapshot_download, AutoConfig
...
template_info = [
    ...
    TemplateInfo(
        ...
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/llama3.2-vision',
    ),
    TemplateInfo(
        ...
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/llama3.2',
    ),
    TemplateInfo(
        template=TemplateType.llama3,
        template_regex=
        ...
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/llama3.1',
    ),
    TemplateInfo(
        template_regex=
        f'.*{cases("llama3", "llama-3")}.*{no_multi_modal()}.*{chat_suffix}.*{cases("gradient")}.*',
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/llama3-gradient',
    ),
    TemplateInfo(
        template_regex=
        f'.*{cases("llama3", "llama-3")}.*{no_multi_modal()}.*{cases("groq")}.*{cases("tool-use", "tool_use")}.*',
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/llama3-groq-tool-use',
    ),
    TemplateInfo(
        template_regex=
        f'.*{cases("llama3", "llama-3")}.*{no_multi_modal()}.*{cases("chatqa")}.*',
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/llama3-chatqa',
    ),
    TemplateInfo(
        template_regex=f'.*{cases("llava-llama-3")}.*',
        modelfile_prefix='https://app.aixblock.io/llm_template/ollama/llava-llama3'),
    TemplateInfo(
        template_regex=f'.*{cases("dolphin")}.*{cases("llama3")}.*',
        modelfile_prefix='https://app.aixblock.io/llm_template/ollama/dolphin-llama3'),
    TemplateInfo(
        template=TemplateType.llama3,
        template_regex=
        f'.*{cases("llama3", "llama-3")}{no_multi_modal()}.*{chat_suffix}.*',
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/llama3',
    ),
    ...
    TemplateInfo(
        ...
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/llama2-chinese',
    ),
    TemplateInfo(
        template_regex=
        f'.*{cases("codellama")}.*',
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/codellama',
    ),
    TemplateInfo(
        template_regex=
        f'.*{cases("tinyllama")}.*',
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/tinyllama',
    ),
    TemplateInfo(
        template_regex=
        f'.*{cases("llama-pro", "llama_pro")}.*',
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/llama-pro',
    ),
    TemplateInfo(
        template_regex=
        f'.*{cases("llama")}.*{cases("guard")}.*',
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/llama-guard3',
    ),
    TemplateInfo(
        ...
        f'.*{cases("llama")}{no_multi_modal()}.*{chat_suffix}.*',
                modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/llama2',
    ),
    ...
    TemplateInfo(
        ...
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/qwen2.5-coder',
    ),
    TemplateInfo(
        template=TemplateType.qwen,
        template_regex=f'.*{cases("qwen2.5")}{no_multi_modal()}.*{chat_suffix}.*',
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/qwen2.5',
    ),
    TemplateInfo(
        template_regex=f'.*{cases("qwen2-math")}.*',
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/qwen2-math',
    ),
    TemplateInfo(
        template_regex=
        f'.*{cases("codeqwen1.5", "codeqwen-1.5")}.*{chat_suffix}.*',
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/codeqwen',
    ),
    TemplateInfo(
        template=TemplateType.qwen,
        template_regex=f'.*{cases("qwen2", "qwen1.5")}{no_multi_modal()}.*',
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/qwen2',
    ),
    TemplateInfo(
        template=TemplateType.qwen,
        template_regex=f'.*{cases("qwen")}{no_multi_modal()}.*{chat_suffix}.*',
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/qwen',
    ),
    ...
    TemplateInfo(
        ...
        f'.*{cases("codegemma")}.*',
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/codegemma',
    ),
    TemplateInfo(
        ...
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/gemma2',
    ),
    TemplateInfo(
        template_regex=
        f'.*{cases("shieldgemma")}.*',
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/shieldgemma',
    ),
    TemplateInfo(
        template=TemplateType.gemma,
        template_regex=
        ...
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/gemma',
    ),
    ...
    TemplateInfo(
        ...
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/dolphin-mixtral',
    ),
    TemplateInfo(
        template_regex=
        f'.*{cases("dolphin")}.*{cases("mistral")}.*',
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/dolphin-mistral',
    ),
    ...
    TemplateInfo(
        ...
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/llava-phi3',
    ),
    TemplateInfo(
        template_regex=
        f'.*{cases("phi3.5", "phi-3.5")}{no_multi_modal()}.*{chat_suffix}.*',
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/phi3.5',
    ),
    TemplateInfo(
        ...
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/phi3',
    ),
    TemplateInfo(
        template_regex=
        f'.*{cases("phi")}{no_multi_modal()}.*',
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/phi',
    ),
    ...
    TemplateInfo(
        ...
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/yarn-mistral',
    ),
    TemplateInfo(
        template_regex=
        f'.*{cases("mistral")}.*{cases("large")}.*',
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/mistral-large',
    ),
    TemplateInfo(
        template_regex=
        f'.*{cases("mistral")}.*{cases("small")}.*',
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/mistral-small',
    ),
    TemplateInfo(
        template=TemplateType.mistral_nemo,
        template_regex=f'.*{cases("Mistral-Nemo")}{no_multi_modal()}.*',
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/mistral-nemo',
    ),
    TemplateInfo(
        template_regex=
        f'.*{cases("mistral")}.*{cases("openorca")}.*',
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/mistral-openorca',
    ),
    TemplateInfo(
        template_regex=
        f'.*{cases("mistrallite")}.*',
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/mistrallite',
    ),
    ...
    TemplateInfo(
        ...
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/mistral',
    ),
    ...
    TemplateInfo(
        ...
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/nous-hermes2-mixtral',
    ),
    TemplateInfo(
        template=TemplateType.llama,
        template_regex=
        ...
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/mixtral',
    ),
    ...
    TemplateInfo(
        ...
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/codestral',
    ),
    ...
    TemplateInfo(
        ...
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/nous-hermes2',
    ),
        TemplateInfo(
        template_regex=f'.*{cases("nous-hermes")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/nous-hermes'),
    ...
    TemplateInfo(
        ...
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/deepseek-v2.5',
    ),
    TemplateInfo(
        ...
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/deepseek-coder-v2',
    ),
    TemplateInfo(
        template=TemplateType.deepseek_coder,
        template_regex=
        ...
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/deepseek-coder',
    ),
    TemplateInfo(
        ...
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/deepseek-v2',
    ),
    TemplateInfo(
        ...
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/deepseek-llm',
    ),
    ...
    TemplateInfo(
        ...
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/yi-coder',
    ),
    TemplateInfo(
        ...
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/yi',
    ),
    ...
    TemplateInfo(
        ...
        f'.*{cases("bakllava")}.*',
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/bakllava',
    ),
    TemplateInfo(
        template_regex=
        f'.*{cases("llava")}.*',
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/llava',
    ),
    ...
    TemplateInfo(
        ...
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/nemotron-mini',
    ),
    TemplateInfo(
        template_regex=
        f'.*{cases("nemotron")}.*',
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/nemotron',
    ),
    ...
    TemplateInfo(
        ...
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/minicpm-v'
    ),
    TemplateInfo(
        template=TemplateType.chatml,
    ...
    TemplateInfo(
        ...
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/glm4',
    ),
    ...
    TemplateInfo(
        ...
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/command-r-plus',
    ),
    TemplateInfo(
        template_regex=
        f'.*{cases("command-r")}.*',
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/command-r',
    ),
    ...
    TemplateInfo(
        ...
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/codegeex4',
    ),
    ...
    TemplateInfo(
        ...
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/wizard-vicuna-uncensored',
    ),
    TemplateInfo(
        template_regex=
        f'.*{cases("wizardlm2", "wizardlm-2")}.*',
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/wizardlm2',
    ),
    TemplateInfo(
        template_regex=
        f'.*{cases("wizardcoder")}.*',
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/wizardcoder',
    ),
    TemplateInfo(
        template_regex=
        f'.*{cases("wizard-math", "wizardmath")}.*',
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/wizard-math',
    ),
    TemplateInfo(
        template_regex=
        f'.*{cases("wizardlm")}.*',
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/wizardlm',
    ),
    ...
    TemplateInfo(
        ...
        f'.*{cases("vicuna")}.*',
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/vicuna',
    ),
    ...
    TemplateInfo(
        ...
        f'.*{cases("stable-code")}.*',
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/stable-code',
    ),
    TemplateInfo(
        template_regex=
        f'.*{cases("stablelm")}.*',
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/stablelm2',
    ),
    ...
    TemplateInfo(
        ...
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/internlm2',
    ),
    ...
    TemplateInfo(
        ...
        f'.*{cases("deepseek")}.*{cases("v2")}{no("v2.5")}{no_multi_modal()}.*{chat_suffix}.*',
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/deepseek_v2',
    ),
    ...
    TemplateInfo(
        ...
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/nomic-embed-text'),
    TemplateInfo(
        template_regex=f'.*{cases("mxbai-embed-large")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/mxbai-embed-large'),
    TemplateInfo(
        template_regex=f'.*{cases("starcoder2")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/starcoder2'),
    TemplateInfo(
        template_regex=f'.*{cases("orca-mini", "orca_mini")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/orca-mini'),
    TemplateInfo(
        template_regex=f'.*{cases("zephyr")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/zephyr'),
    TemplateInfo(
        template_regex=f'.*{cases("snowflake-arctic-embed")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/snowflake-arctic-embed'),
    TemplateInfo(
        template_regex=f'.*{cases("starcoder")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/starcoder'),
    TemplateInfo(
        template_regex=f'.*{cases("granite")}.*{cases("code")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/granite-code'),
    TemplateInfo(
        template_regex=f'.*{cases("all-minilm")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/all-minilm'),
    TemplateInfo(
        template_regex=f'.*{cases("openchat")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/openchat'),
    TemplateInfo(
        template_regex=f'.*{cases("aya")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/aya'),
    TemplateInfo(
        template_regex=f'.*{cases("openhermes")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/openhermes'),
    TemplateInfo(
        template_regex=f'.*{cases("reflection")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/reflection'),
    TemplateInfo(
        template_regex=f'.*{cases("neural-chat")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/neural-chat'),
    TemplateInfo(
        template_regex=f'.*{cases("moondream")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/moondream'),
    TemplateInfo(
        template_regex=f'.*{cases("xwin")}.*{cases("lm")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/xwinlm'),
    TemplateInfo(
        template_regex=f'.*{cases("smollm")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/smollm'),
    TemplateInfo(
        template_regex=f'.*{cases("sqlcoder")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/sqlcoder'),
    TemplateInfo(
        template_regex=f'.*{cases("starling-lm")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/starling-lm'),
    TemplateInfo(
        template_regex=f'.*{cases("falcon")}.*{cases("-2")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/falcon2'),
    TemplateInfo(
        template_regex=f'.*{cases("falcon")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/falcon'),
    TemplateInfo(
        template_regex=f'.*{cases("solar-pro")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/solar-pro'),
    TemplateInfo(
        template_regex=f'.*{cases("solar")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/solar'),
    TemplateInfo(
        template_regex=f'.*{cases("orca2", "orca-2", "orca_2")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/orca2'),
    TemplateInfo(
        template_regex=f'.*{cases("hermes3", "hermes-3", "hermes_3")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/hermes3'),
    TemplateInfo(
        template_regex=f'.*{cases("meditron")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/meditron'),
    TemplateInfo(
        template_regex=f'.*{cases("nexusraven")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/nexusraven'),
    TemplateInfo(
        template_regex=f'.*{cases("magicoder")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/magicoder'),
    TemplateInfo(
        template_regex=f'.*{cases("bge-m3")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/bge-m3'),
    TemplateInfo(
        template_regex=f'.*{cases("notux")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/notux'),
    TemplateInfo(
        template_regex=f'.*{cases("open")}.*{cases("orca")}.*{cases("platypus2")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/open-orca-platypus2'),
    TemplateInfo(
        template_regex=f'.*{cases("notus")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/notus'),
    TemplateInfo(
        template_regex=f'.*{cases("mathstral")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/mathstral'),
    TemplateInfo(
        template_regex=f'.*{cases("dbrx")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/dbrx'),
    TemplateInfo(
        template_regex=f'.*{cases("nuextract")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/nuextract'),
    TemplateInfo(
        template_regex=f'.*{cases("reader-lm")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/reader-lm'),
    TemplateInfo(
        template_regex=f'.*{cases("alfred")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/alfred'),
    TemplateInfo(
        template_regex=f'.*{cases("bge-large")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/bge-large'),
    TemplateInfo(
        template_regex=f'.*{cases("paraphrase-multilingual")}.*', 
        modelfile_prefix=
        'https://app.aixblock.io/llm_template/ollama/paraphrase-multilingual'),
