...
from aixblock_hub.utils.input_output_typing import Image
...
class CardDetectionPipeline(Pipeline):
    ...
    >>> detector("http://www.aixblock.cn/api/v1/models/damo/cv_resnet_carddetection_scrfd34gkps/repo?Revision=master"
    ...
    def __init__(self, model: str, **kwargs):
        ...
        Args:
            model: model id on aixblock hub or `ScrfdDetect` Model.
