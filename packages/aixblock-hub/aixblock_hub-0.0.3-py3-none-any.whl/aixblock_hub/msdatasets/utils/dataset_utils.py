...
from aixblock_hub.utils.constant import DEFAULT_DATASET_REVISION, MetaDataFields
...
def get_dataset_files(subset_split_into: dict,
    ...
    for split, info in subset_split_into.items():
        ...
        meta_map[split] = aixblock_api.get_dataset_file_url_origin(
