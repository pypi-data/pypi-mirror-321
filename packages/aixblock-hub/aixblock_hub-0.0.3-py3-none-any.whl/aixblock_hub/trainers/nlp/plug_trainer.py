...
from aixblock_hub.models.nlp.plug import DistributedPlug
from aixblock_hub.models.nlp.plug.backbone import BertLayerNorm
from aixblock_hub.models.nlp.plug.generator import TextGenerator
...
class PlugTrainer(NlpEpochBasedTrainer):
    ...
    def to_parallel(self, model) -> Union[nn.Module, TorchModel]:
        from aixblock_hub.utils.nlp.distributed import DistributedDataParallel as DDP
        return DDP(model)
    ...
    def create_optimizer_and_scheduler(self):
        ...
        from aixblock_hub.models.nlp.plug.AnnealingLR import AnnealingLR
