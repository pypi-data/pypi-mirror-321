...
from aixblock_hub.models.nlp.structbert import (SbertForMaskedLM, SbertModel,
...
class SpaceForDST(SpacePreTrainedModel):
    ...
    def forward(self, input: Dict[str, Tensor]) -> Dict[str, Tensor]:
        ...
        Example:
            ...
            >>> from aixblock_hub.models.nlp import SpaceForDST
            >>> from aixblock_hub.preprocessors import DialogStateTrackingPreprocessor
