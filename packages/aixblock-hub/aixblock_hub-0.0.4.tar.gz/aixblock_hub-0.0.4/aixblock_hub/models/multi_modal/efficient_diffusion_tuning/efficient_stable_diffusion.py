...
from aixblock_hub.models.multi_modal.efficient_diffusion_tuning.sd_lora import \
    LoRATuner
from aixblock_hub.outputs import OutputKeys
from aixblock_hub.utils.checkpoint import save_checkpoint, save_configuration
...
class EfficientStableDiffusion(TorchModel):
    ...
    def __init__(self, model_dir, *args, **kwargs):
        ...
        pretrained_model_name_or_path = kwargs.pop(
            ...
            'AI-aixblock/stable-diffusion-v1-5')
