...
import aixblock_hub.models.multi_modal.videocomposer.models as models
...
from aixblock_hub.models.multi_modal.videocomposer.annotator.sketch import (
    pidinet_bsd, sketch_simplification_gan)
from aixblock_hub.models.multi_modal.videocomposer.autoencoder import \
    AutoencoderKL
from aixblock_hub.models.multi_modal.videocomposer.clip import (
    FrozenOpenCLIPEmbedder, FrozenOpenCLIPVisualEmbedder)
from aixblock_hub.models.multi_modal.videocomposer.diffusion import (
    GaussianDiffusion, beta_schedule)
from aixblock_hub.models.multi_modal.videocomposer.ops.utils import (
    get_first_stage_encoding, make_masked_images, prepare_model_kwargs,
    save_with_model_kwargs)
from aixblock_hub.models.multi_modal.videocomposer.unet_sd import UNetSD_temporal
from aixblock_hub.models.multi_modal.videocomposer.utils.config import Config
from aixblock_hub.models.multi_modal.videocomposer.utils.utils import (
    find_free_port, setup_seed, to_device)
from aixblock_hub.outputs import OutputKeys
from aixblock_hub.preprocessors.image import load_image
    ...
    def __init__(self, model_dir, *args, **kwargs):
        ...
        Args:
            model_dir (`str` or `os.PathLike`)
                Can be either:
                    - A string, the *model id* of a pretrained model hosted inside a model repo on aixblock
                      or aixblock.cn. Valid model ids can be located at the root-level, like `bert-base-uncased`,
