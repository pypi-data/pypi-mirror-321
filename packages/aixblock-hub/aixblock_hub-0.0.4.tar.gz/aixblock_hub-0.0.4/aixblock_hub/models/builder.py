...
from aixblock_hub.utils.import_utils import INDEX_KEY, LazyImportModule
from aixblock_hub.utils.logger import get_logger
from aixblock_hub.utils.registry import Registry, build_from_cfg
from aixblock_hub.utils.task_utils import get_task_by_subtask_name
...
def build_backbone(cfg: ConfigDict, default_args: dict = None):
    ...
    try:
        ...
        # is limited, thus could be added and registered in aixblock directly
        logger.warning(
            f'The backbone {cfg.type} is not registered in aixblock, try to import the backbone from hf transformers.'
        )
