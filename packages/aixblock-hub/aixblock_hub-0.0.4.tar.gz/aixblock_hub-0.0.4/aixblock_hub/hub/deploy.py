...
from aixblock_hub.hub.constants import (API_RESPONSE_FIELD_DATA,
                                      API_RESPONSE_FIELD_MESSAGE)
from aixblock_hub.hub.errors import (NotLoginException, NotSupportError,
...
class DeployServiceParameters(object):
    ...
    Args:
        ...
        model_id: the aixblock model_id
        revision: the aixblock model revision
...
class ServiceDeployer(object):
    ...
    def __init__(self, endpoint=None):
        ...
        self.cookies = aixblockConfig.get_cookies()
