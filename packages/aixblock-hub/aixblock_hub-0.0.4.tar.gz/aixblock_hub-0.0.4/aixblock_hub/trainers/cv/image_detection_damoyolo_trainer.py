...
from aixblock_hub.models.cv.tinynas_detection.damo.apis.detector_evaluater import \
    Evaluater
from aixblock_hub.models.cv.tinynas_detection.damo.apis.detector_inference import \
    inference
from aixblock_hub.models.cv.tinynas_detection.damo.base_models.losses.distill_loss import \
    FeatureLoss
from aixblock_hub.models.cv.tinynas_detection.damo.detectors.detector import (
    build_ddp_model, build_local_model)
from aixblock_hub.models.cv.tinynas_detection.damo.utils import (
    cosine_scheduler, ema_model)
from aixblock_hub.msdatasets.dataset_cls.custom_datasets.damoyolo import (
...
from aixblock_hub.utils.checkpoint import save_checkpoint
from aixblock_hub.utils.constant import (DEFAULT_MODEL_REVISION, ModelFile,
                                       ThirdParty)
from aixblock_hub.utils.logger import get_logger
from aixblock_hub.utils.metric import MeterBuffer
from aixblock_hub.utils.torch_utils import get_rank, synchronize
...
class ImageDetectionDamoyoloTrainer(BaseTrainer):
    ...
    def __init__(self,
        ...
        Args:
            model: Model id of aixblock models.
