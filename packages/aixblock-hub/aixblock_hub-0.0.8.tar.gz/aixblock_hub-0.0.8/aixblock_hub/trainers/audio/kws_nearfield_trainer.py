...
from aixblock_hub.msdatasets.dataset_cls.custom_datasets.audio.kws_nearfield_dataset import \
...
from aixblock_hub.utils.checkpoint import load_checkpoint, save_checkpoint
...
from aixblock_hub.utils.torch_utils import set_random_seed
...
class KWSNearfieldTrainer(BaseTrainer):
    ...
    def __init__(self,
        ...
        '''
        Args:
            model (str): model id in aixblock
