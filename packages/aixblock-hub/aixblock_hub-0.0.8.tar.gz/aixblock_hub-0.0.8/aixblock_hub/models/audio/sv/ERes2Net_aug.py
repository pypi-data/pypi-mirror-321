...
import aixblock_hub.models.audio.sv.pooling_layers as pooling_layers
from aixblock_hub.metainfo import Models
from aixblock_hub.models import MODELS, TorchModel
from aixblock_hub.models.audio.sv.fusion import AFF
...
class SpeakerVerificationERes2Net(TorchModel):
    ...
    def forward(self, audio):
        ...
        assert len(
            audio.shape
        ) == 2, 'aixblock error: the shape of input audio to model needs to be [N, T]'
        # audio shape: [N, T]
