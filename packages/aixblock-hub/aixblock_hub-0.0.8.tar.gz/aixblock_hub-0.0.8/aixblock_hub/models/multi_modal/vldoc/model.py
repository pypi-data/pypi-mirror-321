...
from aixblock_hub.models.multi_modal.vldoc.conv_fpn_trans import FPNTrans
from aixblock_hub.models.multi_modal.vldoc.modeling_layout_roberta import (
    LayoutRobertaModel, LayoutRobertaPreTrainedModel)
from aixblock_hub.models.multi_modal.vldoc.transformer_local import (
    TransformerDecoder, TransformerDecoderLayer)
from aixblock_hub.utils.constant import ModeKeys, ModelFile, Tasks
...
class VLDocForDocVLEmbedding(TorchModel):
    ...
    def __init__(self, model_dir: str, *args, **kwargs):
        ...
        from aixblock_hub.models.multi_modal.vldoc.modeling_layout_roberta import LayoutRobertaConfig
    ...
    def forward(self,
        ...
        To be more specific, please refer to the class `TextLayoutSerializer` in
          `aixblock/models/multi_modal/vldoc/processing.py`.
        """
