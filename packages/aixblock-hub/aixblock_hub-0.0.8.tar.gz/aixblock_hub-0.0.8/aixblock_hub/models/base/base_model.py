...
from aixblock_hub.metainfo import Tasks
from aixblock_hub.models.builder import build_backbone, build_model
from aixblock_hub.utils.automodel_utils import (can_load_by_ms,
...
from aixblock_hub.utils.device import verify_device
        ...
        Args:
            ...
            **kwargs:
                ...
                use_hf(bool, `optional`):
                    ...
                    If set to False, the model is loaded using the aixblock mode.
