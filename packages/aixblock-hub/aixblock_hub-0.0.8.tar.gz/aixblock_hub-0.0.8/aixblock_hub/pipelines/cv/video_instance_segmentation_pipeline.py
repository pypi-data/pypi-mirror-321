...
from aixblock_hub.models.cv.video_instance_segmentation.video_knet import \
    KNetTrack
...
class VideoInstanceSegmentationPipeline(Pipeline):
    ...
    >>> detector("http://www.aixblock.cn/api/v1/models/damo/cv_swinb_video-instance-segmentation/repo?Revision=master"
