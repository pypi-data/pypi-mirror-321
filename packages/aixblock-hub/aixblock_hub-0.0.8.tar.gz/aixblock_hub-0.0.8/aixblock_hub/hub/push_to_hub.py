...
from aixblock_hub.hub.constants import ModelVisibility
from aixblock_hub.utils.constant import DEFAULT_REPOSITORY_REVISION
...
def push_to_hub(repo_name,
    ...
    Args:
        ...
        token: The user api token, function will check the `AIXBLOCK_API_TOKEN` variable if this argument is None
    ...
    assert token is not None, 'Either pass in a token or to set `AIXBLOCK_API_TOKEN` in the environment variables.'
