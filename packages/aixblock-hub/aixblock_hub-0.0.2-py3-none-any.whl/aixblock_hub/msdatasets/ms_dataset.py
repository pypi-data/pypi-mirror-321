...
from aixblock_hub.hub.repository import DatasetRepository
from aixblock_hub.msdatasets.context.dataset_context_config import \
    DatasetContextConfig
from aixblock_hub.msdatasets.data_loader.data_loader_manager import (
    LocalDataLoaderManager, LocalDataLoaderType, RemoteDataLoaderManager,
    RemoteDataLoaderType)
from aixblock_hub.msdatasets.dataset_cls import (ExternalDataset,
                                               NativeIterableDataset)
from aixblock_hub.msdatasets.dataset_cls.custom_datasets.builder import \
    build_custom_dataset
from aixblock_hub.msdatasets.utils.delete_utils import DatasetDeleteManager
from aixblock_hub.msdatasets.utils.hf_datasets_util import load_dataset_with_ctx
from aixblock_hub.msdatasets.utils.upload_utils import DatasetUploadManager
from aixblock_hub.preprocessors import build_preprocessor
from aixblock_hub.utils.config import Config, ConfigDict
from aixblock_hub.utils.config_ds import MS_DATASETS_CACHE
from aixblock_hub.utils.constant import (DEFAULT_DATASET_NAMESPACE,
                                       DEFAULT_DATASET_REVISION, ConfigFields,
                                       DatasetFormations, DownloadMode, Hubs,
                                       ModeKeys, Tasks, UploadMode)
from aixblock_hub.utils.import_utils import is_tf_available, is_torch_available
...
class MsDataset:
    """
    aixblock Dataset (aka, MsDataset) is backed by a huggingface Dataset to
    ...
    remote hubs, particularly, aixblock's own Dataset-hub. MsDataset also
    ...
    def load(
        ...
        hub: Optional[Hubs] = Hubs.aixblock,
        ...
        **config_kwargs,
        ...
        """Load a MsDataset from the aixblock Hub, Hugging Face Hub, urls, or a local dataset.
            ...
            Args:
                ...
                hub (Hubs or str, optional): When loading from a remote hub, where it is from. default Hubs.aixblock
                ...
                custom_cfg (str, Optional): Model configuration, this can be used for custom datasets.
                                           see https://aixblock.cn/docs/Configuration%E8%AF%A6%E8%A7%A3
                token (str, Optional): SDK token of aixblock.
        ...
        # Load from the aixblock hub
        elif hub == Hubs.aixblock:

            # Get dataset type from aixblock Hub;  dataset_type->4: General Dataset
            from aixblock_hub.hub.api import HubApi
            _api = HubApi()
            dataset_id_on_hub, dataset_type = _api.get_dataset_id_and_type(
                dataset_name=dataset_name, namespace=namespace)

            # Load from the aixblock Hub for type=4 (general)
            ...
            from aixblock_hub.msdatasets.data_loader.data_loader import VirgoDownloader
            from aixblock_hub.utils.constant import VirgoDatasetConfig
            ...
            if cache_dir == MS_DATASETS_CACHE:
                from aixblock_hub.utils.config_ds import CACHE_HOME
            ...
            raise 'Please adjust input args to specify a loading mode, we support following scenes: ' \
                  'loading from local disk, huggingface hub and aixblock hub.'
    ...
    def upload(
        ...
        """
        """Upload dataset file or directory to the aixblock Hub. Please log in to the aixblock Hub first.

        Args:
            object_name (str): The object name on aixblock, in the form of your-dataset-name.zip or your-dataset-name
    ...
    def clone_meta(dataset_work_dir: str,
        ...
        """Clone meta-file of dataset from the aixblock Hub.
    ...
    def upload_meta(dataset_work_dir: str,
        ...
        """Upload meta-file of dataset to the aixblock Hub. Please clone the meta-data from the aixblock Hub first.
    ...
    def to_custom_dataset(self,
        ...
        Args:
            ...
            mode (str, Optional): See aixblock.utils.constant.ModeKeys
