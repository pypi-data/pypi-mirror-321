...
from aixblock_hub.msdatasets.data_loader.data_loader import OssDownloader
from aixblock_hub.utils.constant import EXTENSIONS_TO_LOAD
...
class RemoteDataLoaderType(enum.Enum):
    """ Supported data loader types for remote dataset: huggingface, aixblock """
    HF_DATA_LOADER = 'hf_data_loader'
...
class RemoteDataLoaderManager(DataLoaderManager):
    ...
    def load_dataset(self, data_loader_type: enum.Enum):
        ...
        if data_loader_type == RemoteDataLoaderType.HF_DATA_LOADER:
            ...
            return dataset_ret
        # To use the aixblock data loader
