...
from aixblock_hub.models.nlp.structbert import SbertConfig, SbertModel
from aixblock_hub.models.nlp.task_models.task_model import BaseTaskModel
from aixblock_hub.outputs import FaqQuestionAnsweringOutput
...
class SbertForFaqQuestionAnswering(BaseTaskModel):
    ...
    def forward(self, input: Dict[str, Tensor]) -> FaqQuestionAnsweringOutput:
        ...
        Examples:
            ...
            >>> from aixblock_hub.preprocessors import FaqQuestionAnsweringTransformersPreprocessor
            >>> from aixblock_hub.models.nlp import SbertForFaqQuestionAnswering
