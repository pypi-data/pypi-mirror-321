...
from aixblock_hub.models.cv.video_depth_estimation.utils.horovod import on_rank_0
from aixblock_hub.models.cv.video_depth_estimation.utils.load import (
    backwards_state_dict, load_class)
from aixblock_hub.models.cv.video_depth_estimation.utils.misc import make_list
from aixblock_hub.models.cv.video_depth_estimation.utils.types import (is_cfg,
                                                                     is_list)
...
def parse_test_file(ckpt_file, cfg_file=None):
    ...
    cfg_default = 'aixblock/models/cv/video_depth_estimation/configs/default_config'
