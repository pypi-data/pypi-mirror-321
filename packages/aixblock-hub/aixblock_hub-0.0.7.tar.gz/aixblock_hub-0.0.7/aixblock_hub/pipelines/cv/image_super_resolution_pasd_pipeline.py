...
from aixblock_hub.models.cv.image_portrait_enhancement.retinaface import \
    detection
from aixblock_hub.models.cv.image_super_resolution_pasd.misc import (
    load_dreambooth_lora, wavelet_color_fix)
from aixblock_hub.outputs import OutputKeys
from aixblock_hub.pipelines.base import Input, Pipeline
from aixblock_hub.pipelines.builder import PIPELINES
from aixblock_hub.pipelines.multi_modal.diffusers_wrapped.pasd_pipeline import \
...
class ImageSuperResolutionPASDPipeline(Pipeline):
    ...
    def __init__(self, model: str, device_name: str = 'cuda', **kwargs):
        ...
        if version == 'pasd':
            from aixblock_hub.models.cv.image_super_resolution_pasd import (
                ControlNetModel, UNet2DConditionModel)
        else:
            from aixblock_hub.models.cv.image_super_resolution_pasd_v2 import (
                ControlNetModel, UNet2DConditionModel)
