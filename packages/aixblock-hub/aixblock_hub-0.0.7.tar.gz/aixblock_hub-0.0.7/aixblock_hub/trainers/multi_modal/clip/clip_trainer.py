...
from aixblock_hub.models.multi_modal.clip.model import convert_models_to_fp32
from aixblock_hub.msdatasets.ms_dataset import MsDataset
from aixblock_hub.preprocessors.base import Preprocessor
from aixblock_hub.preprocessors.multi_modal import CLIPPreprocessor
from aixblock_hub.trainers import EpochBasedTrainer
from aixblock_hub.trainers.builder import TRAINERS
from aixblock_hub.trainers.default_config import merge_cfg, update_cfg
...
class CLIPTrainer(EpochBasedTrainer):
    ...
    def __init__(
        ...
        # to compatible with aixblock amp training
