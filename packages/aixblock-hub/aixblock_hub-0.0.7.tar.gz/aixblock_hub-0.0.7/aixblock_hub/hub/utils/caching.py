...
from aixblock_hub.hub.constants import (  # noqa
    FILE_HASH, AIXBLOCK_ENABLE_DEFAULT_HASH_VALIDATION)
...
enable_default_hash_validation = \
    os.getenv(AIXBLOCK_ENABLE_DEFAULT_HASH_VALIDATION, 'False').strip().lower() == 'true'
...
class ModelFileSystemCache(FileSystemCache):
    ...
    def __init__(self, cache_root, owner=None, name=None):
        """Put file to the cache
        Args:
            cache_root(`str`): The aixblock local cache root(default: ~/.cache/aixblock/)
