...
from aixblock_hub.utils.ast_utils import INDEX_KEY
...
def fix_upgrade(module_obj: Any):
    ...
    if hasattr(module_obj, '_set_gradient_checkpointing') \
            ...
            and 'aixblock_hub.' in str(module_obj.__class__):
...
def get_default_automodel(config) -> Optional[type]:
    import aixblock_hub.utils.hf_util as hf_util
...
def get_hf_automodel_class(model_dir: str,
    ...
    from aixblock_hub.utils.hf_util import (AutoConfig, AutoModel,
