...
from aixblock_hub.outputs import AttentionTokenClassificationModelOutput
...
class MGeoForTokenClassification(MGeoPreTrainedModel):
    ...
    Preprocessor:
        ...
        is `aixblock.preprocessors.TokenClassificationTransformersPreprocessor`.
    ...
    Trainer:
        ...
        The preferred trainer in aixblock is NlpEpochBasedTrainer.

    Parameters:
        config (:class:`~aixblock.models.nlp.structbert.SbertConfig`): Model configuration class with
    ...
    def forward(
        ...
        sequence_length)`):
            ...
            :class:`~aixblock.models.nlp.structbert.SbertTokenizer`. See
        ...
        Returns:
            Returns `aixblock.outputs.AttentionTokenClassificationModelOutput`
