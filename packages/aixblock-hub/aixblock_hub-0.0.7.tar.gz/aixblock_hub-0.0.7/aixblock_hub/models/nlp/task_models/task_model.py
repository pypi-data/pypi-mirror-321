...
from aixblock_hub.models.builder import build_backbone, build_head
from aixblock_hub.outputs import OutputKeys
from aixblock_hub.utils.checkpoint import load_task_model_checkpoint
...
class EncoderModel(TorchModel):
    ...
    def forward(self,
        ...
        **kwargs:
        ...
        Returns:
            Returns `aixblock.outputs.ModelOutput`
