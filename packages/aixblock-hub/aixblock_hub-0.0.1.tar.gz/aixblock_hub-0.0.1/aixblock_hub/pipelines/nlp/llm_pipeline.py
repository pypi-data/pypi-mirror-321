...
from aixblock import (AutoModelForCausalLM, AutoTokenizer, Pipeline,
                        snapshot_download)
from aixblock_hub.hub.file_download import model_file_download
from aixblock_hub.models.base import Model
from aixblock_hub.models.nlp import ChatGLM2Tokenizer, Llama2Tokenizer
...
from aixblock_hub.utils.constant import Frameworks, Invoke, ModelFile, Tasks
from aixblock_hub.utils.device import create_device, device_placement
from aixblock_hub.utils.logger import get_logger
from aixblock_hub.utils.model_type_helper import ModelTypeHelper
...
class LLMPipeline(Pipeline, PipelineStreamingOutputMixin):
    ...
    def _wrap_infer_framework(self, model_dir, framework='vllm'):
        from aixblock_hub.pipelines.accelerate.base import InferFramework
