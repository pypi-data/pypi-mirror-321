...
DEFAULT_HUB = os.environ.get('DEFAULT_HUB',  'modelscope')

DEFAULT_AIXBLOCK_DOMAIN = os.environ.get('DEFAULT_AIXBLOCK_DOMAIN',  'www.modelscope.cn') #  huggingface.co 'www.modelscope.cn' 'dev-us-west-1.aixblock.io'
