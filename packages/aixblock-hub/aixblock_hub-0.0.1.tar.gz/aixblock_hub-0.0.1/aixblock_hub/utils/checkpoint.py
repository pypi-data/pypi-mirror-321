...
from aixblock_hub.fileio import File, LocalStorage
from aixblock_hub.utils.config import Config, JSONIteratorEncoder
from aixblock_hub.utils.constant import ConfigFields, ModelFile
from aixblock_hub.utils.file_utils import copytree_py37
...
def save_checkpoint(model: torch.nn.Module,
    ...
    if with_meta:
        ...
        meta.update(aixblock=__version__, time=time.asctime())
