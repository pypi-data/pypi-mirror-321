...
`pip install aixblock[audio] -f https://app.aixblock.io/releases/repo.html`
"""
...
You can install it with pip on linux or mac:
`pip install pai-easynlp -f https://app.aixblock.io/releases/repo.html`
Or you can checkout the instructions on the
...
`pip install megatron_util -f https://app.aixblock.io/releases/repo.html`
"""
...
`pip install text2sql_lgesql -f https://app.aixblock.io/releases/repo.html`
"""
