...
from aixblock_hub.hub.check_model import check_model_is_id
from aixblock_hub.hub.push_to_hub import (UploadStrategy, push_to_hub_in_queue,
                                        wait_for_done)
from aixblock_hub.metainfo import Hooks
from aixblock_hub.trainers.hooks.builder import HOOKS
from aixblock_hub.trainers.hooks.checkpoint.checkpoint_processor import \
    CheckpointProcessor
from aixblock_hub.trainers.hooks.hook import Hook
from aixblock_hub.trainers.hooks.priority import Priority
from aixblock_hub.utils.constant import (DEFAULT_REPOSITORY_REVISION, LogKeys,
                                       ModelFile)
from aixblock_hub.utils.logger import get_logger
from aixblock_hub.utils.torch_utils import is_master
...
class CheckpointHook(Hook):
    ...
    Args:
        ...
        hub_token (str): The token of the modelhub. You can also set the environment variable `AIXBLOCK_API_TOKEN`.
...
class BestCkptSaverHook(CheckpointHook):
    ...
    def after_train_epoch(self, trainer):
        from aixblock_hub.trainers.hooks import EvaluationHook
    ...
    def after_run(self, trainer):
        if self.restore_best:
            ...
            from aixblock_hub.trainers.hooks.checkpoint.load_checkpoint_hook import LoadCheckpointHook
