...
from aixblock_hub.utils.cv.image_utils import InputPadder, flow_to_color
...
class DenseOpticalFlowEstimationPipeline(Pipeline):
    ...
    >>> estimator([[
    >>>         'aixblock/models/cv/dense_optical_flow_estimation/data/test/images/dense_flow1.png',
    >>>         'aixblock/models/cv/dense_optical_flow_estimation/data/test/images/dense_flow2.png'
    >>>          ]])
