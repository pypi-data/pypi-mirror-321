...
from aixblock_hub.hub.snapshot_download import snapshot_download
from aixblock_hub.metainfo import Preprocessors
from aixblock_hub.pipelines.base import Input
from aixblock_hub.pipelines.cv.cmdssl_video_embedding_pipeline import (
...
from aixblock_hub.utils.constant import (Fields, Invoke, ModeKeys, ModelFile,
                                       Tasks)
...
class CLIPPreprocessor(Preprocessor):
    ...
    def __init__(self,
        ...
        self.mode = mode
        # text tokenizer
        from aixblock_hub.models.multi_modal.clip.bert_tokenizer import FullTokenizer
...
class MPlugPreprocessor(Preprocessor):
    ...
    def patch_resize_transform(self):
        if self._patch_resize_transform is None:
            from torchvision import transforms
            from aixblock_hub.models.multi_modal.mplug import CONFIG_NAME, MPlugConfig
...
class VLDocPreprocessor(Preprocessor):
    ...
    def __init__(self,
        ...
        from aixblock_hub.models.multi_modal.vldoc.tokenization import VLDocXLMTokenizer
        ...
        from aixblock_hub.models.multi_modal.vldoc.processing import Processor, ImageProcessor
...
class HiTeAPreprocessor(Preprocessor):
    ...
    def patch_resize_transform(self):
        if self._patch_resize_transform is None:
            from torchvision import transforms
            from aixblock_hub.models.multi_modal.mplug import CONFIG_NAME, HiTeAConfig
...
class MplugOwlPreprocessor(Preprocessor):
    ...
    @property
    def tokenizer(self):
        from aixblock_hub.models.nlp.llama import LlamaTokenizer
