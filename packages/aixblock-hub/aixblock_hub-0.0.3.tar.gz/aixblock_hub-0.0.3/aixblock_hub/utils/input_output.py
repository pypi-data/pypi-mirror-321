...
from aixblock_hub.outputs.outputs import (TASK_OUTPUTS, OutputKeys, OutputTypes,
                                        OutputTypeSchema)
from aixblock_hub.pipeline_inputs import (INPUT_TYPE, INPUT_TYPE_SCHEMA,
...
class PipelineInfomation():
    ...
    def _analyze(self):
        ...
        # use base pipeline __call__ if inputs and outputs are defined in aixblock lib
...
if __name__ == '__main__':
    from aixblock_hub.utils.ast_utils import load_index
    index = load_index()
    task_schemas = {}
