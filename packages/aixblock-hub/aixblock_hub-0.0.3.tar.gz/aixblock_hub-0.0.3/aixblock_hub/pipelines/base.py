...
from aixblock_hub.msdatasets import MsDataset
from aixblock_hub.outputs import TASK_OUTPUTS, ModelOutputBase
from aixblock_hub.pipeline_inputs import TASK_INPUTS, check_input_type
from aixblock_hub.preprocessors import Preprocessor
from aixblock_hub.utils.config import Config
from aixblock_hub.utils.constant import Frameworks, Invoke, ModelFile
from aixblock_hub.utils.device import (create_device, device_placement,
                                     verify_device)
from aixblock_hub.utils.hub import read_config, snapshot_download
from aixblock_hub.utils.import_utils import is_tf_available, is_torch_available
from aixblock_hub.utils.logger import get_logger
from aixblock_hub.utils.torch_utils import compile_model
...
class Pipeline(ABC):
    ...
    def __call__(self, input: Union[Input, List[Input]], *args,
        ...
        # aixblock library developer will handle this function
...
class DistributedPipeline(Pipeline):
    ...
    def __init__(self,
        ...
        master_port = int(kwargs['master_port']
                              ...
                              29500, 39500)
        from aixblock_hub.utils.torch_utils import _find_free_port, _is_free_port
...
def collate_fn(data, device):
    ...
    if isinstance(data, dict) or isinstance(data, Mapping):
        ...
        # aixblock.preprocessors.nlp.InputFeatures
        return data
