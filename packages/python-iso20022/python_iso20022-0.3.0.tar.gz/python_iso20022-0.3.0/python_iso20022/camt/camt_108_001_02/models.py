...
@dataclass
class AccountSchemeName1ChoiceCamt10800102(ISO20022MessageElement):
...
@dataclass
class ActiveCurrencyAndAmountCamt10800102(ISO20022MessageElement):
...
@dataclass
class CashAccountType2ChoiceCamt10800102(ISO20022MessageElement):
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class ChequeCancellationReason1ChoiceCamt10800102(ISO20022MessageElement):
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class ClearingSystemIdentification2ChoiceCamt10800102(ISO20022MessageElement):
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class DateAndDateTime2ChoiceCamt10800102(ISO20022MessageElement):
...
@dataclass
class DateAndPlaceOfBirth1Camt10800102(ISO20022MessageElement):
...
@dataclass
class FinancialIdentificationSchemeName1ChoiceCamt10800102(ISO20022MessageElement):
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class GenericIdentification30Camt10800102(ISO20022MessageElement):
...
@dataclass
class GroupHeader103Camt10800102(ISO20022MessageElement):
...
@dataclass
class OrganisationIdentificationSchemeName1ChoiceCamt10800102(ISO20022MessageElement):
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class OtherContact1Camt10800102(ISO20022MessageElement):
...
@dataclass
class PersonIdentificationSchemeName1ChoiceCamt10800102(ISO20022MessageElement):
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class ProxyAccountType1ChoiceCamt10800102(ISO20022MessageElement):
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class SupplementaryDataEnvelope1Camt10800102(ISO20022MessageElement):
...
@dataclass
class AddressType3ChoiceCamt10800102(ISO20022MessageElement):
...
@dataclass
class ChequeCancellationReason1Camt10800102(ISO20022MessageElement):
...
@dataclass
class ClearingSystemMemberIdentification2Camt10800102(ISO20022MessageElement):
...
@dataclass
class Contact13Camt10800102(ISO20022MessageElement):
...
@dataclass
class GenericAccountIdentification1Camt10800102(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class GenericFinancialIdentification1Camt10800102(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class GenericOrganisationIdentification3Camt10800102(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class GenericPersonIdentification2Camt10800102(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class ProxyAccountIdentification1Camt10800102(ISO20022MessageElement):
...
@dataclass
class SupplementaryData1Camt10800102(ISO20022MessageElement):
...
@dataclass
class AccountIdentification4ChoiceCamt10800102(ISO20022MessageElement):
...
@dataclass
class OrganisationIdentification39Camt10800102(ISO20022MessageElement):
...
@dataclass
class PersonIdentification18Camt10800102(ISO20022MessageElement):
...
@dataclass
class PostalAddress27Camt10800102(ISO20022MessageElement):
...
@dataclass
class BranchData5Camt10800102(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class CashAccount40Camt10800102(ISO20022MessageElement):
...
@dataclass
class FinancialInstitutionIdentification23Camt10800102(ISO20022MessageElement):
...
@dataclass
class Party52ChoiceCamt10800102(ISO20022MessageElement):
...
@dataclass
class BranchAndFinancialInstitutionIdentification8Camt10800102(ISO20022MessageElement):
...
@dataclass
class PartyIdentification272Camt10800102(ISO20022MessageElement):
    nm: Optional[str] = field(
        default=None,
        metadata={
            "name": "Nm",
...
@dataclass
class Cheque20Camt10800102(ISO20022MessageElement):
...
@dataclass
class ChequeCancellationOrStopRequestV02Camt10800102(ISO20022MessageElement):
...
@dataclass
class Camt10800102(ISO20022Message):
    class Meta:
        namespace = "urn:iso:std:iso:20022:tech:xsd:camt.108.001.02"
