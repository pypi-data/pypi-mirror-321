...
@dataclass
class AccountSchemeName1ChoiceTsmt00900105(ISO20022MessageElement):
...
@dataclass
class ActiveCurrencyAndAmountTsmt00900105(ISO20022MessageElement):
...
@dataclass
class AirportDescription1Tsmt00900105(ISO20022MessageElement):
...
@dataclass
class Bicidentification1Tsmt00900105(ISO20022MessageElement):
    class Meta:
...
@dataclass
class BpoapplicableRules1ChoiceTsmt00900105(ISO20022MessageElement):
    class Meta:
...
@dataclass
class CashAccountType2ChoiceTsmt00900105(ISO20022MessageElement):
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class CurrencyAndAmountTsmt00900105(ISO20022MessageElement):
    value: Optional[Decimal] = field(
        default=None,
        metadata={
            "required": True,
...
@dataclass
class DocumentIdentification7Tsmt00900105(ISO20022MessageElement):
...
@dataclass
class GenericIdentification1Tsmt00900105(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class GenericIdentification13Tsmt00900105(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class GenericIdentification4Tsmt00900105(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class MessageIdentification1Tsmt00900105(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class MultimodalTransport3Tsmt00900105(ISO20022MessageElement):
...
@dataclass
class PercentageTolerance1Tsmt00900105(ISO20022MessageElement):
...
@dataclass
class PostalAddress2Tsmt00900105(ISO20022MessageElement):
...
@dataclass
class PostalAddress5Tsmt00900105(ISO20022MessageElement):
    strt_nm: Optional[str] = field(
        default=None,
        metadata={
            "name": "StrtNm",
...
@dataclass
class ShipmentDateRange1Tsmt00900105(ISO20022MessageElement):
...
@dataclass
class ShipmentDateRange2Tsmt00900105(ISO20022MessageElement):
...
@dataclass
class SimpleIdentificationInformationTsmt00900105(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class TransportByRail5Tsmt00900105(ISO20022MessageElement):
...
@dataclass
class TransportByRoad5Tsmt00900105(ISO20022MessageElement):
    plc_of_rct: list[str] = field(
        default_factory=list,
        metadata={
            "name": "PlcOfRct",
...
@dataclass
class TransportBySea6Tsmt00900105(ISO20022MessageElement):
...
@dataclass
class UserDefinedInformation1Tsmt00900105(ISO20022MessageElement):
...
@dataclass
class AdjustmentType1ChoiceTsmt00900105(ISO20022MessageElement):
...
@dataclass
class AirportName1ChoiceTsmt00900105(ISO20022MessageElement):
...
@dataclass
class AmountOrPercentage2ChoiceTsmt00900105(ISO20022MessageElement):
...
@dataclass
class Charges5Tsmt00900105(ISO20022MessageElement):
...
@dataclass
class ChargesType1ChoiceTsmt00900105(ISO20022MessageElement):
...
@dataclass
class ContactIdentification1Tsmt00900105(ISO20022MessageElement):
...
@dataclass
class ContactIdentification3Tsmt00900105(ISO20022MessageElement):
    bic: Optional[str] = field(
        default=None,
        metadata={
            "name": "BIC",
...
@dataclass
class CountrySubdivision1ChoiceTsmt00900105(ISO20022MessageElement):
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class DocumentIdentification1Tsmt00900105(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class GenericAccountIdentification1Tsmt00900105(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class Incoterms4ChoiceTsmt00900105(ISO20022MessageElement):
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class NameAndAddress6Tsmt00900105(ISO20022MessageElement):
    nm: Optional[str] = field(
        default=None,
        metadata={
            "name": "Nm",
...
@dataclass
class PartyIdentification26Tsmt00900105(ISO20022MessageElement):
    nm: Optional[str] = field(
        default=None,
        metadata={
            "name": "Nm",
...
@dataclass
class PartyIdentification27Tsmt00900105(ISO20022MessageElement):
    nm: Optional[str] = field(
        default=None,
        metadata={
            "name": "Nm",
...
@dataclass
class PaymentPeriod3Tsmt00900105(ISO20022MessageElement):
...
@dataclass
class PaymentPeriod4Tsmt00900105(ISO20022MessageElement):
...
@dataclass
class ProductCategory1Tsmt00900105(ISO20022MessageElement):
...
@dataclass
class ProductCharacteristics1Tsmt00900105(ISO20022MessageElement):
...
@dataclass
class ProductIdentifier2Tsmt00900105(ISO20022MessageElement):
...
@dataclass
class RequiredSubmission2Tsmt00900105(ISO20022MessageElement):
...
@dataclass
class RequiredSubmission6Tsmt00900105(ISO20022MessageElement):
    submitr: list[Bicidentification1Tsmt00900105] = field(
        default_factory=list,
        metadata={
            "name": "Submitr",
...
@dataclass
class ShipmentSchedule2ChoiceTsmt00900105(ISO20022MessageElement):
...
@dataclass
class TaxType2ChoiceTsmt00900105(ISO20022MessageElement):
...
@dataclass
class UnitOfMeasure3ChoiceTsmt00900105(ISO20022MessageElement):
...
@dataclass
class AccountIdentification4ChoiceTsmt00900105(ISO20022MessageElement):
...
@dataclass
class Adjustment7Tsmt00900105(ISO20022MessageElement):
...
@dataclass
class ChargesDetails3Tsmt00900105(ISO20022MessageElement):
...
@dataclass
class FinancialInstitutionIdentification4ChoiceTsmt00900105(ISO20022MessageElement):
    bic: Optional[str] = field(
        default=None,
        metadata={
            "name": "BIC",
...
@dataclass
class Incoterms4Tsmt00900105(ISO20022MessageElement):
...
@dataclass
class Location2Tsmt00900105(ISO20022MessageElement):
    ctry: Optional[str] = field(
        default=None,
        metadata={
            "name": "Ctry",
...
@dataclass
class PaymentCodeOrOther1ChoiceTsmt00900105(ISO20022MessageElement):
...
@dataclass
class PaymentCodeOrOther2ChoiceTsmt00900105(ISO20022MessageElement):
...
@dataclass
class ProductCategory1ChoiceTsmt00900105(ISO20022MessageElement):
...
@dataclass
class ProductCharacteristics1ChoiceTsmt00900105(ISO20022MessageElement):
...
@dataclass
class ProductIdentifier2ChoiceTsmt00900105(ISO20022MessageElement):
...
@dataclass
class Quantity9Tsmt00900105(ISO20022MessageElement):
...
@dataclass
class RequiredSubmission3Tsmt00900105(ISO20022MessageElement):
    submitr: list[Bicidentification1Tsmt00900105] = field(
        default_factory=list,
        metadata={
            "name": "Submitr",
...
@dataclass
class RequiredSubmission4Tsmt00900105(ISO20022MessageElement):
    submitr: list[Bicidentification1Tsmt00900105] = field(
        default_factory=list,
        metadata={
            "name": "Submitr",
...
@dataclass
class Tax23Tsmt00900105(ISO20022MessageElement):
...
@dataclass
class TransportByAir5Tsmt00900105(ISO20022MessageElement):
...
@dataclass
class UnitPrice18Tsmt00900105(ISO20022MessageElement):
...
@dataclass
class CashAccount24Tsmt00900105(ISO20022MessageElement):
...
@dataclass
class Charge24Tsmt00900105(ISO20022MessageElement):
...
@dataclass
class PaymentTerms4Tsmt00900105(ISO20022MessageElement):
...
@dataclass
class PaymentTerms5Tsmt00900105(ISO20022MessageElement):
...
@dataclass
class SingleTransport7Tsmt00900105(ISO20022MessageElement):
...
@dataclass
class SettlementTerms3Tsmt00900105(ISO20022MessageElement):
...
@dataclass
class TransportMeans5Tsmt00900105(ISO20022MessageElement):
...
@dataclass
class LineItemDetails13Tsmt00900105(ISO20022MessageElement):
...
@dataclass
class PaymentObligation2Tsmt00900105(ISO20022MessageElement):
...
@dataclass
class LineItem13Tsmt00900105(ISO20022MessageElement):
...
@dataclass
class Baseline5Tsmt00900105(ISO20022MessageElement):
...
@dataclass
class BaselineAmendmentRequestV05Tsmt00900105(ISO20022MessageElement):
...
@dataclass
class Tsmt00900105(ISO20022Message):
    class Meta:
        namespace = "urn:iso:std:iso:20022:tech:xsd:tsmt.009.001.05"
