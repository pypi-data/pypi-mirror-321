...
@dataclass
class ActiveCurrencyAndAmountFxtr01500105(ISO20022MessageElement):
...
@dataclass
class ActiveOrHistoricCurrencyAndAmountFxtr01500105(ISO20022MessageElement):
    value: Optional[Decimal] = field(
        default=None,
        metadata={
            "required": True,
...
@dataclass
class AgreedRate3Fxtr01500105(ISO20022MessageElement):
...
@dataclass
class AgreementConditions1Fxtr01500105(ISO20022MessageElement):
...
@dataclass
class ClearingSystemIdentification2ChoiceFxtr01500105(ISO20022MessageElement):
...
@dataclass
class ContactInformation1Fxtr01500105(ISO20022MessageElement):
...
@dataclass
class DateAndDateTime2ChoiceFxtr01500105(ISO20022MessageElement):
    dt: Optional[XmlDate] = field(
        default=None,
        metadata={
            "name": "Dt",
...
@dataclass
class DigitalTokenAmount1Fxtr01500105(ISO20022MessageElement):
...
@dataclass
class IdentificationSource3ChoiceFxtr01500105(ISO20022MessageElement):
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class MatchingSystemReference1ChoiceFxtr01500105(ISO20022MessageElement):
...
@dataclass
class PartyIdentification265Fxtr01500105(ISO20022MessageElement):
...
@dataclass
class SettlementRateSource1Fxtr01500105(ISO20022MessageElement):
...
@dataclass
class SupplementaryDataEnvelope1Fxtr01500105(ISO20022MessageElement):
...
@dataclass
class UniqueTransactionIdentifier2Fxtr01500105(ISO20022MessageElement):
...
@dataclass
class AmountOrRate4ChoiceFxtr01500105(ISO20022MessageElement):
...
@dataclass
class ClearingBrokerIdentification1Fxtr01500105(ISO20022MessageElement):
...
@dataclass
class CurrencyOrDigitalTokenAmount1ChoiceFxtr01500105(ISO20022MessageElement):
...
@dataclass
class FxamountType1ChoiceFxtr01500105(ISO20022MessageElement):
    class Meta:
...
@dataclass
class OpeningConditions1Fxtr01500105(ISO20022MessageElement):
...
@dataclass
class OtherIdentification1Fxtr01500105(ISO20022MessageElement):
...
@dataclass
class PartyIdentification266Fxtr01500105(ISO20022MessageElement):
...
@dataclass
class PostalAddress1Fxtr01500105(ISO20022MessageElement):
...
@dataclass
class SupplementaryData1Fxtr01500105(ISO20022MessageElement):
...
@dataclass
class TradeAgreement15Fxtr01500105(ISO20022MessageElement):
...
@dataclass
class AmountsAndValueDate6Fxtr01500105(ISO20022MessageElement):
...
@dataclass
class FxcommissionOrFee1Fxtr01500105(ISO20022MessageElement):
    class Meta:
...
@dataclass
class NdfopeningFixing1ChoiceFxtr01500105(ISO20022MessageElement):
    class Meta:
...
@dataclass
class NameAndAddress8Fxtr01500105(ISO20022MessageElement):
    nm: Optional[str] = field(
        default=None,
        metadata={
            "name": "Nm",
...
@dataclass
class SecurityIdentification19Fxtr01500105(ISO20022MessageElement):
...
@dataclass
class NonDeliverableForwardConditions1Fxtr01500105(ISO20022MessageElement):
...
@dataclass
class PartyIdentification242ChoiceFxtr01500105(ISO20022MessageElement):
...
@dataclass
class PartyIdentification60Fxtr01500105(ISO20022MessageElement):
...
@dataclass
class CounterpartySideTransactionReporting2Fxtr01500105(ISO20022MessageElement):
...
@dataclass
class FundIdentification5Fxtr01500105(ISO20022MessageElement):
...
@dataclass
class GeneralInformation8Fxtr01500105(ISO20022MessageElement):
...
@dataclass
class SettlementParties120Fxtr01500105(ISO20022MessageElement):
...
@dataclass
class TradingSideTransactionReporting2Fxtr01500105(ISO20022MessageElement):
    rptg_jursdctn: Optional[str] = field(
        default=None,
        metadata={
            "name": "RptgJursdctn",
...
@dataclass
class RegulatoryReporting7Fxtr01500105(ISO20022MessageElement):
...
@dataclass
class TradePartyIdentification8Fxtr01500105(ISO20022MessageElement):
...
@dataclass
class ForeignExchangeTradeInstructionAmendmentV05Fxtr01500105(ISO20022MessageElement):
...
@dataclass
class Fxtr01500105(ISO20022Message):
    class Meta:
        namespace = "urn:iso:std:iso:20022:tech:xsd:fxtr.015.001.05"
