...
def write_to_dataframe(df,  table_name, db_type=None, server=None, user=None, password=None, database=None, schema=None, engine=None, path_instaclient=None):
    """
    ...
    categorized_dfs_clean = [df for df in categorized_dfs if not df.empty]

    return categorized_dfs_clean
