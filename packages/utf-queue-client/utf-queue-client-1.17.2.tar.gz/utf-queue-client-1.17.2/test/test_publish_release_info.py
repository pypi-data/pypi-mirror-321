...
def test_publish_release_information_success(mock_post):
    ...
    result = publish_release_information("test_username", "test_password", {"test_key": "test_value"})
...
def test_publish_release_information_release_fail_422(mock_post):
    ...
    mock_response_release.json.return_value = {"detail": [{"loc": ["", "test_field"], "msg": "test_error"}]}
