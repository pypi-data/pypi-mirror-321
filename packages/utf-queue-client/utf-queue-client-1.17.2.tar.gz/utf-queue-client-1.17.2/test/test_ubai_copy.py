...
def test_ubai_copy_cli(artifact_id, copy_name, copy_extension, copy_metadata, set_environment_variable):
...
@instrumented
def test_ubai_copy_cli_script(artifact_id, copy_name, copy_extension, copy_metadata, set_environment_variables):

    base_dir = os.path.dirname(os.path.dirname(__file__))

    args = ["--artifact_id", artifact_id, "--name", copy_name, "--extension", copy_extension]
