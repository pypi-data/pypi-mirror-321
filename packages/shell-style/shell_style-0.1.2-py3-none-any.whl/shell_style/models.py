...
class Console(_BaseObject):
    ...
    def print_title(self) -> None:
        self.write(f"<@heading>{self.__title}<@stop>", alignment=Other.CENTER)
    ...
    def log(self, *objects, end: str = f"{Other.STOP}\n", sep: str = " ", 
            style: str = "default", alignment: str = Other.LEFT) -> None:
        """
    ...
    def write(self, *objects: Any, alignment: str = Other.LEFT, end: str = f"{Other.STOP}\n", 
    ...
    def prompt(self, *objects, end: str = Other.STOP, style: str = "default") -> str:
        """
...
class ProgressBar(_BaseObject):
    ...
    def run(self, style: str = "default") -> None:
        ...
        for _ in range(self.__values):
            print(self.__theme.get_style(style) + self.__symbol, end=Other.STOP, flush=True)
            sleep(self.__delay)
...
class Table(_BaseObject):
    ...
    def add_row(self, *objects: Any, style: str = "default") -> None:
        ...
        for obj in objects:
            interpreted_objects.append(interpret(self.__theme.get_style(style) + str(obj) + Other.STOP))
    ...
    def add_column(self, placeholder: Any = "", style: str = "default") -> None:
        ...
        placeholder = interpret(self.__theme.get_style(style) + str(placeholder) + Other.STOP)
    ...
    def set_column(self, info: Any, row_index: int, column_index: int, style: str = "default") -> None:
        ...
        self.__table[row_index][column_index] = interpret(self.__theme.get_style(style) + str(info) + Other.STOP)
