...
class Frame:
    ...
    def TIRF() -> Frame:
        ...
        """
    @staticmethod
    def TOD(epoch: ostk.physics.time.Instant, theory: ...) -> Frame:
        """
                        Get the TOD frame.
    ...
    def _pybind11_conduit_v1_(*args, **kwargs):
        ...
    @staticmethod
    def construct(name: ostk.core.type.String, is_quasi_inertial: bool, parent_frame: Frame, provider: ...) -> Frame:
        """
                        Construct a frame.
...
class Position:
    ...
    def _pybind11_conduit_v1_(*args, **kwargs):
        ...
    @staticmethod
    def from_lla(lla: spherical.LLA, celestial: ... = None) -> Position:
        """
        ...
        """
    @staticmethod
    def meters(coordinates: numpy.ndarray[numpy.float64[3, 1]], frame: ...) -> Position:
        """
    ...
    def __eq__(self, arg0: Position) -> bool:
        """
                        ...
                        Returns:
                            bool: True if equal.
        """
    def __init__(self, coordinates: numpy.ndarray[numpy.float64[3, 1]], unit: ostk.physics.unit.Length.Unit, frame: ...) -> None:
        """
    ...
    def get_unit(self) -> ostk.physics.unit.Length.Unit:
        """
                        ...
                        Returns:
                            Unit: Unit.
        """
    def in_frame(self, frame: ..., instant: ostk.physics.time.Instant) -> Position:
        """
...
class Transform:
    ...
    def __imul__(self, arg0: Transform) -> Transform:
        ...
        """
    def __init__(self, instant: ostk.physics.time.Instant, translation: numpy.ndarray[numpy.float64[3, 1]], velocity: numpy.ndarray[numpy.float64[3, 1]], orientation: ostk.mathematics.geometry.d3.transformation.rotation.Quaternion, angular_velocity: numpy.ndarray[numpy.float64[3, 1]], type: ...) -> None:
        """
...
class Velocity:
    ...
    def _pybind11_conduit_v1_(*args, **kwargs):
        ...
    @staticmethod
    def meters_per_second(coordinates: numpy.ndarray[numpy.float64[3, 1]], frame: ...) -> Velocity:
        """
    ...
    def __eq__(self, arg0: Velocity) -> bool:
        """
                        ...
                        Returns:
                            bool: True if equal.
        """
    def __init__(self, coordinates: numpy.ndarray[numpy.float64[3, 1]], unit: ..., frame: ...) -> None:
        """
    ...
    def get_unit(self) -> ...:
        """
                        ...
                        Returns:
                            Unit: Unit.
        """
    def in_frame(self, position: Position, frame: ..., instant: ostk.physics.time.Instant) -> Velocity:
        """
                        Convert to frame.
                        ...
                        Returns:
                            Velocity: Velocity.
        """
    def in_unit(self, unit: ...) -> Velocity:
        """
                        Convert to unit.
