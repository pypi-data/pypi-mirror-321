...
class Environment:
    ...
    def __init__(self, instant: time.Instant, objects: list[...], set_global_instance: bool = False) -> None:
        ...
        """
    @typing.overload
    def __init__(self, central_celestial_object: ..., objects: list[...], instant: time.Instant = ..., set_global_instance: bool = False) -> None:
        """
                        Constructor
    ...
    def has_object_with_name(self, name: ostk.core.type.String) -> bool:
        ...
        """
    def intersects(self, geometry: ..., objects_to_ignore: list[...] = []) -> bool:
        """
...
class Unit:
    ...
    class Type:
        ...
        None: typing.ClassVar[Unit.Type]  # value = <Type.None: 1>
        ...
        __members__: typing.ClassVar[dict[str, Unit.Type]]  # value = {'Undefined': <Type.Undefined: 0>, 'None': <Type.None: 1>, 'Length': <Type.Length: 2>, 'Mass': <Type.Mass: 3>, 'Time': <Type.Time: 4>, 'Temperature': <Type.Temperature: 5>, 'ElectricCurrent': <Type.ElectricCurrent: 6>, 'LuminousIntensity': <Type.LuminousIntensity: 7>, 'Derived': <Type.Derived: 8>}
        @staticmethod
        def _pybind11_conduit_v1_(*args, **kwargs):
            ...
        def __eq__(self, other: typing.Any) -> bool:
