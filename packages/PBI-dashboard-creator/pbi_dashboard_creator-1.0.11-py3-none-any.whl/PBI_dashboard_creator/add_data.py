...
def add_csv(dashboard_path, data_path):
	...
	tables_folder = os.path.join(dashboard_path, 'definition/tables')
	dataset_file_path = os.path.join(tables_folder, f'{dataset_name}2.tmdl')
	...
	with open(dataset_file_path, 'a') as file:
		...
		file.write(f'\t\t\t\t\tSource = Csv.Document(File.Contents({data_path}),[Delimiter=",", Columns=10, Encoding=1252, QuoteStyle=QuoteStyle.None]),\n')
...
#",".join(map(str, value_list))
	...
	#	file.write(f'\n\nannotation PBI_QueryOrder = [{dataset_name}]\n\nref table {dataset_name}')
...
add_csv("C:/Users/rps1303/PBI_projects/test_dash/blorg", "C:/Users/rps1303/Downloads/colony.csv" )
