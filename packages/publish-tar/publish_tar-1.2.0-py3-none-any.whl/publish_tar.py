...
class TARPublisher:
    ...
    def publish_jsons(self, artifact_obj: dict):
        ...
        info = {
            ...
            'Pipeline Run': f'https://dev.azure.com/hexagonmi/DE-VirtualManufacturing/_build/results?buildId={os.environ["BUILD_BUILDID"]}' if os.getenv("XRAY_EXECUTION_ID") else default_info,
