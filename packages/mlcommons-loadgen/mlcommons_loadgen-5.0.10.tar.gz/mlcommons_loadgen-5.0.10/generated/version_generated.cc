...
const std::string& LoadgenVersion() {
  static const std::string str = "5.0.10";
  return str;
}

const std::string& LoadgenBuildDateLocal() {
  static const std::string str = "2025-01-15T00:31:17.758687";
  return str;
}

const std::string& LoadgenBuildDateUtc() {
  static const std::string str = "2025-01-15T00:31:17.758701";
  return str;
}

const std::string& LoadgenGitRevision() {
  static const std::string str = "ab7f700043";
  return str;
}

const std::string& LoadgenGitCommitDate() {
  static const std::string str = "2025-01-15T00:30:47Z";
  return str;
}
...
const std::string& LoadgenGitLog() {
  static const std::string str = R"LGVG_RSLD(ab7f700043f9824683d173057f668a4f83cfed84 Increment version to 5.0.10)LGVG_RSLD";
  return str;
}
...
eb9476fcd53ceff5ad24a12ea85f22d14b8c8bd9 /VERSION.txt
...
31d9748c0dc09aed7ab6690471e0aab23440e332 /loadgen.cc
...
107bca58fa2a5df39d3237d139844cf50208f631 /mlperf.conf
594843afd83926281d2d1827663dd4b3f4326466 /mlperf_conf.h
...
95ffb8feff62a5ea3b88976b2c46680a085e029a /test_settings_internal.cc
