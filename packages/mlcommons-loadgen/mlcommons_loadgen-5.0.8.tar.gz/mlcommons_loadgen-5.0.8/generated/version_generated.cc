...
const std::string& LoadgenVersion() {
  static const std::string str = "5.0.8";
  return str;
}

const std::string& LoadgenBuildDateLocal() {
  static const std::string str = "2025-01-14T23:44:12.752792";
  return str;
}

const std::string& LoadgenBuildDateUtc() {
  static const std::string str = "2025-01-14T23:44:12.752806";
  return str;
}

const std::string& LoadgenGitRevision() {
  static const std::string str = "4fc54b5f4f";
  return str;
}

const std::string& LoadgenGitCommitDate() {
  static const std::string str = "2025-01-14T17:43:38-06:00";
  return str;
}
...
const std::string& LoadgenGitLog() {
  static const std::string str = R"LGVG_RSLD(4fc54b5f4f43095646e87eea9d2f4a28a9923876 Fix seeds: correct seeds in mlperf.conf (#2036))LGVG_RSLD";
  return str;
}
...
08e078c6229a4b54e8a31e0422f070051a14dafc /VERSION.txt
