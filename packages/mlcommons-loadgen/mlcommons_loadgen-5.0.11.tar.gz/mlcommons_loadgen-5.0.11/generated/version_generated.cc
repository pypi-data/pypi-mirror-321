...
const std::string& LoadgenVersion() {
  static const std::string str = "5.0.11";
  return str;
}

const std::string& LoadgenBuildDateLocal() {
  static const std::string str = "2025-01-16T05:52:18.910802";
  return str;
}

const std::string& LoadgenBuildDateUtc() {
  static const std::string str = "2025-01-16T05:52:18.910816";
  return str;
}

const std::string& LoadgenGitRevision() {
  static const std::string str = "ef1bd3b95e";
  return str;
}

const std::string& LoadgenGitCommitDate() {
  static const std::string str = "2025-01-15T23:51:49-06:00";
  return str;
}
...
const std::string& LoadgenGitLog() {
  static const std::string str = R"LGVG_RSLD(ef1bd3b95e17df85c4cf71fa298018773d83a04a Fix reporting of samples per queries with equal issue mode (#2039))LGVG_RSLD";
  return str;
}
...
54109bb2722ed2fafb85c7d0a377d6b6dc73259c /VERSION.txt
...
5ab235c2fdd3389d81f82b496068603ae002409b /mlperf.conf
3d6fc18ef366524e751b68039699e0e48951167d /mlperf_conf.h
