...
def get_linked_entity_id(ent_id, link_typeId):
   ...
   #get_entity_id(item, "EntityTypeId", "Item", "ItemNumber")
...
def load_pim_data():
    ...
    for article in articles:
        ...
        if data:
            ...
            entity_ids, item_active_web, channels, item_long_copy, item_ecom_status, item_enable_ecom, option_long_copy, product_details, item_image_resc_type, item_image_file_name = data
