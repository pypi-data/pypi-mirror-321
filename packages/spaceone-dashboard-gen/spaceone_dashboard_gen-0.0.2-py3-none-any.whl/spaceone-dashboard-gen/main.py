...
# Static files 설정
app.mount("/static", StaticFiles(directory="src/dashboard-generator/static"), name="static")

# Templates 설정
templates = Jinja2Templates(directory="src/dashboard-generator/templates")
...
# uvicorn src.dashboard-generator.main:app --reload
