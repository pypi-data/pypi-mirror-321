...
class Project(google.protobuf.message.Message):
    ...
    class Settings(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["data_proc_cluster_id", b"data_proc_cluster_id", "default_folder_id", b"default_folder_id", "early_access", b"early_access", "ide", b"ide", "security_group_ids", b"security_group_ids", "service_account_id", b"service_account_id", "stale_exec_timeout_mode", b"stale_exec_timeout_mode", "subnet_id", b"subnet_id"]) -> None: ...
