    ...
    def decorator(func: Callable[..., Any]) -> Callable[..., dict]:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> dict:
            ...
            try:
                ...
                return LambdaResponse.create(result, status_code=200, content_type=config.content_type)
                ...
                return LambdaResponse.create(result, status_code=400, content_type=config.content_type)
                ...
                return LambdaResponse.create(result, status_code=500, content_type=config.content_type)
