...
# TODO REQ 0386: When we configure a BASE with Configurator, we generate the .lnk and batches if they where not there
# REQ 0390: BUG: the detection of last pwpInstaller is broken, since pwpInstaller.exe does not exist anymore
# TODO REQ 0391: Keep only the last 4 packages, on gitlab, in Program files. (if >=20, the last one is not seen!)
