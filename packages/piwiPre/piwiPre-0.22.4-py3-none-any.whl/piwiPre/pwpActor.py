...
class PwpActor:
    ...
    def connect_sql(self, config: dict):
        ...
        if not self.sql_first_album:
            ...
            try:
                ...
                LOGGER.error(f"Error {e} : get name of 1st album, "
                             "something is wrong in your database ")       # pragma no cover: defensive code
        ...
        try:
            ...
            LOGGER.error(f"Error {e} : trying to get id of 1st album '{self.sql_first_album}' ")    # pragma no cover
    ...
    def sql_get_file_info(self, filename: str) -> FileInfo or None:
        ...
        try:
            ...
            LOGGER.error(f"Error {e} : get file info of {sql_name} ")      # pragma no cover: defensive code
    ...
    def sql_set_data(self, filename, md5, size, width, height, latitude, longitude, author,
        ...
        try:
            ...
            LOGGER.error(f"Error {e} : setting db info to {sql_name} ")      # pragma no cover: defensive code
    ...
    def sql_get_user_id(self, username: str):
        ...
        try:
            ...
            LOGGER.error(f"Error {e} : get user id '{username}'")      # pragma no cover: defensive code
        if cur.affected_rows > 1:
    ...
    def sql_insert_file(self, real_file: str, sql_filename: str,
        ...
        try:
            ...
            LOGGER.error(f"SQL Error {e} : insert file '{sql_filename}'")      # pragma no cover: defensive code
        if cur.affected_rows > 1:
            LOGGER.error(f"SQL Error: insert file '{sql_filename}' "
                         f"produced {cur.affected_rows} affected row")       # pragma no cover: defensive code
        ...
        try:
            ...
            LOGGER.error(f"SQL Error {e} : insert file category_id'{sql_filename}'")  # pragma no cover: defensive code
    ...
    def sql_set_dir_representative(self, dir_info: DirInfo, file_id):
        ...
        try:
            ...
            LOGGER.error(f"SQL Error {e}: "
                         f"Set dir {dir_info.dir_id} representative '{file_id}'")      # pragma no cover: defensive code
    ...
    def sql_get_group_id(self, group_name):
        ...
        try:
            ...
            LOGGER.error(f"Error {e} : getting SQL get group ID '{group_name}'")      # pragma no cover: defensive code
    ...
    def sql_set_group_access_to_dir(self, group_id, cat_id):
        ...
        try:
            ...
            LOGGER.error(f"SQL Error {e}: "
                         f"SQL set group {group_id} access to {cat_id}")  # pragma no cover: defensive code
    ...
    def sql_insert_dir_at_rank(self, dir_name: str, father_info: DirInfo, rank,
        ...
        try:
            ...
            LOGGER.error(f"SQL Error {e}: INSERT dir {dir_name} in {father_info}")     # pragma no cover: defensive code
        if cur.affected_rows != 1:
        ...
        try:
            ...
            LOGGER.error(f"SQL Error {e}: "
                         f"UPDATING uppercats for dir {dir_name} ")  # noqa       # pragma no cover: defensive code
    ...
    def sql_change_dir_rank(self, father_info: DirInfo, son_info: DirInfo, new_rank):
        ...
        try:
            ...
            LOGGER.error(f"SQL Error {e} : change dir {son_info} rank {old_rank} "
                         f"-> {new_rank} in {father_info}")       # pragma no cover: defensive code
        if cur.affected_rows != 1:
    ...
    def sql_get_dir_file_list(self, dir_info: DirInfo) -> dict[str, FileInfo]:
        ...
        try:
            ...
            LOGGER.error(f"Error {e} : getting sql files of dir {dir_info}")      # pragma no cover: defensive code
    ...
    def sql_get_dir_sub_dirs(self, dir_info: DirInfo):
        ...
        try:
            ...
            LOGGER.error(f"SQL Error {e} : getting sql files of dir {dir_info}")      # pragma no cover: defensive code
    ...
    def sql_get_dir_category_content(self, dir_info: DirInfo):
        ...
        try:
            ...
            LOGGER.error(f"SQL Error {e} : getting dir {dir_info} "
                         "content as a category")      # pragma no cover: defensive code
    ...
    def sql_remove_file_from_db(self, p_config: dict, file_info: FileInfo):
        ...
        try:
            ...
            LOGGER.error(f"SQL Error {e} : removing file {file_info} ")      # pragma no cover: defensive code
    ...
    def sql_remove_dir_from_db(self, dir_info: DirInfo):
        ...
        try:
            ...
            LOGGER.error(f"SQL Error {e} : removing directory {dir_info}")      # pragma no cover: defensive code

        if cur.affected_rows != 1:
            nb = cur.affected_rows                 # pragma: no cover: defensive code
            LOGGER.error(f"SQL Error: {nb} affected rows "
        ...
        try:
            ...
            LOGGER.error(f"SQL Error {e} : removing directory {dir_info} "
                         "from piwigo_group_access")      # pragma no cover: defensive code
        return True
