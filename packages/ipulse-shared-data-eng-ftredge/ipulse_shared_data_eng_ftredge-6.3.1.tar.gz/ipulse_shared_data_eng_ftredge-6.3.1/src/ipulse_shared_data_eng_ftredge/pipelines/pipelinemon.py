...
class Pipelinemon:
    ...
    def generate_execution_summary(self, countable_subj_name: str, total_countables: int, subj_resource:Resource=AbstractResource.PIPELINE_SUBJECT ) -> str:
        ...
        failures = self.count_logs_for_events_containing(progress_statuses=ProgressStatus.failure_statuses(), resources=subj_resource)
        ...
        - Issue/Error  {subj_resource.name.lower()}(s): [{failures}/{total_countables}] {countable_subj_name}(s)
