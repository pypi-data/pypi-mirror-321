...
class ClusterHandler:
    ...
    def _gather_members(
        ...
        print(f"member ids = {member_list}")
    ...
    def redo_clustering(
        ...
        logger.info("In redo_clustering section")
        ...
        if not redopd.empty and not redo_vs.empty:
            ...
            if len(redo_walktrap_clusters.sizes()) == 1:
                ...
                for idnum in network.members:
                    print(redopd[(redopd.idnum1 == idnum) | (redopd.idnum2 == idnum)])
                    print(idnum)
                    sys.exit(1)
                    conn = sum(
                        list(
                    ...
                    if len(conn_idnum) == 1:
                        ...
                        try:
                            ...
                            print(network.haplotypes)
                            print(network.members)
                            print(redopd)
                            print(redo_vs)
                            print(conn_idnum)
                            print(
                                f"length of redo_walktrap_clusters: {len(redo_walktrap_clusters.sizes())}"
                            )
                            print(f"idnum = {idnum}")
