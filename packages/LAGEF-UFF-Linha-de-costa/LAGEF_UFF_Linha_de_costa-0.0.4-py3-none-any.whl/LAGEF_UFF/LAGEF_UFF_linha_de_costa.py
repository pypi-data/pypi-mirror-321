...
def area_linha_de_costa(start_dateNuv,roi,path1,row1,porcentagem_nuvem_roi,file_path,sheet_name,min_mare,max_mare):
...
def estatisticas_mare(file_path, sheet_name):
    """
...
def area_linha_de_costa_loop(start_year, end_year, area_linha_de_costa, roi, path1, row1, porcentagem_nuvem_roi, file_path, sheet_name, min_mare, max_mare, Map):
    """
    ...
    for ano in range(start_year, end_year):
        try:
            ...
            resultado = area_linha_de_costa(data_inicio, roi, path1, row1, porcentagem_nuvem_roi, file_path, sheet_name, min_mare, max_mare)
