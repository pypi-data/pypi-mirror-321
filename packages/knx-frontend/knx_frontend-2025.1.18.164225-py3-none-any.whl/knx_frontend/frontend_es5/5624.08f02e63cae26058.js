"use strict";(self.webpackChunkknx_frontend=self.webpackChunkknx_frontend||[]).push([["5624"],{90842:function(e,s,t){t.d(s,{t:function(){return o}});t(92745),t(77439),t(19423),t(39527),t(41360),t(88972);class a{constructor(e=window.localStorage){this.storage=void 0,this._storage={},this._listeners={},this.storage=e,e===window.localStorage&&window.addEventListener("storage",(e=>{e.key&&this.hasKey(e.key)&&(this._storage[e.key]=e.newValue?JSON.parse(e.newValue):e.newValue,this._listeners[e.key]&&this._listeners[e.key].forEach((s=>s(e.oldValue?JSON.parse(e.oldValue):e.oldValue,this._storage[e.key]))))}))}addFromStorage(e){if(!this._storage[e]){const s=this.storage.getItem(e);s&&(this._storage[e]=JSON.parse(s))}}subscribeChanges(e,s){return this._listeners[e]?this._listeners[e].push(s):this._listeners[e]=[s],()=>{this.unsubscribeChanges(e,s)}}unsubscribeChanges(e,s){if(!(e in this._listeners))return;const t=this._listeners[e].indexOf(s);-1!==t&&this._listeners[e].splice(t,1)}hasKey(e){return e in this._storage}getValue(e){return this._storage[e]}setValue(e,s){const t=this._storage[e];this._storage[e]=s;try{void 0===s?this.storage.removeItem(e):this.storage.setItem(e,JSON.stringify(s))}catch(a){}finally{this._listeners[e]&&this._listeners[e].forEach((e=>e(t,s)))}}}const i={},o=e=>s=>{const t=e.storage||"localStorage";let o;t&&t in i?o=i[t]:(o=new a(window[t]),i[t]=o);const l=String(s.key),n=e.key||String(s.key),r=s.initializer?s.initializer():void 0;o.addFromStorage(n);const d=!1!==e.subscribe?e=>o.subscribeChanges(n,((t,a)=>{e.requestUpdate(s.key,t)})):void 0,h=()=>o.hasKey(n)?e.deserializer?e.deserializer(o.getValue(n)):o.getValue(n):r;return{kind:"method",placement:"prototype",key:s.key,descriptor:{set(t){((t,a)=>{let i;e.state&&(i=h()),o.setValue(n,e.serializer?e.serializer(a):a),e.state&&t.requestUpdate(s.key,i)})(this,t)},get(){return h()},enumerable:!0,configurable:!0},finisher(t){if(e.state&&e.subscribe){const e=t.prototype.connectedCallback,s=t.prototype.disconnectedCallback;t.prototype.connectedCallback=function(){e.call(this),this[`__unbsubLocalStorage${l}`]=null==d?void 0:d(this)},t.prototype.disconnectedCallback=function(){var e;s.call(this),null===(e=this[`__unbsubLocalStorage${l}`])||void 0===e||e.call(this),this[`__unbsubLocalStorage${l}`]=void 0}}e.state&&t.createProperty(s.key,Object.assign({noAccessor:!0},e.stateOptions))}}}},40137:function(e,s,t){t.r(s),t.d(s,{TTSTryDialog:function(){return _}});var a=t(73577),i=(t(71695),t(19423),t(40251),t(47021),t(57243)),o=t(50778),l=t(90842),n=t(11297),r=(t(20095),t(44118)),d=(t(54993),t(421)),h=t(4557);t(90977);let u,c,g,p,y=e=>e;let _=(0,a.Z)([(0,o.Mo)("dialog-tts-try")],(function(e,s){return{F:class extends s{constructor(...s){super(...s),e(this)}},d:[{kind:"field",decorators:[(0,o.Cb)({attribute:!1})],key:"hass",value:void 0},{kind:"field",decorators:[(0,o.SB)()],key:"_loadingExample",value(){return!1}},{kind:"field",decorators:[(0,o.SB)()],key:"_params",value:void 0},{kind:"field",decorators:[(0,o.SB)()],key:"_valid",value(){return!1}},{kind:"field",decorators:[(0,o.IO)("#message")],key:"_messageInput",value:void 0},{kind:"field",decorators:[(0,l.t)({key:"ttsTryMessages",state:!1,subscribe:!1})],key:"_messages",value:void 0},{kind:"method",key:"showDialog",value:function(e){this._params=e,this._valid=Boolean(this._defaultMessage)}},{kind:"method",key:"closeDialog",value:function(){this._params=void 0,(0,n.B)(this,"dialog-closed",{dialog:this.localName})}},{kind:"get",key:"_defaultMessage",value:function(){var e,s;const t=null===(e=this._params.language)||void 0===e?void 0:e.substring(0,2),a=this.hass.locale.language.substring(0,2);return t&&null!==(s=this._messages)&&void 0!==s&&s[t]?this._messages[t]:t===a?this.hass.localize("ui.dialogs.tts-try.message_example"):""}},{kind:"method",key:"render",value:function(){return this._params?(0,i.dy)(u||(u=y`
      <ha-dialog
        open
        @closed=${0}
        .heading=${0}
    ...
    `),this.closeDialog,(0,r.i)(this.hass,this.hass.localize("ui.dialogs.tts-try.header")),this.hass.localize("ui.dialogs.tts-try.message"),this.hass.localize("ui.dialogs.tts-try.message_placeholder"),this._defaultMessage,this._inputChanged,!this._defaultMessage,this._loadingExample?(0,i.dy)(c||(c=y`
    ...
    `))}}]}}),i.oi)}}]);
//# sourceMappingURL=5624.08f02e63cae26058.js.map