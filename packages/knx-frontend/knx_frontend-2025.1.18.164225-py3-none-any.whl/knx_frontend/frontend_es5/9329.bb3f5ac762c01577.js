"use strict";(self.webpackChunkknx_frontend=self.webpackChunkknx_frontend||[]).push([["9329"],{68024:function(e,i,t){var a=t(73577),n=(t(71695),t(40251),t(47021),t(57243)),s=t(50778),o=t(27486);t(42877);let d,r,l=e=>e;(0,a.Z)([(0,s.Mo)("assist-pipeline-detail-config")],(function(e,i){return{F:class extends i{constructor(...i){super(...i),e(this)}},d:[{kind:"field",decorators:[(0,s.Cb)({attribute:!1})],key:"hass",value:void 0},{kind:"field",decorators:[(0,s.Cb)({attribute:!1})],key:"data",value:void 0},{kind:"field",decorators:[(0,s.Cb)({attribute:!1,type:Array})],key:"supportedLanguages",value:void 0},{kind:"method",key:"focus",value:async function(){var e;await this.updateComplete;const i=null===(e=this.renderRoot)||void 0===e?void 0:e.querySelector("ha-form");null==i||i.focus()}},{kind:"field",key:"_schema",value(){return(0,o.Z)((e=>[{name:"",type:"grid",schema:[{name:"name",required:!0,selector:{text:{}}},e?{name:"language",required:!0,selector:{language:{languages:e}}}:{name:"",type:"constant"}]}]))}},{kind:"field",key:"_computeLabel",value(){return e=>e.name?this.hass.localize(`ui.panel.config.voice_assistants.assistants.pipeline.detail.form.${e.name}`):""}},{kind:"method",key:"render",value:function(){return(0,n.dy)(d||(d=l`
    ...
    `),this.hass.localize("ui.panel.config.voice_assistants.assistants.pipeline.detail.steps.stt.title"),this.hass.localize("ui.panel.config.voice_assistants.assistants.pipeline.detail.steps.stt.description"),this._schema(null===(e=this.data)||void 0===e?void 0:e.language,this._supportedLanguages),this.data,this.hass,this._computeLabel,this._supportedLanguagesChanged)}},{kind:"method",key:"_supportedLanguagesChanged",value:function(e){this._supportedLanguages=e.detail.value}},{kind:"get",static:!0,key:"styles",value:function(){return(0,n.iv)(r||(r=l`
      .section {
        border: 1px solid var(--divider-color);
        border-radius: 8px;
        box-sizing: border-box;
    ...
    `),this.hass.localize("ui.panel.config.voice_assistants.assistants.pipeline.detail.steps.tts.title"),this.hass.localize("ui.panel.config.voice_assistants.assistants.pipeline.detail.steps.tts.description"),this._schema(null===(e=this.data)||void 0===e?void 0:e.language,this._supportedLanguages),this.data,this.hass,this._computeLabel,this._supportedLanguagesChanged,null!==(i=this.data)&&void 0!==i&&i.tts_engine?(0,n.dy)(p||(p=c`<div class="footer">
               <ha-button
                 .label=${0}
                 @click=${0}
               >
               </ha-button>
             </div>`),this.hass.localize("ui.panel.config.voice_assistants.assistants.pipeline.detail.try_tts"),this._preview):n.Ld)}},{kind:"method",key:"_preview",value:async function(){if(!this.data)return;const e=this.data.tts_engine,i=this.data.tts_language||void 0,t=this.data.tts_voice||void 0;var a,n;e&&(a=this,n={engine:e,language:i,voice:t},(0,d.B)(a,"show-dialog",{addHistory:!1,dialogTag:"dialog-tts-try",dialogImport:r,dialogParams:n}))}},{kind:"method",key:"_supportedLanguagesChanged",value:function(e){this._supportedLanguages=e.detail.value}},{kind:"get",static:!0,key:"styles",value:function(){return(0,n.iv)(u||(u=c`
      .section {
        border: 1px solid var(--divider-color);
        border-radius: 8px;
      }
    ...
    `))}}]}}),n.oi)},37744:function(e,i,t){var a=t("73577"),n=(t("71695"),t("19423"),t("40251"),t("39527"),t("13334"),t("36993"),t("47021"),t("57243")),s=t("50778"),o=t("27486");t("42877");var d=t("11297");let r,l,p=e=>e;(0,a.Z)([(0,s.Mo)("assist-pipeline-detail-wakeword")],(function(e,i){return{F:class extends i{constructor(...i){super(...i),e(this)}},d:[{kind:"field",decorators:[(0,s.Cb)({attribute:!1})],key:"hass",value:void 0},{kind:"field",decorators:[(0,s.Cb)({attribute:!1})],key:"data",value:void 0},{kind:"field",decorators:[(0,s.SB)()],key:"_wakeWords",value:void 0},{kind:"field",key:"_schema",value(){return(0,o.Z)((e=>[{name:"",type:"grid",schema:[{name:"wake_word_entity",selector:{entity:{domain:"wake_word"}}},null!=e&&e.length?{name:"wake_word_id",required:!0,selector:{select:{mode:"dropdown",sort:!0,options:e.map((e=>({value:e.id,label:e.name})))}}}:{name:"",type:"constant"}]}]))}},{kind:"field",key:"_computeLabel",value(){return e=>e.name?this.hass.localize(`ui.panel.config.voice_assistants.assistants.pipeline.detail.form.${e.name}`):""}},{kind:"method",key:"willUpdate",value:function(e){var i,t,a,n;e.has("data")&&(null===(i=e.get("data"))||void 0===i?void 0:i.wake_word_entity)!==(null===(t=this.data)||void 0===t?void 0:t.wake_word_entity)&&(null!==(a=e.get("data"))&&void 0!==a&&a.wake_word_entity&&null!==(n=this.data)&&void 0!==n&&n.wake_word_id&&(0,d.B)(this,"value-changed",{value:Object.assign(Object.assign({},this.data),{},{wake_word_id:void 0})}),this._fetchWakeWords())}},{kind:"method",key:"render",value:function(){return(0,n.dy)(r||(r=p`
      <div class="section">
        <div class="content">
          <div class="intro">
            <h3>
    ...
    `))}}]}}),n.oi)},22380:function(e,i,t){t.a(e,(async function(e,i){try{var a=t(73577),n=(t(71695),t(77439),t(39527),t(41360),t(47021),t(57243)),s=t(50778),o=t(27486),d=t(4855),r=t(35047),l=e([r]);r=(l.then?(await l)():l)[0];let p,u,c,h=e=>e;(0,a.Z)([(0,s.Mo)("assist-render-pipeline-events")],(function(e,i){return{F:class extends i{constructor(...i){super(...i),e(this)}},d:[{kind:"field",decorators:[(0,s.Cb)({attribute:!1})],key:"hass",value:void 0},{kind:"field",decorators:[(0,s.Cb)({attribute:!1})],key:"events",value:void 0},{kind:"field",key:"_processEvents",value(){return(0,o.Z)((e=>{let i;return e.forEach((e=>{i=(0,d.eP)(i,e)})),i}))}},{kind:"method",key:"render",value:function(){const e=this._processEvents(this.events);return e?(0,n.dy)(c||(c=h`
      <assist-render-pipeline-run
        .hass=${0}
        .pipelineRun=${0}
      ></assist-render-pipeline-run>
    `),this.hass,e):this.events.length?(0,n.dy)(p||(p=h`<ha-alert alert-type="error">Error showing run</ha-alert>
          <ha-card>
            <ha-expansion-panel>
              <span slot="header">Raw</span>
              <pre>${0}</pre>
            </ha-expansion-panel>
          </ha-card>`),JSON.stringify(this.events,null,2)):(0,n.dy)(u||(u=h`<ha-alert alert-type="warning"
        >There were no events in this run.</ha-alert
      >`))}}]}}),n.oi);i()}catch(p){i(p)}}))},35047:function(e,i,t){t.a(e,(async function(e,i){try{var a=t(73577),n=(t(71695),t(92745),t(39527),t(67670),t(13334),t(47021),t(57243)),s=t(50778),o=(t(1192),t(17949),t(20095),t(90977),t(2383),t(52745)),d=(t(27196),t(4557)),r=e([o]);o=(r.then?(await r)():r)[0];let l,p,u,c,h,v,g,_,m,k,y,f,w,b,$,x,L,R,z,W,C,A,S,E=e=>e;const B={pipeline:"Pipeline",language:"Language"},Z={engine:"Engine"},M={engine:"Engine"},O={engine:"Engine",language:"Language",intent_input:"Input"},P={engine:"Engine",language:"Language",voice:"Voice",tts_input:"Input"},T={ready:0,wake_word:1,stt:2,intent:3,tts:4,done:5,error:6},j=(e,i)=>e.init_options?T[e.init_options.start_stage]<=T[i]&&T[i]<=T[e.init_options.end_stage]:i in e,D=(e,i,t)=>"error"in e&&t===i?(0,n.dy)(l||(l=E`
    <ha-alert alert-type="error">
      ${0} (${0})
    </ha-alert>
  `),e.error.message,e.error.code):"",F=(e,i,t,a="-start")=>{const s=i.events.find((e=>e.type===`${t}`+a)),d=i.events.find((e=>e.type===`${t}-end`));if(!s)return"";if(!d)return"error"in i?(0,n.dy)(p||(p=E`❌`)):(0,n.dy)(u||(u=E`
      <ha-circular-progress size="small" indeterminate></ha-circular-progress>
    `));const r=new Date(d.timestamp).getTime()-new Date(s.timestamp).getTime(),l=(0,o.uf)(r/1e3,e.locale,{maximumFractionDigits:2});return(0,n.dy)(c||(c=E`${0}s ✅`),l)},q=(e,i)=>Object.entries(i).map((([i,t])=>(0,n.dy)(h||(h=E`
      <div class="row">
        <div>${0}</div>
        <div>${0}</div>
      </div>
    `),t,e[i]))),I=(e,i)=>{const t={};let a=!1;for(const n in e)n in i||"done"===n||(a=!0,t[n]=e[n]);return a?(0,n.dy)(v||(v=E`<ha-expansion-panel>
        <span slot="header">Raw</span>
        <ha-yaml-editor readOnly autoUpdate .value=${0}></ha-yaml-editor>
      </ha-expansion-panel>`),t):""};(0,a.Z)([(0,s.Mo)("assist-render-pipeline-run")],(function(e,i){return{F:class extends i{constructor(...i){super(...i),e(this)}},d:[{kind:"field",decorators:[(0,s.Cb)({attribute:!1})],key:"hass",value:void 0},{kind:"field",decorators:[(0,s.Cb)({attribute:!1})],key:"pipelineRun",value:void 0},{kind:"method",key:"render",value:function(){var e,i,t,a;const s=this.pipelineRun&&["tts","intent","stt","wake_word"].find((e=>e in this.pipelineRun))||"ready",o=[],d=(this.pipelineRun.init_options&&"text"in this.pipelineRun.init_options.input?this.pipelineRun.init_options.input.text:void 0)||(null===(e=this.pipelineRun)||void 0===e||null===(e=e.stt)||void 0===e||null===(e=e.stt_output)||void 0===e?void 0:e.text)||(null===(i=this.pipelineRun)||void 0===i||null===(i=i.intent)||void 0===i?void 0:i.intent_input);return d&&o.push({from:"user",text:d}),null!==(t=this.pipelineRun)&&void 0!==t&&null!==(t=t.intent)&&void 0!==t&&null!==(t=t.intent_output)&&void 0!==t&&null!==(t=t.response)&&void 0!==t&&null!==(t=t.speech)&&void 0!==t&&null!==(t=t.plain)&&void 0!==t&&t.speech&&o.push({from:"hass",text:this.pipelineRun.intent.intent_output.response.speech.plain.speech}),(0,n.dy)(g||(g=E`
      <ha-card>
    ...
    `),this.pipelineRun.stage,q(this.pipelineRun.run,B),o.length>0?(0,n.dy)(_||(_=E`
                <div class="messages">
                  ${0}
                </div>
                <div style="clear:both"></div>
              `),o.map((({from:e,text:i})=>(0,n.dy)(m||(m=E`
                      <div class=${0}>${0}</div>
                    `),`message ${e}`,i)))):"",D(this.pipelineRun,"ready",s),j(this.pipelineRun,"wake_word")?(0,n.dy)(k||(k=E`
            <ha-card>
              <div class="card-content">
                <div class="row heading">
                  <span>Wake word</span>
          ...
          `),F(this.hass,this.pipelineRun,"wake_word"),this.pipelineRun.wake_word?(0,n.dy)(y||(y=E`
                      <div class="card-content">
                        ${0}
                        ${0}
                        ${0}
                      </div>
                    `),q(this.pipelineRun.wake_word,M),this.pipelineRun.wake_word.wake_word_output?(0,n.dy)(f||(f=E`<div class="row">
                                <div>Model</div>
                                <div>
                                  ${0}
                                </div>
                              ...
                              </div>`),this.pipelineRun.wake_word.wake_word_output.ww_id,this.pipelineRun.wake_word.wake_word_output.timestamp):"",I(this.pipelineRun.wake_word,Z)):""):"",D(this.pipelineRun,"wake_word",s),j(this.pipelineRun,"stt")?(0,n.dy)(w||(w=E`
            <ha-card>
              <div class="card-content">
                <div class="row heading">
          ...
          `),F(this.hass,this.pipelineRun,"stt","-vad-end"),this.pipelineRun.stt?(0,n.dy)(b||(b=E`
                      <div class="card-content">
                        ${0}
                        <div class="row">
                          <div>Language</div>
                    ...
                    `),q(this.pipelineRun.stt,M),this.pipelineRun.stt.metadata.language,this.pipelineRun.stt.stt_output?(0,n.dy)($||($=E`<div class="row">
                              <div>Output</div>
                              <div>${0}</div>
                            </div>`),this.pipelineRun.stt.stt_output.text):"",I(this.pipelineRun.stt,M)):""):"",D(this.pipelineRun,"stt",s),j(this.pipelineRun,"intent")?(0,n.dy)(x||(x=E`
            <ha-card>
              <div class="card-content">
                <div class="row heading">
          ...
          `),F(this.hass,this.pipelineRun,"intent"),this.pipelineRun.intent?(0,n.dy)(L||(L=E`
                      <div class="card-content">
                        ${0}
                        ${0}
                        <div class="row">
                    ...
                    `),q(this.pipelineRun.intent,O),this.pipelineRun.intent.intent_output?(0,n.dy)(R||(R=E`<div class="row">
                                <div>Response type</div>
                                <div>
                                  ${0}
                                </div>
                              </div>
                              ${0}`),this.pipelineRun.intent.intent_output.response.response_type,"error"===this.pipelineRun.intent.intent_output.response.response_type?(0,n.dy)(z||(z=E`<div class="row">
                                    <div>Error code</div>
                                    <div>
                                      ${0}
                                    </div>
                                  </div>`),this.pipelineRun.intent.intent_output.response.data.code):""):"",this.pipelineRun.intent.prefer_local_intents,this.pipelineRun.intent.processed_locally,I(this.pipelineRun.intent,O)):""):"",D(this.pipelineRun,"intent",s),j(this.pipelineRun,"tts")?(0,n.dy)(W||(W=E`
            <ha-card>
              <div class="card-content">
                <div class="row heading">
          ...
          `),F(this.hass,this.pipelineRun,"tts"),this.pipelineRun.tts?(0,n.dy)(C||(C=E`
                      <div class="card-content">
                        ${0}
                        ${0}
                      </div>
                    `),q(this.pipelineRun.tts,P),I(this.pipelineRun.tts,P)):"",null!==(a=this.pipelineRun)&&void 0!==a&&null!==(a=a.tts)&&void 0!==a&&a.tts_output?(0,n.dy)(A||(A=E`
                    <div class="card-actions">
                      <ha-button @click=${0}>
                        Play Audio
                      </ha-button>
                    </div>
                  `),this._playTTS):""):"",D(this.pipelineRun,"tts",s),this.pipelineRun)}},{kind:"method",key:"_playTTS",value:function(){const e=this.pipelineRun.tts.tts_output.url,i=new Audio(e);i.addEventListener("error",(()=>{(0,d.Ys)(this,{title:"Error",text:"Error playing audio"})})),i.addEventListener("canplaythrough",(()=>{i.play()}))}},{kind:"field",static:!0,key:"styles",value(){return(0,n.iv)(S||(S=E`
    :host {
      display: block;
    }
    ha-card,
  ...
  `))}}]}}),n.oi);i()}catch(l){i(l)}}))},26942:function(e,i,t){t.a(e,(async function(e,a){try{t.r(i),t.d(i,{DialogVoiceAssistantPipelineDetail:function(){return x}});var n=t(73577),s=(t(71695),t(19423),t(40251),t(88044),t(39527),t(41360),t(36993),t(47021),t(57243)),o=t(50778),d=t(27486),r=t(11297),l=(t(20095),t(28906),t(42877),t(4855)),p=t(66193),u=(t(68024),t(54859),t(46343),t(52511),t(37744),t(22380)),c=t(79575),h=t(81036),v=e([u]);u=(v.then?(await v)():v)[0];let g,_,m,k,y,f,w=e=>e;const b="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z",$="M12,16A2,2 0 0,1 14,18A2,2 0 0,1 12,20A2,2 0 0,1 10,18A2,2 0 0,1 12,16M12,10A2,2 0 0,1 14,12A2,2 0 0,1 12,14A2,2 0 0,1 10,12A2,2 0 0,1 12,10M12,4A2,2 0 0,1 14,6A2,2 0 0,1 12,8A2,2 0 0,1 10,6A2,2 0 0,1 12,4Z";let x=(0,n.Z)([(0,o.Mo)("dialog-voice-assistant-pipeline-detail")],(function(e,i){return{F:class extends i{constructor(...i){super(...i),e(this)}},d:[{kind:"field",decorators:[(0,o.Cb)({attribute:!1})],key:"hass",value:void 0},{kind:"field",decorators:[(0,o.SB)()],key:"_params",value:void 0},{kind:"field",decorators:[(0,o.SB)()],key:"_data",value:void 0},{kind:"field",decorators:[(0,o.SB)()],key:"_hideWakeWord",value(){return!1}},{kind:"field",decorators:[(0,o.SB)()],key:"_cloudActive",value:void 0},{kind:"field",decorators:[(0,o.SB)()],key:"_error",value:void 0},{kind:"field",decorators:[(0,o.SB)()],key:"_submitting",value(){return!1}},{kind:"field",decorators:[(0,o.SB)()],key:"_supportedLanguages",value:void 0},{kind:"method",key:"showDialog",value:function(e){if(this._params=e,this._error=void 0,this._cloudActive=this._params.cloudActiveSubscription,this._params.pipeline)return this._data=Object.assign({prefer_local_intents:!1},this._params.pipeline),void(this._hideWakeWord=this._params.hideWakeWord||!this._data.wake_word_entity);let i,t;if(this._hideWakeWord=!0,this._cloudActive)for(const a of Object.values(this.hass.entities))if("cloud"===a.platform)if("stt"===(0,c.M)(a.entity_id)){if(i=a.entity_id,t)break}else if("tts"===(0,c.M)(a.entity_id)&&(t=a.entity_id,i))break;this._data={language:(this.hass.config.language||this.hass.locale.language).substring(0,2),stt_engine:i,tts_engine:t}}},{kind:"method",key:"closeDialog",value:function(){this._params=void 0,this._data=void 0,this._hideWakeWord=!1,(0,r.B)(this,"dialog-closed",{dialog:this.localName})}},{kind:"method",key:"firstUpdated",value:function(){this._getSupportedLanguages()}},{kind:"method",key:"_getSupportedLanguages",value:async function(){const{languages:e}=await(0,l.Dy)(this.hass);this._supportedLanguages=e}},{kind:"field",key:"_hasWakeWorkEntities",value(){return(0,d.Z)((e=>Object.keys(e).some((e=>e.startsWith("wake_word.")))))}},{kind:"method",key:"render",value:function(){var e,i,t;if(!this._params||!this._data)return s.Ld;const a=null!==(e=this._params.pipeline)&&void 0!==e&&e.id?this._params.pipeline.name:this.hass.localize("ui.panel.config.voice_assistants.assistants.pipeline.detail.add_assistant_title");return(0,s.dy)(g||(g=w`
    ...
    `),this.closeDialog,a,this.hass.localize("ui.common.close"),b,a,a,this._hideWakeWord&&!this._params.hideWakeWord&&this._hasWakeWorkEntities(this.hass.states)?(0,s.dy)(_||(_=w`<ha-button-menu
                slot="actionItems"
                @action=${0}
                @closed=${0}
                menu-corner="END"
              ...
              >`),this._handleShowWakeWord,h.U,$,this.hass.localize("ui.panel.config.voice_assistants.assistants.pipeline.detail.add_streaming_wake_word")):s.Ld,this._error?(0,s.dy)(m||(m=w`<ha-alert alert-type="error">${0}</ha-alert>`),this._error):s.Ld,this.hass,this._data,this._supportedLanguages,this._valueChanged,!(null!==(i=this._params.pipeline)&&void 0!==i&&i.id),this.hass,this._data,this._valueChanged,this._cloudActive||"cloud"!==this._data.tts_engine&&"cloud"!==this._data.stt_engine?s.Ld:(0,s.dy)(k||(k=w`
      ...
      `))]}}]}}),s.oi);a()}catch(g){a(g)}}))}}]);
//# sourceMappingURL=9329.bb3f5ac762c01577.js.map