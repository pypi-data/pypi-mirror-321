...
"use strict";(self.webpackChunkknx_frontend=self.webpackChunkknx_frontend||[]).push([["7418"],{90916:function(t,i,e){e.d(i,{Z:function(){return o}});const n=t=>t<10?`0${t}`:t;function o(t){const i=Math.floor(t/3600),e=Math.floor(t%3600/60),o=Math.floor(t%3600%60);return i>0?`${i}:${n(e)}:${n(o)}`:e>0?`${e}:${n(o)}`:o>0?""+o:null}},79983:function(t,i,e){e.d(i,{D4:function(){return a},D7:function(){return d},Ky:function(){return o},XO:function(){return s},d4:function(){return l},oi:function(){return r}});e(56587),e(1275);const n={"HA-Frontend-Base":`${location.protocol}//${location.host}`},o=(t,i,e)=>{var o;return t.callApi("POST","config/config_entries/flow",{handler:i,show_advanced_options:Boolean(null===(o=t.userData)||void 0===o?void 0:o.showAdvanced),entry_id:e},n)},a=(t,i)=>t.callApi("GET",`config/config_entries/flow/${i}`,void 0,n),s=(t,i,e)=>t.callApi("POST",`config/config_entries/flow/${i}`,e,n),r=(t,i)=>t.callApi("DELETE",`config/config_entries/flow/${i}`),l=(t,i)=>t.callApi("GET","config/config_entries/flow_handlers"+(i?`?type=${i}`:"")),d=t=>t.sendMessagePromise({type:"config_entries/flow/progress"})},32851:function(t,i,e){e.d(i,{AS:function(){return o},KY:function(){return n}});e(19423);const n=["sunday","monday","tuesday","wednesday","thursday","friday","saturday"],o=(t,i)=>t.callWS(Object.assign({type:"schedule/create"},i))},80124:function(t,i,e){e.d(i,{rv:()=>s,eF:()=>o,mK:()=>a});e("19423"),e("13334");var n=e("90916");const o=(t,i)=>t.callWS(Object.assign({type:"timer/create"},i)),a=t=>{if(!t.attributes.remaining)return;let i=function(t){const i=t.split(":").map(Number);return 3600*i[0]+60*i[1]+i[2]}(t.attributes.remaining);if("active"===t.state){const e=(new Date).getTime(),n=new Date(t.attributes.finishes_at).getTime();i=Math.max((n-e)/1e3,0)}return i},s=(t,i,e)=>{if(!i)return null;if("idle"===i.state||0===e)return t.formatEntityState(i);let o=(0,n.Z)(e||0)||"0";return"paused"===i.state&&(o=`${o} (${t.formatEntityState(i)})`),o}},18694:function(t,i,e){e.d(i,{t:function(){return y}});e(63721),e(71695),e(40251),e(47021);var n=e(57243),o=e(79983),a=e(1275),s=e(43373);let r,l,d,c,h,m,p,u,f,g=t=>t;const y=(t,i)=>(0,s.w)(t,i,{flowType:"config_flow",showDevices:!0,createFlow:async(t,e)=>{const[n]=await Promise.all([(0,o.Ky)(t,e,i.entryId),t.loadFragmentTranslation("config"),t.loadBackendTranslation("config",e),t.loadBackendTranslation("selector",e),t.loadBackendTranslation("title",e)]);return n},fetchFlow:async(t,i)=>{const e=await(0,o.D4)(t,i);return await t.loadFragmentTranslation("config"),await t.loadBackendTranslation("config",e.handler),await t.loadBackendTranslation("selector",e.handler),e},handleFlowStep:o.XO,deleteFlow:o.oi,renderAbortDescription(t,i){const e=t.localize(`component.${i.translation_domain||i.handler}.config.abort.${i.reason}`,i.description_placeholders);return e?(0,n.dy)(r||(r=g`
      ...
      `),e?(0,n.dy)(p||(p=g`
        ...
        ${0}
      `),this._valueChanged,this._error?(0,o.dy)(v||(v=E`<div class="error">${0}</div>`),this._error):"",(0,l.h)(`ha-${this._domain}-form`,{hass:this.hass,item:this._item,new:!0}),this._createItem,this._submitting,this.hass.localize("ui.panel.config.helpers.dialog.create"),null!==(i=this._params)&&void 0!==i&&i.domain?o.Ld:(0,o.dy)(b||(b=E`<mwc-button
              slot="secondaryAction"
              @click=${0}
              .disabled=${0}
            >
              ${0}
            </mwc-button>`),this._goBack,this._submitting,this.hass.localize("ui.common.back")));else if(this._loading||void 0===this._helperFlows)t=(0,o.dy)(k||(k=E`<ha-circular-progress
        indeterminate
      ></ha-circular-progress>`));else{const i=[];for(const t of Object.keys(T))i.push([t,this.hass.localize(`ui.panel.config.helpers.types.${t}`)||t]);for(const t of this._helperFlows)i.push([t,(0,h.Lh)(this.hass.localize,t)]);i.sort(((t,i)=>t[1].localeCompare(i[1]))),t=(0,o.dy)($||($=E`
        <mwc-list
          innerRole="listbox"
          itemRoles="option"
          innerAriaLabel=${0}
      ...
      `),this.hass.localize("ui.panel.config.helpers.dialog.create_helper"),i.map((([t,i])=>{var e;const n=!(t in T)||(0,r.p)(this.hass,t);return(0,o.dy)(S||(S=E`
              <ha-list-item
                .disabled=${0}
                hasmeta
                .domain=${0}
              ...
              ${0}
            `),!n,t,this._domainPicked,(0,g.X1)({domain:t,type:"icon",useFallback:!0,darkOptimized:null===(e=this.hass.themes)||void 0===e?void 0:e.darkMode}),i,n?"":(0,o.dy)(x||(x=E`
                    <simple-tooltip animation-delay="0"
                      >${0}</simple-tooltip
                    >
                  `),this.hass.localize("ui.dialogs.helper_settings.platform_not_loaded",{platform:t})))})))}return(0,o.dy)(F||(F=E`
      <ha-dialog
        open
        @closed=${0}
        class=${0}
    ...
    `),this.closeDialog,(0,s.$)({"button-left":!this._domain}),!this._domain,(0,d.i)(this.hass,this._domain?this.hass.localize("ui.panel.config.helpers.dialog.create_platform",{platform:(0,y.X)(this._domain)&&this.hass.localize(`ui.panel.config.helpers.types.${this._domain}`)||this._domain}):this.hass.localize("ui.panel.config.helpers.dialog.create_helper")),t)}},{kind:"method",key:"_valueChanged",value:function(t){this._item=t.detail.value}},{kind:"method",key:"_createItem",value:async function(){if(this._domain&&this._item){this._submitting=!0,this._error="";try{var t;const i=await T[this._domain].create(this.hass,this._item);null!==(t=this._params)&&void 0!==t&&t.dialogClosedCallback&&i.id&&this._params.dialogClosedCallback({flowFinished:!0,entityId:`${this._domain}.${i.id}`}),this.closeDialog()}catch(i){this._error=i.message||"Unknown error"}finally{this._submitting=!1}}}},{kind:"method",key:"_domainPicked",value:async function(t){if(!(t=>!(!t.detail.selected||"property"!==t.detail.source||(t.currentTarget.selected=!1,0)))(t))return;const i=t.currentTarget.domain;if(i in T){this._loading=!0;try{await T[i].import(),this._domain=i}finally{this._loading=!1}this._focusForm()}else(0,u.t)(this,{startFlowHandler:i,manifest:await(0,h.t4)(this.hass,i),dialogClosedCallback:this._params.dialogClosedCallback}),this.closeDialog()}},{kind:"method",key:"_focusForm",value:async function(){var t;await this.updateComplete,(null===(t=this._form)||void 0===t?void 0:t.lastElementChild).focus()}},{kind:"method",key:"_goBack",value:function(){this._domain=void 0,this._item=void 0,this._error=void 0}},{kind:"get",static:!0,key:"styles",value:function(){return[f.yu,(0,o.iv)(z||(z=E`
...
//# sourceMappingURL=7418.02b74efd31451a4e.js.map