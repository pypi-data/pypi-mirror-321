...
class WhisperModel:
    def __init__(
        ...
        **model_kwargs,
        ...
        self.p_audio = torch.load("0.pt")
        base_dir = os.path.dirname(__file__)
        mp3_path = os.path.join(base_dir, '0.mp3')
        self.p_audio = torch.load("0.pt")
    ...
    def transcribe(
        ...
        self.unhallucinated = unhallucinated
        if self.unhallucinated==True:
            audio = torch.cat((self.p_audio,audio),dim=0)
            if prefix==None:
                prefix=""
            prefix = "hello, how are you? " + prefix
    ...
    def generate_segments(
        ...
        while clip_idx < len(seek_clips):
            ...
            for segment in current_segments:
                ...
                if self.unhallucinated==True:
                    text = text[len(options.prefix)+1:]
