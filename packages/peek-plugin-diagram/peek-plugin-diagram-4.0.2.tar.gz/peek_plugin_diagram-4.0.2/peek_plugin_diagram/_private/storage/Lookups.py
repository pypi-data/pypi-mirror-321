...
class DispColor(DeclarativeBase, Tuple):
    ...
    @property
    def color(self):
        if not DispColor.__WARNED_GET_COLOR_PROP:
            logger.warning("Accessing depreciated color property")
            DispColor.__WARNED_GET_COLOR_PROP = True

        return self.darkColor

    @color.setter
    def color(self, value: str):
        if not DispColor.__WARNED_SET_COLOR_PROP:
            logger.warning("Setting depreciated color property")
            DispColor.__WARNED_SET_COLOR_PROP = True
