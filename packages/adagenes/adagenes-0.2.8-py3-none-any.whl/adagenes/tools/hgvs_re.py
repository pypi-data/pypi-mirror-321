...
def convert_aa_exchange_to_single_letter_code(aa_exchange, mtype=None):
    """
...
variant_exchange_pt_fs = '([a-z|A-Z][0-9]+fs|del|dup|DEL|DUP$)'
variant_exchange_long_pt = '([a-z|A-Z]+[0-9]+[a-z|A-Z|=|\\*]{1,3})'
