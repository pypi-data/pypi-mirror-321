...
def MFP_3D_series(ds,delta_t,stations,xrange=[-100,100],yrange=[-100,100],zrange=[-100,100],vrange=[2500,2500],freqrange=[100,200],dx=5,dy=5,dz=5,dv=250):
    ...
    waveform_spectra_lim = multi_waveform_spectra[:,:,freq_idx]
    # Normalized
    #print(waveform_spectra_lim.shape)
    #spectral_norm = torch.linalg.norm(waveform_spectra_lim, dim=(2))  # Spectral norm
    #print(spectral_norm[...,None].shape)
    #print(spectral_norm)
    #waveform_spectra_lim = waveform_spectra_lim/spectral_norm[...,None]
