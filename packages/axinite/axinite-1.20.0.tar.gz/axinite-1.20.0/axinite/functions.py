...
def time_to(time: np.float64, unit: str) -> str:
    ...
    """
    if unit == "min":
        return f"{time / 60}min"
    elif unit == "hr":
        return f"{time / 3600}hr"
    elif unit == "d":
        return f"{time / 86400}d"
    elif unit == "yr":
        return f"{time / 31536000}yr"
    else: return f"{time}s"

def mass_to(mass: np.float64, unit: str) -> str:
    ...
    if unit == "kg":
        ...
        return f"{mass * 1000}g"
    elif unit == "t":
        return f"{mass / 1000}t"
    else: return f"{mass}kg"

def distance_to(distance: np.float64, unit: str) -> str:
    ...
    if unit == "m":
        ...
        return f"{distance * 100}cm"
    elif unit == "mm":
        return f"{distance * 1000}mm"
    elif unit == "μm":
        return f"{distance * 1000000}μm"
    elif unit == "nm":
        return f"{distance * 1000000000}nm"
    else: return f"{distance}m"
