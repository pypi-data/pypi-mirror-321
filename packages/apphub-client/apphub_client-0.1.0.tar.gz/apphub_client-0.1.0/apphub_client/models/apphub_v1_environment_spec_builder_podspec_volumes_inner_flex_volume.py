...
class ApphubV1EnvironmentSpecBuilderPodspecVolumesInnerFlexVolume(BaseModel):
    """
    ...
    secret_ref: Optional[ApphubV1EnvironmentSpecBuilderPodspecVolumesInnerFlexVolumeSecretRef] = Field(default=None, alias="secretRef")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ApphubV1EnvironmentSpecBuilderPodspecVolumesInnerFlexVolume from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ApphubV1EnvironmentSpecBuilderPodspecVolumesInnerFlexVolume from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "secretRef": ApphubV1EnvironmentSpecBuilderPodspecVolumesInnerFlexVolumeSecretRef.from_dict(obj.get("secretRef")) if obj.get("secretRef") is not None else None
        })
        return _obj
