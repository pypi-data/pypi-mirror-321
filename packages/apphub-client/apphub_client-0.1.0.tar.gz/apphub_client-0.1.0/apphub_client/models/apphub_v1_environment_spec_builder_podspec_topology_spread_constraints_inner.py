...
class ApphubV1EnvironmentSpecBuilderPodspecTopologySpreadConstraintsInner(BaseModel):
    """
    TopologySpreadConstraint specifies how to spread matching pods among the given topology.
    """ # noqa: E501
    label_selector: Optional[ApphubV1EnvironmentSpecBuilderPodspecTopologySpreadConstraintsInnerLabelSelector] = Field(default=None, alias="labelSelector")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ApphubV1EnvironmentSpecBuilderPodspecTopologySpreadConstraintsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ApphubV1EnvironmentSpecBuilderPodspecTopologySpreadConstraintsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "labelSelector": ApphubV1EnvironmentSpecBuilderPodspecTopologySpreadConstraintsInnerLabelSelector.from_dict(obj.get("labelSelector")) if obj.get("labelSelector") is not None else None,
