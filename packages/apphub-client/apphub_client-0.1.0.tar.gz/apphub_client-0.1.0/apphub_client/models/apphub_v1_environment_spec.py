...
class ApphubV1EnvironmentSpec(BaseModel):
    """
    ...
    allowed_functions_per_container: Optional[StrictStr] = Field(default=None, description="(Optional) defaults to 'single'. AppHub workflow uses 'infinite' to load multiple functions in one function pod. Available value: - single - infinite", alias="allowedFunctionsPerContainer")
    builder: Optional[ApphubV1EnvironmentSpecBuilder] = None
    ...
    resources: Optional[ApphubV1EnvironmentSpecResources] = None
    runtime: ApphubV1EnvironmentSpecRuntime
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ApphubV1EnvironmentSpec from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ApphubV1EnvironmentSpec from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "builder": ApphubV1EnvironmentSpecBuilder.from_dict(obj.get("builder")) if obj.get("builder") is not None else None,
            "imagepullsecret": obj.get("imagepullsecret"),
            "keeparchive": obj.get("keeparchive"),
            "poolsize": obj.get("poolsize"),
            "resources": ApphubV1EnvironmentSpecResources.from_dict(obj.get("resources")) if obj.get("resources") is not None else None,
            "runtime": ApphubV1EnvironmentSpecRuntime.from_dict(obj.get("runtime")) if obj.get("runtime") is not None else None,
