...
class ApphubV1EnvironmentSpecBuilderPodspecVolumesInnerCinder(BaseModel):
    """
    ...
    secret_ref: Optional[ApphubV1EnvironmentSpecBuilderPodspecVolumesInnerCinderSecretRef] = Field(default=None, alias="secretRef")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ApphubV1EnvironmentSpecBuilderPodspecVolumesInnerCinder from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ApphubV1EnvironmentSpecBuilderPodspecVolumesInnerCinder from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "secretRef": ApphubV1EnvironmentSpecBuilderPodspecVolumesInnerCinderSecretRef.from_dict(obj.get("secretRef")) if obj.get("secretRef") is not None else None,
