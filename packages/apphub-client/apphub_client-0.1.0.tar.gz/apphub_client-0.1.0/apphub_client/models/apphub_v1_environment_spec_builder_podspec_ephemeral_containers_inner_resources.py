...
class ApphubV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerResources(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "claims": [ApphubV1EnvironmentSpecBuilderContainerResourcesClaimsInner.from_dict(_item) for _item in obj.get("claims")] if obj.get("claims") is not None else None,
