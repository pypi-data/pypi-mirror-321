...
class ApphubV1FunctionSpec(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "InvokeStrategy": ApphubV1FunctionSpecInvokeStrategy.from_dict(obj.get("InvokeStrategy")) if obj.get("InvokeStrategy") is not None else None,
            "concurrency": obj.get("concurrency"),
            "configmaps": obj.get("configmaps"),
            "environment": ApphubV1FunctionSpecEnvironment.from_dict(obj.get("environment")) if obj.get("environment") is not None else None,
            "functionTimeout": obj.get("functionTimeout"),
            "idletimeout": obj.get("idletimeout"),
            "onceOnly": obj.get("onceOnly"),
            "package": ApphubV1FunctionSpecPackage.from_dict(obj.get("package")) if obj.get("package") is not None else None,
            "podspec": ApphubV1FunctionSpecPodspec.from_dict(obj.get("podspec")) if obj.get("podspec") is not None else None,
            "requestsPerPod": obj.get("requestsPerPod"),
            "resources": ApphubV1FunctionSpecResources.from_dict(obj.get("resources")) if obj.get("resources") is not None else None,
