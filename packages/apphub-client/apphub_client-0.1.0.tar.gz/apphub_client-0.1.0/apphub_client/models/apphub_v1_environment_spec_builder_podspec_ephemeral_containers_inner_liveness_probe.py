...
class ApphubV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerLivenessProbe(BaseModel):
    """
    ...
    grpc: Optional[ApphubV1EnvironmentSpecBuilderContainerLivenessProbeGrpc] = None
    ...
    tcp_socket: Optional[ApphubV1EnvironmentSpecBuilderContainerLivenessProbeTcpSocket] = Field(default=None, alias="tcpSocket")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ApphubV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerLivenessProbe from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ApphubV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerLivenessProbe from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "exec": ApphubV1EnvironmentSpecBuilderContainerLifecyclePostStartExec.from_dict(obj.get("exec")) if obj.get("exec") is not None else None,
            "failureThreshold": obj.get("failureThreshold"),
            "grpc": ApphubV1EnvironmentSpecBuilderContainerLivenessProbeGrpc.from_dict(obj.get("grpc")) if obj.get("grpc") is not None else None,
            "httpGet": ApphubV1EnvironmentSpecBuilderContainerLifecyclePostStartHttpGet.from_dict(obj.get("httpGet")) if obj.get("httpGet") is not None else None,
            ...
            "tcpSocket": ApphubV1EnvironmentSpecBuilderContainerLivenessProbeTcpSocket.from_dict(obj.get("tcpSocket")) if obj.get("tcpSocket") is not None else None,
