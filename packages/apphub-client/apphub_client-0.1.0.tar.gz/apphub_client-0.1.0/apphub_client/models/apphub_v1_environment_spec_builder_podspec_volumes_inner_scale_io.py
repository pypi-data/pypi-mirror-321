...
class ApphubV1EnvironmentSpecBuilderPodspecVolumesInnerScaleIO(BaseModel):
    """
    ...
    secret_ref: ApphubV1EnvironmentSpecBuilderPodspecVolumesInnerScaleIOSecretRef = Field(alias="secretRef")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ApphubV1EnvironmentSpecBuilderPodspecVolumesInnerScaleIO from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ApphubV1EnvironmentSpecBuilderPodspecVolumesInnerScaleIO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "secretRef": ApphubV1EnvironmentSpecBuilderPodspecVolumesInnerScaleIOSecretRef.from_dict(obj.get("secretRef")) if obj.get("secretRef") is not None else None,
