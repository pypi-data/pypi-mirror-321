...
class ApphubV1PackageSpecDeployment(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ApphubV1PackageSpecDeployment from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ApphubV1PackageSpecDeployment from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "checksum": ApphubV1PackageSpecDeploymentChecksum.from_dict(obj.get("checksum")) if obj.get("checksum") is not None else None,
