...
class ApphubV1EnvironmentSpecBuilderPodspecVolumesInnerCsi(BaseModel):
    """
    ...
    node_publish_secret_ref: Optional[ApphubV1EnvironmentSpecBuilderPodspecVolumesInnerCsiNodePublishSecretRef] = Field(default=None, alias="nodePublishSecretRef")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ApphubV1EnvironmentSpecBuilderPodspecVolumesInnerCsi from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ApphubV1EnvironmentSpecBuilderPodspecVolumesInnerCsi from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "nodePublishSecretRef": ApphubV1EnvironmentSpecBuilderPodspecVolumesInnerCsiNodePublishSecretRef.from_dict(obj.get("nodePublishSecretRef")) if obj.get("nodePublishSecretRef") is not None else None,
