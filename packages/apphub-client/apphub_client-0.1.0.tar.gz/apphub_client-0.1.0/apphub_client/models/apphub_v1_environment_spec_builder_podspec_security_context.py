...
class ApphubV1EnvironmentSpecBuilderPodspecSecurityContext(BaseModel):
    """
    SecurityContext holds pod-level security attributes and common container settings. Optional: Defaults to empty.  See type description for default values of each field.
    """ # noqa: E501
    app_armor_profile: Optional[ApphubV1EnvironmentSpecBuilderPodspecSecurityContextAppArmorProfile] = Field(default=None, alias="appArmorProfile")
    ...
    se_linux_options: Optional[ApphubV1EnvironmentSpecBuilderPodspecSecurityContextSeLinuxOptions] = Field(default=None, alias="seLinuxOptions")
    seccomp_profile: Optional[ApphubV1EnvironmentSpecBuilderPodspecSecurityContextSeccompProfile] = Field(default=None, alias="seccompProfile")
    ...
    sysctls: Optional[List[ApphubV1EnvironmentSpecBuilderPodspecSecurityContextSysctlsInner]] = Field(default=None, description="Sysctls hold a list of namespaced sysctls used for the pod. Pods with unsupported sysctls (by the container runtime) might fail to launch. Note that this field cannot be set when spec.os.name is windows.")
    windows_options: Optional[ApphubV1EnvironmentSpecBuilderPodspecSecurityContextWindowsOptions] = Field(default=None, alias="windowsOptions")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ApphubV1EnvironmentSpecBuilderPodspecSecurityContext from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ApphubV1EnvironmentSpecBuilderPodspecSecurityContext from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "appArmorProfile": ApphubV1EnvironmentSpecBuilderPodspecSecurityContextAppArmorProfile.from_dict(obj.get("appArmorProfile")) if obj.get("appArmorProfile") is not None else None,
            ...
            "seLinuxOptions": ApphubV1EnvironmentSpecBuilderPodspecSecurityContextSeLinuxOptions.from_dict(obj.get("seLinuxOptions")) if obj.get("seLinuxOptions") is not None else None,
            "seccompProfile": ApphubV1EnvironmentSpecBuilderPodspecSecurityContextSeccompProfile.from_dict(obj.get("seccompProfile")) if obj.get("seccompProfile") is not None else None,
            "supplementalGroups": obj.get("supplementalGroups"),
            "supplementalGroupsPolicy": obj.get("supplementalGroupsPolicy"),
            "sysctls": [ApphubV1EnvironmentSpecBuilderPodspecSecurityContextSysctlsInner.from_dict(_item) for _item in obj.get("sysctls")] if obj.get("sysctls") is not None else None,
            "windowsOptions": ApphubV1EnvironmentSpecBuilderPodspecSecurityContextWindowsOptions.from_dict(obj.get("windowsOptions")) if obj.get("windowsOptions") is not None else None
        })
        return _obj
