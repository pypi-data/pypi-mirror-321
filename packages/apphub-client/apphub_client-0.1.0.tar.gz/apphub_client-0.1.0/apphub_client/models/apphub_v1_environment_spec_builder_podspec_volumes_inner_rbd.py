...
class ApphubV1EnvironmentSpecBuilderPodspecVolumesInnerRbd(BaseModel):
    """
    ...
    secret_ref: Optional[ApphubV1EnvironmentSpecBuilderPodspecVolumesInnerRbdSecretRef] = Field(default=None, alias="secretRef")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ApphubV1EnvironmentSpecBuilderPodspecVolumesInnerRbd from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ApphubV1EnvironmentSpecBuilderPodspecVolumesInnerRbd from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "secretRef": ApphubV1EnvironmentSpecBuilderPodspecVolumesInnerRbdSecretRef.from_dict(obj.get("secretRef")) if obj.get("secretRef") is not None else None,
            "user": obj.get("user")
        })
        return _obj
