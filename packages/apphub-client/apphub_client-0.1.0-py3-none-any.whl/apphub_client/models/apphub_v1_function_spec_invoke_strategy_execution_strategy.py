...
class ApphubV1FunctionSpecInvokeStrategyExecutionStrategy(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "hpaBehavior": ApphubV1FunctionSpecInvokeStrategyExecutionStrategyHpaBehavior.from_dict(obj.get("hpaBehavior")) if obj.get("hpaBehavior") is not None else None,
            "hpaMetrics": [ApphubV1FunctionSpecInvokeStrategyExecutionStrategyHpaMetricsInner.from_dict(_item) for _item in obj.get("hpaMetrics")] if obj.get("hpaMetrics") is not None else None
        })
        return _obj
