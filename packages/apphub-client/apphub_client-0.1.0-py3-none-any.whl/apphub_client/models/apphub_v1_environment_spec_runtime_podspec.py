...
class ApphubV1EnvironmentSpecRuntimePodspec(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "affinity": ApphubV1EnvironmentSpecBuilderPodspecAffinity.from_dict(obj.get("affinity")) if obj.get("affinity") is not None else None,
            "automountServiceAccountToken": obj.get("automountServiceAccountToken"),
            "containers": [ApphubV1EnvironmentSpecBuilderPodspecContainersInner.from_dict(_item) for _item in obj.get("containers")] if obj.get("containers") is not None else None,
            "dnsConfig": ApphubV1EnvironmentSpecBuilderPodspecDnsConfig.from_dict(obj.get("dnsConfig")) if obj.get("dnsConfig") is not None else None,
            "dnsPolicy": obj.get("dnsPolicy"),
            "enableServiceLinks": obj.get("enableServiceLinks"),
            "ephemeralContainers": [ApphubV1EnvironmentSpecBuilderPodspecEphemeralContainersInner.from_dict(_item) for _item in obj.get("ephemeralContainers")] if obj.get("ephemeralContainers") is not None else None,
            "hostAliases": [ApphubV1EnvironmentSpecBuilderPodspecHostAliasesInner.from_dict(_item) for _item in obj.get("hostAliases")] if obj.get("hostAliases") is not None else None,
            "hostIPC": obj.get("hostIPC"),
            "hostNetwork": obj.get("hostNetwork"),
            "hostPID": obj.get("hostPID"),
            "hostUsers": obj.get("hostUsers"),
            "hostname": obj.get("hostname"),
            "imagePullSecrets": [ApphubV1EnvironmentSpecBuilderPodspecImagePullSecretsInner.from_dict(_item) for _item in obj.get("imagePullSecrets")] if obj.get("imagePullSecrets") is not None else None,
            "initContainers": [ApphubV1EnvironmentSpecBuilderPodspecContainersInner.from_dict(_item) for _item in obj.get("initContainers")] if obj.get("initContainers") is not None else None,
            "nodeName": obj.get("nodeName"),
            "nodeSelector": obj.get("nodeSelector"),
            "os": ApphubV1EnvironmentSpecBuilderPodspecOs.from_dict(obj.get("os")) if obj.get("os") is not None else None,
            "overhead": obj.get("overhead"),
            "preemptionPolicy": obj.get("preemptionPolicy"),
            "priority": obj.get("priority"),
            "priorityClassName": obj.get("priorityClassName"),
            "readinessGates": [ApphubV1EnvironmentSpecBuilderPodspecReadinessGatesInner.from_dict(_item) for _item in obj.get("readinessGates")] if obj.get("readinessGates") is not None else None,
            "resourceClaims": [ApphubV1EnvironmentSpecBuilderPodspecResourceClaimsInner.from_dict(_item) for _item in obj.get("resourceClaims")] if obj.get("resourceClaims") is not None else None,
            "restartPolicy": obj.get("restartPolicy"),
            "runtimeClassName": obj.get("runtimeClassName"),
            "schedulerName": obj.get("schedulerName"),
            "schedulingGates": [ApphubV1EnvironmentSpecBuilderPodspecSchedulingGatesInner.from_dict(_item) for _item in obj.get("schedulingGates")] if obj.get("schedulingGates") is not None else None,
            "securityContext": ApphubV1EnvironmentSpecBuilderPodspecSecurityContext.from_dict(obj.get("securityContext")) if obj.get("securityContext") is not None else None,
            ...
            "tolerations": [ApphubV1EnvironmentSpecBuilderPodspecTolerationsInner.from_dict(_item) for _item in obj.get("tolerations")] if obj.get("tolerations") is not None else None,
            "topologySpreadConstraints": [ApphubV1EnvironmentSpecBuilderPodspecTopologySpreadConstraintsInner.from_dict(_item) for _item in obj.get("topologySpreadConstraints")] if obj.get("topologySpreadConstraints") is not None else None,
            "volumes": [ApphubV1EnvironmentSpecBuilderPodspecVolumesInner.from_dict(_item) for _item in obj.get("volumes")] if obj.get("volumes") is not None else None
        })
        return _obj
