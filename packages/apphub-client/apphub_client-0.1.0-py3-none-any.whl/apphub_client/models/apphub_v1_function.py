...
class ApphubV1Function(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ApphubV1Function from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ApphubV1Function from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "spec": ApphubV1FunctionSpec.from_dict(obj.get("spec")) if obj.get("spec") is not None else None
        })
        return _obj
