...
class ApphubV1EnvironmentSpecBuilderPodspecDnsConfig(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ApphubV1EnvironmentSpecBuilderPodspecDnsConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ApphubV1EnvironmentSpecBuilderPodspecDnsConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "options": [ApphubV1EnvironmentSpecBuilderPodspecDnsConfigOptionsInner.from_dict(_item) for _item in obj.get("options")] if obj.get("options") is not None else None,
