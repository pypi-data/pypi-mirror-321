...
class ApphubV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerSecurityContext(BaseModel):
    """
    ...
    app_armor_profile: Optional[ApphubV1EnvironmentSpecBuilderContainerSecurityContextAppArmorProfile] = Field(default=None, alias="appArmorProfile")
    capabilities: Optional[ApphubV1EnvironmentSpecBuilderContainerSecurityContextCapabilities] = None
    ...
    se_linux_options: Optional[ApphubV1EnvironmentSpecBuilderContainerSecurityContextSeLinuxOptions] = Field(default=None, alias="seLinuxOptions")
    seccomp_profile: Optional[ApphubV1EnvironmentSpecBuilderContainerSecurityContextSeccompProfile] = Field(default=None, alias="seccompProfile")
    windows_options: Optional[ApphubV1EnvironmentSpecBuilderContainerSecurityContextWindowsOptions] = Field(default=None, alias="windowsOptions")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ApphubV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerSecurityContext from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ApphubV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerSecurityContext from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "appArmorProfile": ApphubV1EnvironmentSpecBuilderContainerSecurityContextAppArmorProfile.from_dict(obj.get("appArmorProfile")) if obj.get("appArmorProfile") is not None else None,
            "capabilities": ApphubV1EnvironmentSpecBuilderContainerSecurityContextCapabilities.from_dict(obj.get("capabilities")) if obj.get("capabilities") is not None else None,
            ...
            "seLinuxOptions": ApphubV1EnvironmentSpecBuilderContainerSecurityContextSeLinuxOptions.from_dict(obj.get("seLinuxOptions")) if obj.get("seLinuxOptions") is not None else None,
            "seccompProfile": ApphubV1EnvironmentSpecBuilderContainerSecurityContextSeccompProfile.from_dict(obj.get("seccompProfile")) if obj.get("seccompProfile") is not None else None,
            "windowsOptions": ApphubV1EnvironmentSpecBuilderContainerSecurityContextWindowsOptions.from_dict(obj.get("windowsOptions")) if obj.get("windowsOptions") is not None else None
        })
        return _obj
