...
from ..errors.exceptions import UsbDisconnectionError
...
class UsbHidManager:
    ...
    def __main(self):
        ...
        while self.run == True:
            try:
                ...
                # Kill process
                self.run = False
                # Rise ONLY the UsbDisconnectionError exception
                raise UsbDisconnectionError from None
    ...
    def send(self, transfer):
        ...
        for packet in packets:
            ...
            self.usbHidDevice.write(transfer_with_endpoint)
