...
class SysCommandCodes(Enum):
    ...
    """
    SYS_RESET_DEVICE                            = makeCommandCode(GROUP_SYS, CommandRole.GENERIC.value, CommandType.REQUEST_RESPONSE.value, 1)
    SYS_ENTER_BOOT_MODE                         = makeCommandCode(GROUP_SYS, CommandRole.GENERIC.value, CommandType.REQUEST_RESPONSE.value, 2)
    SYS_ENTER_ISP_MODE                          = makeCommandCode(GROUP_SYS, CommandRole.GENERIC.value, CommandType.REQUEST_RESPONSE.value, 3)
    SYS_SET_I3C_VOLTAGE                         = makeCommandCode(GROUP_SYS, CommandRole.GENERIC.value, CommandType.REQUEST_RESPONSE.value, 4)
    SYS_SET_I2C_SPI_UART_GPIO_VOLTAGE           = makeCommandCode(GROUP_SYS, CommandRole.GENERIC.value, CommandType.REQUEST_RESPONSE.value, 5)
    SYS_SET_1WIRE_VOLTAGE                       = makeCommandCode(GROUP_SYS, CommandRole.GENERIC.value, CommandType.REQUEST_RESPONSE.value, 6)
    SYS_GET_USB_STRING                          = makeCommandCode(GROUP_SYS, CommandRole.GENERIC.value, CommandType.REQUEST_RESPONSE.value, 7)
    SYS_GET_I3C_CONNECTOR_STATUS                = makeCommandCode(GROUP_SYS, CommandRole.GENERIC.value, CommandType.REQUEST_RESPONSE.value, 8)
    SYS_GET_ANALOG_MEASUREMENTS                 = makeCommandCode(GROUP_SYS, CommandRole.GENERIC.value, CommandType.REQUEST_RESPONSE.value, 9)
    SYS_USE_EXTERNAL_I3C_VOLTAGE                = makeCommandCode(GROUP_SYS, CommandRole.GENERIC.value, CommandType.REQUEST_RESPONSE.value, 10)
    SYS_USE_EXTERNAL_I2C_SPI_UART_GPIO_VOLTAGE  = makeCommandCode(GROUP_SYS, CommandRole.GENERIC.value, CommandType.REQUEST_RESPONSE.value, 11)
    SYS_I3C_CONNECTOR_EVENT_NOTIFICATION        = makeCommandCode(GROUP_SYS, CommandRole.GENERIC.value, CommandType.NOTIFICATION.value, 1)
...
class SysResultCodes(Enum):
    ...
    """
    VOLTAGE_OUT_OF_RANGE                = makeResultCode(GROUP_SYS, 1)
    EXTERNAL_VOLTAGE_DETECTED           = makeResultCode(GROUP_SYS, 2)
    VOLTAGE_ADJUSTMENT_FAILURE          = makeResultCode(GROUP_SYS, 3)
    I3C_PORTS_NOT_POWERED               = makeResultCode(GROUP_SYS, 4)
    BOTH_I3C_PORTS_POWERED              = makeResultCode(GROUP_SYS, 5)
    VOLTAGE_OUT_OF_RANGE_ON_I3C_LV      = makeResultCode(GROUP_SYS, 6)
    VOLTAGE_OUT_OF_RANGE_ON_I3C_HV      = makeResultCode(GROUP_SYS, 7)
