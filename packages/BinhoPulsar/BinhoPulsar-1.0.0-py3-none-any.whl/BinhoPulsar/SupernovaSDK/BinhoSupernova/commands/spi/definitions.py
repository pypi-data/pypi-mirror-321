...
class SpiCommandCodes(Enum):
    ...
    """
    SPI_DEINIT                      = makeCommandCode(GROUP_SPI, CommandRole.GENERIC.value, CommandType.REQUEST_RESPONSE.value, 1)
    SPI_CONTROLLER_INIT             = makeCommandCode(GROUP_SPI, CommandRole.CONTROLLER.value, CommandType.REQUEST_RESPONSE.value, 1)
    SPI_CONTROLLER_SET_PARAMETERS   = makeCommandCode(GROUP_SPI, CommandRole.CONTROLLER.value, CommandType.REQUEST_RESPONSE.value, 2)
    SPI_CONTROLLER_GET_PARAMETERS   = makeCommandCode(GROUP_SPI, CommandRole.CONTROLLER.value, CommandType.REQUEST_RESPONSE.value, 3)
    SPI_CONTROLLER_TRANSFER         = makeCommandCode(GROUP_SPI, CommandRole.CONTROLLER.value, CommandType.REQUEST_RESPONSE.value, 4)
