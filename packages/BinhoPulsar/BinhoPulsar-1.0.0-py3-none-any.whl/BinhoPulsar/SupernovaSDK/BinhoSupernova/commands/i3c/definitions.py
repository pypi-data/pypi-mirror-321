...
class I3cCommandCodes(Enum):
    ...
    """
    I3C_DEINIT                                  = makeCommandCode(GROUP_I3C, CommandRole.GENERIC.value, CommandType.REQUEST_RESPONSE.value, 1)
    I3C_SET_PULLUP_RESISTORS                    = makeCommandCode(GROUP_I3C, CommandRole.GENERIC.value, CommandType.REQUEST_RESPONSE.value, 2)
    I3C_CONTROLLER_INIT                         = makeCommandCode(GROUP_I3C, CommandRole.CONTROLLER.value, CommandType.REQUEST_RESPONSE.value, 1)
    I3C_CONTROLLER_SET_PARAMETERS               = makeCommandCode(GROUP_I3C, CommandRole.CONTROLLER.value, CommandType.REQUEST_RESPONSE.value, 2)
    I3C_CONTROLLER_GET_PARAMETERS               = makeCommandCode(GROUP_I3C, CommandRole.CONTROLLER.value, CommandType.REQUEST_RESPONSE.value, 3)
    I3C_CONTROLLER_INIT_BUS                     = makeCommandCode(GROUP_I3C, CommandRole.CONTROLLER.value, CommandType.REQUEST_RESPONSE.value, 4)
    I3C_CONTROLLER_RESET_BUS                    = makeCommandCode(GROUP_I3C, CommandRole.CONTROLLER.value, CommandType.REQUEST_RESPONSE.value, 5)
    I3C_CONTROLLER_GET_TARGET_DEVICES_TABLE     = makeCommandCode(GROUP_I3C, CommandRole.CONTROLLER.value, CommandType.REQUEST_RESPONSE.value, 6)
    I3C_CONTROLLER_SET_TARGET_DEVICE_CONFIG     = makeCommandCode(GROUP_I3C, CommandRole.CONTROLLER.value, CommandType.REQUEST_RESPONSE.value, 7)
    I3C_CONTROLLER_PRIVATE_TRANSFER             = makeCommandCode(GROUP_I3C, CommandRole.CONTROLLER.value, CommandType.REQUEST_RESPONSE.value, 8)
    I3C_CONTROLLER_CCC_TRANSFER                 = makeCommandCode(GROUP_I3C, CommandRole.CONTROLLER.value, CommandType.REQUEST_RESPONSE.value, 9)
    I3C_CONTROLLER_TRIGGER_PATTERN              = makeCommandCode(GROUP_I3C, CommandRole.CONTROLLER.value, CommandType.REQUEST_RESPONSE.value, 10)
    I3C_CONTROLLER_IBI_REQUEST_NOTIFICATION     = makeCommandCode(GROUP_I3C, CommandRole.CONTROLLER.value, CommandType.NOTIFICATION.value, 1)
    I3C_CONTROLLER_HJ_REQUEST_NOTIFICATION      = makeCommandCode(GROUP_I3C, CommandRole.CONTROLLER.value, CommandType.NOTIFICATION.value, 2)
    I3C_CONTROLLER_CR_REQUEST_NOTIFICATION      = makeCommandCode(GROUP_I3C, CommandRole.CONTROLLER.value, CommandType.NOTIFICATION.value, 3)
    I3C_TARGET_INIT                             = makeCommandCode(GROUP_I3C, CommandRole.TARGET.value, CommandType.REQUEST_RESPONSE.value, 1)
    I3C_TARGET_SET_PARAMETERS                   = makeCommandCode(GROUP_I3C, CommandRole.TARGET.value, CommandType.REQUEST_RESPONSE.value, 2)
    I3C_TARGET_WRITE_MEMORY                     = makeCommandCode(GROUP_I3C, CommandRole.TARGET.value, CommandType.REQUEST_RESPONSE.value, 3)
    I3C_TARGET_READ_MEMORY                      = makeCommandCode(GROUP_I3C, CommandRole.TARGET.value, CommandType.REQUEST_RESPONSE.value, 4)
    I3C_TARGET_BUS_EVENT_NOTIFICATION           = makeCommandCode(GROUP_I3C, CommandRole.TARGET.value, CommandType.NOTIFICATION.value, 1)
...
class I3cResultCodes(Enum):
    ...
    """
    FULL_TARGET_DEVICES_TABLE 					= makeResultCode(GROUP_I3C,1)
    NOT_ENOUGH_SPACE_IN_TARGET_DEVICES_TABLE 	= makeResultCode(GROUP_I3C,2)
    TARGET_DEVICES_TABLE_OVERFLOW 				= makeResultCode(GROUP_I3C,3)
    TARGET_ADDRESS_NOT_FOUND_IN_THE_TABLE 		= makeResultCode(GROUP_I3C,4)
    REPEATED_TARGET_ADDRESS 					= makeResultCode(GROUP_I3C,5)
    INVALID_TARGET_ADDRESS 						= makeResultCode(GROUP_I3C,6)
    I3C_BUS_INIT_NACK_RSTDAA 					= makeResultCode(GROUP_I3C,7)
    I3C_BUS_INIT_NACK_SETDASA 					= makeResultCode(GROUP_I3C,8)
    I3C_BUS_INIT_NACK_SETAASA 					= makeResultCode(GROUP_I3C,9)
    I3C_BUS_INIT_NACK_ENTDAA 					= makeResultCode(GROUP_I3C,10)
    I3C_NACK_ADDRESS 							= makeResultCode(GROUP_I3C,11)
    I3C_I2C_NACK_BYTE 							= makeResultCode(GROUP_I3C,12)
    I3C_TRANSFER_ABORTED_BY_CONTROLLER			= makeResultCode(GROUP_I3C,13)
    I3C_TRANSFER_MWL_REACHED 					= makeResultCode(GROUP_I3C,14)
    I3C_TRANSFER_MRL_REACHED 					= makeResultCode(GROUP_I3C,15)
    I3C_TRANSFER_PARITY_ERROR 					= makeResultCode(GROUP_I3C,16)
    IBI_REQUEST_ACCEPTED 						= makeResultCode(GROUP_I3C,17)
    IBI_REQUEST_ACCEPTED_WITH_PAYLOAD			= makeResultCode(GROUP_I3C,18)
    IBI_REQUEST_REJECTED 						= makeResultCode(GROUP_I3C,19)
    HJ_REQUEST_ACCEPTED 						= makeResultCode(GROUP_I3C,20)
    HJ_REQUEST_REJECTED 						= makeResultCode(GROUP_I3C,21)
    REGISTER_ADDRESS_OUT_OF_RANGE               = makeResultCode(GROUP_I3C,22)
    SURPASSED_MEMORY_SIZE                       = makeResultCode(GROUP_I3C,23)
...
class I3cPushPullTransferRate(Enum):
    """
    This enum represents the possible values to be assigned to the transfer rate bits in the command descriptor.
    ...
    """
    PUSH_PULL_3_75_MHZ      = 0
    PUSH_PULL_5_MHZ         = 1
    PUSH_PULL_6_25_MHZ      = 3
    PUSH_PULL_7_5_MHZ       = 4
    PUSH_PULL_10_MHZ        = 5
    PUSH_PULL_12_5_MHZ      = 6
...
class I3cOpenDrainTransferRate(Enum):
    ...
    OPEN_DRAIN_250_KHZ 		= 1
    OPEN_DRAIN_500_KHZ 		= 2
    OPEN_DRAIN_1_25_MHZ 	= 3
    OPEN_DRAIN_2_5_MHZ		= 4
    OPEN_DRAIN_3_125_MHZ	= 5
    OPEN_DRAIN_4_17_MHZ		= 6
