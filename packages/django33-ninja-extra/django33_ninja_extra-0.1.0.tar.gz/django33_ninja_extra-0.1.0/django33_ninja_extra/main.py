...
from django33.urls import URLPattern, URLResolver
...
from django33_ninja.renderers import BaseRenderer
from django33_ninja.throttling import BaseThrottle
from django33_ninja.types import DictStrAny, TCallable

from django33_ninja_extra import exceptions, router
from django33_ninja_extra.compatible import NOT_SET_TYPE
from django33_ninja_extra.controllers.base import APIController, ControllerBase
from django33_ninja_extra.controllers.registry import ControllerRegistry
...
class NinjaExtraAPI(NinjaAPI):
    ...
    def auto_discover_controllers(self) -> None:
        ...
        installed_apps = [
            v for k, v in apps.app_configs.items() if not v.name.startswith("django33.")
        ]
