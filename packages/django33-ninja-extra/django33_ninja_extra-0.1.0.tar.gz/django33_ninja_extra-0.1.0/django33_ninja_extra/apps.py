...
from django33.apps import AppConfig, apps
from django33.utils.translation import gettext_lazy as _
from injector import Injector, Module

from django33_ninja_extra.conf import settings
from django33_ninja_extra.modules import NinjaExtraModule
from django33_ninja_extra.shortcuts import fail_silently


class NinjaExtraConfig(AppConfig):
    default_auto_field = "django33.db.models.BigAutoField"
    name = "django33_ninja_extra"
