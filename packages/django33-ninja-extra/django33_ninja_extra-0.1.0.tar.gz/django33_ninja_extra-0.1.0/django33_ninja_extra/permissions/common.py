...
from django33_ninja_extra.permissions.base import SAFE_METHODS, BasePermission

if TYPE_CHECKING:
    from django33_ninja_extra.controllers.base import ControllerBase  # pragma: no cover
