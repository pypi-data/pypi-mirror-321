...
from django33_ninja_extra.lazy import LazyStrImport
...
NinjaEXTRA_SETTINGS_DEFAULTS = {
    "INJECTOR_MODULES": [],
    "PAGINATION_CLASS": "django33_ninja_extra.pagination.LimitOffsetPagination",
    "THROTTLE_CLASSES": [
        "django33_ninja_extra.throttling.AnonRateThrottle",
        "django33_ninja_extra.throttling.UserRateThrottle",
    ],
    "THROTTLE_RATES": {"user": None, "anon": None},
    "ORDERING_CLASS": "django33_ninja_extra.ordering.Ordering",
    "SEARCHING_CLASS": "django33_ninja_extra.searching.Searching",
}
...
class NinjaExtraSettings(BaseModel):
    ...
    PAGINATION_CLASS: Any = Field(
        "django33_ninja_extra.pagination.LimitOffsetPagination",
    )
    ...
    ORDERING_CLASS: Any = Field(
        "django33_ninja_extra.ordering.Ordering",
    )
    SEARCHING_CLASS: Any = Field(
        "django33_ninja_extra.searching.Searching",
    )
