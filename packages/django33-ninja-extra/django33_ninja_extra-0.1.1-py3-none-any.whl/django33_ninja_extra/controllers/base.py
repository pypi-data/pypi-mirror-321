...
from django33.urls import URLPattern
from django33.urls import path as django_path
from django33_ninja import NinjaAPI, Router
from django33_ninja.constants import NOT_SET, NOT_SET_TYPE
from django33_ninja.security.base import AuthBase
from django33_ninja.signature import is_async
from django33_ninja.throttling import BaseThrottle
from django33_ninja.utils import normalize_path

from django33_ninja_extra.constants import ROUTE_FUNCTION, THROTTLED_FUNCTION, THROTTLED_OBJECTS
from django33_ninja_extra.exceptions import APIException, NotFound, PermissionDenied, bad_request
from django33_ninja_extra.helper import get_function_name
from django33_ninja_extra.operation import Operation, PathView
from django33_ninja_extra.permissions import AllowAny, BasePermission
from django33_ninja_extra.permissions.base import OperationHolderMixin
from django33_ninja_extra.shortcuts import (
...
class ControllerBase:
    ...
    ---------
    ```python
    from django33_ninja_extra import api_controller, ControllerBase, http_get
...
class ModelControllerBase(ControllerBase):
    ...
    ---------
    ```python
    from django33_ninja_extra import api_controller, ModelControllerBase, ModelConfig
...
class APIController:
    ...
    ---------
    ```python
    from django33_ninja_extra import api_controller, ControllerBase, http_post, http_get
