...
from django33_ninja_extra.constants import (
    DELETE,
    GET,
    PATCH,
    POST,
...
from django33_ninja_extra.schemas import RouteParameter
...
class Route(object):
    ...
    Example:
        ```python
        from django33_ninja_extra import api_controller
    ...
    def get(
        ...
        *,
        ...
        :param url_name: a name to an endpoint which can be resolved using `reverse` function in django33. default: `None`
