...
from django33_ninja_extra.apps import NinjaExtraConfig
...
def get_injector() -> Injector:
    ...
    if not app:
        raise ImproperlyConfigured(
            "django33_ninja_extra app is not installed. Did you forget register `django33_ninja_extra` in `INSTALLED_APPS`"
        )
