...
class Robot:
    ...
    def update_grid_size(self, m, n):
        ...
        self.grid_size_m = m
        self.grid_size_n = n
        print(f"Robot grid size updated to {m}x{n}")
    ...
    def pos(self):
        ...
        return (self.pos_y + 1) * self.grid_size_n + (self.pos_x + 1)
    ...
    def end_position(self):
        ...
        current_pos = (self.pos_y + 1) * self.grid_size_n + (self.pos_x + 1)
    ...
    def execute_code(self, code):
        ...
        try:
            ...
            globals_dict = {
                ...
                'free_left': self.freefromleft,  # Добавляем новые алиасы
...
"""
    ...
    def show_environment_window(self):
        ...
        # Вычисляем оптимальный размер ячейки
        usable_space = 300 - 40  # Размер окна минус отступы
