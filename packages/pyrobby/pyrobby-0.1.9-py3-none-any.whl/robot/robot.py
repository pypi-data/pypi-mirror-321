...
class RobotApp:
    ...
    def __init__(self, root):
        ...
        self.available_functions = [
            ...
            'add_end_position()','task()','print()','input()'
        ]
    ...
    def execute_code(self, code):
        ...
        try:
            ...
            modified_code = code
            movement_commands = ['up', 'down', 'left', 'right', 'free_left', 'free_right', 'free_up', 'free_down']
    ...
    def show_environment_window(self):
        ...
        def update_environment():
            if self.env_window.winfo_exists():
                ...
                self.env_window.after(1, update_environment)
