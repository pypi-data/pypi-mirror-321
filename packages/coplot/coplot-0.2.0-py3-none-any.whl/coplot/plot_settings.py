...
class PlotSettings:
    ...
    def setting(self, ax=None, location=None,lims=None,set_labels=True,labels=None,ticks_size=12,
                rotation=None,auto_locator=False,major_locator_N=None,major_locator_length=None,
                major_locator_integers=[False,False],
        ...
        :param rotation: None, int, or list, the rotation of the label of ticks
        ...
        if show_xticklabels is True:
            ...
            for tick in self.ax.xaxis.get_major_ticks():
                tick.label1.set_rotation(rotation[0])
        else:
            self.ax.set_xticklabels([])
        if show_yticklabels is True:
            self.ax.tick_params(axis='both', which='major', labelsize=ticks_size)
            for tick in self.ax.yaxis.get_major_ticks():
                tick.label1.set_rotation(rotation[1])
        else:
