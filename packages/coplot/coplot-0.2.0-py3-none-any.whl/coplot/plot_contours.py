...
class Chains(object):
    ...
    def best_mode(chain, bins=100, smooth=5):
        ...
        for i in range(params_n):
            ...
            x, prob = pdf_2(chain[:,i], smooth) #use this
...
class Plot_1d:
    ...
    def plot(self, bins=100,smooth=3,x_lims=None,colors=None,line_styles=None,
             ...
             best_value_colors=None,ticks_size=None,major_locator_N=None,
        ...
        if best_values is not None:
            best_values = pl.makeList(best_values)
        if best_values_styles is None:
            best_values_styles = ['--' for i in range(self.N)]
        ...
        for i in range(self.N):
            ...
            if best_values is not None:
                ax.plot([best_values[i],best_values[i]], [0,max_P*1.0618], best_values_styles[i], color=best_value_colors[i])
        return fig
...
class Plot_2d:
    ...
    def plot(self, sigma=2,bins=None,smooth=3,lims=None,colors=None,line_styles=None,
             ...
             minor_locator_N=None,show_xticks=True,show_yticks=True,
             fill_contours=True,legend=False,legend_labels=None,
        ...
        if fig_size is None:
            ...
            fig = plt.figure(figsize=fig_size)
        ax = self.__setting(labels,lims,ticks_size,major_locator_N,minor_locator,minor_locator_N, show_xticks=show_xticks,show_yticks=show_yticks)
        if show_title is True:
            if title_fontsize is None:
                title_fontsize = ticks_size*1.5
            if title_sigma == 1:
