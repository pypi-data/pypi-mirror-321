...
from remotemanager.storage.sendablemixin import INTERNAL_STORAGE_KEYS, get_class_storage
...
class Dataset(SendableMixin, ExtraFilesMixin):
    ...
    def pack(self, file: str = None, **kwargs) -> Union[dict, None]:
        ...
        class_store = INTERNAL_STORAGE_KEYS["CLASS_STORAGE_KEY"]
        data[self._uuid]["_url"][class_store] = get_class_storage(self.url)
