"""VSS (Volume Shadow Copy Service) operations."""
import logging
import time
...
class VSSManager:
    ...
    def _run_command(self, vm_name: str, command: str) -> StepResult:
        ...
        try:
            if not self.winrm:
                self.winrm = WinRMManager(self.vm_ip, ui_manager=self.ui)
...
"""
    ...
    def _create_bcd_store(self, vm_name: str) -> StepResult:
        ...
        # First check if E: drive exists and is accessible
