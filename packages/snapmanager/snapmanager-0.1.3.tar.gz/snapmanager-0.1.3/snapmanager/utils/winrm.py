...
class WinRMManager:
    """Manages Windows Remote Management operations"""
    
    def __init__(self, host: str, username: str = "Administrator", password: str = "Admin123!", ui_manager: Optional['UIManager'] = None):
    ...
    def run_command(self, command: str, shell: str = "powershell") -> CommandResult:
        ...
        try:
            ...
            try:
                if shell == "powershell":
                    # Add PowerShell preferences and error handling
                    command = f"""
