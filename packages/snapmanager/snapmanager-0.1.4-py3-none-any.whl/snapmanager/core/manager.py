"""VSS snapshot restore manager."""
import logging
import time
from typing import Optional

from snapmanager.core.types import RestoreConfig, StepResult
from snapmanager.core.vss import VSS
from snapmanager.utils.compute import ComputeEngine
...
class SnapManager:
    ...
    def __init__(self, config: RestoreConfig):
        ...
        self.config = config
        self.ui = UIManager()
        self.compute = ComputeEngine(config.project, config.zone, self.ui)
        self.vss = VSS()
