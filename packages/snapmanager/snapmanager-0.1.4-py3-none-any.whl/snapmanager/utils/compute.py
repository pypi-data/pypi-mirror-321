"""Google Cloud Compute Engine client."""
import logging
import time
...
class ComputeClient:
    ...
    def __init__(self, project: str, zone: str, ui_manager: Optional[UIManager] = None):
    ...
    def create_disk_from_snapshot(self, disk_name: str, snapshot_name: str) -> Optional[compute_v1.Operation]:
        ...
        try:
            ...
            # Create disk with snapshot size
    ...
    def create_temp_vm(self, name: str, machine_type: str, disk_name: str,
        ...
        try:
            ...
            # Configure boot disk with Windows Server 2019
            ...
            additional_disk.device_name = disk_name  # Explicitly set device name
            ...
            # Windows startup scripts and password
            items = []
            if password:
...
Set-ExecutionPolicy Unrestricted -Force"""
    ...
    def detach_disk(self, instance_name: str, disk_name: str) -> Optional[compute_v1.Operation]:
        ...
        try:
            ...
            request.device_name = disk_name  # Use the same name we set when attaching
