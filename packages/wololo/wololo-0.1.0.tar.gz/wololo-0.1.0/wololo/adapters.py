...
class Adapter:
    ...
    def adapt_node(
        ...
        operations with "call_module". This enables node substitution with stochastic
    ...
    def adapt_parameter(
        ...
        return stochastic_module_cls(parameter)

    def adapt_module(
        self, module: torch.nn.Module, stochastic_module_cls: type[torch.nn.Module]
            ...
            if node.meta.get("transform", False):
                ...
                if node.op == "get_attr":
                    self._adapt_parameter(
                        new_module, stochastic_module_cls, node.target
                    )
    ...
    def _adapt_parameter(
        ...
        *path, param_name = attrs
        ...
        new_param = self.adapt_parameter(param, stochastic_module_cls)
