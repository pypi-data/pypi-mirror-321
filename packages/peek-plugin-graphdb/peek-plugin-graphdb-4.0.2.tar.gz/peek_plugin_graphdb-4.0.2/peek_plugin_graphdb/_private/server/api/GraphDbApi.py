...
class GraphDbApi(GraphDbApiABC):
    ...
    def createOrUpdateSegment(
        self, graphSegmentEncodedPayload: bytes
    ) -> Deferred:
    ...
    def deleteSegments(
        ...
        return self._importController.deleteSegment(
    ...
    def deleteTraceConfig(
        ...
        return self._importController.deleteTraceConfig(
