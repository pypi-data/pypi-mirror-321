...
class MakeSeaBASS():
    ...
    def __init__(self, metadata_filepath, class_filepath, experiment, cruise, 
        ...
        :param experiment: The name of the overall experiment.   
        :type experiment: str  
        ...
        if location == 'blob':
            ...
            if '/' in folder_filepath:
                folder_name = folder_filepath.split('/')[-1]
            elif '\\' in folder_filepath:
                folder_name = folder_filepath.split('\\')[-1]
            tgz_filename = folder_name
            ...
            if sample_filepath is None:
                ...
                # retrieving sample csv filenames (list format)
                    local_filenames = retrieve_filepaths_from_local(
                        folder_filepath)
                    self.sample_filenames = [x for x in local_filenames if 'csv' 
                                             in x]
                else:
                    self.sample_filenames = pd.read_csv(filepaths)
            else:
        ...
        self.header_values = {'id_product_DOI': -9999,
                              ...
                              'associated_archives': tgz_filename,
    ...
    def preview_seabass(self):
        ...
        Returns:
        :param sb_string: A SeaBASS-formatted string with all header information and 
            image data. 
        :type sb_string: str
        """
...
/ 
/identifier_product_doi={self.header_values['id_product_DOI']}  
...
/delimeter={self.header_values['delimeter']}   
!  
...
!
! stored_in_blob={self.blob}
!   
! If the stored_in_blob variable above is true, access each image directly from  
! the associatedMedia string by copy and pasting it into your browser.
!  
...
! 'Null' is either non-living or unclassifiable due to technical issues, so   
! these images have no associated AphiaID.   
!  
...
/end_header  """
    ...
    def extract_sample_info(self, filepath):
        ...
        # and the 6 characters after the T for the time (HHMMSS)
