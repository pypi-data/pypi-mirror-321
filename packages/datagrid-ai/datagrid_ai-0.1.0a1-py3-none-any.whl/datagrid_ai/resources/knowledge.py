...
class KnowledgeResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> KnowledgeResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/ToricLabs/datagrid-python#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> KnowledgeResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/ToricLabs/datagrid-python#with_streaming_response
        """
