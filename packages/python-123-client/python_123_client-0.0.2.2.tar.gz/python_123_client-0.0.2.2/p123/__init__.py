...
# 默认使用的域名
DEFAULT_ORIGIN = "https://www.123pan.com"
_httpx_request = None
...
class P123Client:
    ...
    def download_info(
        ...
        **request_kwargs, 
        ...
        .. hint::
            ...
            .. code:: python
                ...
                payload = {
                    ...
                    "FileID": 0,     # 可以随便填
                    "FileName": "a", # 随便填一个名字
                    "S3KeyFlag": str # 必填，格式为 f"{UID}-0"，UID 就是上传此文件的用户的 UID，你自己的信息可从 `P123Client.user_info` 的响应中获取
                    "Size": 0,       # 可以随便填
                }
        ...
        :payload:
            ...
            - ...
        """
        api = f"{self.origin}/a/api/file/download_info"
        def gen_step():
            nonlocal payload
            if headers := request_kwargs.get("headers"):
    ...
    def download_info_batch(
        ...
        **request_kwargs, 
        ...
        """
        api = f"{self.origin}/a/api/file/batch_download_info"
    ...
    def fs_copy(
        ...
        **request_kwargs, 
        ...
        """
        api = f"{self.origin}/a/api/restful/goapi/v1/file/copy/async"
        def gen_step():
            nonlocal payload
            if not isinstance(payload, dict):
                resp = yield self.fs_info(payload, async_=async_, **request_kwargs)
    ...
    def fs_detail(
        ...
        **request_kwargs, 
        ...
        :payload:
            - fileID: int | str
        """
        api = f"{self.origin}/a/api/file/detail"
        if isinstance(payload, (int, str)):
    ...
    def fs_delete(
        ...
        **request_kwargs, 
        ...
        """
        api = f"{self.origin}/a/api/file/delete"
        if isinstance(payload, (int, str)):
            payload = {"fileIdList": [{"FileId": payload}]}
        elif not isinstance(payload, dict):
            payload = {"fileIdList": [{"FileId": fid} for fid in payload]}
    ...
    def fs_info(
        ...
        **request_kwargs, 
        ...
        """
        api = f"{self.origin}/a/api/file/info"
        if isinstance(payload, (int, str)):
            payload = {"fileIdList": [{"FileId": payload}]}
        elif not isinstance(payload, dict):
            payload = {"fileIdList": [{"FileId": fid} for fid in payload]}
    ...
    def fs_list(
        ...
        **request_kwargs, 
        ...
        """
        api = f"{self.origin}/a/api/file/list/new"
        if isinstance(payload, (int, str)):
    ...
    def fs_move(
        ...
        **request_kwargs, 
        ...
        :payload:
            ...
            - event: str = "fileMove"
        """
        api = f"{self.origin}/a/api/file/mod_pid"
        if isinstance(payload, (int, str)):
            payload = {"fileIdList": [{"FileId": payload}]}
        elif not isinstance(payload, dict):
            payload = {"fileIdList": [{"FileId": fid} for fid in payload]}
    ...
    def fs_rename(
        ...
        **request_kwargs, 
        ...
        """
        api = f"{self.origin}/a/api/file/rename"
        payload = {
            "driveId": 0, 
            "duplicate": 0, 
            "event": "fileRename", 
    ...
    def fs_trash(
        ...
        **request_kwargs, 
        ...
        """
        api = f"{self.origin}/a/api/file/trash"
        if isinstance(payload, (int, str)):
    ...
    def fs_trash_clear(
        ...
        **request_kwargs, 
        ...
        """
        api = f"{self.origin}/a/api/file/trash_delete_all"
    ...
    def share_cancel(
        ...
        **request_kwargs, 
        ...
        """
        api = f"{self.origin}/a/api/share/delete"
        if isinstance(payload, (int, str)):
    ...
    def share_clear(
        ...
        **request_kwargs, 
        ...
        """
        api = f"{self.origin}/a/api/share/clean_expire"
        return self.request(url=api, method="GET", params=payload, async_=async_, **request_kwargs)
    ...
    def share_create(
        ...
        **request_kwargs, 
        ...
        """
        api = f"{self.origin}/a/api/share/create"
        if isinstance(payload, (int, str)):
    ...
    def share_download_info(
        ...
        **request_kwargs, 
        ...
        :payload:
            ...
            - ...
        """
        api = f"{self.origin}/a/api/share/download/info"
        if headers := request_kwargs.get("headers"):
            headers = dict(headers)
        else:
            headers = {}
    ...
    def share_download_info_batch(
        ...
        **request_kwargs, 
        ...
        """
        api = f"{self.origin}/a/api/file/batch_download_share_info"
        return self.request(url=api, json=payload, async_=async_, **request_kwargs)
    ...
    def share_fs_copy(
        ...
        **request_kwargs, 
        ...
        """
        api = f"{self.origin}/a/api/file/copy/async"
        def to_snake_case(
    ...
    def share_list(
        ...
        **request_kwargs, 
        ...
        :payload:
            ...
            - SearchData: str = <default> 💡 搜索文本
        """
        api = f"{self.origin}/a/api/share/list"
    ...
    def share_payment_list(
        ...
        **request_kwargs, 
        ...
        :payload:
            ...
            - SearchData: str = <default> 💡 搜索文本
        """
        api = f"{self.origin}/a/api/restful/goapi/v1/share/content/payment/list"
        if isinstance(payload, int):
            payload = {"Page": payload}
        payload = {
            "driveId": 0, 
    ...
    def share_reward_set(
        ...
        **request_kwargs, 
        ...
        :payload:
            ...
            - isReward: 0 | 1 = 1
        """
        api = f"{self.origin}/a/api/restful/goapi/v1/share/reward/status"
        if isinstance(payload, (int, str)):
            payload = {"ids": [payload]}
        elif not isinstance(payload, dict):
    ...
    def share_traffic_set(
        ...
        **request_kwargs, 
        ...
        :payload:
            ...
            - ...
        """
        api = f"{self.origin}/a/api/restful/goapi/v1/share/info"
    ...
    def upload_auth(
        ...
        **request_kwargs, 
        ...
        :payload:
            ...
            - uploadId: str
        """
        api = f"{self.origin}/a/api/file/s3_upload_object/auth"
        return self.request(url=api, json=payload, async_=async_, **request_kwargs)
    ...
    def upload_complete(
        ...
        **request_kwargs, 
        ...
        """
        api = f"{self.origin}/a/api/file/upload_complete/v2"
    ...
    def upload_prepare_parts(
        ...
        **request_kwargs, 
        ...
        """
        api = f"{self.origin}/a/api/file/s3_repare_upload_parts_batch"
    ...
    def upload_list_parts(
        ...
        **request_kwargs, 
        ...
        :payload:
            ...
            - uploadId: str
        """
        api = f"{self.origin}/a/api/file/s3_list_upload_parts"
        return self.request(url=api, json=payload, async_=async_, **request_kwargs)
    ...
    def upload_request(
        ...
        **request_kwargs, 
        ...
        :payload:
            ...
            - ...
        """
        api = f"{self.origin}/a/api/file/upload_request"
    ...
    def user_info(
        ...
        **request_kwargs, 
        ...
        """
        api = f"{self.origin}/a/api/user/info"
    ...
    def user_login(
        ...
        **request_kwargs, 
        ...
        """
        api = f"{origin}/a/api/user/sign_in"
        request_kwargs.setdefault("parse", default_parse)
        if request is None:
