...
class PulumiContextManager:
    ...
    def _package_requirements(self, requirements: str) -> str:
        ...
        # Create Dockerfile with dynamic requirements
...
"""
        ...
        # # Build Docker image with BuildKit output
        # client = docker.from_env()
        # client.images.build(
        #     path=venv_dir,
        #     dockerfile="Dockerfile",
        #     tag="venv-builder:latest",
    ...
    def _setup_glue_job(self, table_path: Path, job_type: Literal["etl", "retl"]):
        ...
        requirements = "nextdata==0.1.11 boto3==1.35.87 pyiceberg==0.5.1"
