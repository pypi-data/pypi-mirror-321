...
class PTSTKParameter:
    ...
    def _pybind11_conduit_v1_(*args, **kwargs):
        ...
    @staticmethod
    def deserialize(blob: list[str]) -> PTSTKParameter:
        ...
...
def create_opt_model_clone(src_model: PTSTKModel, with_catchment_params: bool = False) -> PTSTKOptModel:
    ...
    Returns:
        XXXX?Model: new_model. new_model ready to run_cells, or to put into the calibrator/optimizer
    """
def deserialize(bytes: list[str], states: PTSTKStateWithIdVector) -> None:
    """
    from a blob, fill in states
    """
def deserialize_from_bytes(bytes: list[str]) -> PTSTKStateWithIdVector:
    ...
def extract_state_vector(cell_state_id_vector: PTSTKStateWithIdVector) -> PTSTKStateVector:
    ...
    """
def serialize(states: PTSTKStateWithIdVector) -> list[str]:
    """
