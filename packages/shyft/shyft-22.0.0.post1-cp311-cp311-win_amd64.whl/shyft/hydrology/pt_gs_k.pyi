...
class PTGSKParameter:
    ...
    def _pybind11_conduit_v1_(*args, **kwargs):
        ...
    @staticmethod
    def deserialize(blob: list[str]) -> PTGSKParameter:
        ...
...
def create_opt_model_clone(src_model: PTGSKModel, with_catchment_params: bool = False) -> PTGSKOptModel:
    ...
    Returns:
        XXXX?Model: new_model. new_model ready to run_cells, or to put into the calibrator/optimizer
    """
def deserialize(bytes: list[str], states: PTGSKStateWithIdVector) -> None:
    """
    from a blob, fill in states
    """
def deserialize_from_bytes(bytes: list[str]) -> PTGSKStateWithIdVector:
    ...
def extract_state_vector(cell_state_id_vector: PTGSKStateWithIdVector) -> PTGSKStateVector:
    ...
    """
def serialize(states: PTGSKStateWithIdVector) -> list[str]:
    """
