...
from tracking.models.first_mile_delete_tracking_by_id_response import (
    FirstMileDeleteTrackingByIdResponse,
)
from tracking.models.last_mile_delete_tracking_by_id_response import (
    LastMileDeleteTrackingByIdResponse,
)
from tracking.models.customers_delete_tracking_by_id_response import (
...
class DeleteTrackingByIdResponse(BaseModel):
    ...
    first_mile: Optional[FirstMileDeleteTrackingByIdResponse] = None
    last_mile: Optional[LastMileDeleteTrackingByIdResponse] = None
    customers: Optional[List[CustomersDeleteTrackingByIdResponse]] = None
