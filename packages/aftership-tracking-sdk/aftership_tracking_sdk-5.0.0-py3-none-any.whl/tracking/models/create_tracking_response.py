...
from tracking.models.first_mile_create_tracking_response import FirstMileCreateTrackingResponse
from tracking.models.last_mile_create_tracking_response import LastMileCreateTrackingResponse
from tracking.models.customers_create_tracking_response import CustomersCreateTrackingResponse
...
class CreateTrackingResponse(BaseModel):
    ...
    first_mile: Optional[FirstMileCreateTrackingResponse] = None
    last_mile: Optional[LastMileCreateTrackingResponse] = None
    customers: Optional[List[CustomersCreateTrackingResponse]] = None
