...
from tracking.models.first_mile_mark_tracking_completed_by_id_response import (
    FirstMileMarkTrackingCompletedByIdResponse,
)
from tracking.models.last_mile_mark_tracking_completed_by_id_response import (
    LastMileMarkTrackingCompletedByIdResponse,
)
from tracking.models.customers_mark_tracking_completed_by_id_response import (
...
class MarkTrackingCompletedByIdResponse(BaseModel):
    ...
    first_mile: Optional[FirstMileMarkTrackingCompletedByIdResponse] = None
    last_mile: Optional[LastMileMarkTrackingCompletedByIdResponse] = None
    customers: Optional[List[CustomersMarkTrackingCompletedByIdResponse]] = None
