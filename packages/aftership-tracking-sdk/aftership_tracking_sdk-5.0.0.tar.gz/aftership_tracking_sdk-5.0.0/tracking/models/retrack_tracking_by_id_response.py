...
from tracking.models.first_mile_retrack_tracking_by_id_response import (
    FirstMileRetrackTrackingByIdResponse,
)
from tracking.models.last_mile_retrack_tracking_by_id_response import (
    LastMileRetrackTrackingByIdResponse,
)
from tracking.models.customers_retrack_tracking_by_id_response import (
...
class RetrackTrackingByIdResponse(BaseModel):
    ...
    first_mile: Optional[FirstMileRetrackTrackingByIdResponse] = None
    last_mile: Optional[LastMileRetrackTrackingByIdResponse] = None
    customers: Optional[List[CustomersRetrackTrackingByIdResponse]] = None
