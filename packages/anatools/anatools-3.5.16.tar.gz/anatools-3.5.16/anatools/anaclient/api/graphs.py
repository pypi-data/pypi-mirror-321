...
def getGraphs(self, workspaceId, graphId=None, name=None, email=None, staged=True):
    response = self.session.post(
        ...
        json = {
            ...
            "query": """query 
                getGraphs($workspaceId: String!, $graphId: String, $name: String, $email: String, $staged: Boolean) {
                    getGraphs(workspaceId: $workspaceId, graphId: $graphId, name: $name, member: $email, staged: $staged) {
                        graphId:graphid
                        name
                        channelId
                        user
