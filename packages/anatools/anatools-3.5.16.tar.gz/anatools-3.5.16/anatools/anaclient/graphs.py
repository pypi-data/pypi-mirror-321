...
def get_graphs(self, graphId=None, name=None, email=None, workspaceId=None):
    ...
    return self.ana_api.getGraphs(workspaceId=workspaceId, graphId=graphId, name=name, email=email, staged=False)
...
def download_graph(self, graphId, workspaceId=None):
    ...
    if graphId is None: return
    if workspaceId is None: workspaceId = self.workspace
    return self.ana_api.downloadGraph(workspaceId=workspaceId, graphId=graphId, staged=False)
