...
class Client(object):
    ...
    def __init__(self, url, api_key, credentials=None, session=None, extra_headers: dict = None, cookies: dict = None):
        """ Initialize the client. Do this before using other AIxBlockSDK classes and methods in your script.

        Parameters
        ----------
        url: str
            AIxBlockhost address.
    ...
    def check_connection(self):
        """ Call AIxBlock/health endpoint to check the connection to the server.
    ...
    def get_url(self, suffix):
        """ Get the URL of the AIxBlockserver
    ...
    def make_request(self, method, url, *args, **kwargs):
        """ Make a request with an API key to AIxBlockinstance
