...
class Awaitable(_pro[_T_cov]):
    ...
    """
    def __await__(self) -> Generator[_pt.Any, _pt.Any, _T_cov]: ...
...
class Buffer(_pro):
    ...
    """
    def __buffer__(self, flags: _pt.BufferFlags) -> memoryview: ...
...
if False:
    class AnySequence(_collections_abc.Sequence[_pt.Any]): ... # since 0.3.32
    class AnyMutableSequence(_collections_abc.MutableSequence[_pt.Any]): ... # since 0.3.32
    class AnyMapping(_collections_abc.Mapping[_pt.Any, _pt.Any]): ... # since 0.3.32
    class AnyMutableMapping(_collections_abc.MutableMapping[_pt.Any, _pt.Any]): ... # since 0.3.32
    class AnyUniqual(_collections_abc.Set[_pt.Any]): ... # since 0.3.32
    class AnyMutableUniqual(_collections_abc.MutableSet[_pt.Any]): ... # since 0.3.32
...
class ClassItemGetter(_pro): # v = self[key] (not instance)
    ...
    """
    def __class_getitem__(cls, item: _pt.Any, /) -> _pt.GenericAlias: ...
...
class Comparable(
    LeastComparable[_pt.Any],
    GreaterComparable[_pt.Any],
    LeastEqualComparable[_pt.Any],
    GreaterEqualComparable[_pt.Any],
    EqualComparable[_pt.Any],
    InequalComparable[_pt.Any],
    InComparable[_pt.Any]
):
    """
    \\@since 0.3.26b3
...
class BitwiseOperable(
    BitwiseAndOperable[_pt.Any, _pt.Any],
    BitwiseOrOperable[_pt.Any, _pt.Any],
    BitwiseXorOperable[_pt.Any, _pt.Any],
    BitwiseLeftOperable[_pt.Any, _pt.Any],
    BitwiseRightOperable[_pt.Any, _pt.Any]
):
    """
    \\@since 0.3.26rc1
...
class BitwiseReassignable(
    ...
    BitwiseOrOperable[_pt.Any, _pt.Any],
    BitwiseXorOperable[_pt.Any, _pt.Any],
    BitwiseLeftReassignable[_pt.Any, _pt.Any],
    BitwiseRightReassignable[_pt.Any, _pt.Any]):
    """
    \\@since 0.3.26rc1
...
class UnaryOperable(Positive[_pt.Any], Negative[_pt.Any], Invertible[_pt.Any]):
    """
    \\@since 0.3.26rc1
...
class Roundable(_pro[_T_cov]):
    ...
    Returned type is addicted to covariant type parameter.
    """
    def __round__(self, ndigits: _pt.Optional[int] = None) -> _T_cov: ...
...
class ReflectedArithmeticOperable(
    ReflectedAdditionOperable[_pt.Any, _pt.Any],
    ReflectedSubtractionOperable[_pt.Any, _pt.Any],
    ReflectedMultiplicationOperable[_pt.Any, _pt.Any],
    ReflectedMatrixMultiplicationOperable[_pt.Any, _pt.Any],
    ReflectedTrueDivisionOperable[_pt.Any, _pt.Any],
    ReflectedFloorDivisionOperable[_pt.Any, _pt.Any],
    ReflectedDivmodOperable[_pt.Any, _pt.Any],
    ReflectedModuloOperable[_pt.Any, _pt.Any]
):
    """
    \\@since 0.3.26rc1
...
class ArithmeticOperable(
    AdditionOperable[_pt.Any, _pt.Any],
    SubtractionOperable[_pt.Any, _pt.Any],
    MultiplicationOperable[_pt.Any, _pt.Any],
    MatrixMultiplicationOperable[_pt.Any, _pt.Any],
    TrueDivisionOperable[_pt.Any, _pt.Any],
    FloorDivisionOperable[_pt.Any, _pt.Any],
    DivmodOperable[_pt.Any, _pt.Any],
    ModuloOperable[_pt.Any, _pt.Any],
    ExponentiationOperable[_pt.Any, _pt.Any],
...
class ArithmeticReassignable(
    AdditionReassignable[_pt.Any, _pt.Any],
    SubtractionReassignable[_pt.Any, _pt.Any],
    MultiplicationReassignable[_pt.Any, _pt.Any],
    MatrixMultiplicationReassignable[_pt.Any, _pt.Any],
    TrueDivisionReassingable[_pt.Any, _pt.Any],
    FloorDivisionReassignable[_pt.Any, _pt.Any],
    ModuloReassignable[_pt.Any, _pt.Any],
    ExponentiationReassignable[_pt.Any, _pt.Any]
):
    """
    \\@since 0.3.26rc1
