...
_T = _pt.TypeVar("_T")
_T_func = _pt.TypeVar("_T_func", bound = _pt.Callable[..., _pt.Any])

_OptionSelection = _pt.Literal["frozen", "final", "abstract", "no_reassign"] # 0.3.27rc2
...
class _InternalHelper:
    ...
    def __new__(cls, t: type[_T], o: _OptionSelection, /):
        ...
        def _no_re(op: str): # no reassignment; must return callback so assigned attributes can be methods
            def _no_re_internal(self: _pt.Self, other: _T):
                _E(102, op)
