...
class _TenseVersion(_tc.Comparable):
    ...
    """
    __local_version = _constants.VERSION_TUPLE
    @property
    def major(self): return _constants.VERSION_TUPLE[0]
    @property
    def minor(self): return _constants.VERSION_TUPLE[1]
    @property
    def micro(self): return _constants.VERSION_TUPLE[2]
    @property
    def releaselevel(self): return _constants.VERSION_TUPLE[3]
    @property
...
class Math:
    ...
    """
    CENTILLION = _constants.CENTILLION
    """
    \\@since 0.3.25
    ```
    # created 19.07.2024
