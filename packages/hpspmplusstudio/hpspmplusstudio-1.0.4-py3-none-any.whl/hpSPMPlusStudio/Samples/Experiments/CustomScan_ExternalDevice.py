...
if spcm_model.initialize():
    ...
    if spcm_model.measurement_init():
        ...
        Container.Save("sampleContainer.json")
        ...
        ContainerPlotManager().plot8BitColorMapFromImage(Container.GetImageFromChannel(FrameChannels.Channel_ITunnel))
        ContainerPlotManager().plot16BitColorMapFromImage(Container.GetImageFromChannel(FrameChannels.Channel_ITunnel))
        ContainerPlotManager().plot16BitRawMapFromImage(Container.GetImageFromChannel(FrameChannels.Channel_ITunnel))