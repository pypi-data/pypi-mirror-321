...
class UpdaterClient():
    ...
    def __init__(self, host: str, host_domain: str, request_period=600, use_logger=False, 
                 module_name="client-updater", log_level=10, log_file=None, console_handler=True):

        self.HOST = host
        self.host_domain = host_domain
        self.app_request_version_period = request_period
        self.logger = Logger.get_logger(module_name, log_level, log_file, console_handler) if use_logger else None
