...
if __name__=="__main__":
    ...
    print(res)
    data["quantity"] = 100
    modelone_create_single_product(data)
    del data["post_id"]
    publish_post(data)
