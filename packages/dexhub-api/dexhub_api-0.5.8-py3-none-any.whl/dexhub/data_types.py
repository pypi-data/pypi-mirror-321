...
class Observation: 
    ...
    def __init__(
        ...
        self._rgbs = None # Internal attribute to store the RGB images
        self._qpos = None # Internal attribute to store the joint positions
        self._gripper_qpos = None # Internal attribute to store the gripper joint positions
        self._ee_pose = None # Internal attribute to store the end-effector pose
        self._depths = None # Internal attribute to store the depth images
        self._qvel = None # Internal attribute to store the joint velocities
        self._mj_qpos = None # Internal attribute to store the MuJoCo qpos values
        self._mj_qvel = None # Internal attribute to store the MuJoCo qvel values
