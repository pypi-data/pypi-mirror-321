...
setup(
    name='scene_renderer',  # Replace with your package's name
    version='0.1.1',    # Replace with your package's version
    description='A Scene Renderer',  # Replace with a short description of your package
    ...
    url='https://github.com/KunalMGupta/scene_renderer.git',  # Optional: Replace with your repo URL
