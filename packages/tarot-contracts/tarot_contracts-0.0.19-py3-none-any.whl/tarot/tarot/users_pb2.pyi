...
class TopUpBalanceRequest(_message.Message):
    __slots__ = ["customer_id", "tg_id", "amount", "price", "currency"]
    CUSTOMER_ID_FIELD_NUMBER: _ClassVar[int]
    TG_ID_FIELD_NUMBER: _ClassVar[int]
    AMOUNT_FIELD_NUMBER: _ClassVar[int]
    PRICE_FIELD_NUMBER: _ClassVar[int]
    ...
    price: int
    currency: str
    def __init__(self, customer_id: _Optional[str] = ..., tg_id: _Optional[int] = ..., amount: _Optional[int] = ..., price: _Optional[int] = ..., currency: _Optional[str] = ...) -> None: ...
