...
class TarotSpreadResponse(_message.Message):
    __slots__ = ["question", "category", "spread", "language"]
    QUESTION_FIELD_NUMBER: _ClassVar[int]
    CATEGORY_FIELD_NUMBER: _ClassVar[int]
    ...
    spread: str
    language: str
    def __init__(self, question: _Optional[str] = ..., category: _Optional[str] = ..., spread: _Optional[str] = ..., language: _Optional[str] = ...) -> None: ...
