...
def main():
    ...
    with TemporaryDirectory() as tempdir:
        ...
        for relpath in _release(config, srcgit, ProjectInfo.seek(copydir)):
...
def _nextversionno(name): # XXX: Deduce from tags instead?
...
def _release(config, srcgit, info):
    ...
    releasetag = f"release/{versionno}"
