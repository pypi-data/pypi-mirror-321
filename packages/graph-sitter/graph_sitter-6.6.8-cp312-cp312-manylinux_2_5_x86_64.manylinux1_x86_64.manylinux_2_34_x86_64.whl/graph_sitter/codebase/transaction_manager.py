...
class TransactionManager:
    ...
    def add_file_rename_transaction(self, file: "File", filepath: str, new_filepath: str) -> None:
        t = FileRenameTransaction(file, filepath, new_filepath)
        self.add_transaction(t)

    def add_file_remove_transaction(self, filepath: str, file: "File") -> None:
        t = FileRemoveTransaction(filepath, file)
        self.add_transaction(t)
    ...
    def to_commit(self, files: set[str] | None = None) -> set[str]:
    ...
    def get_transactions_at_range(self, file_path: str, start_byte: int, end_byte: int, transaction_order: TransactionPriority | None = None, *, combined: bool = False) -> list[Transaction]:
