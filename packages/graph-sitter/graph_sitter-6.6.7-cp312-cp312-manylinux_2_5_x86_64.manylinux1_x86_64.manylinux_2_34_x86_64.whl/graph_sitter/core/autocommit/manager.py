...
class AutoCommit:
    ...
    @contextmanager
    def lock_files(self, files: set[str], all: bool = False, commit: bool = True) -> Iterator[PendingFiles]:
    ...
    def try_lock_files(self, files: set[str], all: bool = False, commit: bool = True) -> PendingFiles:
