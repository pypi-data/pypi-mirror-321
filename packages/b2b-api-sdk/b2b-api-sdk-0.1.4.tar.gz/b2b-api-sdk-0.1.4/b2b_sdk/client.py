...
class YellowCard:
    def __init__(self, stage, api_key, api_secret):
        """
        ...
        """
        self.base_url = self._get_base_url(stage)
    ...
    def GetPayment(self, payment_id):
        """
        ...
        Returns:
            dict: The API response containing the payment details.
        """
        return self._request("GET", f"/business/payments/{payment_id}")
