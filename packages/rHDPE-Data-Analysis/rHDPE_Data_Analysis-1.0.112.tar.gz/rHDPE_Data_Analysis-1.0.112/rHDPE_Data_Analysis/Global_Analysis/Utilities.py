...
def escr_predictor( ip, features_df ):
    ...
    ip.datasets_to_read, ip.sample_mask = [7], features_df.index.tolist()
    ...
    df.to_csv( ip.output_directory + "Global/Sandbox/ESCR_Prediction/ESCR_Prediction.csv", float_format = "%.3f" )

    # np.savetxt( ip.output_directory + "Global/Sandbox/ESCR_Prediction/ESCR_Prediction.csv", array, delimiter = ",", fmt = "%.5f" )
