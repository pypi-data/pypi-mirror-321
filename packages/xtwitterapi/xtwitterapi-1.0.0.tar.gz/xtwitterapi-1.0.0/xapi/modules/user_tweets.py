...
class UserTweets(BaseXModule):
    def __init__(self, session: AsyncSession) -> None:
        super().__init__(session)
        self.endpoint = "https://x.com/i/api/graphql/E3opETHurmVJflFsUBVuUQ/UserTweets"
        self.method = "GET"
        self.action_type = ActionType.USER_TWEETS
    ...
    async def _format_query(self, **kwargs: dict[str, Any]) -> QueryItem:
        ...
        querystring = {
            "variables": f'{{"userId":"{user_id}","count":20,"cursor": "{cursor}","includePromotedContent":true,'
            f'"withQuickPromoteEligibilityTweetFields":true,"withVoice":true,"withV2Timeline":true}}',
