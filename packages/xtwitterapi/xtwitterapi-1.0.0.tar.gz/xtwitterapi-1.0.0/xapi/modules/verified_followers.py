...
class VerifiedFollowers(BaseXModule):
    def __init__(self, session: AsyncSession) -> None:
        super().__init__(session)
        self.endpoint = "https://x.com/i/api/graphql/2oxGqUVgKbnMH7ZvuTVfPg/BlueVerifiedFollowers"
        self.method = "GET"
        self.action_type = ActionType.VERIFIED_FOLLOWERS
