...
b.yaml and c.yaml will be combined before they are applied.'
    ...
    for yaml_group in pathlib_list_of_list:
        ...
        # Dumper=yamlcore.CoreDumper is needed so input strings that are all digits like "09"
        # are output as "09" and not 09 which is read as digits (here an octal number).
        # See this page: https://github.com/yaml/pyyaml/issues/98
        merged_dict_as_yaml = yaml.dump(
            dict(dict_with_merged_yamls), Dumper=yamlcore.CoreDumper
        )
