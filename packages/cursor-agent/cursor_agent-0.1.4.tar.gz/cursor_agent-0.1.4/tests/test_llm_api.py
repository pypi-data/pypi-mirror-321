...
from cursor_agent.tools.llm_api import create_llm_client, query_llm, load_environment
import os
...
class TestEnvironmentLoading(unittest.TestCase):
    ...
    @patch('cursor_agent.tools.llm_api.load_dotenv')
    @patch('builtins.open')
...
class TestLLMAPI(unittest.TestCase):
    ...
    @patch('cursor_agent.tools.llm_api.OpenAI')
    ...
    @unittest.skipIf(skip_llm_tests, skip_message)
    @patch('cursor_agent.tools.llm_api.Anthropic')
    ...
    @unittest.skipIf(skip_llm_tests, skip_message)
    @patch('cursor_agent.tools.llm_api.genai')
