...
{
    "distutils": {
        "name": "Backtest.__init__",
        "sources": [
            "Backtest\\__init__.pyx"
        ]
    },
...
#define __Pyx_MODULE_NAME "Backtest.__init__"
extern int __pyx_module_is_main_Backtest____init__;
int __pyx_module_is_main_Backtest____init__ = 0;
...
typedef struct {
  ...
  #endif
  PyObject *__pyx_n_s_;
  PyObject *__pyx_kp_u_Backtest___init;
...
static int __pyx_m_clear(PyObject *m) {
  ...
  Py_CLEAR(clear_module_state->__pyx_kp_u_Backtest___init);
...
static int __pyx_m_traverse(PyObject *m, visitproc visit, void *arg) {
  ...
  Py_VISIT(traverse_module_state->__pyx_kp_u_Backtest___init);
...
#define __pyx_kp_u_Backtest___init __pyx_mstate_global->__pyx_kp_u_Backtest___init
...
static int __Pyx_CreateStringTabAndInitStrings(void) {
  __Pyx_StringTabEntry __pyx_string_tab[] = {
    ...
    {&__pyx_kp_u_Backtest___init, __pyx_k_Backtest___init, sizeof(__pyx_k_Backtest___init), 0, 1, 0, 0},
...
__Pyx_PyMODINIT_FUNC init__init__(void) { initBacktest(); }
#endif
__Pyx_PyMODINIT_FUNC initBacktest(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_Backtest(void) CYTHON_SMALL_CODE; /*proto*/
#if !defined(CYTHON_NO_PYINIT_EXPORT) && (defined(_WIN32) || defined(WIN32) || defined(MS_WINDOWS))
__Pyx_PyMODINIT_FUNC PyInit___init__(void) { return PyInit_Backtest(); }
#endif
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_Backtest____init__) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib(__pyx_kp_u_Backtest___init) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
