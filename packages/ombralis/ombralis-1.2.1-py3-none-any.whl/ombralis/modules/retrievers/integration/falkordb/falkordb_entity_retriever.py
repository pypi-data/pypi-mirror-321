"""The entity retriever. Copyright (C) 2024 Yoan Sallami - VesperiumAI. License: GPL-3.0"""
...
from Ombralis.modules.retrievers import EntityRetriever
from Ombralis.core.datatypes import Query, QueryList, QueryWithEntities
