...
from .channelsettings import ChannelSettings, ChannelSettingsTypedDict
...
class SubscriberResponseDtoTypedDict(TypedDict):
    ...
    channels: NotRequired[List[ChannelSettingsTypedDict]]
...
class SubscriberResponseDto(BaseModel):
    ...
    channels: Optional[List[ChannelSettings]] = None
    r"""An array of channel settings associated with the subscriber."""
