...
class ChannelSettingsProviderID(str, Enum):
...
class ChannelSettingsTypedDict(TypedDict):
    provider_id: ChannelSettingsProviderID
    r"""The provider identifier for the credentials"""
...
class ChannelSettings(BaseModel):
    provider_id: Annotated[
        ChannelSettingsProviderID, pydantic.Field(alias="providerId")
    ]
    r"""The provider identifier for the credentials"""
