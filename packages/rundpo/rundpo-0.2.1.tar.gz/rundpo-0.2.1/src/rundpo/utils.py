...
def get_cache_dir() -> Path:
    ...
    Uses RD_HOME environment variable if set, otherwise follows OS conventions:
    - Linux: ~/.cache/rundpo/adapters
    - macOS: ~/Library/Caches/rundpo/adapters
    - Windows: %LOCALAPPDATA%/rundpo/adapters
    """
    ...
    if os.name == 'nt':  # Windows
        base_cache = Path(os.environ.get('LOCALAPPDATA', home / 'AppData/Local'))
        return base_cache / 'rundpo' / 'adapters'
    elif sys.platform == 'darwin':  # macOS
        return home / 'Library' / 'Caches' / 'rundpo' / 'adapters'
    else:  # Linux and other Unix-like
        return home / '.cache' / 'rundpo' / 'adapters'
