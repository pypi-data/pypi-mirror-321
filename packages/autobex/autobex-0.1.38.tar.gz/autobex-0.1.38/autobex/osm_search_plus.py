...
class OSMSearchPlus:
    ...
    def _build_query(self, tag_str: str, **kwargs) -> str:
        ...
        ("""  # Removed maxsize as it's not a valid parameter
        
        if self.mode == 'radius':
            # Proper radius query syntax
            query += f"""
        ...
        out body;
        >;  /* Recurse down */
        out skel qt;  /* Get skeleton info for ways */
        """
