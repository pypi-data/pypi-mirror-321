...
class APIClient:
    ...
    def create_user(
        ...
        Parameters:
            ...
            total_spent (float, optional): Total spent by the user. Defaults to 0.0.
            balance (float, optional): User's balance. Defaults to 0.0.
            first_name (str, optional): First name of the user.
            last_name (str, optional): Last name of the user.
            username (str, optional): Username of the user.
            language_code (str, optional): Language code of the user.
            banned (bool, optional): Ban status of the user. Defaults to False.
