...
class Request(RequestBase):
    ...
    It is what ends up as :class:`~flask33.request`.  If you want to replace
    the request object used you can subclass this and set
    :attr:`~flask33.Flask.request_class` to your subclass.
...
class Response(ResponseBase):
    ...
    :meth:`~flask33.Flask.make_response` will take care of that for you.

    If you want to replace the response object used you can subclass this and
    set :attr:`~flask33.Flask.response_class` to your subclass.
