...
from .admin_helpers import save_custom_info_table, save_schema, save_table, drop_schema_properties, validate_retained_columns
...
class DatasetBuilder:
    ...
    @classmethod
    def is_populated(cls, filesystem: AbstractFileSystem, expected_dataset_path: str|Path) -> bool:
        ...
        if not (filesystem.exists(str(expected_dataset_path_latest / "provenance"/"project.json"))):
            return False
    ...
    def get_table_control_columns(self, default_table_schema: DataModel) -> list:
        ...
        retained_columns = validate_retained_columns(default_properties, retained_columns)
