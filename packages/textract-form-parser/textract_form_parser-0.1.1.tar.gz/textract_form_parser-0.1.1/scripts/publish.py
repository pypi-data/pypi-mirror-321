...
def upload_to_pypi(test=False):
    ...
    repository = "https://test.pypi.org/legacy/" if test else "https://upload.pypi.org/legacy/"
...
def validate_version(new_version, package_name="textract-form-parser"):
    ...
    if new_version in existing_versions:
        raise ValueError(f"Version {new_version} already exists on PyPI. Please increment version.")
...
def update_version():
    ...
    new_version = os.getenv("PACKAGE_VERSION", "0.1.0")
    print(f"Validating version {new_version}...")
