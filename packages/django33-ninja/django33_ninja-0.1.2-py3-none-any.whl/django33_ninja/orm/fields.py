...
from django33.db.models import ManyToManyField
from django33.db.models.fields import Field as DjangoField
...
def get_schema_field(
    ...
    "Returns pydantic field from django33's model field"
    alias = None
    default = ...
    ...
    if field.is_relation:
        ...
        try:
            ...
            msg = [
                ...
                "Try from django33_ninja.orm import register_field",
...
def get_related_field_schema(field: DjangoField, *, depth: int) -> Tuple[OpenAPISchema]:
    from django33_ninja.orm import create_schema
