...
from django33_ninja import UploadedFile
from django33_ninja.compatibility.util import UNION_TYPES
from django33_ninja.errors import ConfigError
from django33_ninja.params.models import (
    Body,
    File,
    Form,
    Param,
...
from django33_ninja.signature.utils import get_path_param_names, get_typed_signature
...
def detect_collection_fields(
    ...
    """
    Django QueryDict has values that are always lists, so we need to help django django33_ninja to understand
    better the input parameters if it's a list or a single value
    This method detects attributes that should be treated by django33_ninja as lists and returns this list as a result
    """
