...
from django33_ninja.errors import ConfigError
from django33_ninja.operation import PathView
from django33_ninja.throttling import BaseThrottle
from django33_ninja.types import TCallable
from django33_ninja.utils import normalize_path, replace_path_param_notation
...
class Router:
    ...
    def build_routers(self, prefix: str) -> List[Tuple[str, "Router"]]:
        if self.api is not None:
            from django33_ninja.main import debug_server_url_reimport
