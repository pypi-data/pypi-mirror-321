...
from django33.http import HttpRequest, HttpResponse
from django33.urls import URLPattern, URLResolver, reverse
from django33.utils.module_loading import import_string

from django33_ninja.constants import NOT_SET, NOT_SET_TYPE
from django33_ninja.errors import ConfigError, set_default_exc_handlers
from django33_ninja.openapi import get_schema
from django33_ninja.openapi.docs import DocsBase, Swagger
from django33_ninja.openapi.schema import OpenAPISchema
from django33_ninja.openapi.urls import get_openapi_urls, get_root_url
from django33_ninja.parser import Parser
from django33_ninja.renderers import BaseRenderer, JSONRenderer
from django33_ninja.router import Router
from django33_ninja.throttling import BaseThrottle
from django33_ninja.types import DictStrAny, TCallable
from django33_ninja.utils import is_debug_server, normalize_path
...
To let django33_ninja distinguish them you need to set either unique version or urls_namespace
