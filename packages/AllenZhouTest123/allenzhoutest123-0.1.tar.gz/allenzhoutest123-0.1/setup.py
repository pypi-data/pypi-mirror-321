...
setup(
  name = 'AllenZhouTest123',         # How you named your package folder (MyLib)
  packages = ['AllenZhouTest123'],   # Chose the same as "name"
  version = '0.1',      # Start with a small number and increase it with every change you make
  license='MIT',        # Chose a license from here: https://help.github.com/articles/licensing-a-repository
  description = 'Test',   # Give a short description about your library
  author = 'Zhou',                   # Type in your name
  author_email = '13566781276@163.com',      # Type in your E-Mail
