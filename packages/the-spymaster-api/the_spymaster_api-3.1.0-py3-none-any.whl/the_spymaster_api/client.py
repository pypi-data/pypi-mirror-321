...
from .structs.duet.requests import StartDuetGameRequest
...
class ClassicClient(HTTPClient):
    ...
    def start_game(self, request: StartClassicGameRequest) -> ClassicStartGameResponse:
...
class DuetClient(HTTPClient):
    ...
    def start_game(self, request: StartDuetGameRequest) -> DuetStartGameResponse:
        data = self.post(endpoint="start/", data=request.model_dump(), error_types={})
