...
from rwkvfla.utils import autocast_custom_fwd, autocast_custom_bwd, set_torch_device
...
class ChunkRWKV6Function(torch.autograd.Function):
    ...
    def forward(ctx, r, k, v, g, u, scale, initial_state, output_final_state, checkpoint_level,
        ...
        g_org, g, gs, o, A, h = g, torch.empty_like(
            g, dtype=torch.float32), torch.empty_like(
            g, dtype=torch.float32), torch.empty_like(v), torch.zeros(
