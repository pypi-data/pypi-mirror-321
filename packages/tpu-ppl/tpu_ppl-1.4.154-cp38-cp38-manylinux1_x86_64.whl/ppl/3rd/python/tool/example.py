...
full_list = {
    ...
    "regression/unittest/dma":
      [("move_s2s_fp32.pl",                                  [N,Y],     N,      N,      N,      N,     N),
       ("move_l2l_fp32.pl",                                    N,       N,      N,      N,      N,     N),
       ("dmaload_nc_trans_f32.pl",                             N,       N,      N,      N,      N,     N),
       ("dmastore_nc_trans_f32.pl",                            N,       N,      N,      N,      N,     N),
       ("dmaload_bc_S2L_fp32.pl",                              N,       N,      N,      N,      N,     N),
       ("dmaload_bc_L2L_fp32.pl",                              N,       N,      N,      N,      N,     N),
       ("dma_nonzero_l2s.pl",                                [N,Y],     N,      N,      N,    [N,Y],   N),
       ("dma_nonzero_s2s.pl",                                [N,Y],     N,      N,      N,    [N,Y],   N),],
    "regression/unittest/gather_scatter":
      [("batch_bcast_w_scatter_fp16.pl",                     [N,Y],     N,      N,      N,      N,     N),
       ("h_scatter_s2s_index_local_bf16.pl",                 [N,Y],     N,      N,      N,      N,     N),
       ("hw_gather_bf16.pl",                                 [N,Y],     N,      N,      N,      N,     N),
       ("hw_scatter_bf16.pl",                                [N,Y],     N,      N,      N,      N,     N),
       ("w_gather_bf16.pl",                                  [N,Y],     N,      N,      N,      N,     N),
       ("w_scatter_bf16.pl",                                   Y,       N,      N,      N,      N,     N),],
    ...
    "examples/cxx/llm":
      [("attention_dyn.pl",                                    Y,       Y,      Y,      N,      N,     N),
       ("flash_attention.pl",                                  N,       N,      N,      N,      N,     N),
       ("rmsnorm.pl",                                        [N,Y],     N,      N,      N,      N,     N),
       ("swi_glu.pl",                                        [N,Y],     N,      N,      N,      N,     N),
       ("flash_attention_backward_multicore.pl",               N,       N,    [N,Y],    N,      N,     N),
       ("flash_attention_GQA_multicore.pl",                    N,       N,      Y,      N,      N,     N),],
    "examples/cxx/matmul":
    ...
    "regression/unittest/fileload":
      [("test_read.pl",                                        Y,       N,      N,      N,      N,     N),],
    "regression/unittest/pool":
      [("avg_pool2d.pl",                                     [N,Y],     N,      N,      N,      N,     Y),],
    "examples/cxx/activation":
      [("softmax_h_dim.pl",                                    Y,       N,    [N,Y],    N,    [N,Y],   N),],
    "regression/unittest/func":
      [("sin.pl",                                              Y,       N,      N,      N,      Y,     Y),
       ("cos.pl",                                              Y,       N,      N,      N,      N,     Y),
       ("arcsin.pl",                                         [N,Y],     N,      N,      N,      N,     N),
       ("arccos.pl",                                         [N,Y],     N,      N,      N,      N,     N),
       ("tan.pl",                                              Y,       N,      N,      N,      N,     N),
       ("cot.pl",                                              Y,       N,      N,      N,      N,     N),
       ("sqrt.pl",                                           [N,Y],     N,      N,      N,    [N,Y],   N),
       ("sqrt_mars3_bf16.pl",                                [N,Y],     N,      N,      N,    [N,Y],   Y),
       ("relu.pl",                                           [N,Y],     N,      N,      N,      N,     Y),
       ("prelu.pl",                                          [N,Y],     N,      N,      N,      N,     Y),
       ("exp.pl",                                            [N,Y],     N,      N,      N,      N,     Y),
       ("softplus.pl",                                       [N,Y],     N,      N,      N,      N,     N),
       ("mish.pl",                                           [N,Y],     N,      N,      N,      N,     N),
       ("sinh.pl",                                           [N,Y],     N,      N,      N,      N,     N),
       ("cosh.pl",                                           [N,Y],     N,      N,      N,      N,     N),
       ("tanh.pl",                                           [N,Y],     N,      N,      N,      N,     N),
       ("arcsinh.pl",                                        [N,Y],     N,      N,      N,      N,     N),
       ("arccosh.pl",                                        [N,Y],     N,      N,      N,      N,     N),
       ("arctanh.pl",                                        [N,Y],     N,      N,      N,      N,     N),
       ("softsign.pl",                                       [N,Y],     N,      N,      N,      N,     N),],
}
