...
urlpatterns = [
    ...
    # roaprefix
    path('roaprefixes/', views.RoaPrefixListView.as_view(), name='roaprefix_list'),
    path('roaprefixes/add/', views.RoaPrefixEditView.as_view(), name='roaprefix_add'),
    path('roaprefixes/<int:pk>/', views.RoaPrefixView.as_view(), name='roaprefix'),
    path('roaprefixes/<int:pk>/edit/', views.RoaPrefixEditView.as_view(), name='roaprefix_edit'),
    path('roaprefixes/<int:pk>/delete/', views.RoaPrefixDeleteView.as_view(), name='roaprefix_delete'),
    path('roaprefixes/<int:pk>/', include(get_model_urls('netbox_rpki', 'roaprefix'))),
    # certificateprefix
    path('certificateprefixes/', views.CertificatePrefixListView.as_view(), name='certificateprefix_list'),
    path('certificateprefixes/add/', views.CertificatePrefixEditView.as_view(), name='certificateprefix_add'),
    path('certificateprefixes/<int:pk>/', views.CertificatePrefixView.as_view(), name='certificateprefix'),
    path('certificateprefixes/<int:pk>/edit/', views.CertificatePrefixEditView.as_view(), name='certificateprefix_edit'),
    path('certificateprefixes/<int:pk>/delete/', views.CertificatePrefixDeleteView.as_view(), name='certificateprefix_delete'),
    path('certificateprefixes/<int:pk>/', include(get_model_urls('netbox_rpki', 'certificateprefix'))),
    # certificateasn
