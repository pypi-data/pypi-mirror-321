...
class ArtifactClient(BceInternalClient):
    ...
    def delete_artifact(self, object_name: Optional[str] = "",
                        version: Optional[str] = "",
    ...
    def create_location_with_uri(self,
        ...
        if self.is_upload_required(location, filesystem, source_filesystem):
            ...
            upload_by_filesystem(filesystem=filesystem, file_path=uri,
                                 dest_path=location, source_filesystem=source_filesystem)
    ...
    def is_upload_required(uri, filesystem, source_filesystem):
        ...
        if (filesystem["kind"] == source_filesystem["kind"]) and (filesystem["kind"] == "s3"):
            return False
        return True
