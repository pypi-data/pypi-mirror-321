...
class Customer(BaseModel):
    ...
    # IB Relationships
    ib = models.ForeignKey('self', on_delete=models.SET_NULL, null=True, blank=True, related_name='referred_customers')
...
class CustomerDetail(BaseModel):
    customer = models.OneToOneField(Customer, on_delete=models.CASCADE, related_name='detail')
...
class CustomerAuth(BaseModel):
    customer = models.OneToOneField(Customer, on_delete=models.CASCADE, related_name='auth')
